...
impl Depth9Fmt {
    # [doc = "specification constructor for `depth9`."] pub open spec fn spec_inner() -> Depth9FmtSpec {
        Named ("depth9",
        Mapped {
            inner: Depth8Fmt,
            mapper: BiMap (Depth9Forward,
            Depth9Reverse),
        }
        )
    }
...
impl Depth10Fmt {
    # [doc = "specification constructor for `depth10`."] pub open spec fn spec_inner() -> Depth10FmtSpec {
        Named ("depth10",
        Mapped {
            inner: Depth9Fmt,
            mapper: BiMap (Depth10Forward,
            Depth10Reverse),
        }
        )
    }
...
impl Depth11Fmt {
    # [doc = "specification constructor for `depth11`."] pub open spec fn spec_inner() -> Depth11FmtSpec {
        Named ("depth11",
        Mapped {
            inner: Depth10Fmt,
            mapper: BiMap (Depth11Forward,
            Depth11Reverse),
        }
        )
    }
...
impl Depth12Fmt {
    # [doc = "specification constructor for `depth12`."] pub open spec fn spec_inner() -> Depth12FmtSpec {
        Named ("depth12",
        Mapped {
            inner: Depth11Fmt,
            mapper: BiMap (Depth12Forward,
            Depth12Reverse),
        }
        )
    }
...
impl Depth13Fmt {
    # [doc = "specification constructor for `depth13`."] pub open spec fn spec_inner() -> Depth13FmtSpec {
        Named ("depth13",
        Mapped {
            inner: Depth12Fmt,
            mapper: BiMap (Depth13Forward,
            Depth13Reverse),
        }
        )
    }
...
impl Depth14Fmt {
    # [doc = "specification constructor for `depth14`."] pub open spec fn spec_inner() -> Depth14FmtSpec {
        Named ("depth14",
        Mapped {
            inner: Depth13Fmt,
            mapper: BiMap (Depth14Forward,
            Depth14Reverse),
        }
        )
    }
...
impl Depth15Fmt {
    # [doc = "specification constructor for `depth15`."] pub open spec fn spec_inner() -> Depth15FmtSpec {
        Named ("depth15",
        Mapped {
            inner: Depth14Fmt,
            mapper: BiMap (Depth15Forward,
            Depth15Reverse),
        }
        )
    }
...
impl Depth16Fmt {
    # [doc = "specification constructor for `depth16`."] pub open spec fn spec_inner() -> Depth16FmtSpec {
        Named ("depth16",
        Mapped {
            inner: Depth15Fmt,
            mapper: BiMap (Depth16Forward,
            Depth16Reverse),
        }
        )
    }
...
mod derived_proofs {
    ...
    impl SoundParser for Depth9Fmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner() ;
            assert forall | input: Depth9Inner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for Depth9Fmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< Depth9Fmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner() ;
            assert forall | output: Depth9Spec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
    ...
    impl SoundParser for Depth10Fmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner() ;
            assert forall | input: Depth10Inner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for Depth10Fmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< Depth10Fmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner() ;
            assert forall | output: Depth10Spec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
    ...
    impl SoundParser for Depth11Fmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner() ;
            assert forall | input: Depth11Inner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for Depth11Fmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< Depth11Fmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner() ;
            assert forall | output: Depth11Spec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
    ...
    impl SoundParser for Depth12Fmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner() ;
            assert forall | input: Depth12Inner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for Depth12Fmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< Depth12Fmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner() ;
            assert forall | output: Depth12Spec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
    ...
    impl SoundParser for Depth13Fmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner() ;
            assert forall | input: Depth13Inner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for Depth13Fmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< Depth13Fmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner() ;
            assert forall | output: Depth13Spec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
    ...
    impl SoundParser for Depth14Fmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner() ;
            assert forall | input: Depth14Inner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for Depth14Fmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< Depth14Fmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner() ;
            assert forall | output: Depth14Spec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
    ...
    impl SoundParser for Depth15Fmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner() ;
            assert forall | input: Depth15Inner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for Depth15Fmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< Depth15Fmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner() ;
            assert forall | output: Depth15Spec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
    ...
    impl SoundParser for Depth16Fmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner() ;
            assert forall | input: Depth16Inner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for Depth16Fmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< Depth16Fmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner() ;
            assert forall | output: Depth16Spec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
