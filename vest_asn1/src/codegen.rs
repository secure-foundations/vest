...
impl<'a> Generator<'a> {
    pub(super) fn generate(&self) -> Result<String, CodegenError> {
        ...
        output.line(format_args!(
            "// @generated by vest_asn1 from ASN.1 module `{}`.",
            self.module.name
        ));
        output.line(format_args!(
        ...
        output.blank_line();
        output.line(format_args!("use vest_lib::asn1::*;"));
        output.line(format_args!(
            "use vest_lib::asn1::der_ord::{{DerOrd, DerState}};"
        ));
        output.line(format_args!("#[cfg(verus_only)]"));
        output.line(format_args!(
            "use vest_lib::asn1::disjoint::{{asn1_start_any_non_eoc, asn1_start_ber_boundary, asn1_start_empty, asn1_start_exact_uint, asn1_start_identity_uint, asn1_start_mask, asn1_start_union, asn1_starts_disjoint, lemma_asn1_start_exact_uint, lemma_asn1_start_identity_uint, lemma_disjoint_asn1_starts, HasAsn1Start}};"
        ));
        output.line(format_args!("use vest_lib::asn1::tag::tag_num_from_uint;"));
        if self.mixed_rules {
            output.line(format_args!(
                "use vest_lib::asn1::modifiers::{{\
            ...
            if self.options.encoding_rules == EncodingRules::Ber {
                output.line(format_args!(
                    "use vest_lib::asn1::ber::{{BerEndFmt, BER_END}};"
                ));
            } else {
                output.line(format_args!("use vest_lib::asn1::der::{{SetFmt, SET}};"));
            }
        }
        output.line(format_args!(
            "use vest_lib::combinators::mapped::spec::{{BiMap, SpecMap}};"
        ));
        output.line(format_args!("use vest_lib::combinators::*;"));
        output.line(format_args!("use vest_lib::combinators::Eof;"));
        ...
        output.line(format_args!("use vest_lib::core::exec::serializer::{{ByteLen, PreSerializeError, Prepare, Serializer}};"));
        output.line(format_args!("use vest_lib::core::proof::*;"));
        output.line(format_args!("use vest_lib::core::spec::*;"));
        output.line(format_args!(
            "use vstd::prelude::*;
"
        ));
...
"
    ...
    fn render_format_impl_invocation(
        ...
        output.blank_line();
        output.line(format_args!(
            "    vest_lib::{implementation}!({kind}, {ownership}, {}, {}, {}, {}{mapper});",
