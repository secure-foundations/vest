...
mod vest_mavlink {
    // This module includes the code generated by the build script from src/mavlink.vest
    // The generated file is placed in OUT_DIR/mavlink.rs by build.rs
    include!(concat!(env!("OUT_DIR"), "/mavlink.rs"));
}
