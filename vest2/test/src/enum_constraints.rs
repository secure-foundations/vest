...
verus! {
    ...
    mod derived_specs {
        ...
        impl SpecSerializerDps for MyTypedEnumFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                my_typed_enum_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for MyEnumFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                my_enum_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for TypedEnumConstraintsFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                typed_enum_constraints_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for EnumConstraintsFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                enum_constraints_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
    ...
    // ============================================================
    // TODO(execs): emit Parser / Serializer / Prepare impls for MyTypedEnum


    // TODO(execs): emit Parser / Serializer / Prepare impls for MyEnum


    // TODO(execs): emit Parser / Serializer / Prepare impls for TypedEnumConstraints


    // TODO(execs): emit Parser / Serializer / Prepare impls for EnumConstraints
}
