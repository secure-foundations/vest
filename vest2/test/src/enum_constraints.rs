...
verus! {
    ...
    pub type TypedEnumConstraintsInner = (MyTypedEnumSpec , (MyTypedEnumSpec , (MyTypedEnumSpec , MyTypedEnumSpec))) ;
    ...
    pub type MyTypedEnumFmtSpec = Named < Mapped < Refined < U16Le , PredFnSpec < u16 >> , FnSpecMapper < MyTypedEnumInner , MyTypedEnumSpec >> > ;

    impl MyTypedEnumFmt {
        # [doc = "specification constructor for `my_typed_enum`."] pub open spec fn spec_inner () -> MyTypedEnumFmtSpec {
            Named ("my_typed_enum" ,
            Mapped {
                inner : Refined (U16Le ,
                | x : u16 | x == 1 || x == 2 || x == 3) ,
                mapper : (| parsed : MyTypedEnumInner | -> MyTypedEnumSpec {
                    match parsed {
                        1 => MyTypedEnumSpec :: X ,
                        2 => MyTypedEnumSpec :: Y ,
                        3 => MyTypedEnumSpec :: Z ,
    ...
    pub type MyEnumFmtSpec = Named < Mapped < Refined < U8 , PredFnSpec < u8 >> , FnSpecMapper < MyEnumInner , MyEnumSpec >> > ;

    impl MyEnumFmt {
        # [doc = "specification constructor for `my_enum`."] pub open spec fn spec_inner () -> MyEnumFmtSpec {
            Named ("my_enum" ,
            Mapped {
                inner : Refined (U8 ,
                | x : u8 | x == 1 || x == 2 || x == 3) ,
                mapper : (| parsed : MyEnumInner | -> MyEnumSpec {
                    match parsed {
                        1 => MyEnumSpec :: A ,
                        2 => MyEnumSpec :: B ,
                        3 => MyEnumSpec :: C ,
    ...
    pub type TypedEnumConstraintsFmtSpec = Named < Mapped < Pair < Refined < MyTypedEnumFmt , PredFnSpec < MyTypedEnumSpec >> , Pair < Refined < MyTypedEnumFmt , PredFnSpec < MyTypedEnumSpec >> , Pair < Refined < MyTypedEnumFmt , PredFnSpec < MyTypedEnumSpec >> , Const < MyTypedEnumFmt , MyTypedEnumSpec > > > > , FnSpecMapper < TypedEnumConstraintsInner , TypedEnumConstraintsSpec >> > ;

    impl TypedEnumConstraintsFmt {
        # [doc = "specification constructor for `typed_enum_constraints`."] pub open spec fn spec_inner () -> TypedEnumConstraintsFmtSpec {
            Named ("typed_enum_constraints" ,
            Mapped {
                inner : Pair (Refined (MyTypedEnumFmt ,
                | x : MyTypedEnumSpec | x == MyTypedEnumSpec :: X) ,
                Pair (Refined (MyTypedEnumFmt ,
                | x : MyTypedEnumSpec | ! (x == MyTypedEnumSpec :: Y)) ,
                Pair (Refined (MyTypedEnumFmt ,
                | x : MyTypedEnumSpec | x == MyTypedEnumSpec :: X || x == MyTypedEnumSpec :: Z) ,
                Const (MyTypedEnumFmt ,
                MyTypedEnumSpec :: X)))) ,
                mapper : (| parsed : TypedEnumConstraintsInner | -> TypedEnumConstraintsSpec {
                    let (foo ,
                    (bar ,
                    (baz ,
                    tag))) = parsed ;
    ...
    pub type EnumConstraintsFmtSpec = Named < Mapped < Pair < Refined < MyEnumFmt , PredFnSpec < MyEnumSpec >> , Pair < Refined < MyEnumFmt , PredFnSpec < MyEnumSpec >> , Pair < Refined < MyEnumFmt , PredFnSpec < MyEnumSpec >> , Const < MyEnumFmt , MyEnumSpec > > > > , FnSpecMapper < EnumConstraintsInner , EnumConstraintsSpec >> > ;

    impl EnumConstraintsFmt {
        # [doc = "specification constructor for `enum_constraints`."] pub open spec fn spec_inner () -> EnumConstraintsFmtSpec {
            Named ("enum_constraints" ,
            Mapped {
                inner : Pair (Refined (MyEnumFmt ,
                | x : MyEnumSpec | x == MyEnumSpec :: A) ,
                Pair (Refined (MyEnumFmt ,
                | x : MyEnumSpec | ! (x == MyEnumSpec :: B)) ,
                Pair (Refined (MyEnumFmt ,
                | x : MyEnumSpec | x == MyEnumSpec :: A || x == MyEnumSpec :: C) ,
                Const (MyEnumFmt ,
                MyEnumSpec :: A)))) ,
                mapper : (| parsed : EnumConstraintsInner | -> EnumConstraintsSpec {
                    let (foo ,
                    (bar ,
                    (baz ,
                    tag))) = parsed ;
    ...
    mod derived_specs {
        ...
        impl SpecSerializerDps for MyTypedEnumFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                MyTypedEnumFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for MyEnumFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                MyEnumFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for TypedEnumConstraintsFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                TypedEnumConstraintsFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for EnumConstraintsFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                EnumConstraintsFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
    ...
    mod exec_impls {
        ...
        impl < 'i > Parser < & 'i [u8] > for TypedEnumConstraintsFmt {
            ...
            return Err (ParseError :: predicate_failed ()) ;
                ...
                let final_v = TypedEnumConstraints {
            foo ,
            bar ,
            baz ,
            tag
