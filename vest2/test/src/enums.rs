...
verus! {
    ...
    pub open spec fn a_typed_choose_with_default_fmt (e : ATypedOpenEnumSpec) -> ATypedChooseWithDefaultFmtSpec {
        ...
        Mapped {
            ...
            mapper : (| parsed : ATypedChooseWithDefaultInner | -> ATypedChooseWithDefaultSpec {
                match parsed {
                    ...
                    Sum :: Inr (Sum :: Inr (Sum :: Inr (v))) => ATypedChooseWithDefaultSpec :: Default (v) ,
                }
            }
            ,
            | value : ATypedChooseWithDefaultSpec | -> ATypedChooseWithDefaultInner {
                match value {
                    ...
                    ATypedChooseWithDefaultSpec :: Default (v) => Sum :: Inr (Sum :: Inr (Sum :: Inr (v))) ,
                }
            }
            )
        }
    ...
    mod derived_specs {
        ...
        impl SpecSerializerDps for ATypedChooseFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                a_typed_choose_fmt (self . e . deep_view ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for ATypedOpenEnumFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                a_typed_open_enum_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for ANonDependentChooseFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                a_non_dependent_choose_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for ARegularChooseFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                a_regular_choose_fmt (self . e . deep_view ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for AMixedTypedEnumFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                a_mixed_typed_enum_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for AClosedEnumFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                a_closed_enum_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for ATypedClosedEnumFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                a_typed_closed_enum_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for AnOpenEnumFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                an_open_enum_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for ATypedChooseWithDefaultFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                a_typed_choose_with_default_fmt (self . e . deep_view ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for AChooseWithDefaultFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                a_choose_with_default_fmt (self . e . deep_view ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
