...
pub type ATypedOpenEnumInner = Sum<u32, Sum<u32, Sum<u32, u32>>>;
...
pub type AMixedTypedEnumInner = Sum<u8, Sum<u8, u8>>;
...
pub type AClosedEnumInner = Sum<u8, Sum<u8, u8>>;
...
pub type ATypedClosedEnumInner = Sum<u16, Sum<u16, u16>>;
...
pub type AnOpenEnumInner = Sum<u8, Sum<u8, Sum<u8, u8>>>;
...
pub type ATypedChooseFmtSpec = Named<
    Mapped<
        Choice<Cond<U8>, Choice<Cond<U16Le>, Cond<U32Le>>>,
        FnSpecMapper<ATypedChooseInner, ATypedChooseSpec>,
    >,
>;
...
pub open spec fn a_typed_choose_fmt(e: ATypedClosedEnumSpec) -> ATypedChooseFmtSpec {
    Named(
        ...
        Mapped {
            inner: Choice(
                Cond(e == ATypedClosedEnumSpec::X, U8),
                Choice(
                    Cond(e == ATypedClosedEnumSpec::Y, U16Le),
                    Cond(e == ATypedClosedEnumSpec::Z, U32Le),
                ),
            ),
            mapper: (
...
pub type ATypedOpenEnumFmtSpec = Named<
    Mapped<
        Choice<
            Const<U32Le, u32>,
            Choice<Const<U32Le, u32>, Choice<Const<U32Le, u32>, Refined<U32Le, PredFnSpec<u32>>>>,
        >,
        ...
        Mapped {
            inner: Choice(
                ...
                Choice(
                    ...
                    Choice(
                        Const(U32Le, 2),
                        Refined(U32Le, |x: u32| true && x != 0 && x != 1 && x != 2),
                    ),
                ),
            ),
            mapper: (
                |parsed: ATypedOpenEnumInner| -> ATypedOpenEnumSpec
                    {
                        match parsed {
                            Sum::Inl(_) => ATypedOpenEnumSpec::P,
                            Sum::Inr(Sum::Inl(_)) => ATypedOpenEnumSpec::Q,
                            Sum::Inr(Sum::Inr(Sum::Inl(_))) => ATypedOpenEnumSpec::R,
                            Sum::Inr(Sum::Inr(Sum::Inr(v))) => ATypedOpenEnumSpec::Unknown(v),
                        }
                    },
                |value: ATypedOpenEnumSpec| -> ATypedOpenEnumInner
                    {
                        match value {
                            ...
                            ATypedOpenEnumSpec::Q => Sum::Inr(Sum::Inl(1)),
                            ATypedOpenEnumSpec::R => Sum::Inr(Sum::Inr(Sum::Inl(2))),
                            ATypedOpenEnumSpec::Unknown(v) => Sum::Inr(Sum::Inr(Sum::Inr(v))),
                        }
                    },
            ),
        },
...
pub type ARegularChooseFmtSpec = Named<
    Mapped<
        Choice<Cond<U8>, Choice<Cond<U16Le>, Cond<U32Le>>>,
        FnSpecMapper<ARegularChooseInner, ARegularChooseSpec>,
    >,
>;
...
pub open spec fn a_regular_choose_fmt(e: AClosedEnumSpec) -> ARegularChooseFmtSpec {
    Named(
        ...
        Mapped {
            inner: Choice(
                Cond(e == AClosedEnumSpec::A, U8),
                Choice(Cond(e == AClosedEnumSpec::B, U16Le), Cond(e == AClosedEnumSpec::C, U32Le)),
            ),
            mapper: (
...
pub type AMixedTypedEnumFmtSpec = Named<
    Mapped<
        Choice<Const<U8, u8>, Choice<Const<U8, u8>, Const<U8, u8>>>,
        FnSpecMapper<AMixedTypedEnumInner, AMixedTypedEnumSpec>,
    >,
>;
...
pub open spec fn a_mixed_typed_enum_fmt() -> AMixedTypedEnumFmtSpec {
    Named(
        "a_mixed_typed_enum",
        Mapped {
            inner: Choice(Const(U8, 0), Choice(Const(U8, 1), Const(U8, 2))),
            mapper: (
                |parsed: AMixedTypedEnumInner| -> AMixedTypedEnumSpec
                    {
                        match parsed {
                            Sum::Inl(_) => AMixedTypedEnumSpec::M,
                            Sum::Inr(Sum::Inl(_)) => AMixedTypedEnumSpec::N,
                            Sum::Inr(Sum::Inr(_)) => AMixedTypedEnumSpec::O,
                        }
                    },
                |value: AMixedTypedEnumSpec| -> AMixedTypedEnumInner
                    {
                        match value {
                            AMixedTypedEnumSpec::M => Sum::Inl(0),
                            AMixedTypedEnumSpec::N => Sum::Inr(Sum::Inl(1)),
                            AMixedTypedEnumSpec::O => Sum::Inr(Sum::Inr(2)),
                        }
                    },
            ),
        },
...
pub type AClosedEnumFmtSpec = Named<
    Mapped<
        Choice<Const<U8, u8>, Choice<Const<U8, u8>, Const<U8, u8>>>,
        FnSpecMapper<AClosedEnumInner, AClosedEnumSpec>,
    >,
>;
        ...
        Mapped {
            ...
            mapper: (
                |parsed: AClosedEnumInner| -> AClosedEnumSpec
                    {
                        match parsed {
                            Sum::Inl(_) => AClosedEnumSpec::A,
                            Sum::Inr(Sum::Inl(_)) => AClosedEnumSpec::B,
                            Sum::Inr(Sum::Inr(_)) => AClosedEnumSpec::C,
                        }
                    },
                |value: AClosedEnumSpec| -> AClosedEnumInner
                    {
                        match value {
                            AClosedEnumSpec::A => Sum::Inl(0),
                            AClosedEnumSpec::B => Sum::Inr(Sum::Inl(1)),
                            AClosedEnumSpec::C => Sum::Inr(Sum::Inr(2)),
                        }
                    },
            ),
        },
...
pub type ATypedClosedEnumFmtSpec = Named<
    Mapped<
        Choice<Const<U16Le, u16>, Choice<Const<U16Le, u16>, Const<U16Le, u16>>>,
...
pub open spec fn a_typed_closed_enum_fmt() -> ATypedClosedEnumFmtSpec {
    Named(
        "a_typed_closed_enum",
        Mapped {
            inner: Choice(Const(U16Le, 0), Choice(Const(U16Le, 1), Const(U16Le, 2))),
            mapper: (
                |parsed: ATypedClosedEnumInner| -> ATypedClosedEnumSpec
                    {
                        match parsed {
                            Sum::Inl(_) => ATypedClosedEnumSpec::X,
                            Sum::Inr(Sum::Inl(_)) => ATypedClosedEnumSpec::Y,
                            Sum::Inr(Sum::Inr(_)) => ATypedClosedEnumSpec::Z,
                        }
                    },
                |value: ATypedClosedEnumSpec| -> ATypedClosedEnumInner
                    {
                        match value {
                            ATypedClosedEnumSpec::X => Sum::Inl(0),
                            ATypedClosedEnumSpec::Y => Sum::Inr(Sum::Inl(1)),
                            ATypedClosedEnumSpec::Z => Sum::Inr(Sum::Inr(2)),
                        }
                    },
            ),
        },
...
pub type AnOpenEnumFmtSpec = Named<
    Mapped<
        Choice<
            Const<U8, u8>,
            Choice<Const<U8, u8>, Choice<Const<U8, u8>, Refined<U8, PredFnSpec<u8>>>>,
        >,
    ...
    Named(
        ...
        Mapped {
            inner: Choice(
                ...
                Choice(
                    Const(U8, 1),
                    Choice(Const(U8, 2), Refined(U8, |x: u8| true && x != 0 && x != 1 && x != 2)),
                ),
            ),
            mapper: (
                |parsed: AnOpenEnumInner| -> AnOpenEnumSpec
                    {
                        match parsed {
                            Sum::Inl(_) => AnOpenEnumSpec::A,
                            Sum::Inr(Sum::Inl(_)) => AnOpenEnumSpec::B,
                            Sum::Inr(Sum::Inr(Sum::Inl(_))) => AnOpenEnumSpec::C,
                            Sum::Inr(Sum::Inr(Sum::Inr(v))) => AnOpenEnumSpec::Unknown(v),
                        }
                    },
                |value: AnOpenEnumSpec| -> AnOpenEnumInner
                    {
                        match value {
                            ...
                            AnOpenEnumSpec::B => Sum::Inr(Sum::Inl(1)),
                            AnOpenEnumSpec::C => Sum::Inr(Sum::Inr(Sum::Inl(2))),
                            AnOpenEnumSpec::Unknown(v) => Sum::Inr(Sum::Inr(Sum::Inr(v))),
                        }
                    },
            ),
        },
...
pub type ATypedChooseWithDefaultFmtSpec = Named<
    Mapped<
        Choice<Cond<U8>, Choice<Cond<U16Le>, Choice<Cond<U32Le>, Cond<Tail>>>>,
...
pub open spec fn a_typed_choose_with_default_fmt(
    ...
    Named(
        ...
        Mapped {
            inner: Choice(
                Cond(e == ATypedOpenEnumSpec::P, U8),
                Choice(
                    Cond(e == ATypedOpenEnumSpec::Q, U16Le),
                    Choice(
                        Cond(e == ATypedOpenEnumSpec::R, U32Le),
                        Cond(
                            e != ATypedOpenEnumSpec::P && e != ATypedOpenEnumSpec::Q && e
                                != ATypedOpenEnumSpec::R,
                            Tail,
                        ),
                    ),
                ),
...
pub open spec fn a_choose_with_default_fmt(e: AnOpenEnumSpec) -> AChooseWithDefaultFmtSpec {
    Named(
        ...
        Mapped {
            inner: Choice(
                Cond(e == AnOpenEnumSpec::A, U8),
                Choice(
                    Cond(e == AnOpenEnumSpec::B, U16Le),
                    Choice(
                        Cond(e == AnOpenEnumSpec::C, U32Le),
                        Cond(
                            e != AnOpenEnumSpec::A && e != AnOpenEnumSpec::B && e
                                != AnOpenEnumSpec::C,
                            Tail,
                        ),
                    ),
...
mod derived_proofs {
    ...
    impl SoundParser for ATypedChooseFmt {
        proof fn lemma_parse_sound_consumption(&self, ibuf: Seq<u8>) {
            ...
            a_typed_choose_fmt(self.e.deep_view()).lemma_parse_sound_consumption(ibuf);
        }

        proof fn lemma_parse_sound_value(&self, ibuf: Seq<u8>) {
            reveal(<ATypedChooseFmt as SpecParser>::spec_parse);
            reveal(<ATypedChooseFmt as Consistency>::consistent);
            a_typed_choose_fmt(self.e.deep_view()).lemma_parse_sound_value(ibuf);
        }
    }
    ...
    impl NonTailFmt for ATypedChooseFmt {
        proof fn lemma_serialize_dps_prepend(&self, v: Self::SValue, obuf: Seq<u8>) {
            ...
            a_typed_choose_fmt(self.e.deep_view()).lemma_serialize_dps_prepend(v, obuf);
        }

        proof fn lemma_serialize_dps_len(&self, v: Self::SValue, obuf: Seq<u8>) {
            reveal(<ATypedChooseFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<ATypedChooseFmt as SpecByteLen>::byte_len);
            a_typed_choose_fmt(self.e.deep_view()).lemma_serialize_dps_len(v, obuf);
        }
    }
    ...
    impl GoodSerializer for ATypedChooseFmt {
        proof fn lemma_serialize_len(&self, v: Self::SVal) {
            ...
            reveal(<ATypedChooseFmt as SpecByteLen>::byte_len);
            a_typed_choose_fmt(self.e.deep_view()).lemma_serialize_len(v);
        }
    }
    ...
    impl SPRoundTripDps for ATypedChooseFmt {
        proof fn theorem_serialize_dps_parse_roundtrip(&self, v: Self::T, obuf: Seq<u8>) {
            ...
            reveal(<ATypedChooseFmt as Consistency>::consistent);
            reveal(<ATypedChooseFmt as SpecByteLen>::byte_len);
            a_typed_choose_fmt(self.e.deep_view()).theorem_serialize_dps_parse_roundtrip(v, obuf);
        }
    }
    ...
    impl NonMalleable for ATypedChooseFmt {
        proof fn lemma_parse_non_malleable(&self, buf1: Seq<u8>, buf2: Seq<u8>) {
            reveal(<ATypedChooseFmt as SpecParser>::spec_parse);
            a_typed_choose_fmt(self.e.deep_view()).lemma_parse_non_malleable(buf1, buf2);
        }
    }
    ...
    impl EquivSerializersGeneral for ATypedChooseFmt {
        proof fn lemma_serialize_equiv(&self, v: Self::SVal, obuf: Seq<u8>) {
            reveal(<ATypedChooseFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<ATypedChooseFmt as SpecSerializer>::spec_serialize);
            a_typed_choose_fmt(self.e.deep_view()).lemma_serialize_equiv(v, obuf);
        }
    }
    ...
    impl EquivSerializers for ATypedChooseFmt {
        proof fn lemma_serialize_equiv_on_empty(&self, v: Self::SVal) {
            reveal(<ATypedChooseFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<ATypedChooseFmt as SpecSerializer>::spec_serialize);
            a_typed_choose_fmt(self.e.deep_view()).lemma_serialize_equiv_on_empty(v);
        }
    }
    ...
    impl SoundParser for ATypedOpenEnumFmt {
        proof fn lemma_parse_sound_consumption(&self, ibuf: Seq<u8>) {
            ...
            a_typed_open_enum_fmt().lemma_parse_sound_consumption(ibuf);
        }

        proof fn lemma_parse_sound_value(&self, ibuf: Seq<u8>) {
            reveal(<ATypedOpenEnumFmt as SpecParser>::spec_parse);
            reveal(<ATypedOpenEnumFmt as Consistency>::consistent);
            a_typed_open_enum_fmt().lemma_parse_sound_value(ibuf);
        }
    }
    ...
    impl NonTailFmt for ATypedOpenEnumFmt {
        proof fn lemma_serialize_dps_prepend(&self, v: Self::SValue, obuf: Seq<u8>) {
            ...
            a_typed_open_enum_fmt().lemma_serialize_dps_prepend(v, obuf);
        }

        proof fn lemma_serialize_dps_len(&self, v: Self::SValue, obuf: Seq<u8>) {
            reveal(<ATypedOpenEnumFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<ATypedOpenEnumFmt as SpecByteLen>::byte_len);
            a_typed_open_enum_fmt().lemma_serialize_dps_len(v, obuf);
        }
    }
    ...
    impl GoodSerializer for ATypedOpenEnumFmt {
        proof fn lemma_serialize_len(&self, v: Self::SVal) {
            ...
            reveal(<ATypedOpenEnumFmt as SpecByteLen>::byte_len);
            a_typed_open_enum_fmt().lemma_serialize_len(v);
        }
    }
    ...
    impl SPRoundTripDps for ATypedOpenEnumFmt {
        proof fn theorem_serialize_dps_parse_roundtrip(&self, v: Self::T, obuf: Seq<u8>) {
            ...
            reveal(<ATypedOpenEnumFmt as Consistency>::consistent);
            reveal(<ATypedOpenEnumFmt as SpecByteLen>::byte_len);
            a_typed_open_enum_fmt().theorem_serialize_dps_parse_roundtrip(v, obuf);
        }
    }
    ...
    impl NonMalleable for ATypedOpenEnumFmt {
        proof fn lemma_parse_non_malleable(&self, buf1: Seq<u8>, buf2: Seq<u8>) {
            reveal(<ATypedOpenEnumFmt as SpecParser>::spec_parse);
            a_typed_open_enum_fmt().lemma_parse_non_malleable(buf1, buf2);
        }
    }
    ...
    impl EquivSerializersGeneral for ATypedOpenEnumFmt {
        proof fn lemma_serialize_equiv(&self, v: Self::SVal, obuf: Seq<u8>) {
            reveal(<ATypedOpenEnumFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<ATypedOpenEnumFmt as SpecSerializer>::spec_serialize);
            a_typed_open_enum_fmt().lemma_serialize_equiv(v, obuf);
        }
    }
    ...
    impl EquivSerializers for ATypedOpenEnumFmt {
        proof fn lemma_serialize_equiv_on_empty(&self, v: Self::SVal) {
            reveal(<ATypedOpenEnumFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<ATypedOpenEnumFmt as SpecSerializer>::spec_serialize);
            a_typed_open_enum_fmt().lemma_serialize_equiv_on_empty(v);
        }
    }
    ...
    impl SoundParser for ANonDependentChooseFmt {
        proof fn lemma_parse_sound_consumption(&self, ibuf: Seq<u8>) {
            ...
            a_non_dependent_choose_fmt().lemma_parse_sound_consumption(ibuf);
        }

        proof fn lemma_parse_sound_value(&self, ibuf: Seq<u8>) {
            reveal(<ANonDependentChooseFmt as SpecParser>::spec_parse);
            reveal(<ANonDependentChooseFmt as Consistency>::consistent);
            a_non_dependent_choose_fmt().lemma_parse_sound_value(ibuf);
        }
    }
    ...
    impl NonTailFmt for ANonDependentChooseFmt {
        proof fn lemma_serialize_dps_prepend(&self, v: Self::SValue, obuf: Seq<u8>) {
            ...
            a_non_dependent_choose_fmt().lemma_serialize_dps_prepend(v, obuf);
        }

        proof fn lemma_serialize_dps_len(&self, v: Self::SValue, obuf: Seq<u8>) {
            reveal(<ANonDependentChooseFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<ANonDependentChooseFmt as SpecByteLen>::byte_len);
            a_non_dependent_choose_fmt().lemma_serialize_dps_len(v, obuf);
        }
    }
    ...
    impl GoodSerializer for ANonDependentChooseFmt {
        proof fn lemma_serialize_len(&self, v: Self::SVal) {
            ...
            reveal(<ANonDependentChooseFmt as SpecByteLen>::byte_len);
            a_non_dependent_choose_fmt().lemma_serialize_len(v);
        }
    }
    ...
    impl SPRoundTripDps for ANonDependentChooseFmt {
        proof fn theorem_serialize_dps_parse_roundtrip(&self, v: Self::T, obuf: Seq<u8>) {
            ...
            reveal(<ANonDependentChooseFmt as Consistency>::consistent);
            reveal(<ANonDependentChooseFmt as SpecByteLen>::byte_len);
            a_non_dependent_choose_fmt().theorem_serialize_dps_parse_roundtrip(v, obuf);
        }
    }
    ...
    impl NonMalleable for ANonDependentChooseFmt {
        proof fn lemma_parse_non_malleable(&self, buf1: Seq<u8>, buf2: Seq<u8>) {
            reveal(<ANonDependentChooseFmt as SpecParser>::spec_parse);
            a_non_dependent_choose_fmt().lemma_parse_non_malleable(buf1, buf2);
        }
    }
    ...
    impl EquivSerializersGeneral for ANonDependentChooseFmt {
        proof fn lemma_serialize_equiv(&self, v: Self::SVal, obuf: Seq<u8>) {
            reveal(<ANonDependentChooseFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<ANonDependentChooseFmt as SpecSerializer>::spec_serialize);
            a_non_dependent_choose_fmt().lemma_serialize_equiv(v, obuf);
        }
    }
    ...
    impl EquivSerializers for ANonDependentChooseFmt {
        proof fn lemma_serialize_equiv_on_empty(&self, v: Self::SVal) {
            reveal(<ANonDependentChooseFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<ANonDependentChooseFmt as SpecSerializer>::spec_serialize);
            a_non_dependent_choose_fmt().lemma_serialize_equiv_on_empty(v);
        }
    }
    ...
    impl SoundParser for ARegularChooseFmt {
        proof fn lemma_parse_sound_consumption(&self, ibuf: Seq<u8>) {
            ...
            a_regular_choose_fmt(self.e.deep_view()).lemma_parse_sound_consumption(ibuf);
        }

        proof fn lemma_parse_sound_value(&self, ibuf: Seq<u8>) {
            reveal(<ARegularChooseFmt as SpecParser>::spec_parse);
            reveal(<ARegularChooseFmt as Consistency>::consistent);
            a_regular_choose_fmt(self.e.deep_view()).lemma_parse_sound_value(ibuf);
        }
    }
    ...
    impl NonTailFmt for ARegularChooseFmt {
        proof fn lemma_serialize_dps_prepend(&self, v: Self::SValue, obuf: Seq<u8>) {
            ...
            a_regular_choose_fmt(self.e.deep_view()).lemma_serialize_dps_prepend(v, obuf);
        }

        proof fn lemma_serialize_dps_len(&self, v: Self::SValue, obuf: Seq<u8>) {
            reveal(<ARegularChooseFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<ARegularChooseFmt as SpecByteLen>::byte_len);
            a_regular_choose_fmt(self.e.deep_view()).lemma_serialize_dps_len(v, obuf);
        }
    }
    ...
    impl GoodSerializer for ARegularChooseFmt {
        proof fn lemma_serialize_len(&self, v: Self::SVal) {
            ...
            reveal(<ARegularChooseFmt as SpecByteLen>::byte_len);
            a_regular_choose_fmt(self.e.deep_view()).lemma_serialize_len(v);
        }
    }
    ...
    impl SPRoundTripDps for ARegularChooseFmt {
        proof fn theorem_serialize_dps_parse_roundtrip(&self, v: Self::T, obuf: Seq<u8>) {
            ...
            reveal(<ARegularChooseFmt as Consistency>::consistent);
            reveal(<ARegularChooseFmt as SpecByteLen>::byte_len);
            a_regular_choose_fmt(self.e.deep_view()).theorem_serialize_dps_parse_roundtrip(v, obuf);
        }
    }
    ...
    impl NonMalleable for ARegularChooseFmt {
        proof fn lemma_parse_non_malleable(&self, buf1: Seq<u8>, buf2: Seq<u8>) {
            reveal(<ARegularChooseFmt as SpecParser>::spec_parse);
            a_regular_choose_fmt(self.e.deep_view()).lemma_parse_non_malleable(buf1, buf2);
        }
    }
    ...
    impl EquivSerializersGeneral for ARegularChooseFmt {
        proof fn lemma_serialize_equiv(&self, v: Self::SVal, obuf: Seq<u8>) {
            reveal(<ARegularChooseFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<ARegularChooseFmt as SpecSerializer>::spec_serialize);
            a_regular_choose_fmt(self.e.deep_view()).lemma_serialize_equiv(v, obuf);
        }
    }
    ...
    impl EquivSerializers for ARegularChooseFmt {
        proof fn lemma_serialize_equiv_on_empty(&self, v: Self::SVal) {
            reveal(<ARegularChooseFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<ARegularChooseFmt as SpecSerializer>::spec_serialize);
            a_regular_choose_fmt(self.e.deep_view()).lemma_serialize_equiv_on_empty(v);
        }
    }
    ...
    impl SoundParser for AMixedTypedEnumFmt {
        proof fn lemma_parse_sound_consumption(&self, ibuf: Seq<u8>) {
            ...
            a_mixed_typed_enum_fmt().lemma_parse_sound_consumption(ibuf);
        }

        proof fn lemma_parse_sound_value(&self, ibuf: Seq<u8>) {
            reveal(<AMixedTypedEnumFmt as SpecParser>::spec_parse);
            reveal(<AMixedTypedEnumFmt as Consistency>::consistent);
            a_mixed_typed_enum_fmt().lemma_parse_sound_value(ibuf);
        }
    }
    ...
    impl NonTailFmt for AMixedTypedEnumFmt {
        proof fn lemma_serialize_dps_prepend(&self, v: Self::SValue, obuf: Seq<u8>) {
            ...
            a_mixed_typed_enum_fmt().lemma_serialize_dps_prepend(v, obuf);
        }

        proof fn lemma_serialize_dps_len(&self, v: Self::SValue, obuf: Seq<u8>) {
            reveal(<AMixedTypedEnumFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<AMixedTypedEnumFmt as SpecByteLen>::byte_len);
            a_mixed_typed_enum_fmt().lemma_serialize_dps_len(v, obuf);
        }
    }
    ...
    impl GoodSerializer for AMixedTypedEnumFmt {
        proof fn lemma_serialize_len(&self, v: Self::SVal) {
            ...
            reveal(<AMixedTypedEnumFmt as SpecByteLen>::byte_len);
            a_mixed_typed_enum_fmt().lemma_serialize_len(v);
        }
    }
    ...
    impl SPRoundTripDps for AMixedTypedEnumFmt {
        proof fn theorem_serialize_dps_parse_roundtrip(&self, v: Self::T, obuf: Seq<u8>) {
            ...
            reveal(<AMixedTypedEnumFmt as Consistency>::consistent);
            reveal(<AMixedTypedEnumFmt as SpecByteLen>::byte_len);
            a_mixed_typed_enum_fmt().theorem_serialize_dps_parse_roundtrip(v, obuf);
        }
    }
    ...
    impl NonMalleable for AMixedTypedEnumFmt {
        proof fn lemma_parse_non_malleable(&self, buf1: Seq<u8>, buf2: Seq<u8>) {
            reveal(<AMixedTypedEnumFmt as SpecParser>::spec_parse);
            a_mixed_typed_enum_fmt().lemma_parse_non_malleable(buf1, buf2);
        }
    }
    ...
    impl EquivSerializersGeneral for AMixedTypedEnumFmt {
        proof fn lemma_serialize_equiv(&self, v: Self::SVal, obuf: Seq<u8>) {
            reveal(<AMixedTypedEnumFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<AMixedTypedEnumFmt as SpecSerializer>::spec_serialize);
            a_mixed_typed_enum_fmt().lemma_serialize_equiv(v, obuf);
        }
    }
    ...
    impl EquivSerializers for AMixedTypedEnumFmt {
        proof fn lemma_serialize_equiv_on_empty(&self, v: Self::SVal) {
            reveal(<AMixedTypedEnumFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<AMixedTypedEnumFmt as SpecSerializer>::spec_serialize);
            a_mixed_typed_enum_fmt().lemma_serialize_equiv_on_empty(v);
        }
    }
    ...
    impl SoundParser for AClosedEnumFmt {
        proof fn lemma_parse_sound_consumption(&self, ibuf: Seq<u8>) {
            ...
            a_closed_enum_fmt().lemma_parse_sound_consumption(ibuf);
        }

        proof fn lemma_parse_sound_value(&self, ibuf: Seq<u8>) {
            reveal(<AClosedEnumFmt as SpecParser>::spec_parse);
            reveal(<AClosedEnumFmt as Consistency>::consistent);
            a_closed_enum_fmt().lemma_parse_sound_value(ibuf);
        }
    }
    ...
    impl NonTailFmt for AClosedEnumFmt {
        proof fn lemma_serialize_dps_prepend(&self, v: Self::SValue, obuf: Seq<u8>) {
            ...
            a_closed_enum_fmt().lemma_serialize_dps_prepend(v, obuf);
        }

        proof fn lemma_serialize_dps_len(&self, v: Self::SValue, obuf: Seq<u8>) {
            reveal(<AClosedEnumFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<AClosedEnumFmt as SpecByteLen>::byte_len);
            a_closed_enum_fmt().lemma_serialize_dps_len(v, obuf);
        }
    }
    ...
    impl GoodSerializer for AClosedEnumFmt {
        proof fn lemma_serialize_len(&self, v: Self::SVal) {
            ...
            reveal(<AClosedEnumFmt as SpecByteLen>::byte_len);
            a_closed_enum_fmt().lemma_serialize_len(v);
        }
    }
    ...
    impl SPRoundTripDps for AClosedEnumFmt {
        proof fn theorem_serialize_dps_parse_roundtrip(&self, v: Self::T, obuf: Seq<u8>) {
            ...
            reveal(<AClosedEnumFmt as Consistency>::consistent);
            reveal(<AClosedEnumFmt as SpecByteLen>::byte_len);
            a_closed_enum_fmt().theorem_serialize_dps_parse_roundtrip(v, obuf);
        }
    }
    ...
    impl NonMalleable for AClosedEnumFmt {
        proof fn lemma_parse_non_malleable(&self, buf1: Seq<u8>, buf2: Seq<u8>) {
            reveal(<AClosedEnumFmt as SpecParser>::spec_parse);
            a_closed_enum_fmt().lemma_parse_non_malleable(buf1, buf2);
        }
    }
    ...
    impl EquivSerializersGeneral for AClosedEnumFmt {
        proof fn lemma_serialize_equiv(&self, v: Self::SVal, obuf: Seq<u8>) {
            reveal(<AClosedEnumFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<AClosedEnumFmt as SpecSerializer>::spec_serialize);
            a_closed_enum_fmt().lemma_serialize_equiv(v, obuf);
        }
    }
    ...
    impl EquivSerializers for AClosedEnumFmt {
        proof fn lemma_serialize_equiv_on_empty(&self, v: Self::SVal) {
            reveal(<AClosedEnumFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<AClosedEnumFmt as SpecSerializer>::spec_serialize);
            a_closed_enum_fmt().lemma_serialize_equiv_on_empty(v);
        }
    }
    ...
    impl SoundParser for ATypedClosedEnumFmt {
        proof fn lemma_parse_sound_consumption(&self, ibuf: Seq<u8>) {
            ...
            a_typed_closed_enum_fmt().lemma_parse_sound_consumption(ibuf);
        }

        proof fn lemma_parse_sound_value(&self, ibuf: Seq<u8>) {
            reveal(<ATypedClosedEnumFmt as SpecParser>::spec_parse);
            reveal(<ATypedClosedEnumFmt as Consistency>::consistent);
            a_typed_closed_enum_fmt().lemma_parse_sound_value(ibuf);
        }
    }
    ...
    impl NonTailFmt for ATypedClosedEnumFmt {
        proof fn lemma_serialize_dps_prepend(&self, v: Self::SValue, obuf: Seq<u8>) {
            ...
            a_typed_closed_enum_fmt().lemma_serialize_dps_prepend(v, obuf);
        }

        proof fn lemma_serialize_dps_len(&self, v: Self::SValue, obuf: Seq<u8>) {
            reveal(<ATypedClosedEnumFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<ATypedClosedEnumFmt as SpecByteLen>::byte_len);
            a_typed_closed_enum_fmt().lemma_serialize_dps_len(v, obuf);
        }
    }
    ...
    impl GoodSerializer for ATypedClosedEnumFmt {
        proof fn lemma_serialize_len(&self, v: Self::SVal) {
            ...
            reveal(<ATypedClosedEnumFmt as SpecByteLen>::byte_len);
            a_typed_closed_enum_fmt().lemma_serialize_len(v);
        }
    }
    ...
    impl SPRoundTripDps for ATypedClosedEnumFmt {
        proof fn theorem_serialize_dps_parse_roundtrip(&self, v: Self::T, obuf: Seq<u8>) {
            ...
            reveal(<ATypedClosedEnumFmt as Consistency>::consistent);
            reveal(<ATypedClosedEnumFmt as SpecByteLen>::byte_len);
            a_typed_closed_enum_fmt().theorem_serialize_dps_parse_roundtrip(v, obuf);
        }
    }
    ...
    impl NonMalleable for ATypedClosedEnumFmt {
        proof fn lemma_parse_non_malleable(&self, buf1: Seq<u8>, buf2: Seq<u8>) {
            reveal(<ATypedClosedEnumFmt as SpecParser>::spec_parse);
            a_typed_closed_enum_fmt().lemma_parse_non_malleable(buf1, buf2);
        }
    }
    ...
    impl EquivSerializersGeneral for ATypedClosedEnumFmt {
        proof fn lemma_serialize_equiv(&self, v: Self::SVal, obuf: Seq<u8>) {
            reveal(<ATypedClosedEnumFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<ATypedClosedEnumFmt as SpecSerializer>::spec_serialize);
            a_typed_closed_enum_fmt().lemma_serialize_equiv(v, obuf);
        }
    }
    ...
    impl EquivSerializers for ATypedClosedEnumFmt {
        proof fn lemma_serialize_equiv_on_empty(&self, v: Self::SVal) {
            reveal(<ATypedClosedEnumFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<ATypedClosedEnumFmt as SpecSerializer>::spec_serialize);
            a_typed_closed_enum_fmt().lemma_serialize_equiv_on_empty(v);
        }
    }
    ...
    impl SoundParser for AnOpenEnumFmt {
        proof fn lemma_parse_sound_consumption(&self, ibuf: Seq<u8>) {
            ...
            an_open_enum_fmt().lemma_parse_sound_consumption(ibuf);
        }

        proof fn lemma_parse_sound_value(&self, ibuf: Seq<u8>) {
            reveal(<AnOpenEnumFmt as SpecParser>::spec_parse);
            reveal(<AnOpenEnumFmt as Consistency>::consistent);
            an_open_enum_fmt().lemma_parse_sound_value(ibuf);
        }
    }
    ...
    impl NonTailFmt for AnOpenEnumFmt {
        proof fn lemma_serialize_dps_prepend(&self, v: Self::SValue, obuf: Seq<u8>) {
            ...
            an_open_enum_fmt().lemma_serialize_dps_prepend(v, obuf);
        }

        proof fn lemma_serialize_dps_len(&self, v: Self::SValue, obuf: Seq<u8>) {
            reveal(<AnOpenEnumFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<AnOpenEnumFmt as SpecByteLen>::byte_len);
            an_open_enum_fmt().lemma_serialize_dps_len(v, obuf);
        }
    }
    ...
    impl GoodSerializer for AnOpenEnumFmt {
        proof fn lemma_serialize_len(&self, v: Self::SVal) {
            ...
            reveal(<AnOpenEnumFmt as SpecByteLen>::byte_len);
            an_open_enum_fmt().lemma_serialize_len(v);
        }
    }
    ...
    impl SPRoundTripDps for AnOpenEnumFmt {
        proof fn theorem_serialize_dps_parse_roundtrip(&self, v: Self::T, obuf: Seq<u8>) {
            ...
            reveal(<AnOpenEnumFmt as Consistency>::consistent);
            reveal(<AnOpenEnumFmt as SpecByteLen>::byte_len);
            an_open_enum_fmt().theorem_serialize_dps_parse_roundtrip(v, obuf);
        }
    }
    ...
    impl NonMalleable for AnOpenEnumFmt {
        proof fn lemma_parse_non_malleable(&self, buf1: Seq<u8>, buf2: Seq<u8>) {
            reveal(<AnOpenEnumFmt as SpecParser>::spec_parse);
            an_open_enum_fmt().lemma_parse_non_malleable(buf1, buf2);
        }
    }
    ...
    impl EquivSerializersGeneral for AnOpenEnumFmt {
        proof fn lemma_serialize_equiv(&self, v: Self::SVal, obuf: Seq<u8>) {
            reveal(<AnOpenEnumFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<AnOpenEnumFmt as SpecSerializer>::spec_serialize);
            an_open_enum_fmt().lemma_serialize_equiv(v, obuf);
        }
    }
    ...
    impl EquivSerializers for AnOpenEnumFmt {
        proof fn lemma_serialize_equiv_on_empty(&self, v: Self::SVal) {
            reveal(<AnOpenEnumFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<AnOpenEnumFmt as SpecSerializer>::spec_serialize);
            an_open_enum_fmt().lemma_serialize_equiv_on_empty(v);
        }
    }
    ...
    impl SoundParser for ATypedChooseWithDefaultFmt {
        proof fn lemma_parse_sound_consumption(&self, ibuf: Seq<u8>) {
            ...
            a_typed_choose_with_default_fmt(self.e.deep_view()).lemma_parse_sound_consumption(ibuf);
        }

        proof fn lemma_parse_sound_value(&self, ibuf: Seq<u8>) {
            reveal(<ATypedChooseWithDefaultFmt as SpecParser>::spec_parse);
            reveal(<ATypedChooseWithDefaultFmt as Consistency>::consistent);
            a_typed_choose_with_default_fmt(self.e.deep_view()).lemma_parse_sound_value(ibuf);
        }
    }
    ...
    impl GoodSerializer for ATypedChooseWithDefaultFmt {
        proof fn lemma_serialize_len(&self, v: Self::SVal) {
            ...
            reveal(<ATypedChooseWithDefaultFmt as SpecByteLen>::byte_len);
            a_typed_choose_with_default_fmt(self.e.deep_view()).lemma_serialize_len(v);
        }
    }
    ...
    impl SPRoundTripDps for ATypedChooseWithDefaultFmt {
        proof fn theorem_serialize_dps_parse_roundtrip(&self, v: Self::T, obuf: Seq<u8>) {
            ...
            reveal(<ATypedChooseWithDefaultFmt as Consistency>::consistent);
            reveal(<ATypedChooseWithDefaultFmt as SpecByteLen>::byte_len);
            a_typed_choose_with_default_fmt(
                self.e.deep_view(),
    ...
    impl NonMalleable for ATypedChooseWithDefaultFmt {
        proof fn lemma_parse_non_malleable(&self, buf1: Seq<u8>, buf2: Seq<u8>) {
            reveal(<ATypedChooseWithDefaultFmt as SpecParser>::spec_parse);
            a_typed_choose_with_default_fmt(self.e.deep_view()).lemma_parse_non_malleable(
                buf1,
                buf2,
            );
        }
    ...
    impl EquivSerializers for ATypedChooseWithDefaultFmt {
        proof fn lemma_serialize_equiv_on_empty(&self, v: Self::SVal) {
            reveal(<ATypedChooseWithDefaultFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<ATypedChooseWithDefaultFmt as SpecSerializer>::spec_serialize);
            a_typed_choose_with_default_fmt(self.e.deep_view()).lemma_serialize_equiv_on_empty(v);
        }
    }
    ...
    impl SoundParser for AChooseWithDefaultFmt {
        proof fn lemma_parse_sound_consumption(&self, ibuf: Seq<u8>) {
            ...
            a_choose_with_default_fmt(self.e.deep_view()).lemma_parse_sound_consumption(ibuf);
        }

        proof fn lemma_parse_sound_value(&self, ibuf: Seq<u8>) {
            reveal(<AChooseWithDefaultFmt as SpecParser>::spec_parse);
            reveal(<AChooseWithDefaultFmt as Consistency>::consistent);
            a_choose_with_default_fmt(self.e.deep_view()).lemma_parse_sound_value(ibuf);
        }
    }
    ...
    impl GoodSerializer for AChooseWithDefaultFmt {
        proof fn lemma_serialize_len(&self, v: Self::SVal) {
            ...
            reveal(<AChooseWithDefaultFmt as SpecByteLen>::byte_len);
            a_choose_with_default_fmt(self.e.deep_view()).lemma_serialize_len(v);
        }
    }
    ...
    impl SPRoundTripDps for AChooseWithDefaultFmt {
        proof fn theorem_serialize_dps_parse_roundtrip(&self, v: Self::T, obuf: Seq<u8>) {
            ...
            reveal(<AChooseWithDefaultFmt as Consistency>::consistent);
            reveal(<AChooseWithDefaultFmt as SpecByteLen>::byte_len);
            a_choose_with_default_fmt(self.e.deep_view()).theorem_serialize_dps_parse_roundtrip(
                v,
                obuf,
            );
        }
    ...
    impl NonMalleable for AChooseWithDefaultFmt {
        proof fn lemma_parse_non_malleable(&self, buf1: Seq<u8>, buf2: Seq<u8>) {
            reveal(<AChooseWithDefaultFmt as SpecParser>::spec_parse);
            a_choose_with_default_fmt(self.e.deep_view()).lemma_parse_non_malleable(buf1, buf2);
        }
    }
    ...
    impl EquivSerializers for AChooseWithDefaultFmt {
        proof fn lemma_serialize_equiv_on_empty(&self, v: Self::SVal) {
            reveal(<AChooseWithDefaultFmt as SpecSerializerDps>::spec_serialize_dps);
            reveal(<AChooseWithDefaultFmt as SpecSerializer>::spec_serialize);
            a_choose_with_default_fmt(self.e.deep_view()).lemma_serialize_equiv_on_empty(v);
        }
    }
...
// ============================================================
// TODO(execs): emit Parser / Serializer / Prepare impls for ATypedChoose
// TODO(execs): emit Parser / Serializer / Prepare impls for ATypedOpenEnum
// TODO(execs): emit Parser / Serializer / Prepare impls for ANonDependentChoose
// TODO(execs): emit Parser / Serializer / Prepare impls for ARegularChoose
// TODO(execs): emit Parser / Serializer / Prepare impls for AMixedTypedEnum
// TODO(execs): emit Parser / Serializer / Prepare impls for AClosedEnum
// TODO(execs): emit Parser / Serializer / Prepare impls for ATypedClosedEnum
// TODO(execs): emit Parser / Serializer / Prepare impls for AnOpenEnum
// TODO(execs): emit Parser / Serializer / Prepare impls for ATypedChooseWithDefault
// TODO(execs): emit Parser / Serializer / Prepare impls for AChooseWithDefault
} // verus!
