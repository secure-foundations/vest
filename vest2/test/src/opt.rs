...
verus! {
    ...
    pub type AFmtSpec = Named < WithPrefixTag < U8 , WithPrefixTag < U8 , WithSuffixTag < U8 , Fixed < 10 > > > > > ;
    ...
    pub type BFmtSpec = Named < Mapped < Pair < Fixed < 10 > , WithPrefixTag < Fixed < 3 > , WithSuffixTag < U8 , AFmt > > > , FnSpecMapper < BInner , BSpec >> > ;
    ...
    pub type TaggedMixFmtSpec = Named < Mapped < Optional < WithPrefixTag < U8 , Fixed < 1 > > , Repeat < WithPrefixTag < U8 , Fixed < 2 > > , Optional < WithPrefixTag < U8 , Fixed < 3 > > , RepeatTillEnd < WithPrefixTag < U8 , Fixed < 4 > > > > > > , FnSpecMapper < TaggedMixInner , TaggedMixSpec >> > ;

    # [doc = "specification constructor for `tagged_mix`."]
    pub open spec fn tagged_mix_fmt () -> TaggedMixFmtSpec {
        Named ("tagged_mix" ,
        Mapped {
            inner : Optional (WithPrefixTag (U8 ,
            10 ,
            Fixed :: < 1 >) ,
            Repeat (WithPrefixTag (U8 ,
            11 ,
            Fixed :: < 2 >) ,
            Optional (WithPrefixTag (U8 ,
            12 ,
            Fixed :: < 3 >) ,
            RepeatTillEnd (WithPrefixTag (U8 ,
            13 ,
            Fixed :: < 4 >))))) ,
    ...
    pub type MsgFmtSpec = Named < Mapped < Pair < Const < U8 , u8 > , Const < Fixed < 2 > , Seq < u8 >> > , FnSpecMapper < MsgInner , MsgSpec >> > ;
    ...
    mod derived_specs {
        ...
        impl SpecSerializerDps for TaggedMixFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                tagged_mix_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for OptmsgFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                optmsg_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
    ...
    // ============================================================
    // TODO(execs): emit Parser / Serializer / Prepare impls for A


    // TODO(execs): emit Parser / Serializer / Prepare impls for B


    // TODO(execs): emit Parser / Serializer / Prepare impls for TaggedMix


    // TODO(execs): emit Parser / Serializer / Prepare impls for Msg


    // TODO(execs): emit Parser / Serializer / Prepare impls for Optmsg
}
