...
pub type Msg5ContentFmtSpec = Named<
    Mapped<Sum<U16Le, Tail>, FnSpecMapper<Msg5ContentInner, Msg5ContentSpec>>,
>;
        ...
        Mapped {
            inner: match b {
                x if x == [
                    ...
                    0x33u8,
                    0x9cu8,
                ].deep_view() => Sum::Inl(HelloRetryRequestFmt),
...
pub type Msg4ContentFmtSpec = Named<
    Mapped<Sum<U16Le, Tail>, FnSpecMapper<Msg4ContentInner, Msg4ContentSpec>>,
>;
...
pub type Msg3ContentFmtSpec = Named<
    Mapped<
        Sum<U16Le, Sum<U32Le, Sum<U32Le, Tail>>>,
...
pub open spec fn msg3_fmt() -> Msg3FmtSpec {
    Named(
        "msg3",
        Mapped {
            inner: Bind(U8, |i: u8| Msg3ContentFmt { i }),
            mapper: (
...
pub open spec fn msg5_fmt() -> Msg5FmtSpec {
    Named(
        "msg5",
        Mapped {
            inner: Bind(VarInt::<true>, |i: u64| Msg5ContentFmt { i }),
            mapper: (
...
pub open spec fn msg2_content_fmt(b: Seq<u8>) -> Msg2ContentFmtSpec {
    Named(
        ...
        Mapped {
            inner: match b {
                x if x == [0x16u8, 0x03u8, 0x01u8].deep_view() => Sum::Inl(U16Le),
                _ => Sum::Inr(U32Le),
            },
            mapper: (
...
pub open spec fn msg1_fmt() -> Msg1FmtSpec {
    Named(
        "msg1",
        Mapped {
            inner: Bind(Fixed::<32>, |b: Seq<u8>| msg1_payload_fmt(b)),
            mapper: (
...
pub open spec fn msg2_fmt() -> Msg2FmtSpec {
    Named(
        "msg2",
        Mapped {
            inner: Bind(Fixed::<3>, |b: Seq<u8>| msg2_content_fmt(b)),
            mapper: (
...
pub open spec fn msg4_fmt() -> Msg4FmtSpec {
    Named(
        "msg4",
        Mapped {
            inner: Bind(U24Le, |i: u32| Msg4ContentFmt { i }),
            mapper: (
...
mod derived_specs {
    ...
    impl SpecSerializerDps for Msg5ContentFmt {
        ...
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            msg5_content_fmt(self.i.deep_view()).spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for HelloRetryRequestFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            hello_retry_request_fmt().spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for ServerHelloFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            server_hello_fmt().spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl<'i> SpecSerializerDps for Msg1PayloadFmt<'i> {
        ...
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            msg1_payload_fmt(self.b.deep_view()).spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for Msg4ContentFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            msg4_content_fmt(self.i.deep_view()).spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for Msg3ContentFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            msg3_content_fmt(self.i.deep_view()).spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for Msg5Fmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            msg5_fmt().spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl<'i> SpecSerializerDps for Msg2ContentFmt<'i> {
        ...
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            msg2_content_fmt(self.b.deep_view()).spec_serialize_dps(v, obuf)
        }
    }
