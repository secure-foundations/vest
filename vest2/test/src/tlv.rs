...
verus! {
    ...
    pub type Msg1FmtSpec = Named < Mapped < Pair < U8 , Pair < U16Le , Pair < Fixed < 3 > , Tail > > > , FnSpecMapper < Msg1Inner , Msg1Spec >> > ;
    ...
    impl MsgParamFmt {
        # [doc = "specification constructor for `msg_param`."] pub open spec fn spec_inner (tag : MsgTypeSpec) -> MsgParamFmtSpec {
            Named ("msg_param" ,
            Mapped {
                inner : match tag {
                ...
                ,
                mapper : (| parsed : MsgParamInner | -> MsgParamSpec {
                    match parsed {
    ...
    impl MsgContentFmt {
        # [doc = "specification constructor for `msg_content`."] pub open spec fn spec_inner (tag : MsgTypeSpec) -> MsgContentFmtSpec {
            Named ("msg_content" ,
            Mapped {
                inner : match tag {
                    MsgTypeSpec :: Msg1 => L (Msg1Fmt) ,
                ...
                ,
                mapper : (| parsed : MsgContentInner | -> MsgContentSpec {
                    match parsed {
    ...
    impl MsgAltContentFmt {
        ...
        pub closed spec fn spec (len : u16 ,
        tag : u8) -> Self {
            MsgAltContentFmt {
                len ,
                tag
    ...
    impl MsgAltContentFmt {
        # [doc = "specification constructor for `msg_alt_content`."] pub open spec fn spec_inner (len : u16 ,
        tag : u8) -> MsgAltContentFmtSpec {
            ...
            Mapped {
                ...
                ,
                mapper : (| parsed : MsgAltContentInner | -> MsgAltContentSpec {
                    match parsed {
    ...
    impl MsgAltFmt {
        # [doc = "specification constructor for `msg_alt`."] pub open spec fn spec_inner () -> MsgAltFmtSpec {
            Named ("msg_alt" ,
            Mapped {
                inner : Bind (U8 ,
                | tag : u8 | Bind (U16Le ,
                | len : u16 | ExactLen ((len as usize) ,
                MsgAltContentFmt :: spec (len ,
                tag)))) ,
    ...
    pub type MsgTypeFmtSpec = Named < Mapped < Refined < U8 , PredFnSpec < u8 >> , FnSpecMapper < MsgTypeInner , MsgTypeSpec >> > ;

    impl MsgTypeFmt {
        # [doc = "specification constructor for `msg_type`."] pub open spec fn spec_inner () -> MsgTypeFmtSpec {
            Named ("msg_type" ,
            Mapped {
                inner : Refined (U8 ,
                | x : u8 | x == 1 || x == 2 || x == 3) ,
                mapper : (| parsed : MsgTypeInner | -> MsgTypeSpec {
                    match parsed {
                        1 => MsgTypeSpec :: Msg1 ,
                        2 => MsgTypeSpec :: Msg2 ,
                        3 => MsgTypeSpec :: Msg3 ,
    ...
    mod derived_specs {
        ...
        impl SpecParser for MsgParamFmt {
            ...
            ibuf : Seq < u8 >) -> Option < (int ,
            Self :: PVal) > {
                MsgParamFmt :: spec_inner (self . tag_spec ()) . spec_parse (ibuf)
            }
        }
        impl Consistency for MsgParamFmt {
            ...
            open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                MsgParamFmt :: spec_inner (self . tag_spec ()) . consistent (v)
            }
        }
        impl SpecSerializerDps for MsgParamFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                MsgParamFmt :: spec_inner (self . tag_spec ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        impl SpecSerializer for MsgParamFmt {
            ...
            # [verifier :: opaque] open spec fn spec_serialize (& self ,
            v : Self :: SVal) -> Seq < u8 > {
                MsgParamFmt :: spec_inner (self . tag_spec ()) . spec_serialize (v)
            }
        }
        ...
        impl SpecParser for MsgContentFmt {
            ...
            ibuf : Seq < u8 >) -> Option < (int ,
            Self :: PVal) > {
                MsgContentFmt :: spec_inner (self . tag_spec ()) . spec_parse (ibuf)
            }
        }
        impl Consistency for MsgContentFmt {
            ...
            open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                MsgContentFmt :: spec_inner (self . tag_spec ()) . consistent (v)
            }
        }
        impl SpecSerializerDps for MsgContentFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                MsgContentFmt :: spec_inner (self . tag_spec ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        impl SpecSerializer for MsgContentFmt {
            ...
            # [verifier :: opaque] open spec fn spec_serialize (& self ,
            v : Self :: SVal) -> Seq < u8 > {
                MsgContentFmt :: spec_inner (self . tag_spec ()) . spec_serialize (v)
            }
        }
        impl SpecByteLen for MsgContentFmt {
            ...
            # [verifier :: opaque] open spec fn byte_len (& self ,
            v : Self :: T) -> nat {
                MsgContentFmt :: spec_inner (self . tag_spec ()) . byte_len (v)
            }
        }
        ...
        impl SpecParser for MsgAltContentFmt {
            ...
            ibuf : Seq < u8 >) -> Option < (int ,
            Self :: PVal) > {
                MsgAltContentFmt :: spec_inner (self . len_spec () ,
        ...
        impl SpecSerializerDps for MsgAltFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                MsgAltFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for MsgTypeFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                MsgTypeFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
    ...
    mod derived_proofs {
        ...
        impl Productive for MsgAltContentFmt {
            ...
            s : Seq < u8 >) {
                reveal (< MsgAltContentFmt as SpecParser > :: spec_parse) ;
                let fmt = MsgAltContentFmt :: spec_inner (self . len_spec () ,
                self . tag_spec ()) ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        ...
        impl SafeParser for MsgTypeFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                MsgTypeFmt :: spec_inner () . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for MsgTypeFmt {
            open spec fn productive_inv (& self) -> bool {
                MsgTypeFmt :: spec_inner () . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< MsgTypeFmt as SpecParser > :: spec_parse) ;
                let fmt = MsgTypeFmt :: spec_inner () ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
    ...
    mod exec_impls {
        ...
        impl < 'i > Parser < & 'i [u8] > for MsgAltFmt {
            ...
            fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
                ...
                let rest = rest.skip(n2);
                let (n3 , content) = (ExactLen ((len as usize) , MsgAltContentFmt {
            len : len ,
            tag : tag
        }
        )) . parse (& rest) ? ;
        ...
        impl < 'i > Parser < & 'i [u8] > for MsgFmt {
            ...
            fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
                ...
                let (n2 , len) = (U16Le) . parse (& rest) ? ;
                let rest = rest.skip(n2);
                let (n3 , content) = (ExactLen ((len as usize) , MsgContentFmt {
            tag : tag
        }
        )) . parse (& rest) ? ;
                let rest = rest.skip(n3);
