...
verus! {
    ...
    mod derived_specs {
        ...
        impl SpecParser for MsgAltContentFmt {
            ...
            ibuf : Seq < u8 >) -> Option < (int ,
            Self :: PVal) > {
                msg_alt_content_fmt (self . len . deep_view () ,
                self . tag . deep_view ()) . spec_parse (ibuf)
            }
        }
        ...
        impl SpecSerializerDps for MsgAltFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                msg_alt_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for MsgTypeFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                msg_type_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
    ...
    // TODO(execs): emit Parser / Serializer / Prepare impls for MsgParam


    // TODO(execs): emit Parser / Serializer / Prepare impls for MsgContent


    // TODO(execs): emit Parser / Serializer / Prepare impls for MsgAltContent


    // TODO(execs): emit Parser / Serializer / Prepare impls for MsgAlt


    // TODO(execs): emit Parser / Serializer / Prepare impls for MsgType


    // TODO(execs): emit Parser / Serializer / Prepare impls for Msg
}
