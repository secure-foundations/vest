...
verus! {
    ...
    impl HeaderAliasFmt {
        # [doc = "specification constructor for `header_alias`."] pub open spec fn spec_inner () -> HeaderAliasFmtSpec {
            Named ("header_alias" ,
            HeaderFmt)
        }
    }
    ...
    impl FixedChoiceFmt {
        # [doc = "specification constructor for `fixed_choice`."] pub open spec fn spec_inner (tag : u8) -> FixedChoiceFmtSpec {
            Named ("fixed_choice" ,
            Mapped {
                inner : match tag {
                    0 => L (U16Le) ,
    ...
    impl SimpleSubFmt {
        # [doc = "specification constructor for `simple_sub`."] pub open spec fn spec_inner (len : u16) -> SimpleSubFmtSpec {
            Named ("simple_sub" ,
            Mapped {
    ...
    impl AliasSizeFmt {
        # [doc = "specification constructor for `alias_size`."] pub open spec fn spec_inner () -> AliasSizeFmtSpec {
            Named ("alias_size" ,
            Mapped {
                inner : Fixed :: < 3 > ,
    ...
    impl MultiArithFmt {
        # [verifier :: type_invariant] spec fn wf (& self) -> bool {
            self . total >= 263 && self . total <= 4294967295 && self . hdr_len >= 0 && self . hdr_len <= 255
        }
        pub closed spec fn total_spec (& self) -> u32 {
            self . total . deep_view ()
        }
        pub closed spec fn hdr_len_spec (& self) -> u8 {
            self . hdr_len . deep_view ()
        }
        pub closed spec fn spec (total : u32 ,
        hdr_len : u8) -> Self {
            MultiArithFmt {
                total ,
                hdr_len
    ...
    impl MultiArithFmt {
        # [doc = "specification constructor for `multi_arith`."] pub open spec fn spec_inner (total : u32 ,
        hdr_len : u8) -> MultiArithFmtSpec {
            Named ("multi_arith" ,
            Mapped {
    ...
    impl SizeArithFmt {
        # [doc = "specification constructor for `size_arith`."] pub open spec fn spec_inner () -> SizeArithFmtSpec {
            Named ("size_arith" ,
            Mapped {
                inner : Fixed :: < 4 > ,
    ...
    impl PayloadWithHeaderFmt {
        # [doc = "specification constructor for `payload_with_header`."] pub open spec fn spec_inner (hdr : HeaderSpec) -> PayloadWithHeaderFmtSpec {
    ...
    impl MixedConstFmt {
        # [doc = "specification constructor for `mixed_const`."] pub open spec fn spec_inner (len : u16) -> MixedConstFmtSpec {
            Named ("mixed_const" ,
            Mapped {
    ...
    impl ChoiceTagFmt {
        # [doc = "specification constructor for `choice_tag`."] pub open spec fn spec_inner () -> ChoiceTagFmtSpec {
            Named ("choice_tag" ,
            Fixed :: < 2 >)
        }
    }
    ...
    impl NamedSizeFmt {
        # [doc = "specification constructor for `named_size`."] pub open spec fn spec_inner () -> NamedSizeFmtSpec {
            Named ("named_size" ,
            Mapped {
                inner : Fixed :: < 3 > ,
    ...
    impl ChoiceFormatSizeFmt {
        # [doc = "specification constructor for `choice_format_size`."] pub open spec fn spec_inner () -> ChoiceFormatSizeFmtSpec {
    ...
    impl HeaderBytesFmt {
        # [doc = "specification constructor for `header_bytes`."] pub open spec fn spec_inner () -> HeaderBytesFmtSpec {
            Named ("header_bytes" ,
            ExactLen (3 ,
            HeaderFmt))
        }
    ...
    impl < 'i > ChoiceArraysFoldedBodyFmt < 'i > {
        # [doc = "specification constructor for `choice_arrays_folded_body`."] pub open spec fn spec_inner (tag : ChoiceTagSpec) -> ChoiceArraysFoldedBodyFmtSpec {
    ...
    impl ChoiceArraysFoldedFmt {
        # [doc = "specification constructor for `choice_arrays_folded`."] pub open spec fn spec_inner () -> ChoiceArraysFoldedFmtSpec {
    ...
    impl ParenExprFmt {
        ...
        pub closed spec fn b_spec (& self) -> u8 {
            self . b . deep_view ()
        }
        pub closed spec fn c_spec (& self) -> u8 {
            self . c . deep_view ()
        }
        pub closed spec fn spec (a : u16 ,
        b : u8 ,
        c : u8) -> Self {
            ParenExprFmt {
                a ,
    ...
    impl ParenExprFmt {
        # [doc = "specification constructor for `paren_expr`."] pub open spec fn spec_inner (a : u16 ,
        b : u8 ,
        c : u8) -> ParenExprFmtSpec {
            Named ("paren_expr" ,
            Mapped {
    ...
    impl ReinterpretSizeFmt {
        # [doc = "specification constructor for `reinterpret_size`."] pub open spec fn spec_inner () -> ReinterpretSizeFmtSpec {
    ...
    impl PrimitiveSizesFmt {
        # [doc = "specification constructor for `primitive_sizes`."] pub open spec fn spec_inner () -> PrimitiveSizesFmtSpec {
    ...
    mod derived_specs {
        ...
        impl SpecSerializerDps for HeaderFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                HeaderFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for HeaderAliasFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                HeaderAliasFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for FixedChoiceFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                FixedChoiceFmt :: spec_inner (self . tag_spec ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for SimpleSubFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                SimpleSubFmt :: spec_inner (self . len_spec ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for AliasSizeFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                AliasSizeFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecParser for MultiArithFmt {
            ...
            ibuf : Seq < u8 >) -> Option < (int ,
            Self :: PVal) > {
                MultiArithFmt :: spec_inner (self . total_spec () ,
                self . hdr_len_spec ()) . spec_parse (ibuf)
            }
        }
        impl Consistency for MultiArithFmt {
            ...
            v : Self :: Val) -> bool {
                MultiArithFmt :: spec_inner (self . total_spec () ,
                self . hdr_len_spec ()) . consistent (v)
            }
        }
        impl SpecSerializerDps for MultiArithFmt {
            ...
            obuf : Seq < u8 >) -> Seq < u8 > {
                MultiArithFmt :: spec_inner (self . total_spec () ,
                self . hdr_len_spec ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        impl SpecSerializer for MultiArithFmt {
            ...
            v : Self :: SVal) -> Seq < u8 > {
                MultiArithFmt :: spec_inner (self . total_spec () ,
                self . hdr_len_spec ()) . spec_serialize (v)
            }
        }
        ...
        impl SpecSerializerDps for SizeArithFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                SizeArithFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for PayloadWithHeaderFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                PayloadWithHeaderFmt :: spec_inner (self . hdr_spec ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for MixedConstFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                MixedConstFmt :: spec_inner (self . len_spec ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for ChoiceTagFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                ChoiceTagFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for NamedSizeFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                NamedSizeFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for ChoiceFormatSizeFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                ChoiceFormatSizeFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecParser for HeaderBytesFmt {
            ...
            ibuf : Seq < u8 >) -> Option < (int ,
            Self :: PVal) > {
                HeaderBytesFmt :: spec_inner () . spec_parse (ibuf)
            }
        }
        impl Consistency for HeaderBytesFmt {
            ...
            open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                HeaderBytesFmt :: spec_inner () . consistent (v)
            }
        }
        impl SpecSerializerDps for HeaderBytesFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                HeaderBytesFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        impl SpecSerializer for HeaderBytesFmt {
            ...
            # [verifier :: opaque] open spec fn spec_serialize (& self ,
            v : Self :: SVal) -> Seq < u8 > {
                HeaderBytesFmt :: spec_inner () . spec_serialize (v)
            }
        }
        impl SpecByteLen for HeaderBytesFmt {
            ...
            # [verifier :: opaque] open spec fn byte_len (& self ,
            v : Self :: T) -> nat {
                HeaderBytesFmt :: spec_inner () . byte_len (v)
            }
        }
        ...
        impl < 'i > SpecSerializerDps for ChoiceArraysFoldedBodyFmt < 'i > {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                ChoiceArraysFoldedBodyFmt :: spec_inner (self . tag_spec ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for ChoiceArraysFoldedFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                ChoiceArraysFoldedFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecParser for ParenExprFmt {
            ...
            ibuf : Seq < u8 >) -> Option < (int ,
            Self :: PVal) > {
                ParenExprFmt :: spec_inner (self . a_spec () ,
                self . b_spec () ,
                self . c_spec ()) . spec_parse (ibuf)
            }
        }
        ...
        impl SpecSerializerDps for ParenExprFmt {
            ...
            obuf : Seq < u8 >) -> Seq < u8 > {
                ParenExprFmt :: spec_inner (self . a_spec () ,
                self . b_spec () ,
                self . c_spec ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecParser for ReinterpretSizeFmt {
            ...
            ibuf : Seq < u8 >) -> Option < (int ,
            Self :: PVal) > {
                ReinterpretSizeFmt :: spec_inner () . spec_parse (ibuf)
            }
        }
        impl Consistency for ReinterpretSizeFmt {
            ...
            open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                ReinterpretSizeFmt :: spec_inner () . consistent (v)
            }
        }
        impl SpecSerializerDps for ReinterpretSizeFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                ReinterpretSizeFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        impl SpecSerializer for ReinterpretSizeFmt {
            ...
            # [verifier :: opaque] open spec fn spec_serialize (& self ,
            v : Self :: SVal) -> Seq < u8 > {
                ReinterpretSizeFmt :: spec_inner () . spec_serialize (v)
            }
        }
        impl SpecByteLen for ReinterpretSizeFmt {
            ...
            # [verifier :: opaque] open spec fn byte_len (& self ,
            v : Self :: T) -> nat {
                ReinterpretSizeFmt :: spec_inner () . byte_len (v)
            }
        }
        ...
        impl SpecSerializerDps for PrimitiveSizesFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                PrimitiveSizesFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
    ...
    mod derived_proofs {
        ...
        impl SafeParser for MultiArithFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                MultiArithFmt :: spec_inner (self . total_spec () ,
                self . hdr_len_spec ()) . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for MultiArithFmt {
            open spec fn productive_inv (& self) -> bool {
                MultiArithFmt :: spec_inner (self . total_spec () ,
                self . hdr_len_spec ()) . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< MultiArithFmt as SpecParser > :: spec_parse) ;
                let fmt = MultiArithFmt :: spec_inner (self . total_spec () ,
                self . hdr_len_spec ()) ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        ...
        impl SafeParser for HeaderBytesFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                HeaderBytesFmt :: spec_inner () . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for HeaderBytesFmt {
            open spec fn productive_inv (& self) -> bool {
                HeaderBytesFmt :: spec_inner () . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< HeaderBytesFmt as SpecParser > :: spec_parse) ;
                let fmt = HeaderBytesFmt :: spec_inner () ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
        ...
        impl SafeParser for ParenExprFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                ParenExprFmt :: spec_inner (self . a_spec () ,
                self . b_spec () ,
                self . c_spec ()) . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for ParenExprFmt {
            open spec fn productive_inv (& self) -> bool {
                ParenExprFmt :: spec_inner (self . a_spec () ,
                self . b_spec () ,
                self . c_spec ()) . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< ParenExprFmt as SpecParser > :: spec_parse) ;
                let fmt = ParenExprFmt :: spec_inner (self . a_spec () ,
                self . b_spec () ,
                self . c_spec ()) ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
        ...
        impl SafeParser for ReinterpretSizeFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                ReinterpretSizeFmt :: spec_inner () . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for ReinterpretSizeFmt {
            open spec fn productive_inv (& self) -> bool {
                ReinterpretSizeFmt :: spec_inner () . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< ReinterpretSizeFmt as SpecParser > :: spec_parse) ;
                let fmt = ReinterpretSizeFmt :: spec_inner () ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
    ...
    mod exec_impls {
        ...
        impl < 'i > Parser < & 'i [u8] > for SimpleSubFmt {
            ...
            fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
                ...
                let (n1 , data) = (Varied ((((((self . len as usize) - 3 as usize) as usize) - 1 as usize) as usize))) . parse (& rest) ? ;
                let rest = rest.skip(n1);
                let total_n = n1;
                let final_v = SimpleSub {
            data
        }
        ;
                assert (self . spec_parse (ibuf @) == Some ((total_n as int , final_v . deep_view ()))) ;
        ...
        impl < 'i > Parser < & 'i [u8] > for MultiArithFmt {
            ...
            fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
                ...
                let (n1 , body) = (Varied ((((((self . total as usize) - (self . hdr_len as usize)) as usize) - 8 as usize) as usize))) . parse (& rest) ? ;
                let rest = rest.skip(n1);
                let total_n = n1;
                let final_v = MultiArith {
            body
        }
        ;
                assert (self . spec_parse (ibuf @) == Some ((total_n as int , final_v . deep_view ()))) ;
        ...
        impl < 'i > Parser < & 'i [u8] > for PayloadWithHeaderFmt {
            ...
            fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
                ...
                let (n1 , data) = (Varied ((((self . hdr . len as usize) - 3 as usize) as usize))) . parse (& rest) ? ;
                let rest = rest.skip(n1);
                let total_n = n1;
                let final_v = PayloadWithHeader {
            data
        }
        ;
                assert (self . spec_parse (ibuf @) == Some ((total_n as int , final_v . deep_view ()))) ;
        ...
        impl < 'i > Parser < & 'i [u8] > for MixedConstFmt {
            ...
            fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
                ...
                let (n1 , data) = (Varied ((((((self . len as usize) - 4 as usize) as usize) + 2 as usize) as usize))) . parse (& rest) ? ;
                let rest = rest.skip(n1);
                let total_n = n1;
                let final_v = MixedConst {
            data
        }
        ;
                assert (self . spec_parse (ibuf @) == Some ((total_n as int , final_v . deep_view ()))) ;
        ...
        impl < 'i > Parser < & 'i [u8] > for HeaderBytesFmt {
            type PT = HeaderBytes ;
            ...
            fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
                ...
                let (n , v) = (ExactLen (3 as usize , HeaderFmt)) . parse (ibuf) ? ;
                assert (self . spec_parse (ibuf @) == Some ((n as int , v . deep_view ()))) ;
                Ok((n, v))
            }
        }
        ...
        impl < 'i > Parser < & 'i [u8] > for ChoiceArraysFoldedBodyFmt < 'i > {
            ...
            x if x . deep_eq (& [0x00 , 0x00]) => {
                ...
                v) = (U8) . parse (& rest) ? ;
                (n ,
                ChoiceArraysFoldedBody :: Variant1 (v))
            }
            ,
            x if x . deep_eq (& [0x01 , 0x01]) => {
                ...
                v) = (U16Le) . parse (& rest) ? ;
                (n ,
                ChoiceArraysFoldedBody :: Variant2 (v))
            }
            ,
            _ => {
                let (n ,
                v) = (U16Le) . parse (& rest) ? ;
                (n ,
                ChoiceArraysFoldedBody :: Default (v))
            }
            ,
        }
        ;
        ...
        impl < 'i > Parser < & 'i [u8] > for ChoiceArraysFoldedFmt {
            ...
            fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
                ...
                let rest = rest.skip(n1);
                let (n2 , body) = (ChoiceArraysFoldedBodyFmt {
            tag : tag
        }
        ) . parse (& rest) ? ;
                let rest = rest.skip(n2);
                let total_n = n1 + n2;
                let final_v = ChoiceArraysFolded {
            tag ,
            body
        }
        ;
        ...
        impl < 'i > Parser < & 'i [u8] > for ParenExprFmt {
            ...
            fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
                ...
                let (n1 , data) = (Varied ((((((self . a as usize) - (self . b as usize)) as usize) + (self . c as usize)) as usize))) . parse (& rest) ? ;
                let rest = rest.skip(n1);
                let total_n = n1;
                let final_v = ParenExpr {
            data
        }
        ;
                assert (self . spec_parse (ibuf @) == Some ((total_n as int , final_v . deep_view ()))) ;
        ...
        impl < 'i > Parser < & 'i [u8] > for ReinterpretSizeFmt {
            type PT = ReinterpretSize < 'i > ;
