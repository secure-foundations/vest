...
impl<'i> DeepView for Divide<'i> {
    ...
    open spec fn deep_view(&self) -> Self::V {
        DivideSpec { chunks: self.chunks.deep_view() }
    }
}
...
impl<'i> DeepView for Multiply<'i> {
    ...
    open spec fn deep_view(&self) -> Self::V {
        MultiplySpec { items: self.items.deep_view() }
    }
}
...
impl<'i> DeepView for ReinterpretSize<'i> {
    ...
    open spec fn deep_view(&self) -> Self::V {
        ReinterpretSizeSpec { bytes: self.bytes.deep_view() }
    }
}
...
pub open spec fn header_bytes_fmt() -> HeaderBytesFmtSpec {
    Named("header_bytes", ExactLen(3, HeaderFmt))
}
...
pub open spec fn multiply_fmt(count: u16, size: u8) -> MultiplyFmtSpec {
    Named(
        ...
        Mapped {
            ...
            mapper: (
                |parsed: MultiplyInner| -> MultiplySpec
                    {
                        let items = parsed;
                        MultiplySpec { items }
                    },
...
pub open spec fn choice_arrays_folded_body_fmt(
    tag: ChoiceTagSpec,
) -> ChoiceArraysFoldedBodyFmtSpec {
    Named(
        "choice_arrays_folded_body",
        Mapped {
            inner: match tag {
                x if x == [0x00u8;2].deep_view() => Sum::Inl(U8),
                x if x == [0x01u8;2].deep_view() => Sum::Inr(Sum::Inl(U16Le)),
...
pub open spec fn choice_arrays_folded_fmt() -> ChoiceArraysFoldedFmtSpec {
    Named(
        ...
        Mapped {
            inner: Bind(ChoiceTagFmt, |tag: ChoiceTagSpec| choice_arrays_folded_body_fmt(tag)),
            mapper: (
...
pub type ReinterpretSizeFmtSpec = Named<
    Mapped<Fixed<3>, FnSpecMapper<ReinterpretSizeInner, ReinterpretSizeSpec>>,
>;
...
pub open spec fn reinterpret_size_fmt() -> ReinterpretSizeFmtSpec {
    Named(
        ...
        Mapped {
            inner: Fixed::<3>,
            mapper: (
                |parsed: ReinterpretSizeInner| -> ReinterpretSizeSpec
                    {
                        let bytes = parsed;
                        ReinterpretSizeSpec { bytes }
                    },
                |value: ReinterpretSizeSpec| -> ReinterpretSizeInner
                    {
                        let ReinterpretSizeSpec { bytes } = value;
                        bytes
                    },
            ),
        },
...
mod derived_specs {
    ...
    impl SpecSerializerDps for HeaderFmt {
        ...
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            header_fmt().spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for HeaderAliasFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            header_alias_fmt().spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for DivideFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            divide_fmt(self.total.deep_view()).spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for FixedChoiceFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            fixed_choice_fmt(self.tag.deep_view()).spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for SimpleSubFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            simple_sub_fmt(self.len.deep_view()).spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for AliasSizeFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            alias_size_fmt().spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecParser for MultiArithFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_parse(&self, ibuf: Seq<u8>) -> Option<(int, Self::PVal)> {
            multi_arith_fmt(self.total.deep_view(), self.hdr_len.deep_view()).spec_parse(ibuf)
        }
    }
    ...
    impl Consistency for MultiArithFmt {
        ...
        # [verifier :: opaque]
        open spec fn consistent(&self, v: Self::Val) -> bool {
            multi_arith_fmt(self.total.deep_view(), self.hdr_len.deep_view()).consistent(v)
        }
    }
    ...
    impl SpecSerializerDps for MultiArithFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            multi_arith_fmt(self.total.deep_view(), self.hdr_len.deep_view()).spec_serialize_dps(
                v,
                obuf,
            )
        }
    ...
    impl SpecSerializer for MultiArithFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize(&self, v: Self::SVal) -> Seq<u8> {
            multi_arith_fmt(self.total.deep_view(), self.hdr_len.deep_view()).spec_serialize(v)
        }
    }
    ...
    impl SpecByteLen for MultiArithFmt {
        ...
        # [verifier :: opaque]
        open spec fn byte_len(&self, v: Self::T) -> nat {
            multi_arith_fmt(self.total.deep_view(), self.hdr_len.deep_view()).byte_len(v)
        }
    }
    ...
    impl SpecSerializerDps for SizeArithFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            size_arith_fmt().spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for PayloadWithHeaderFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            payload_with_header_fmt(self.hdr.deep_view()).spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for MixedConstFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            mixed_const_fmt(self.len.deep_view()).spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for ChoiceTagFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            choice_tag_fmt().spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for NamedSizeFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            named_size_fmt().spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for ChoiceFormatSizeFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            choice_format_size_fmt().spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for HeaderBytesFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            header_bytes_fmt().spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecParser for MultiplyFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_parse(&self, ibuf: Seq<u8>) -> Option<(int, Self::PVal)> {
            multiply_fmt(self.count.deep_view(), self.size.deep_view()).spec_parse(ibuf)
        }
    }
    ...
    impl Consistency for MultiplyFmt {
        ...
        # [verifier :: opaque]
        open spec fn consistent(&self, v: Self::Val) -> bool {
            multiply_fmt(self.count.deep_view(), self.size.deep_view()).consistent(v)
        }
    }
    ...
    impl SpecSerializerDps for MultiplyFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            multiply_fmt(self.count.deep_view(), self.size.deep_view()).spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializer for MultiplyFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize(&self, v: Self::SVal) -> Seq<u8> {
            multiply_fmt(self.count.deep_view(), self.size.deep_view()).spec_serialize(v)
        }
    }
    ...
    impl SpecByteLen for MultiplyFmt {
        ...
        # [verifier :: opaque]
        open spec fn byte_len(&self, v: Self::T) -> nat {
            multiply_fmt(self.count.deep_view(), self.size.deep_view()).byte_len(v)
        }
    }
    ...
    impl<'i> SpecSerializerDps for ChoiceArraysFoldedBodyFmt<'i> {
        ...
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            choice_arrays_folded_body_fmt(self.tag.deep_view()).spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for ChoiceArraysFoldedFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            choice_arrays_folded_fmt().spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecParser for ParenExprFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_parse(&self, ibuf: Seq<u8>) -> Option<(int, Self::PVal)> {
            paren_expr_fmt(self.a.deep_view(), self.b.deep_view(), self.c.deep_view()).spec_parse(
                ibuf,
            )
        }
    }
    ...
    impl Consistency for ParenExprFmt {
        ...
        # [verifier :: opaque]
        open spec fn consistent(&self, v: Self::Val) -> bool {
            paren_expr_fmt(self.a.deep_view(), self.b.deep_view(), self.c.deep_view()).consistent(v)
        }
    }
    ...
    impl SpecByteLen for ParenExprFmt {
        ...
        # [verifier :: opaque]
        open spec fn byte_len(&self, v: Self::T) -> nat {
            paren_expr_fmt(self.a.deep_view(), self.b.deep_view(), self.c.deep_view()).byte_len(v)
        }
    }
    ...
    impl SpecSerializerDps for ReinterpretSizeFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            reinterpret_size_fmt().spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for PrimitiveSizesFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            primitive_sizes_fmt().spec_serialize_dps(v, obuf)
        }
    }
...
mod derived_proofs {
    ...
    impl SafeParser for MultiArithFmt {
        proof fn lemma_parse_safe(&self, ibuf: Seq<u8>) {
            ...
            multi_arith_fmt(self.total.deep_view(), self.hdr_len.deep_view()).lemma_parse_safe(
                ibuf,
            );
        }
    }
    ...
    impl Productive for MultiArithFmt {
        open spec fn productive_inv(&self) -> bool {
            multi_arith_fmt(self.total.deep_view(), self.hdr_len.deep_view()).productive_inv()
        }

        proof fn lemma_productive(&self, s: Seq<u8>) {
            reveal(<MultiArithFmt as SpecParser>::spec_parse);
            let fmt = multi_arith_fmt(self.total.deep_view(), self.hdr_len.deep_view());
            assert(fmt.productive_inv());
            fmt.lemma_productive(s);
        }
    }
    ...
    impl SafeParser for MultiplyFmt {
        proof fn lemma_parse_safe(&self, ibuf: Seq<u8>) {
            ...
            multiply_fmt(self.count.deep_view(), self.size.deep_view()).lemma_parse_safe(ibuf);
        }
    }

    impl Productive for MultiplyFmt {
        open spec fn productive_inv(&self) -> bool {
            multiply_fmt(self.count.deep_view(), self.size.deep_view()).productive_inv()
        }

        proof fn lemma_productive(&self, s: Seq<u8>) {
            reveal(<MultiplyFmt as SpecParser>::spec_parse);
            let fmt = multiply_fmt(self.count.deep_view(), self.size.deep_view());
            assert(fmt.productive_inv());
            fmt.lemma_productive(s);
        }
    }
    ...
    impl Productive for ParenExprFmt {
        ...
        proof fn lemma_productive(&self, s: Seq<u8>) {
            reveal(<ParenExprFmt as SpecParser>::spec_parse);
            let fmt = paren_expr_fmt(self.a.deep_view(), self.b.deep_view(), self.c.deep_view());
            assert(fmt.productive_inv());
            fmt.lemma_productive(s);
        }
    }
...
impl<'i> Parser<&'i [u8]> for DivideFmt {
    type PT = Divide<'i>;
    ...
    fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
        ...
        let (n1, chunks) = (Varied((((self.total as usize) / 4 as usize) as usize))).parse(&rest)?;
        let rest = rest.skip(n1);
        let total_n = n1;
        let final_v = Divide { chunks };
        assert(self.spec_parse(ibuf@) == Some((total_n as int, final_v.deep_view())));
        Ok((total_n, final_v))
    }
}
...
impl<'i> Parser<&'i [u8]> for SimpleSubFmt {
    ...
    fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
        ...
        let (n1, data) = (Varied(
            (((((self.len as usize) - 3 as usize) as usize) - 1 as usize) as usize),
        )).parse(&rest)?;
        let rest = rest.skip(n1);
        let total_n = n1;
...
impl<'i> Parser<&'i [u8]> for MultiArithFmt {
    ...
    fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
        ...
        let (n1, body) = (Varied(
            (((((self.total as usize) - (self.hdr_len as usize)) as usize) - 8 as usize) as usize),
        )).parse(&rest)?;
        let rest = rest.skip(n1);
        let total_n = n1;
...
impl<'i> Parser<&'i [u8]> for MixedConstFmt {
    ...
    fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
        ...
        let (n1, data) = (Varied(
            (((((self.len as usize) - 4 as usize) as usize) + 2 as usize) as usize),
        )).parse(&rest)?;
        let rest = rest.skip(n1);
        let total_n = n1;
...
impl<'i> Parser<&'i [u8]> for MultiplyFmt {
    type PT = Multiply<'i>;
    ...
    fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
        ...
        let (n1, items) = (Varied((((self.count as usize) * (self.size as usize)) as usize))).parse(
            &rest,
        )?;
        let rest = rest.skip(n1);
        let total_n = n1;
        let final_v = Multiply { items };
        assert(self.spec_parse(ibuf@) == Some((total_n as int, final_v.deep_view())));
        Ok((total_n, final_v))
    }
}
...
impl<'i> Parser<&'i [u8]> for ParenExprFmt {
    ...
    fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
        ...
        let (n1, data) = (Varied(
            (((((self.a as usize) - (self.b as usize)) as usize) * (self.c as usize)) as usize),
        )).parse(&rest)?;
        let rest = rest.skip(n1);
        let total_n = n1;
...
impl<'i> Parser<&'i [u8]> for ReinterpretSizeFmt {
    ...
    fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
        ...
        let rest = rest.skip(n1);
        let total_n = n1;
        let final_v = ReinterpretSize { bytes };
        assert(self.spec_parse(ibuf@) == Some((total_n as int, final_v.deep_view())));
        Ok((total_n, final_v))
    }
}
