...
mod derived_specs {
    ...
    impl SpecSerializerDps for OpaqueU16Fmt {
        ...
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            opaque_u16_fmt().spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for RepeatFixFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            repeat_fix_fmt().spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for ResponderIdFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            responder_id_fmt().spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for ResponderIdListFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            responder_id_list_fmt().spec_serialize_dps(v, obuf)
        }
    }
    ...
    impl SpecSerializerDps for RepeatDynFmt {
        ...
        # [verifier :: opaque]
        open spec fn spec_serialize_dps(&self, v: Self::SValue, obuf: Seq<u8>) -> Seq<u8> {
            repeat_dyn_fmt().spec_serialize_dps(v, obuf)
        }
    }
...
impl<'i> Parser<&'i [u8]> for RepeatDynFmt {
    ...
    fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
        ...
        let rest = rest.skip(n1);
        let (n2, data) = (RepeatN((l as usize), ResponderIdListFmt)).parse(&rest)?;
        let rest = rest.skip(n2);
        let total_n = n1 + n2;
