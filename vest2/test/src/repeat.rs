...
verus! {
    ...
    pub type OpaqueU16FmtSpec = Named < Mapped < Bind < Refined < U16Le , PredFnSpec < u16 >> , spec_fn (u16) -> Varied < usize > > , FnSpecMapper < OpaqueU16Inner , OpaqueU16Spec >> > ;

    # [doc = "specification constructor for `opaque_u16`."]
    pub open spec fn opaque_u16_fmt () -> OpaqueU16FmtSpec {
        Named ("opaque_u16" ,
        Mapped {
            inner : Bind (Refined (U16Le ,
            | x : u16 | x >= 1 && x <= 65535) ,
            | l : u16 | Varied ((l as usize))) ,
            mapper : (| parsed : OpaqueU16Inner | -> OpaqueU16Spec {
                let (l ,
                data) = parsed ;
                OpaqueU16Spec {
                    l ,
    ...
    pub open spec fn repeat_fix_fmt () -> RepeatFixFmtSpec {
        Named ("repeat_fix" ,
        Array :: < 32 ,
        _ > (U16Le))
    }
    ...
    pub type ResponderIdListFmtSpec = Named < Mapped < Bind < Refined < U16Le , PredFnSpec < u16 >> , spec_fn (u16) -> ExactLen < RepeatTillEnd < ResponderIdFmt > , usize > > , FnSpecMapper < ResponderIdListInner , ResponderIdListSpec >> > ;

    # [doc = "specification constructor for `responder_id_list`."]
    pub open spec fn responder_id_list_fmt () -> ResponderIdListFmtSpec {
    ...
    pub type RepeatDynFmtSpec = Named < Mapped < Bind < VarInt < true > , spec_fn (u64) -> RepeatN < ResponderIdListFmt , usize > > , FnSpecMapper < RepeatDynInner , RepeatDynSpec >> > ;

    # [doc = "specification constructor for `repeat_dyn`."]
    pub open spec fn repeat_dyn_fmt () -> RepeatDynFmtSpec {
        Named ("repeat_dyn" ,
        Mapped {
            inner : Bind (VarInt :: < true > ,
            | l : u64 | RepeatN ((l as usize) ,
            ResponderIdListFmt)) ,
            mapper : (| parsed : RepeatDynInner | -> RepeatDynSpec {
                let (l ,
                data) = parsed ;
                RepeatDynSpec {
                    l ,
    ...
    mod derived_specs {
        ...
        impl SpecParser for OpaqueU16Fmt {
            ...
            Self :: PVal) > {
                opaque_u16_fmt () . spec_parse (ibuf)
            }
        }
        ...
        impl SpecSerializerDps for OpaqueU16Fmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                opaque_u16_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        impl SpecSerializer for OpaqueU16Fmt {
            ...
            v : Self :: SVal) -> Seq < u8 > {
                opaque_u16_fmt () . spec_serialize (v)
            }
        }
        ...
        impl SpecParser for RepeatFixFmt {
            ...
            ibuf : Seq < u8 >) -> Option < (int ,
            Self :: PVal) > {
                repeat_fix_fmt () . spec_parse (ibuf)
            }
        }
        ...
        impl SpecSerializerDps for RepeatFixFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                repeat_fix_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        impl SpecSerializer for RepeatFixFmt {
            ...
            # [verifier :: opaque] open spec fn spec_serialize (& self ,
            v : Self :: SVal) -> Seq < u8 > {
                repeat_fix_fmt () . spec_serialize (v)
            }
        }
        ...
        impl SpecParser for ResponderIdFmt {
            ...
            ibuf : Seq < u8 >) -> Option < (int ,
            Self :: PVal) > {
                responder_id_fmt () . spec_parse (ibuf)
            }
        }
        ...
        impl SpecSerializerDps for ResponderIdFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                responder_id_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        impl SpecSerializer for ResponderIdFmt {
            ...
            # [verifier :: opaque] open spec fn spec_serialize (& self ,
            v : Self :: SVal) -> Seq < u8 > {
                responder_id_fmt () . spec_serialize (v)
            }
        }
        ...
        impl SpecParser for ResponderIdListFmt {
            ...
            ibuf : Seq < u8 >) -> Option < (int ,
            Self :: PVal) > {
                responder_id_list_fmt () . spec_parse (ibuf)
            }
        }
        impl Consistency for ResponderIdListFmt {
            ...
            # [verifier :: opaque] open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                responder_id_list_fmt () . consistent (v)
            }
        }
        impl SpecSerializerDps for ResponderIdListFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                responder_id_list_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        impl SpecSerializer for ResponderIdListFmt {
            ...
            # [verifier :: opaque] open spec fn spec_serialize (& self ,
            v : Self :: SVal) -> Seq < u8 > {
                responder_id_list_fmt () . spec_serialize (v)
            }
        }
        impl SpecByteLen for ResponderIdListFmt {
            ...
            # [verifier :: opaque] open spec fn byte_len (& self ,
            v : Self :: T) -> nat {
                responder_id_list_fmt () . byte_len (v)
            }
        }
        ...
        impl SpecParser for RepeatDynFmt {
            ...
            ibuf : Seq < u8 >) -> Option < (int ,
            Self :: PVal) > {
                repeat_dyn_fmt () . spec_parse (ibuf)
            }
        }
        ...
        impl SpecSerializerDps for RepeatDynFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                repeat_dyn_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        impl SpecSerializer for RepeatDynFmt {
            ...
            # [verifier :: opaque] open spec fn spec_serialize (& self ,
            v : Self :: SVal) -> Seq < u8 > {
                repeat_dyn_fmt () . spec_serialize (v)
            }
        }
    ...
    mod derived_proofs {
        ...
        impl SafeParser for OpaqueU16Fmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                opaque_u16_fmt () . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for OpaqueU16Fmt {
            open spec fn productive_inv (& self) -> bool {
                opaque_u16_fmt () . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< OpaqueU16Fmt as SpecParser > :: spec_parse) ;
                let fmt = opaque_u16_fmt () ;
        ...
        impl SafeParser for RepeatFixFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                repeat_fix_fmt () . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for RepeatFixFmt {
            open spec fn productive_inv (& self) -> bool {
                repeat_fix_fmt () . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< RepeatFixFmt as SpecParser > :: spec_parse) ;
                let fmt = repeat_fix_fmt () ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
        ...
        impl SafeParser for ResponderIdFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                responder_id_fmt () . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for ResponderIdFmt {
            open spec fn productive_inv (& self) -> bool {
                responder_id_fmt () . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< ResponderIdFmt as SpecParser > :: spec_parse) ;
                let fmt = responder_id_fmt () ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
        ...
        impl SafeParser for ResponderIdListFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                responder_id_list_fmt () . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for ResponderIdListFmt {
            open spec fn productive_inv (& self) -> bool {
                responder_id_list_fmt () . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< ResponderIdListFmt as SpecParser > :: spec_parse) ;
                let fmt = responder_id_list_fmt () ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
        ...
        impl SafeParser for RepeatDynFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                repeat_dyn_fmt () . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for RepeatDynFmt {
            open spec fn productive_inv (& self) -> bool {
                repeat_dyn_fmt () . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< RepeatDynFmt as SpecParser > :: spec_parse) ;
                let fmt = repeat_dyn_fmt () ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
    ...
    // ============================================================
    // TODO(execs): emit Parser / Serializer / Prepare impls for OpaqueU16


    // TODO(execs): emit Parser / Serializer / Prepare impls for RepeatFix
    ...
    // TODO(execs): emit Parser / Serializer / Prepare impls for RepeatDyn
}
