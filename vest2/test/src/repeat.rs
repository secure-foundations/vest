...
verus! {
    ...
    impl OpaqueU16Fmt {
        # [doc = "specification constructor for `opaque_u16`."] pub open spec fn spec_inner () -> OpaqueU16FmtSpec {
            Named ("opaque_u16" ,
            Mapped {
    ...
    impl RepeatFixFmt {
        # [doc = "specification constructor for `repeat_fix`."] pub open spec fn spec_inner () -> RepeatFixFmtSpec {
            Named ("repeat_fix" ,
            Array :: < 32 ,
            _ > (U16Le))
        }
    ...
    impl ResponderIdFmt {
        # [doc = "specification constructor for `responder_id`."] pub open spec fn spec_inner () -> ResponderIdFmtSpec {
            Named ("responder_id" ,
            OpaqueU16Fmt)
        }
    }
    ...
    impl RepeatDynFmt {
        # [doc = "specification constructor for `repeat_dyn`."] pub open spec fn spec_inner () -> RepeatDynFmtSpec {
            Named ("repeat_dyn" ,
            Mapped {
    ...
    mod derived_specs {
        ...
        impl SpecSerializerDps for OpaqueU16Fmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                OpaqueU16Fmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for RepeatFixFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                RepeatFixFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for ResponderIdFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                ResponderIdFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for ResponderIdListFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                ResponderIdListFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for RepeatDynFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                RepeatDynFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
