...
verus! {
    ...
    impl DeepEq for COrD {
        fn deep_eq (& self ,
        other : & Self) -> bool {
            * self == * other
        }
    }
    impl SelfView for COrD {
    ...
    impl DeepEq for AOrB {
        fn deep_eq (& self ,
        other : & Self) -> bool {
            * self == * other
        }
    }
    impl SelfView for AOrB {
        proof fn self_view (& self) {
        }
        fn eq (& self ,
        other : & Self) -> bool {
    ...
    impl CaptureParamAndLocalXAPayloadFmt {
        ...
        pub closed spec fn spec (choice2 : COrD ,
        len : u8) -> Self {
            CaptureParamAndLocalXAPayloadFmt {
                choice2 ,
                len
            }
        }
    ...
    impl CaptureParamAndLocalXAPayloadFmt {
        # [doc = "specification constructor for `capture_param_and_local_x_a_payload`."] pub open spec fn spec_inner (choice2 : COrDSpec ,
        len : u8) -> CaptureParamAndLocalXAPayloadFmtSpec {
    ...
    impl CaptureParamAndLocalXAFmt {
        # [doc = "specification constructor for `capture_param_and_local_x_a`."] pub open spec fn spec_inner (choice2 : COrDSpec) -> CaptureParamAndLocalXAFmtSpec {
            Named ("capture_param_and_local_x_a" ,
            Mapped {
                inner : Bind (U8 ,
                | len : u8 | CaptureParamAndLocalXAPayloadFmt :: spec (choice2 ,
                len)) ,
    ...
    impl CaptureParamAndLocalXBYFmt {
        # [doc = "specification constructor for `capture_param_and_local_x_b_y`."] pub open spec fn spec_inner (tag : u8) -> CaptureParamAndLocalXBYFmtSpec {
    ...
    impl CaptureParamAndLocalXBFmt {
        # [doc = "specification constructor for `capture_param_and_local_x_b`."] pub open spec fn spec_inner () -> CaptureParamAndLocalXBFmtSpec {
            Named ("capture_param_and_local_x_b" ,
            Mapped {
                inner : Bind (U8 ,
                | tag : u8 | CaptureParamAndLocalXBYFmt :: spec (tag)) ,
    ...
    impl CaptureParamAndLocalXFmt {
        ...
        pub closed spec fn spec (choice1 : AOrB ,
        choice2 : COrD) -> Self {
    ...
    impl CaptureParamAndLocalXFmt {
        # [doc = "specification constructor for `capture_param_and_local_x`."] pub open spec fn spec_inner (choice1 : AOrBSpec ,
        choice2 : COrDSpec) -> CaptureParamAndLocalXFmtSpec {
    ...
    impl NestedInnerChoiceXAFmt {
        # [doc = "specification constructor for `nested_inner_choice_x_a`."] pub open spec fn spec_inner (choice2 : COrDSpec) -> NestedInnerChoiceXAFmtSpec {
    ...
    impl NestedInnerStructVFmt {
        # [doc = "specification constructor for `nested_inner_struct_v`."] pub open spec fn spec_inner () -> NestedInnerStructVFmtSpec {
    ...
    impl CaptureOuterAndLocalPayloadBodyChoice1Fmt {
        # [doc = "specification constructor for `capture_outer_and_local_payload_body_choice1`."] pub open spec fn spec_inner () -> CaptureOuterAndLocalPayloadBodyChoice1FmtSpec {
    ...
    impl CaptureOuterAndLocalPayloadBodyFmt {
        ...
        pub closed spec fn spec (frame_len : u8 ,
        tag : u8) -> Self {
    ...
    impl CaptureOuterAndLocalPayloadBodyFmt {
        # [doc = "specification constructor for `capture_outer_and_local_payload_body`."] pub open spec fn spec_inner (frame_len : u8 ,
        tag : u8) -> CaptureOuterAndLocalPayloadBodyFmtSpec {
    ...
    impl CaptureOuterAndLocalPayloadFmt {
        # [doc = "specification constructor for `capture_outer_and_local_payload`."] pub open spec fn spec_inner (frame_len : u8) -> CaptureOuterAndLocalPayloadFmtSpec {
            Named ("capture_outer_and_local_payload" ,
            Mapped {
                inner : Bind (U8 ,
                | tag : u8 | CaptureOuterAndLocalPayloadBodyFmt :: spec (frame_len ,
                tag)) ,
    ...
    impl CaptureOuterAndLocalFmt {
        # [doc = "specification constructor for `capture_outer_and_local`."] pub open spec fn spec_inner () -> CaptureOuterAndLocalFmtSpec {
    ...
    impl CaptureLocalInAnonStructWrapperValueChoice0Fmt {
        # [doc = "specification constructor for `capture_local_in_anon_struct_wrapper_value_choice0`."] pub open spec fn spec_inner () -> CaptureLocalInAnonStructWrapperValueChoice0FmtSpec {
    ...
    impl CaptureLocalInAnonStructWrapperValueFmt {
        ...
        pub closed spec fn spec (tag : u8) -> Self {
            CaptureLocalInAnonStructWrapperValueFmt {
                tag
            }
        }
    }
    ...
    impl CaptureLocalInAnonStructWrapperValueFmt {
        # [doc = "specification constructor for `capture_local_in_anon_struct_wrapper_value`."] pub open spec fn spec_inner (tag : u8) -> CaptureLocalInAnonStructWrapperValueFmtSpec {
    ...
    impl NestedInnerChoiceXFmt {
        # [doc = "specification constructor for `nested_inner_choice_x`."] pub open spec fn spec_inner (choice1 : AOrBSpec ,
        choice2 : COrDSpec) -> NestedInnerChoiceXFmtSpec {
    ...
    impl NestedInnerChoiceFmt {
        # [doc = "specification constructor for `nested_inner_choice`."] pub open spec fn spec_inner (choice1 : AOrBSpec ,
        choice2 : COrDSpec) -> NestedInnerChoiceFmtSpec {
            Named ("nested_inner_choice" ,
            Mapped {
                inner : NestedInnerChoiceXFmt :: spec (choice1 ,
                choice2) ,
    ...
    impl CaptureParamAndLocalFmt {
        # [doc = "specification constructor for `capture_param_and_local`."] pub open spec fn spec_inner (choice1 : AOrBSpec ,
        choice2 : COrDSpec) -> CaptureParamAndLocalFmtSpec {
            Named ("capture_param_and_local" ,
            Mapped {
                inner : CaptureParamAndLocalXFmt :: spec (choice1 ,
                choice2) ,
    ...
    impl NestedInnerStructFmt {
        # [doc = "specification constructor for `nested_inner_struct`."] pub open spec fn spec_inner () -> NestedInnerStructFmtSpec {
    ...
    impl COrDFmt {
        # [doc = "specification constructor for `c_or_d`."] pub open spec fn spec_inner () -> COrDFmtSpec {
            Named ("c_or_d" ,
            Mapped {
                inner : Refined (U8 ,
                | x : u8 | x == 1 || x == 2) ,
    ...
    impl CaptureLocalInAnonStructWrapperFmt {
        # [doc = "specification constructor for `capture_local_in_anon_struct_wrapper`."] pub open spec fn spec_inner () -> CaptureLocalInAnonStructWrapperFmtSpec {
            Named ("capture_local_in_anon_struct_wrapper" ,
            Mapped {
                inner : Bind (U8 ,
                | tag : u8 | CaptureLocalInAnonStructWrapperValueFmt :: spec (tag)) ,
    ...
    impl CaptureLocalInAnonStructFmt {
        # [doc = "specification constructor for `capture_local_in_anon_struct`."] pub open spec fn spec_inner () -> CaptureLocalInAnonStructFmtSpec {
    ...
    impl AOrBFmt {
        # [doc = "specification constructor for `a_or_b`."] pub open spec fn spec_inner () -> AOrBFmtSpec {
            Named ("a_or_b" ,
            Mapped {
                inner : Refined (U8 ,
                | x : u8 | x == 1 || x == 2) ,
    ...
    mod derived_specs {
        ...
        impl SpecParser for CaptureParamAndLocalXAPayloadFmt {
            ...
            Self :: PVal) > {
                CaptureParamAndLocalXAPayloadFmt :: spec_inner (self . choice2_spec () ,
                self . len_spec ()) . spec_parse (ibuf)
            }
        }
        ...
        impl SpecSerializerDps for CaptureParamAndLocalXAPayloadFmt {
            ...
            obuf : Seq < u8 >) -> Seq < u8 > {
                CaptureParamAndLocalXAPayloadFmt :: spec_inner (self . choice2_spec () ,
                self . len_spec ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        impl SpecSerializer for CaptureParamAndLocalXAPayloadFmt {
            ...
            v : Self :: SVal) -> Seq < u8 > {
                CaptureParamAndLocalXAPayloadFmt :: spec_inner (self . choice2_spec () ,
                self . len_spec ()) . spec_serialize (v)
            }
        }
        ...
        impl Consistency for CaptureParamAndLocalXAFmt {
            ...
            open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                CaptureParamAndLocalXAFmt :: spec_inner (self . choice2_spec ()) . consistent (v)
            }
        }
        impl SpecSerializerDps for CaptureParamAndLocalXAFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                CaptureParamAndLocalXAFmt :: spec_inner (self . choice2_spec ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl Consistency for CaptureParamAndLocalXBYFmt {
            ...
            open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                CaptureParamAndLocalXBYFmt :: spec_inner (self . tag_spec ()) . consistent (v)
            }
        }
        impl SpecSerializerDps for CaptureParamAndLocalXBYFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                CaptureParamAndLocalXBYFmt :: spec_inner (self . tag_spec ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl Consistency for CaptureParamAndLocalXBFmt {
            ...
            open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                CaptureParamAndLocalXBFmt :: spec_inner () . consistent (v)
            }
        }
        impl SpecSerializerDps for CaptureParamAndLocalXBFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                CaptureParamAndLocalXBFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecParser for CaptureParamAndLocalXFmt {
            ...
            ibuf : Seq < u8 >) -> Option < (int ,
            Self :: PVal) > {
                CaptureParamAndLocalXFmt :: spec_inner (self . choice1_spec () ,
                self . choice2_spec ()) . spec_parse (ibuf)
            }
        }
        impl Consistency for CaptureParamAndLocalXFmt {
            ...
            v : Self :: Val) -> bool {
                CaptureParamAndLocalXFmt :: spec_inner (self . choice1_spec () ,
                self . choice2_spec ()) . consistent (v)
            }
        }
        impl SpecSerializerDps for CaptureParamAndLocalXFmt {
            ...
            obuf : Seq < u8 >) -> Seq < u8 > {
                CaptureParamAndLocalXFmt :: spec_inner (self . choice1_spec () ,
                self . choice2_spec ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        impl SpecSerializer for CaptureParamAndLocalXFmt {
            ...
            v : Self :: SVal) -> Seq < u8 > {
                CaptureParamAndLocalXFmt :: spec_inner (self . choice1_spec () ,
                self . choice2_spec ()) . spec_serialize (v)
            }
        }
        ...
        impl Consistency for NestedInnerChoiceXAFmt {
            ...
            open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                NestedInnerChoiceXAFmt :: spec_inner (self . choice2_spec ()) . consistent (v)
            }
        }
        impl SpecSerializerDps for NestedInnerChoiceXAFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                NestedInnerChoiceXAFmt :: spec_inner (self . choice2_spec ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecParser for NestedInnerStructVFmt {
            ...
            ibuf : Seq < u8 >) -> Option < (int ,
            Self :: PVal) > {
                NestedInnerStructVFmt :: spec_inner () . spec_parse (ibuf)
            }
        }
        impl Consistency for NestedInnerStructVFmt {
            ...
            open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                NestedInnerStructVFmt :: spec_inner () . consistent (v)
            }
        }
        impl SpecSerializerDps for NestedInnerStructVFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                NestedInnerStructVFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        impl SpecSerializer for NestedInnerStructVFmt {
            ...
            # [verifier :: opaque] open spec fn spec_serialize (& self ,
            v : Self :: SVal) -> Seq < u8 > {
                NestedInnerStructVFmt :: spec_inner () . spec_serialize (v)
            }
        }
        impl SpecByteLen for NestedInnerStructVFmt {
            ...
            # [verifier :: opaque] open spec fn byte_len (& self ,
            v : Self :: T) -> nat {
                NestedInnerStructVFmt :: spec_inner () . byte_len (v)
            }
        }
        ...
        impl Consistency for CaptureOuterAndLocalPayloadBodyChoice1Fmt {
            ...
            open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                CaptureOuterAndLocalPayloadBodyChoice1Fmt :: spec_inner () . consistent (v)
            }
        }
        impl SpecSerializerDps for CaptureOuterAndLocalPayloadBodyChoice1Fmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                CaptureOuterAndLocalPayloadBodyChoice1Fmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecParser for CaptureOuterAndLocalPayloadBodyFmt {
            ...
            ibuf : Seq < u8 >) -> Option < (int ,
            Self :: PVal) > {
                CaptureOuterAndLocalPayloadBodyFmt :: spec_inner (self . frame_len_spec () ,
                self . tag_spec ()) . spec_parse (ibuf)
            }
        }
        ...
        impl SpecSerializerDps for CaptureOuterAndLocalPayloadBodyFmt {
            ...
            obuf : Seq < u8 >) -> Seq < u8 > {
                CaptureOuterAndLocalPayloadBodyFmt :: spec_inner (self . frame_len_spec () ,
                self . tag_spec ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        impl SpecSerializer for CaptureOuterAndLocalPayloadBodyFmt {
            ...
            v : Self :: SVal) -> Seq < u8 > {
                CaptureOuterAndLocalPayloadBodyFmt :: spec_inner (self . frame_len_spec () ,
                self . tag_spec ()) . spec_serialize (v)
            }
        }
        ...
        impl Consistency for CaptureOuterAndLocalPayloadFmt {
            ...
            open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                CaptureOuterAndLocalPayloadFmt :: spec_inner (self . frame_len_spec ()) . consistent (v)
            }
        }
        impl SpecSerializerDps for CaptureOuterAndLocalPayloadFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                CaptureOuterAndLocalPayloadFmt :: spec_inner (self . frame_len_spec ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl Consistency for CaptureOuterAndLocalFmt {
            ...
            open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                CaptureOuterAndLocalFmt :: spec_inner () . consistent (v)
            }
        }
        impl SpecSerializerDps for CaptureOuterAndLocalFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                CaptureOuterAndLocalFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl Consistency for CaptureLocalInAnonStructWrapperValueChoice0Fmt {
            ...
            open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                CaptureLocalInAnonStructWrapperValueChoice0Fmt :: spec_inner () . consistent (v)
            }
        }
        impl SpecSerializerDps for CaptureLocalInAnonStructWrapperValueChoice0Fmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                CaptureLocalInAnonStructWrapperValueChoice0Fmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl Consistency for CaptureLocalInAnonStructWrapperValueFmt {
            ...
            open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                CaptureLocalInAnonStructWrapperValueFmt :: spec_inner (self . tag_spec ()) . consistent (v)
            }
        }
        impl SpecSerializerDps for CaptureLocalInAnonStructWrapperValueFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                CaptureLocalInAnonStructWrapperValueFmt :: spec_inner (self . tag_spec ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecParser for NestedInnerChoiceXFmt {
            ...
            ibuf : Seq < u8 >) -> Option < (int ,
            Self :: PVal) > {
                NestedInnerChoiceXFmt :: spec_inner (self . choice1_spec () ,
                self . choice2_spec ()) . spec_parse (ibuf)
            }
        }
        ...
        impl SpecParser for NestedInnerChoiceFmt {
            ...
            ibuf : Seq < u8 >) -> Option < (int ,
            Self :: PVal) > {
                NestedInnerChoiceFmt :: spec_inner (self . choice1_spec () ,
                self . choice2_spec ()) . spec_parse (ibuf)
            }
        }
        ...
        impl SpecParser for CaptureParamAndLocalFmt {
            ...
            ibuf : Seq < u8 >) -> Option < (int ,
            Self :: PVal) > {
                CaptureParamAndLocalFmt :: spec_inner (self . choice1_spec () ,
                self . choice2_spec ()) . spec_parse (ibuf)
            }
        }
        ...
        impl Consistency for NestedInnerStructFmt {
            ...
            open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                NestedInnerStructFmt :: spec_inner () . consistent (v)
            }
        }
        impl SpecSerializerDps for NestedInnerStructFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                NestedInnerStructFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl Consistency for COrDFmt {
            ...
            open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                COrDFmt :: spec_inner () . consistent (v)
            }
        }
        impl SpecSerializerDps for COrDFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                COrDFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl Consistency for CaptureLocalInAnonStructWrapperFmt {
            ...
            open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                CaptureLocalInAnonStructWrapperFmt :: spec_inner () . consistent (v)
            }
        }
        impl SpecSerializerDps for CaptureLocalInAnonStructWrapperFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                CaptureLocalInAnonStructWrapperFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl Consistency for CaptureLocalInAnonStructFmt {
            ...
            open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                CaptureLocalInAnonStructFmt :: spec_inner () . consistent (v)
            }
        }
        impl SpecSerializerDps for CaptureLocalInAnonStructFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                CaptureLocalInAnonStructFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl Consistency for AOrBFmt {
            ...
            open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                AOrBFmt :: spec_inner () . consistent (v)
            }
        }
        impl SpecSerializerDps for AOrBFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                AOrBFmt :: spec_inner () . spec_serialize_dps (v ,
                obuf)
            }
        }
    ...
    mod derived_proofs {
        ...
        impl SafeParser for CaptureParamAndLocalXAPayloadFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                CaptureParamAndLocalXAPayloadFmt :: spec_inner (self . choice2_spec () ,
                self . len_spec ()) . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for CaptureParamAndLocalXAPayloadFmt {
            open spec fn productive_inv (& self) -> bool {
                CaptureParamAndLocalXAPayloadFmt :: spec_inner (self . choice2_spec () ,
                self . len_spec ()) . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< CaptureParamAndLocalXAPayloadFmt as SpecParser > :: spec_parse) ;
                let fmt = CaptureParamAndLocalXAPayloadFmt :: spec_inner (self . choice2_spec () ,
                self . len_spec ()) ;
        ...
        impl SafeParser for CaptureParamAndLocalXAFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                CaptureParamAndLocalXAFmt :: spec_inner (self . choice2_spec ()) . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for CaptureParamAndLocalXAFmt {
            open spec fn productive_inv (& self) -> bool {
                CaptureParamAndLocalXAFmt :: spec_inner (self . choice2_spec ()) . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< CaptureParamAndLocalXAFmt as SpecParser > :: spec_parse) ;
                let fmt = CaptureParamAndLocalXAFmt :: spec_inner (self . choice2_spec ()) ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
        ...
        impl SafeParser for CaptureParamAndLocalXBYFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                CaptureParamAndLocalXBYFmt :: spec_inner (self . tag_spec ()) . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for CaptureParamAndLocalXBYFmt {
            open spec fn productive_inv (& self) -> bool {
                CaptureParamAndLocalXBYFmt :: spec_inner (self . tag_spec ()) . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< CaptureParamAndLocalXBYFmt as SpecParser > :: spec_parse) ;
                let fmt = CaptureParamAndLocalXBYFmt :: spec_inner (self . tag_spec ()) ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
        ...
        impl SafeParser for CaptureParamAndLocalXBFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                CaptureParamAndLocalXBFmt :: spec_inner () . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for CaptureParamAndLocalXBFmt {
            open spec fn productive_inv (& self) -> bool {
                CaptureParamAndLocalXBFmt :: spec_inner () . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< CaptureParamAndLocalXBFmt as SpecParser > :: spec_parse) ;
                let fmt = CaptureParamAndLocalXBFmt :: spec_inner () ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
        ...
        impl SafeParser for CaptureParamAndLocalXFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                CaptureParamAndLocalXFmt :: spec_inner (self . choice1_spec () ,
                self . choice2_spec ()) . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for CaptureParamAndLocalXFmt {
            open spec fn productive_inv (& self) -> bool {
                CaptureParamAndLocalXFmt :: spec_inner (self . choice1_spec () ,
                self . choice2_spec ()) . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< CaptureParamAndLocalXFmt as SpecParser > :: spec_parse) ;
                let fmt = CaptureParamAndLocalXFmt :: spec_inner (self . choice1_spec () ,
                self . choice2_spec ()) ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        ...
        impl SafeParser for NestedInnerChoiceXAFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                NestedInnerChoiceXAFmt :: spec_inner (self . choice2_spec ()) . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for NestedInnerChoiceXAFmt {
            open spec fn productive_inv (& self) -> bool {
                NestedInnerChoiceXAFmt :: spec_inner (self . choice2_spec ()) . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< NestedInnerChoiceXAFmt as SpecParser > :: spec_parse) ;
                let fmt = NestedInnerChoiceXAFmt :: spec_inner (self . choice2_spec ()) ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
        ...
        impl SafeParser for NestedInnerStructVFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                NestedInnerStructVFmt :: spec_inner () . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for NestedInnerStructVFmt {
            open spec fn productive_inv (& self) -> bool {
                NestedInnerStructVFmt :: spec_inner () . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< NestedInnerStructVFmt as SpecParser > :: spec_parse) ;
                let fmt = NestedInnerStructVFmt :: spec_inner () ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
        ...
        impl SafeParser for CaptureOuterAndLocalPayloadBodyChoice1Fmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                CaptureOuterAndLocalPayloadBodyChoice1Fmt :: spec_inner () . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for CaptureOuterAndLocalPayloadBodyChoice1Fmt {
            open spec fn productive_inv (& self) -> bool {
                CaptureOuterAndLocalPayloadBodyChoice1Fmt :: spec_inner () . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< CaptureOuterAndLocalPayloadBodyChoice1Fmt as SpecParser > :: spec_parse) ;
                let fmt = CaptureOuterAndLocalPayloadBodyChoice1Fmt :: spec_inner () ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
        ...
        impl SafeParser for CaptureOuterAndLocalPayloadBodyFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                CaptureOuterAndLocalPayloadBodyFmt :: spec_inner (self . frame_len_spec () ,
                self . tag_spec ()) . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for CaptureOuterAndLocalPayloadBodyFmt {
            open spec fn productive_inv (& self) -> bool {
                CaptureOuterAndLocalPayloadBodyFmt :: spec_inner (self . frame_len_spec () ,
                self . tag_spec ()) . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< CaptureOuterAndLocalPayloadBodyFmt as SpecParser > :: spec_parse) ;
                let fmt = CaptureOuterAndLocalPayloadBodyFmt :: spec_inner (self . frame_len_spec () ,
                self . tag_spec ()) ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        ...
        impl SafeParser for CaptureOuterAndLocalPayloadFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                CaptureOuterAndLocalPayloadFmt :: spec_inner (self . frame_len_spec ()) . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for CaptureOuterAndLocalPayloadFmt {
            open spec fn productive_inv (& self) -> bool {
                CaptureOuterAndLocalPayloadFmt :: spec_inner (self . frame_len_spec ()) . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< CaptureOuterAndLocalPayloadFmt as SpecParser > :: spec_parse) ;
                let fmt = CaptureOuterAndLocalPayloadFmt :: spec_inner (self . frame_len_spec ()) ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
        ...
        impl SafeParser for CaptureOuterAndLocalFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                CaptureOuterAndLocalFmt :: spec_inner () . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for CaptureOuterAndLocalFmt {
            open spec fn productive_inv (& self) -> bool {
                CaptureOuterAndLocalFmt :: spec_inner () . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< CaptureOuterAndLocalFmt as SpecParser > :: spec_parse) ;
                let fmt = CaptureOuterAndLocalFmt :: spec_inner () ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
        ...
        impl SafeParser for CaptureLocalInAnonStructWrapperValueChoice0Fmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                CaptureLocalInAnonStructWrapperValueChoice0Fmt :: spec_inner () . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for CaptureLocalInAnonStructWrapperValueChoice0Fmt {
            open spec fn productive_inv (& self) -> bool {
                CaptureLocalInAnonStructWrapperValueChoice0Fmt :: spec_inner () . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< CaptureLocalInAnonStructWrapperValueChoice0Fmt as SpecParser > :: spec_parse) ;
                let fmt = CaptureLocalInAnonStructWrapperValueChoice0Fmt :: spec_inner () ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
        ...
        impl SafeParser for CaptureLocalInAnonStructWrapperValueFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                CaptureLocalInAnonStructWrapperValueFmt :: spec_inner (self . tag_spec ()) . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for CaptureLocalInAnonStructWrapperValueFmt {
            open spec fn productive_inv (& self) -> bool {
                CaptureLocalInAnonStructWrapperValueFmt :: spec_inner (self . tag_spec ()) . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< CaptureLocalInAnonStructWrapperValueFmt as SpecParser > :: spec_parse) ;
                let fmt = CaptureLocalInAnonStructWrapperValueFmt :: spec_inner (self . tag_spec ()) ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
        ...
        impl Productive for NestedInnerChoiceXFmt {
            ...
            s : Seq < u8 >) {
                reveal (< NestedInnerChoiceXFmt as SpecParser > :: spec_parse) ;
                let fmt = NestedInnerChoiceXFmt :: spec_inner (self . choice1_spec () ,
                self . choice2_spec ()) ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        ...
        impl Productive for NestedInnerChoiceFmt {
            ...
            s : Seq < u8 >) {
                reveal (< NestedInnerChoiceFmt as SpecParser > :: spec_parse) ;
                let fmt = NestedInnerChoiceFmt :: spec_inner (self . choice1_spec () ,
                self . choice2_spec ()) ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        ...
        impl Productive for CaptureParamAndLocalFmt {
            ...
            s : Seq < u8 >) {
                reveal (< CaptureParamAndLocalFmt as SpecParser > :: spec_parse) ;
                let fmt = CaptureParamAndLocalFmt :: spec_inner (self . choice1_spec () ,
                self . choice2_spec ()) ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        ...
        impl SafeParser for NestedInnerStructFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                NestedInnerStructFmt :: spec_inner () . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for NestedInnerStructFmt {
            open spec fn productive_inv (& self) -> bool {
                NestedInnerStructFmt :: spec_inner () . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< NestedInnerStructFmt as SpecParser > :: spec_parse) ;
                let fmt = NestedInnerStructFmt :: spec_inner () ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
        ...
        impl SafeParser for COrDFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                COrDFmt :: spec_inner () . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for COrDFmt {
            open spec fn productive_inv (& self) -> bool {
                COrDFmt :: spec_inner () . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< COrDFmt as SpecParser > :: spec_parse) ;
                let fmt = COrDFmt :: spec_inner () ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
        ...
        impl SafeParser for CaptureLocalInAnonStructWrapperFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                CaptureLocalInAnonStructWrapperFmt :: spec_inner () . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for CaptureLocalInAnonStructWrapperFmt {
            open spec fn productive_inv (& self) -> bool {
                CaptureLocalInAnonStructWrapperFmt :: spec_inner () . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< CaptureLocalInAnonStructWrapperFmt as SpecParser > :: spec_parse) ;
                let fmt = CaptureLocalInAnonStructWrapperFmt :: spec_inner () ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
        ...
        impl SafeParser for CaptureLocalInAnonStructFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                CaptureLocalInAnonStructFmt :: spec_inner () . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for CaptureLocalInAnonStructFmt {
            open spec fn productive_inv (& self) -> bool {
                CaptureLocalInAnonStructFmt :: spec_inner () . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< CaptureLocalInAnonStructFmt as SpecParser > :: spec_parse) ;
                let fmt = CaptureLocalInAnonStructFmt :: spec_inner () ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
        ...
        impl SafeParser for AOrBFmt {
            ...
            ibuf : Seq < u8 >) {
                ...
                AOrBFmt :: spec_inner () . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for AOrBFmt {
            open spec fn productive_inv (& self) -> bool {
                AOrBFmt :: spec_inner () . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< AOrBFmt as SpecParser > :: spec_parse) ;
                let fmt = AOrBFmt :: spec_inner () ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
    ...
    mod exec_impls {
        ...
        impl < 'i > Parser < & 'i [u8] > for CaptureParamAndLocalXAPayloadFmt {
            ...
            COrD :: C => {
                let (n ,
                v) = (Varied ((self . len as usize))) . parse (& rest) ? ;
                (n ,
        ...
        impl < 'i > Parser < & 'i [u8] > for CaptureParamAndLocalXAFmt {
            ...
            len : len
                ...
                let total_n = n1 + n2;
                let final_v = CaptureParamAndLocalXA {
            len ,
            payload
        }
        ;
        ...
        impl < 'i > Parser < & 'i [u8] > for CaptureParamAndLocalXBFmt {
            ...
            fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
                ...
                let rest = rest.skip(n1);
                let (n2 , y) = (CaptureParamAndLocalXBYFmt {
            tag : tag
        }
        ) . parse (& rest) ? ;
                let rest = rest.skip(n2);
                let total_n = n1 + n2;
                let final_v = CaptureParamAndLocalXB {
            tag ,
            y
        }
        ;
        ...
        impl < 'i > Parser < & 'i [u8] > for CaptureParamAndLocalXFmt {
            ...
            AOrB :: A => {
                let (n ,
                v) = (CaptureParamAndLocalXAFmt {
                    choice2 : self . choice2
                }
                ) . parse (& rest) ? ;
                (n ,
                CaptureParamAndLocalX :: A (v))
            }
            ,
            AOrB :: B => {
                let (n ,
                v) = (CaptureParamAndLocalXBFmt) . parse (& rest) ? ;
                (n ,
                CaptureParamAndLocalX :: B (v))
            }
            ,
        }
        ;
        ...
        impl < 'i > Parser < & 'i [u8] > for NestedInnerStructVFmt {
            type PT = NestedInnerStructV < 'i > ;
            ...
            fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
                ...
                let rest = rest.skip(n2);
                let total_n = n1 + n2;
                let final_v = NestedInnerStructV {
            x ,
            y
        }
        ;
        ...
        impl < 'i > Parser < & 'i [u8] > for CaptureOuterAndLocalPayloadBodyChoice1Fmt {
            ...
            fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
                ...
                let rest = rest.skip(n1);
                let (n2 , items) = (Varied ((count as usize))) . parse (& rest) ? ;
                let rest = rest.skip(n2);
                let total_n = n1 + n2;
                let final_v = CaptureOuterAndLocalPayloadBodyChoice1 {
            count ,
            items
        }
        ;
        ...
        impl < 'i > Parser < & 'i [u8] > for CaptureOuterAndLocalPayloadBodyFmt {
            ...
            0 => {
                let (n ,
                v) = (Varied ((((self . frame_len as usize) - 1 as usize) as usize))) . parse (& rest) ? ;
                (n ,
            ...
            _ => {
                let (n ,
                v) = (CaptureOuterAndLocalPayloadBodyChoice1Fmt) . parse (& rest) ? ;
                (n ,
        ...
        impl < 'i > Parser < & 'i [u8] > for CaptureOuterAndLocalPayloadFmt {
            ...
            tag : tag
                ...
                let rest = rest.skip(n2);
                let total_n = n1 + n2;
                let final_v = CaptureOuterAndLocalPayload {
            tag ,
            body
        }
        ;
        ...
        impl < 'i > Parser < & 'i [u8] > for CaptureOuterAndLocalFmt {
            ...
            return Err (ParseError :: predicate_failed ()) ;
                ...
                let rest = rest.skip(n1);
                let (n2 , payload) = (ExactLen ((frame_len as usize) , CaptureOuterAndLocalPayloadFmt {
            frame_len : frame_len
        }
        )) . parse (& rest) ? ;
                let rest = rest.skip(n2);
                let total_n = n1 + n2;
                let final_v = CaptureOuterAndLocal {
            frame_len ,
            payload
        }
        ;
        ...
        impl < 'i > Parser < & 'i [u8] > for CaptureLocalInAnonStructWrapperValueChoice0Fmt {
            ...
            fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
                ...
                let (n1 , len) = (U8) . parse (& rest) ? ;
                let rest = rest.skip(n1);
                let (n2 , bytes) = (Varied ((len as usize))) . parse (& rest) ? ;
                let rest = rest.skip(n2);
                let total_n = n1 + n2;
                let final_v = CaptureLocalInAnonStructWrapperValueChoice0 {
            len ,
            bytes
        }
        ;
        ...
        impl < 'i > Parser < & 'i [u8] > for CaptureLocalInAnonStructWrapperValueFmt {
            ...
            0 => {
                let (n ,
                v) = (CaptureLocalInAnonStructWrapperValueChoice0Fmt) . parse (& rest) ? ;
                (n ,
        ...
        impl < 'i > Parser < & 'i [u8] > for NestedInnerChoiceXFmt {
            ...
            AOrB :: A => {
                let (n ,
                v) = (NestedInnerChoiceXAFmt {
                    choice2 : self . choice2
                }
                ) . parse (& rest) ? ;
                (n ,
                NestedInnerChoiceX :: A (v))
            }
            ,
            AOrB :: B => {
                let (n ,
        ...
        impl < 'i > Parser < & 'i [u8] > for CaptureParamAndLocalFmt {
            ...
            choice2 : self . choice2
                ...
                let rest = rest.skip(n1);
                let total_n = n1;
                let final_v = CaptureParamAndLocal {
            x
        }
        ;
                assert (self . spec_parse (ibuf @) == Some ((total_n as int , final_v . deep_view ()))) ;
        ...
        impl < 'i > Parser < & 'i [u8] > for NestedInnerStructFmt {
            ...
            fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
                ...
                let rest = rest.skip(n1);
                let (n2 , v) = (ExactLen ((len as usize) , NestedInnerStructVFmt)) . parse (& rest) ? ;
                let rest = rest.skip(n2);
                let total_n = n1 + n2;
                let final_v = NestedInnerStruct {
            len ,
            v
        }
        ;
        ...
        impl < 'i > Parser < & 'i [u8] > for CaptureLocalInAnonStructWrapperFmt {
            ...
            fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
                ...
                let (n1 , tag) = (U8) . parse (& rest) ? ;
                let rest = rest.skip(n1);
                let (n2 , value) = (CaptureLocalInAnonStructWrapperValueFmt {
            tag : tag
        }
        ) . parse (& rest) ? ;
                let rest = rest.skip(n2);
                let total_n = n1 + n2;
                let final_v = CaptureLocalInAnonStructWrapper {
            tag ,
            value
        }
        ;
        ...
        impl < 'i > Parser < & 'i [u8] > for CaptureLocalInAnonStructFmt {
            ...
            fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
                ...
                let rest = rest.skip(n1);
                let total_n = n1;
                let final_v = CaptureLocalInAnonStruct {
            wrapper
        }
        ;
                assert (self . spec_parse (ibuf @) == Some ((total_n as int , final_v . deep_view ()))) ;
