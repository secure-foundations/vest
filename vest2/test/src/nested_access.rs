...
verus! {
    ...
    mod derived_specs {
        ...
        impl SpecSerializerDps for GenericHeaderFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                generic_header_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for OuterHeaderFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                outer_header_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for PayloadWithHeaderFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                payload_with_header_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for DeepNestedFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                deep_nested_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for CombinedExampleFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                combined_example_fmt (self . total_len . deep_view ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
    ...
    // ============================================================
    // TODO(execs): emit Parser / Serializer / Prepare impls for GenericHeader


    // TODO(execs): emit Parser / Serializer / Prepare impls for OuterHeader


    // TODO(execs): emit Parser / Serializer / Prepare impls for PayloadWithHeader


    // TODO(execs): emit Parser / Serializer / Prepare impls for DeepNested


    // TODO(execs): emit Parser / Serializer / Prepare impls for CombinedExample
}
