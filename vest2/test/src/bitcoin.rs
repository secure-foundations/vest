...
verus! {
    ...
    pub type TxRestInner = Sum < TxSegwitSpec , TxNonsegwitSpec > ;
    impl < 'i > DeepView for TxRest < 'i > {
        type V = TxRestSpec ;
        open spec fn deep_view (& self) -> Self :: V {
            match self {
                TxRest :: Variant1 (v) => TxRestSpec :: Variant1 (v . deep_view ()) ,
                TxRest :: Default (v) => TxRestSpec :: Default (v . deep_view ()) ,
            }
        }
    }
    ...
    pub type TxInner = (u32 , (u64 , TxRestSpec)) ;
    ...
    # [doc = "named format combinator for `tx_rest`."]
    pub struct TxRestFmt {
        pub txin_count : u64 ,
    }

    pub type TxRestFmtSpec = Named < Mapped < Sum < TxSegwitFmt , TxNonsegwitFmt > , FnSpecMapper < TxRestInner , TxRestSpec >> > ;

    # [doc = "specification constructor for `tx_rest`."]
    pub open spec fn tx_rest_fmt (txin_count : u64) -> TxRestFmtSpec {
        Named ("tx_rest" ,
        Mapped {
            inner : match txin_count {
                0 => Sum :: Inl (TxSegwitFmt) ,
                _ => Sum :: Inr (TxNonsegwitFmt {
                    txin_count
                }
                ) ,
            }
            ,
            mapper : (| parsed : TxRestInner | -> TxRestSpec {
                match parsed {
                    Sum :: Inl (v) => TxRestSpec :: Variant1 (v) ,
                    Sum :: Inr (v) => TxRestSpec :: Default (v) ,
                }
            }
            ,
            | value : TxRestSpec | -> TxRestInner {
                match value {
                    TxRestSpec :: Variant1 (v) => Sum :: Inl (v) ,
                    TxRestSpec :: Default (v) => Sum :: Inr (v) ,
                }
            }
            )
        }
    ...
    pub type TxFmtSpec = Named < Mapped < Pair < U32Le , Bind < VarInt < true > , spec_fn (u64) -> TxRestFmt > > , FnSpecMapper < TxInner , TxSpec >> > ;
    ...
    mod derived_specs {
        ...
        impl SpecSerializerDps for ScriptFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                script_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for TxoutFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                txout_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for OutpointFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                outpoint_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for ScriptSigFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                script_sig_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for WitnessComponentFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                witness_component_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for WitnessFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                witness_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for LockTimeFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                lock_time_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for TxSegwitFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                tx_segwit_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecSerializerDps for TxNonsegwitFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                tx_nonsegwit_fmt (self . txin_count . deep_view ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        ...
        impl SpecParser for TxRestFmt {
            type PVal = TxRestSpec ;
            # [verifier :: opaque] open spec fn spec_parse (& self ,
            ibuf : Seq < u8 >) -> Option < (int ,
            Self :: PVal) > {
                tx_rest_fmt (self . txin_count . deep_view ()) . spec_parse (ibuf)
            }
        }
        impl Consistency for TxRestFmt {
            type Val = TxRestSpec ;
            # [verifier :: opaque] open spec fn consistent (& self ,
            v : Self :: Val) -> bool {
                tx_rest_fmt (self . txin_count . deep_view ()) . consistent (v)
            }
        }
        impl SpecSerializerDps for TxRestFmt {
            type SValue = TxRestSpec ;
            # [verifier :: opaque] open spec fn spec_serialize_dps (& self ,
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                tx_rest_fmt (self . txin_count . deep_view ()) . spec_serialize_dps (v ,
                obuf)
            }
        }
        impl SpecSerializer for TxRestFmt {
            type SVal = TxRestSpec ;
            # [verifier :: opaque] open spec fn spec_serialize (& self ,
            v : Self :: SVal) -> Seq < u8 > {
                tx_rest_fmt (self . txin_count . deep_view ()) . spec_serialize (v)
            }
        }
        impl SpecByteLen for TxRestFmt {
            type T = TxRestSpec ;
            # [verifier :: opaque] open spec fn byte_len (& self ,
            v : Self :: T) -> nat {
                tx_rest_fmt (self . txin_count . deep_view ()) . byte_len (v)
            }
        }
        ...
        impl SpecSerializerDps for BlockFmt {
            ...
            v : Self :: SValue ,
            obuf : Seq < u8 >) -> Seq < u8 > {
                block_fmt () . spec_serialize_dps (v ,
                obuf)
            }
        }
    ...
    mod derived_proofs {
        ...
        impl SafeParser for TxRestFmt {
            proof fn lemma_parse_safe (& self ,
            ibuf : Seq < u8 >) {
                reveal (< TxRestFmt as SpecParser > :: spec_parse) ;
                tx_rest_fmt (self . txin_count . deep_view ()) . lemma_parse_safe (ibuf) ;
            }
        }
        impl Productive for TxRestFmt {
            open spec fn productive_inv (& self) -> bool {
                tx_rest_fmt (self . txin_count . deep_view ()) . productive_inv ()
            }
            proof fn lemma_productive (& self ,
            s : Seq < u8 >) {
                reveal (< TxRestFmt as SpecParser > :: spec_parse) ;
                let fmt = tx_rest_fmt (self . txin_count . deep_view ()) ;
                assert (fmt . productive_inv ()) ;
                fmt . lemma_productive (s) ;
            }
        }
        impl SoundParser for TxRestFmt {
            proof fn lemma_parse_sound_consumption (& self ,
            ibuf : Seq < u8 >) {
                reveal (< TxRestFmt as SpecParser > :: spec_parse) ;
                reveal (< TxRestFmt as SpecByteLen > :: byte_len) ;
                let fmt = tx_rest_fmt (self . txin_count . deep_view ()) ;
                assert (fmt . sound_inv ()) ;
                fmt . lemma_parse_sound_consumption (ibuf) ;
            }
            ...
            ibuf : Seq < u8 >) {
                reveal (< TxRestFmt as SpecParser > :: spec_parse) ;
                reveal (< TxRestFmt as Consistency > :: consistent) ;
                let fmt = tx_rest_fmt (self . txin_count . deep_view ()) ;
                assert (fmt . sound_inv ()) ;
                fmt . lemma_parse_sound_value (ibuf) ;
            }
        }
        impl NonTailFmt for TxRestFmt {
            proof fn lemma_serialize_dps_prepend (& self ,
            v : Self :: SValue ,
            obuf : Seq < u8 >) {
                reveal (< TxRestFmt as SpecSerializerDps > :: spec_serialize_dps) ;
                let fmt = tx_rest_fmt (self . txin_count . deep_view ()) ;
                assert (fmt . serialize_dps_inv ()) ;
                fmt . lemma_serialize_dps_prepend (v ,
                obuf) ;
        ...
        impl GoodSerializer for TxRestFmt {
            proof fn lemma_serialize_len (& self ,
            v : Self :: SVal) {
                reveal (< TxRestFmt as SpecSerializer > :: spec_serialize) ;
                reveal (< TxRestFmt as SpecByteLen > :: byte_len) ;
                let fmt = tx_rest_fmt (self . txin_count . deep_view ()) ;
                assert (fmt . serialize_inv ()) ;
                fmt . lemma_serialize_len (v) ;
        ...
        impl SPRoundTripDps for TxRestFmt {
            proof fn theorem_serialize_dps_parse_roundtrip (& self ,
            v : Self :: T ,
            obuf : Seq < u8 >) {
                reveal (< TxRestFmt as SpecParser > :: spec_parse) ;
        ...
        impl NonMalleable for TxRestFmt {
            proof fn lemma_parse_non_malleable (& self ,
            buf1 : Seq < u8 > ,
            buf2 : Seq < u8 >) {
                reveal (< TxRestFmt as SpecParser > :: spec_parse) ;
        ...
        impl EquivSerializersGeneral for TxRestFmt {
            proof fn lemma_serialize_equiv (& self ,
            v : Self :: SVal ,
            obuf : Seq < u8 >) {
                reveal (< TxRestFmt as SpecSerializerDps > :: spec_serialize_dps) ;
        ...
        impl EquivSerializers for TxRestFmt {
            proof fn lemma_serialize_equiv_on_empty (& self ,
            v : Self :: SVal) {
                reveal (< TxRestFmt as SpecSerializerDps > :: spec_serialize_dps) ;
                reveal (< TxRestFmt as SpecSerializer > :: spec_serialize) ;
    ...
    // ============================================================
    // TODO(execs): emit Parser / Serializer / Prepare impls for Script


    // TODO(execs): emit Parser / Serializer / Prepare impls for Txout


    // TODO(execs): emit Parser / Serializer / Prepare impls for Outpoint


    // TODO(execs): emit Parser / Serializer / Prepare impls for ScriptSig


    // TODO(execs): emit Parser / Serializer / Prepare impls for Txin


    // TODO(execs): emit Parser / Serializer / Prepare impls for WitnessComponent


    // TODO(execs): emit Parser / Serializer / Prepare impls for Witness


    // TODO(execs): emit Parser / Serializer / Prepare impls for LockTime


    // TODO(execs): emit Parser / Serializer / Prepare impls for TxSegwit


    // TODO(execs): emit Parser / Serializer / Prepare impls for TxNonsegwit


    // TODO(execs): emit Parser / Serializer / Prepare impls for TxRest


    // TODO(execs): emit Parser / Serializer / Prepare impls for Tx


    // TODO(execs): emit Parser / Serializer / Prepare impls for Block
}
