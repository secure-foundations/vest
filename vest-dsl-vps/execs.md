 ...
 # Exec Codegen Plan for vest-dsl-vps/src/codegen/execs.rs
...
nominal mapping, predicates, enums, and dependent choices, while still reusing existing vps_lib exec combinators for length-restricted
...
- cargo test in vest_dsl_vps
- cargo verus verify -- --expand-errors --verify-only-module <module> in vest-dsl-vps/test
- final acceptance: full cargo verus verify -- --expand-errors in vest-dsl-vps/test
