...
impl StructWidth16 {
    pub proof fn lemma_deep_view_fields(&self)
        ensures
            self.deep_view().field0 == self.field0.deep_view(),
...
impl<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> StructWidth16Spec<
    T0,
    T1,
    T2,
    T3,
...
> {
    ...
    # [verifier::opaque]
    pub open spec fn into_structural(self) -> (
        T0,
        (
            T1,
...
pub type ChoiceWidth64Inner = Sum<
    Sum<
        Sum<
            Sum<Sum<Sum<u8, u8>, Sum<u8, u8>>, Sum<Sum<u8, u8>, Sum<u8, u8>>>,
            Sum<Sum<Sum<u8, u8>, Sum<u8, u8>>, Sum<Sum<u8, u8>, Sum<u8, u8>>>,
        >,
        Sum<
            Sum<Sum<Sum<u8, u8>, Sum<u8, u8>>, Sum<Sum<u8, u8>, Sum<u8, u8>>>,
...
> {
    ...
    pub open spec fn from_structural(
        input: Sum<
            Sum<
                Sum<
                    Sum<Sum<Sum<T0, T1>, Sum<T2, T3>>, Sum<Sum<T4, T5>, Sum<T6, T7>>>,
                    Sum<Sum<Sum<T8, T9>, Sum<T10, T11>>, Sum<Sum<T12, T13>, Sum<T14, T15>>>,
                >,
                Sum<
                    Sum<Sum<Sum<T16, T17>, Sum<T18, T19>>, Sum<Sum<T20, T21>, Sum<T22, T23>>>,
                    Sum<Sum<Sum<T24, T25>, Sum<T26, T27>>, Sum<Sum<T28, T29>, Sum<T30, T31>>>,
                >,
            >,
            Sum<
                Sum<
                    Sum<Sum<Sum<T32, T33>, Sum<T34, T35>>, Sum<Sum<T36, T37>, Sum<T38, T39>>>,
                    Sum<Sum<Sum<T40, T41>, Sum<T42, T43>>, Sum<Sum<T44, T45>, Sum<T46, T47>>>,
                >,
                Sum<
                    Sum<Sum<Sum<T48, T49>, Sum<T50, T51>>, Sum<Sum<T52, T53>, Sum<T54, T55>>>,
                    Sum<Sum<Sum<T56, T57>, Sum<T58, T59>>, Sum<Sum<T60, T61>, Sum<T62, T63>>>,
                >,
            >,
        >,
    ) -> Self {
    ...
    # [verifier::opaque]
    pub open spec fn into_structural(self) -> Sum<
        Sum<
            Sum<
                Sum<Sum<Sum<T0, T1>, Sum<T2, T3>>, Sum<Sum<T4, T5>, Sum<T6, T7>>>,
                Sum<Sum<Sum<T8, T9>, Sum<T10, T11>>, Sum<Sum<T12, T13>, Sum<T14, T15>>>,
...
pub type StructWidth16FmtSpec = Named<
    Mapped<
        Pair<
            U8,
            Pair<
                                    ...
                                    Pair<
                                        ...
                                        Pair<
                                            ...
                                            Pair<
                                                ...
                                                Pair<
                                                    U8,
                                                    Pair<U8, Pair<U8, Pair<U8, Pair<U8, U8>>>>,
                                                >,
                                            >,
                                        >,
                                    >,
            ...
            >,
        >,
        BiMap<StructWidth16Forward, StructWidth16Reverse>,
    >,
>;

impl StructWidth16Fmt {
    # [doc = "specification constructor for `struct_width16`."]
    pub open spec fn spec_inner() -> StructWidth16FmtSpec {
        Named(
            "struct_width16",
            Mapped {
                inner: Pair(
                ...
                mapper: BiMap(StructWidth16Forward, StructWidth16Reverse),
            },
        )
    }
}
...
pub type ChoiceWidth64FmtSpec = Named<
    Mapped<
        Choice<
            Choice<
                Choice<
            ...
            >,
        >,
        BiMap<ChoiceWidth64Forward, ChoiceWidth64Reverse>,
    >,
>;

impl ChoiceWidth64Fmt {
    # [doc = "specification constructor for `choice_width64`."]
    pub open spec fn spec_inner() -> ChoiceWidth64FmtSpec {
        Named(
            "choice_width64",
            Mapped {
                inner: Choice(
                    Choice(
                        Choice(
                            ...
                            Choice(
                                Choice(
                                    ...
                                    Choice(
                                        Refined(U8, |x: u8| x == 10),
                                        Refined(U8, |x: u8| x == 11),
                                    ),
                                ),
                                Choice(
                                    Choice(
                                        Refined(U8, |x: u8| x == 12),
                                        Refined(U8, |x: u8| x == 13),
                                    ),
                                    Choice(
                                        Refined(U8, |x: u8| x == 14),
                                        Refined(U8, |x: u8| x == 15),
                                    ),
                                ),
                            ),
                        ),
                        Choice(
                            Choice(
                                Choice(
                                    Choice(
                                        Refined(U8, |x: u8| x == 16),
                                        Refined(U8, |x: u8| x == 17),
                                    ),
                                    Choice(
                                        Refined(U8, |x: u8| x == 18),
                                        Refined(U8, |x: u8| x == 19),
                                    ),
                                ),
                                Choice(
                                    Choice(
                                        Refined(U8, |x: u8| x == 20),
                                        Refined(U8, |x: u8| x == 21),
                                    ),
                                    Choice(
                                        Refined(U8, |x: u8| x == 22),
                                        Refined(U8, |x: u8| x == 23),
                                    ),
                                ),
                            ),
                            Choice(
                                Choice(
                                    Choice(
                                        Refined(U8, |x: u8| x == 24),
                                        Refined(U8, |x: u8| x == 25),
                                    ),
                                    Choice(
                                        Refined(U8, |x: u8| x == 26),
                                        Refined(U8, |x: u8| x == 27),
                                    ),
                                ),
                                Choice(
                                    Choice(
                                        Refined(U8, |x: u8| x == 28),
                                        Refined(U8, |x: u8| x == 29),
                                    ),
                                    Choice(
                                        Refined(U8, |x: u8| x == 30),
                                        Refined(U8, |x: u8| x == 31),
                                    ),
                                ),
                            ),
                        ),
                    ...
                    Choice(
                        Choice(
                            Choice(
                                Choice(
                                    Choice(
                                        Refined(U8, |x: u8| x == 32),
                                        Refined(U8, |x: u8| x == 33),
                                    ),
                                    Choice(
                                        Refined(U8, |x: u8| x == 34),
                                        Refined(U8, |x: u8| x == 35),
                                    ),
                                ),
                                Choice(
                                    Choice(
                                        Refined(U8, |x: u8| x == 36),
                                        Refined(U8, |x: u8| x == 37),
                                    ),
                                    Choice(
                                        Refined(U8, |x: u8| x == 38),
                                        Refined(U8, |x: u8| x == 39),
                                    ),
                                ),
                            ),
                            Choice(
                                Choice(
                                    Choice(
                                        Refined(U8, |x: u8| x == 40),
                                        Refined(U8, |x: u8| x == 41),
                                    ),
                                    Choice(
                                        Refined(U8, |x: u8| x == 42),
                                        Refined(U8, |x: u8| x == 43),
                                    ),
                                ),
                                Choice(
                                    Choice(
                                        Refined(U8, |x: u8| x == 44),
                                        Refined(U8, |x: u8| x == 45),
                                    ),
                                    Choice(
                                        Refined(U8, |x: u8| x == 46),
                                        Refined(U8, |x: u8| x == 47),
                                    ),
                                ),
                            ),
                        ),
                        Choice(
                            Choice(
                                Choice(
                                    Choice(
                                        Refined(U8, |x: u8| x == 48),
                                        Refined(U8, |x: u8| x == 49),
                                    ),
                                    Choice(
                                        Refined(U8, |x: u8| x == 50),
                                        Refined(U8, |x: u8| x == 51),
                                    ),
                                ),
                                Choice(
                                    Choice(
                                        Refined(U8, |x: u8| x == 52),
                                        Refined(U8, |x: u8| x == 53),
                                    ),
                                    Choice(
                                        Refined(U8, |x: u8| x == 54),
                                        Refined(U8, |x: u8| x == 55),
                                    ),
                                ),
                            ),
                            Choice(
                                Choice(
                                    Choice(
                                        Refined(U8, |x: u8| x == 56),
                                        Refined(U8, |x: u8| x == 57),
                                    ),
                                    Choice(
                                        Refined(U8, |x: u8| x == 58),
                                        Refined(U8, |x: u8| x == 59),
                                    ),
                                ),
                                Choice(
                                    Choice(
                                        Refined(U8, |x: u8| x == 60),
                                        Refined(U8, |x: u8| x == 61),
                                    ),
                                    Choice(
                                        Refined(U8, |x: u8| x == 62),
                                        Refined(U8, |x: u8| x >= 63),
                                    ),
                                ),
                            ),
                        ),
                ...
                mapper: BiMap(ChoiceWidth64Forward, ChoiceWidth64Reverse),
            },
        )
    }
}
...
mod derived_proofs {
    ...
    impl SoundParser for StructWidth16Fmt {
        proof fn lemma_parse_sound_consumption(&self, ibuf: Seq<u8>) {
            ...
            let fmt = Self::spec_inner();
            assert forall|input: StructWidth16Inner| # [trigger]
    ...
    impl SPRoundTripDps for StructWidth16Fmt {
        proof fn theorem_serialize_dps_parse_roundtrip(&self, v: Self::T, obuf: Seq<u8>) {
            ...
            reveal(<StructWidth16Fmt as SpecByteLen>::byte_len);
            let fmt = Self::spec_inner();
            assert forall|output: StructWidth16Spec| # [trigger]
    ...
    impl SoundParser for ChoiceWidth64Fmt {
        proof fn lemma_parse_sound_consumption(&self, ibuf: Seq<u8>) {
            ...
            let fmt = Self::spec_inner();
            assert forall|input: ChoiceWidth64Inner| # [trigger]
                fmt.1.inner.consistent(input) implies fmt.1.mapper.lossless(input) by {
    ...
    impl SPRoundTripDps for ChoiceWidth64Fmt {
        proof fn theorem_serialize_dps_parse_roundtrip(&self, v: Self::T, obuf: Seq<u8>) {
            ...
            reveal(<ChoiceWidth64Fmt as SpecByteLen>::byte_len);
            let fmt = Self::spec_inner();
            assert forall|output: ChoiceWidth64Spec| # [trigger]
                fmt.1.consistent(output) implies fmt.1.mapper.sound(output) by {
    ...
    impl<'i> Prepare<StructWidth16> for StructWidth16Fmt {
        fn prepare(&self, v: &StructWidth16) -> Result<usize, PreSerializeError> {
            ...
            let total_len = l1.checked_add(l2).ok_or(
                ...
                PreSerializeError::length_too_large(),
            )?.checked_add(l9).ok_or(PreSerializeError::length_too_large())?.checked_add(l10).ok_or(
                PreSerializeError::length_too_large(),
            )?.checked_add(l11).ok_or(PreSerializeError::length_too_large())?.checked_add(
                l12,
            ).ok_or(PreSerializeError::length_too_large())?.checked_add(l13).ok_or(
                PreSerializeError::length_too_large(),
            )?.checked_add(l14).ok_or(PreSerializeError::length_too_large())?.checked_add(
                l15,
            ).ok_or(PreSerializeError::length_too_large())?.checked_add(l16).ok_or(
                PreSerializeError::length_too_large(),
            )?;
            Ok(total_len)
        }
    ...
    impl<'i> Parser<&'i [u8]> for ChoiceWidth64Fmt {
        ...
        fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
            ...
            let (n, v) = match (U8).parse(&rest) {
                Ok((n, va)) if va == 0 => { Ok((n, ChoiceWidth64::Variant0(va))) },
                _ => match (U8).parse(&rest) {
                    Ok((n, va)) if va == 1 => { Ok((n, ChoiceWidth64::Variant1(va))) },
                    _ => match (U8).parse(&rest) {
                        Ok((n, va)) if va == 2 => { Ok((n, ChoiceWidth64::Variant2(va))) },
                        _ => match (U8).parse(&rest) {
                            Ok((n, va)) if va == 3 => { Ok((n, ChoiceWidth64::Variant3(va))) },
                            _ => match (U8).parse(&rest) {
                                Ok((n, va)) if va == 4 => { Ok((n, ChoiceWidth64::Variant4(va))) },
                                _ => match (U8).parse(&rest) {
                                    Ok((n, va)) if va == 5 => { Ok((n, ChoiceWidth64::Variant5(va)))
                                    },
                                    _ => match (U8).parse(&rest) {
                                        Ok((n, va)) if va == 6 => {
                                            Ok((n, ChoiceWidth64::Variant6(va)))
                                        },
                                        _ => match (U8).parse(&rest) {
                                            Ok((n, va)) if va == 7 => {
                                                Ok((n, ChoiceWidth64::Variant7(va)))
                                            },
                                            _ => match (U8).parse(&rest) {
                                                Ok((n, va)) if va == 8 => {
                                                    Ok((n, ChoiceWidth64::Variant8(va)))
                                                },
                                                _ => match (U8).parse(&rest) {
                                                    Ok((n, va)) if va == 9 => {
                                                        Ok((n, ChoiceWidth64::Variant9(va)))
                                                    },
                                                    _ => match (U8).parse(&rest) {
                                                        Ok((n, va)) if va == 10 => {
                                                            Ok((n, ChoiceWidth64::Variant10(va)))
                                                        },
                                                        _ => match (U8).parse(&rest) {
                                                            Ok((n, va)) if va == 11 => {
                                                                Ok(
