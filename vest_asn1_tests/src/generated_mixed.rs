// @generated by vest_asn1 from ASN.1 module `MixedFixture`.
...
pub struct Ordered<'a> {
    pub first: bool,
    pub second: Option<vest_lib::asn1::Integer<'a>>,
}
...
pub struct Outer<'a> {
    ...
    pub trailing: Option<vest_lib::asn1::AnyOwned>,
}

#[verifier::ext_equal]
pub struct OuterSpec<T0 = SharedSpec, T1 = CanonicalSpec, T2 = OrderedSpec, T3 = Option<vest_lib::asn1::AnySpec>> {
    pub shared: T0,
    pub canonical: T1,
    pub ordered: T2,
    pub trailing: T3,
...
pub type NumericLabel = vest_lib::asn1::NumericStringOwned;
pub type NumericLabelSpec = vest_lib::asn1::NumericStringSpec;

pub type UniversalLabel = vest_lib::asn1::UniversalString;
pub type UniversalLabelSpec = vest_lib::asn1::UniversalStringSpec;
...
impl<'a> Map<(bool, (Option<vest_lib::asn1::Integer<'a>>, ()))> for OrderedForward {
    type O = Ordered<'a>;
    fn map(&self, input: (bool, (Option<vest_lib::asn1::Integer<'a>>, ()))) -> (value: Self::O) {
        proof {
...
impl<'a, 'x> Map<&'x Ordered<'a>> for OrderedReverse {
    type O = (&'x bool, (Option<&'x vest_lib::asn1::Integer<'a>>, ()));
...
impl SpecMap for OuterForward {
    type Input = (SharedSpec, (CanonicalSpec, (OrderedSpec, (Option<vest_lib::asn1::AnySpec>, ()))));
...
impl SpecMap for OuterReverse {
    ...
    type Output = (SharedSpec, (CanonicalSpec, (OrderedSpec, (Option<vest_lib::asn1::AnySpec>, ()))));
    open spec fn spec_map(&self, value: Self::Input) -> Self::Output {
        value.into_structural()
    }
}

impl<'a> Map<(Shared<'a>, (Canonical<'a>, (Ordered<'a>, (Option<vest_lib::asn1::AnyOwned>, ()))))> for OuterForward {
    type O = Outer<'a>;
    fn map(&self, input: (Shared<'a>, (Canonical<'a>, (Ordered<'a>, (Option<vest_lib::asn1::AnyOwned>, ()))))) -> (value: Self::O) {
        proof {
...
impl<'a, 'x> Map<&'x Outer<'a>> for OuterReverse {
    type O = (&'x Shared<'a>, (&'x Canonical<'a>, (&'x Ordered<'a>, (Option<&'x vest_lib::asn1::AnyOwned>, ()))));
...
type VERSION__ = Refined<vest_lib::asn1::der::Integer8TlvFmt, IntegerRange<true, 0, true, 1>>;
#[derive(Clone, Copy)]
#[verifier::ext_equal]
...
type SHARED__ = Mapped<vest_lib::asn1::der::SequenceFmt<vest_lib::asn1::der::DefaultFmt<VERSION, i8, Pair<Ref<vest_lib::asn1::der::OctetStringTlvFmt>, Eof>>>, BiMap<SharedForward, SharedReverse>>;
#[derive(Clone, Copy)]
#[verifier::ext_equal]
...
impl SHARED {
    ...
    pub const fn schema() -> SHARED__
        returns
            ({
                use vest_lib::asn1::der::{DEFAULT, OCTET_STRING, SEQUENCE};
                Mapped {
                    inner:
                        SEQUENCE(
...
type CANONICAL__ = vest_lib::asn1::der::SetOfTlvFmt<SHARED>;
#[derive(Clone, Copy)]
#[verifier::ext_equal]
...
type ORDERED__ = Mapped<vest_lib::asn1::der::SetFmt<Pair<ImplicitFmt<Ref<vest_lib::asn1::der::BoolTlvFmt>>, Optional<ImplicitFmt<Ref<vest_lib::asn1::der::IntegerTlvFmt>>, Eof>>>, BiMap<OrderedForward, OrderedReverse>>;
#[derive(Clone, Copy)]
#[verifier::ext_equal]
...
impl ORDERED {
    ...
    pub const fn schema() -> ORDERED__
        returns
            ({
                use vest_lib::asn1::der::{BOOLEAN, INTEGER, SET};
                Mapped {
                    inner:
                        SET(
            ...
            Self::Fmt.asn1_start() == asn1_start_mask(false, 0x0002000000000000u64, 0x0000000000000000u64, 0x0000000000000000u64, 0x0000000000000000u64),
    {
        ...
        lemma_asn1_start_exact_uint(self.0, true, self.1);
        let __asn1_fmt_0 =
            IMPLICIT(1u64, Ref(vest_lib::asn1::der::INTEGER));
...
type OUTER__ = Mapped<vest_lib::asn1::ber::SequenceFmt<Pair<Ref<SHARED>, Pair<ImplicitFmt<Ref<CANONICAL>>, Pair<vest_lib::asn1::ber::ExplicitFmt<Ref<ORDERED>>, Optional<Ref<vest_lib::asn1::ber::AnyTlvFmt>, vest_lib::asn1::ber::BerEndFmt>>>>>, BiMap<OuterForward, OuterReverse>>;
#[derive(Clone, Copy)]
#[verifier::ext_equal]
...
type NUMERIC_LABEL__ = Refined<vest_lib::asn1::ber::NumericStringTlvFmt, Size<true, 1, true, 16>>;
#[derive(Clone, Copy)]
#[verifier::ext_equal]
...
impl NUMERIC_LABEL {
    ...
    pub const fn schema() -> NUMERIC_LABEL__
        returns
            ({
                use vest_lib::asn1::ber::NUMERIC_STRING;
...
type UNIVERSAL_LABEL__ = Refined<vest_lib::asn1::ber::UniversalStringTlvFmt, Size<true, 1, true, 16>>;
#[derive(Clone, Copy)]
#[verifier::ext_equal]
...
impl UNIVERSAL_LABEL {
    ...
    pub const fn schema() -> UNIVERSAL_LABEL__
        returns
            ({
                use vest_lib::asn1::ber::UNIVERSAL_STRING;
...
mod __impl_shared {
    ...
    vest_lib::impl_der!(tagged_exact(true), borrowed, SHARED, SHARED__, SharedSpec, Shared, SharedForward, SharedReverse);
}

mod __impl_canonical {
    use super::*;

    vest_lib::impl_der!(tagged_exact(true), borrowed, CANONICAL, CANONICAL__, CanonicalSpec, Canonical);
}

mod __impl_ordered {
    use super::*;

    vest_lib::impl_der!(tagged_exact(true), borrowed, ORDERED, ORDERED__, OrderedSpec, Ordered, OrderedForward, OrderedReverse);
}

mod __impl_outer {
    use super::*;

    vest_lib::impl_ber!(tagged_exact(true), borrowed, OUTER, OUTER__, OuterSpec, Outer, OuterForward, OuterReverse);
}

mod __impl_numeric_label {
    use super::*;

    vest_lib::impl_ber!(tagged_identity(false), owned, NUMERIC_LABEL, NUMERIC_LABEL__, NumericLabelSpec, NumericLabel);
}

mod __impl_universal_label {
    use super::*;

    vest_lib::impl_ber!(tagged_identity(false), owned, UNIVERSAL_LABEL, UNIVERSAL_LABEL__, UniversalLabelSpec, UniversalLabel);
}
