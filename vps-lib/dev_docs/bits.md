...
- [`vps-lib/src/combinators/bits`](../src/combinators/bits)
...
- `Bits<Repr, Tuple, Nominal>` in `vps_lib`
...
`vest-dsl-vps/test/src/*.rs`.

That split is deliberate:

- spec/proof composition is factored into `vps_lib`
...
- [`vps-lib/src/combinators/bits/mod.rs`](../src/combinators/bits/mod.rs)
...
[`vps-lib/src/combinators/bits/spec.rs`](../src/combinators/bits/spec.rs)
...
- [`vps-lib/src/combinators/bits/proof.rs`](../src/combinators/bits/proof.rs)
...
- parse a `bits { ... }` block in the Vest DSL frontend
