...
The core of VPS is built upon a set of traits defining the parsing and
...
In other words, all VPS combinators can (and should) prove `SPRoundTrip`, but
...
VPS handles **malleable** formats (where multiple binary sequences map to the
