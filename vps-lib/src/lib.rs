...
//!
//! VPS provides a library of formally verified (de-)serializer **combinators** built with
...
//! ## Key Properties
//!
//! All VPS combinators are formally proven to satisfy **[Serialize-Parse Roundtrip](core::proof::SPRoundTrip)**:
