//! Core specifications and correctness/security theorems for VPS combinators.
//!
//! This module forms the foundation of the VPS combinator framework. It defines:
//!
...
//! VPS combinators generally provide trait implementations for all of these traits, and the proofs
