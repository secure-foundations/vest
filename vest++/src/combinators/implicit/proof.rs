...
impl<Head, Tail> SPRoundTripDps for super::Implicit<Head, Tail> where
...
impl<Head, Tail> EquivSerializers for super::Implicit<Head, Tail> where
    Head: EquivSerializersGeneral,
    Tail: super::DepCombinator<Key = Head::SVal>,
...
impl<A, B> SPRoundTripDps for super::ImplicitManual<
    A,
    spec_fn(A::T) -> B,
    spec_fn(B::T) -> A::T,
...
impl<A, B> EquivSerializers for super::ImplicitManual<
    A,
    spec_fn(A::SVal) -> B,
    spec_fn(B::SVal) -> A::SVal,
> where
