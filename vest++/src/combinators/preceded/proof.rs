...
impl<A, AVal, B, const NONMAL: bool> SPRoundTripDps for super::Preceded2<A, AVal, B, NONMAL> where
    A: SPRoundTripDps + NonTailFmt,
...
impl<A, AVal, B> NonMalleable for super::Preceded2<A, AVal, B, true> where
 ...
 {
    open spec fn nonmal_inv(&self) -> bool {
        // When NONMAL is true, we check that the value parsed by A is exactly a_val, making the `BiMap` `lossless` (the nonmal_inv condition
        // required by `Mapped<Inner, BiMap<M, MRev>>`).
...
impl<A, AVal, B, const NONMAL: bool> NoLookAhead for super::Preceded2<A, AVal, B, NONMAL> where
    A: NoLookAhead,
    AVal: DeepView<V = A::PVal>,
    B: NoLookAhead,
 {
...
impl<A, AVal, B, const NONMAL: bool> EquivSerializersGeneral for super::Preceded2<
    A,
    AVal,
    B,
    NONMAL,
...
impl<A, AVal, B, const NONMAL: bool> EquivSerializers for super::Preceded2<
    A,
    AVal,
    B,
    NONMAL,
