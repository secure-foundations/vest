...
impl View for Outpoint<'_> {
    ...
    open spec fn view(&self) -> Self::V {
        SpecOutpoint { hash: self.hash@, index: self.index@ }
    }
}
...
pub closed spec fn spec_outpoint() -> SpecOutpointCombinator {
    SpecOutpointCombinator(
        Mapped { inner: (BytesN::<32>, U32Le), mapper: OutpointMapper::spec_new() },
    )
}
...
pub fn outpoint<'a>() -> (o: OutpointCombinator<'a>)
    ensures
        o@ == spec_outpoint(),
{
    OutpointCombinator(Mapped { inner: (BytesN::<32>, U32Le), mapper: OutpointMapper::new() })
}
...
impl View for Script<'_> {
    ...
    open spec fn view(&self) -> Self::V {
        SpecScript { l: self.l@, data: self.data@ }
    }
}
...
pub type ScriptCombinatorAlias<'a> = Mapped<
    Depend<&'a [u8], Vec<u8>, BtcVarint, Bytes, ScriptCont0<'a>>,
    ScriptMapper<'a>,
>;
    ...
    ScriptCombinator(
        Mapped {
            inner: Depend {
                fst: BtcVarint,
                snd: ScriptCont0::new(),
                spec_snd: Ghost(|deps| spec_script_cont0(deps)),
            },
...
impl SpecFrom<SpecBlock> for SpecBlockInner {
    open spec fn spec_from(m: SpecBlock) -> SpecBlockInner {
        (
            (
                m.version,
                (m.prev_block, (m.merkle_root, (m.timestamp, (m.bits, (m.nonce, m.tx_count))))),
            ),
            m.txs,
        )
    }
...
pub type BlockInner<'a> = (
    (u32, (&'a [u8], (&'a [u8], (u32, (u32, (u32, VarInt)))))),
    RepeatResult<Tx<'a>>,
);
...
pub type SpecBlockCombinatorAlias = Mapped<
    SpecDepend<
        (U32Le, (BytesN<32>, (BytesN<32>, (U32Le, (U32Le, (U32Le, BtcVarint)))))),
        RepeatN<SpecTxCombinator>,
    >,
    BlockMapper<'static>,
>;
...
pub type BlockCombinatorAlias<'a> = Mapped<
    Depend<
        &'a [u8],
        Vec<u8>,
        (U32Le, (BytesN<32>, (BytesN<32>, (U32Le, (U32Le, (U32Le, BtcVarint)))))),
        RepeatN<TxCombinator<'a>>,
        BlockCont0<'a>,
    >,
    BlockMapper<'a>,
>;
...
pub closed spec fn spec_block() -> SpecBlockCombinator {
    SpecBlockCombinator(
        Mapped {
            inner: SpecDepend {
                fst: (U32Le, (BytesN::<32>, (BytesN::<32>, (U32Le, (U32Le, (U32Le, BtcVarint)))))),
                snd: |deps| spec_block_cont0(deps),
            },
...
pub open spec fn spec_block_cont0(
    ...
    BlockCombinator(
        Mapped {
            inner: Depend {
                fst: (U32Le, (BytesN::<32>, (BytesN::<32>, (U32Le, (U32Le, (U32Le, BtcVarint)))))),
                snd: BlockCont0::new(),
                spec_snd: Ghost(|deps| spec_block_cont0(deps)),
            },
...
impl<'a> Continuation<&(u32, (&'a [u8], (&'a [u8], (u32, (u32, (u32, VarInt))))))> for BlockCont0<
    'a,
> {
    ...
    open spec fn requires(
        &self,
        deps: &(u32, (&'a [u8], (&'a [u8], (u32, (u32, (u32, VarInt)))))),
    ) -> bool {
        true
    }
...
impl View for Txout<'_> {
    ...
    open spec fn view(&self) -> Self::V {
        SpecTxout { value: self.value@, script_pubkey: self.script_pubkey@ }
    }
}
...
pub closed spec fn spec_txout() -> SpecTxoutCombinator {
    SpecTxoutCombinator(Mapped { inner: (U64Le, spec_script()), mapper: TxoutMapper::spec_new() })
}
...
pub fn txout<'a>() -> (o: TxoutCombinator<'a>)
    ensures
        o@ == spec_txout(),
{
    TxoutCombinator(Mapped { inner: (U64Le, script()), mapper: TxoutMapper::new() })
}
...
impl View for WitnessComponent<'_> {
    ...
    open spec fn view(&self) -> Self::V {
        SpecWitnessComponent { l: self.l@, data: self.data@ }
    }
}
...
impl SpecCombinator for SpecWitnessComponentCombinator {
    type SpecResult = SpecWitnessComponent;
...
pub type SpecWitnessComponentCombinatorAlias = Mapped<
    SpecDepend<BtcVarint, Bytes>,
    WitnessComponentMapper<'static>,
>;
...
impl<'a> View for WitnessComponentCombinator<'a> {
    ...
    closed spec fn view(&self) -> Self::V {
        SpecWitnessComponentCombinator(self.0@)
    }
}

impl<'a> Combinator<&'a [u8], Vec<u8>> for WitnessComponentCombinator<'a> {
    type Result = WitnessComponent<'a>;
...
pub type WitnessComponentCombinatorAlias<'a> = Mapped<
    Depend<&'a [u8], Vec<u8>, BtcVarint, Bytes, WitnessComponentCont0<'a>>,
    WitnessComponentMapper<'a>,
>;
...
pub fn witness_component<'a>() -> (o: WitnessComponentCombinator<'a>)
    ensures
        o@ == spec_witness_component(),
{
    WitnessComponentCombinator(
        Mapped {
            inner: Depend {
                fst: BtcVarint,
                snd: WitnessComponentCont0::new(),
                spec_snd: Ghost(|deps| spec_witness_component_cont0(deps)),
            },
...
impl View for ScriptSig<'_> {
    ...
    open spec fn view(&self) -> Self::V {
        SpecScriptSig { l: self.l@, data: self.data@ }
    }
}
...
pub type SpecScriptSigCombinatorAlias = Mapped<
    SpecDepend<BtcVarint, Bytes>,
    ScriptSigMapper<'static>,
>;
...
pub type ScriptSigCombinatorAlias<'a> = Mapped<
    Depend<&'a [u8], Vec<u8>, BtcVarint, Bytes, ScriptSigCont0<'a>>,
    ScriptSigMapper<'a>,
>;
        ...
        o@ == spec_script_sig(),
{
    ScriptSigCombinator(
        Mapped {
            inner: Depend {
                fst: BtcVarint,
                snd: ScriptSigCont0::new(),
                spec_snd: Ghost(|deps| spec_script_sig_cont0(deps)),
            },
...
pub type SpecLockTimeCombinatorAlias = Mapped<
    OrdChoice<
        Refined<U32Le, Predicate675963002568997194>,
        Refined<U32Le, Predicate3133141078119142300>,
    >,
    LockTimeMapper,
>;
...
pub type LockTimeCombinatorAlias = Mapped<
    OrdChoice<
        Refined<U32Le, Predicate675963002568997194>,
        Refined<U32Le, Predicate3133141078119142300>,
    >,
...
pub closed spec fn spec_lock_time() -> SpecLockTimeCombinator {
    SpecLockTimeCombinator(
        Mapped {
            inner: OrdChoice(
                Refined { inner: U32Le, predicate: Predicate675963002568997194 },
                Refined { inner: U32Le, predicate: Predicate3133141078119142300 },
            ),
            mapper: LockTimeMapper::spec_new(),
        },
    )
}
...
pub type SpecTxSegwitInner = (
    ((u8, VarInt), (Seq<SpecTxin>, VarInt)),
    (Seq<SpecTxout>, (Seq<SpecWitness>, SpecLockTime)),
);
...
pub type TxSegwitInner<'a> = (
    ((u8, VarInt), (RepeatResult<Txin<'a>>, VarInt)),
    (RepeatResult<Txout<'a>>, (RepeatResult<Witness<'a>>, LockTime)),
);
...
pub type SpecTxSegwitCombinatorAlias = Mapped<
    SpecDepend<
        SpecDepend<(Refined<U8, TagPred<u8>>, BtcVarint), (RepeatN<SpecTxinCombinator>, BtcVarint)>,
        (RepeatN<SpecTxoutCombinator>, (RepeatN<SpecWitnessCombinator>, SpecLockTimeCombinator)),
    >,
    TxSegwitMapper<'static>,
>;
...
pub type TxSegwitCombinatorAlias<'a> = Mapped<
    Depend<
        &'a [u8],
        Vec<u8>,
        Depend<
            &'a [u8],
            Vec<u8>,
            (Refined<U8, TagPred<u8>>, BtcVarint),
            (RepeatN<TxinCombinator<'a>>, BtcVarint),
            TxSegwitCont1<'a>,
        >,
        (RepeatN<TxoutCombinator<'a>>, (RepeatN<WitnessCombinator<'a>>, LockTimeCombinator)),
        TxSegwitCont0<'a>,
    >,
    TxSegwitMapper<'a>,
>;
...
pub closed spec fn spec_tx_segwit() -> SpecTxSegwitCombinator {
    SpecTxSegwitCombinator(
        Mapped {
            inner: SpecDepend {
                fst: SpecDepend {
                    fst: (Refined { inner: U8, predicate: TagPred(TXSEGWIT_FLAG) }, BtcVarint),
                    snd: |deps| spec_tx_segwit_cont1(deps),
                },
                snd: |deps| spec_tx_segwit_cont0(deps),
            },
...
pub open spec fn spec_tx_segwit_cont1(deps: (u8, VarInt)) -> (
    RepeatN<SpecTxinCombinator>,
    BtcVarint,
) {
...
pub open spec fn spec_tx_segwit_cont0(deps: ((u8, VarInt), (Seq<SpecTxin>, VarInt))) -> (
    RepeatN<SpecTxoutCombinator>,
    (RepeatN<SpecWitnessCombinator>, SpecLockTimeCombinator),
) {
    let ((_, txin_count), (_, txout_count)) = deps;
    (
        RepeatN(spec_txout(), txout_count.spec_into()),
        (RepeatN(spec_witness(), txin_count.spec_into()), spec_lock_time()),
    )
}
    ...
    TxSegwitCombinator(
        Mapped {
            inner: Depend {
                fst: Depend {
                    fst: (Refined { inner: U8, predicate: TagPred(TXSEGWIT_FLAG) }, BtcVarint),
                    snd: TxSegwitCont1::new(),
                    spec_snd: Ghost(|deps| spec_tx_segwit_cont1(deps)),
                },
                snd: TxSegwitCont0::new(),
                spec_snd: Ghost(|deps| spec_tx_segwit_cont0(deps)),
            },
...
impl<'a> Continuation<&(u8, VarInt)> for TxSegwitCont1<'a> {
    ...
    open spec fn requires(&self, deps: &(u8, VarInt)) -> bool {
        true
    }
...
impl<'a> Continuation<&((u8, VarInt), (RepeatResult<Txin<'a>>, VarInt))> for TxSegwitCont0<'a> {
    type Output = (
        RepeatN<TxoutCombinator<'a>>,
        (RepeatN<WitnessCombinator<'a>>, LockTimeCombinator),
    );

    open spec fn requires(&self, deps: &((u8, VarInt), (RepeatResult<Txin<'a>>, VarInt))) -> bool {
        true
    }

    open spec fn ensures(
        &self,
        deps: &((u8, VarInt), (RepeatResult<Txin<'a>>, VarInt)),
        o: Self::Output,
    ) -> bool {
    ...
    fn apply(&self, deps: &((u8, VarInt), (RepeatResult<Txin<'a>>, VarInt))) -> Self::Output {
        let ((_, txin_count), (_, txout_count)) = *deps;
        (
            RepeatN(txout(), txout_count.ex_into()),
            (RepeatN(witness(), txin_count.ex_into()), lock_time()),
        )
    }
}
...
pub type TxNonsegwitInner<'a> = (
    (RepeatResult<Txin<'a>>, VarInt),
    (RepeatResult<Txout<'a>>, LockTime),
);
...
impl SpecCombinator for SpecTxNonsegwitCombinator {
    type SpecResult = SpecTxNonsegwit;
...
pub type SpecTxNonsegwitCombinatorAlias = Mapped<
    SpecDepend<
        (RepeatN<SpecTxinCombinator>, BtcVarint),
        (RepeatN<SpecTxoutCombinator>, SpecLockTimeCombinator),
    >,
    TxNonsegwitMapper<'static>,
>;
...
impl<'a> View for TxNonsegwitCombinator<'a> {
    ...
    closed spec fn view(&self) -> Self::V {
        SpecTxNonsegwitCombinator(self.0@)
    }
}

impl<'a> Combinator<&'a [u8], Vec<u8>> for TxNonsegwitCombinator<'a> {
    type Result = TxNonsegwit<'a>;
...
pub type TxNonsegwitCombinatorAlias<'a> = Mapped<
    Depend<
        &'a [u8],
        Vec<u8>,
        (RepeatN<TxinCombinator<'a>>, BtcVarint),
        (RepeatN<TxoutCombinator<'a>>, LockTimeCombinator),
        TxNonsegwitCont0<'a>,
    >,
    TxNonsegwitMapper<'a>,
>;
...
pub closed spec fn spec_tx_nonsegwit(txin_count: VarInt) -> SpecTxNonsegwitCombinator {
    SpecTxNonsegwitCombinator(
        Mapped {
            inner: SpecDepend {
                fst: (RepeatN(spec_txin(), txin_count.spec_into()), BtcVarint),
                snd: |deps| spec_tx_nonsegwit_cont0(deps),
            },
...
pub open spec fn spec_tx_nonsegwit_cont0(deps: (Seq<SpecTxin>, VarInt)) -> (
    RepeatN<SpecTxoutCombinator>,
    SpecLockTimeCombinator,
) {
...
pub fn tx_nonsegwit<'a>(txin_count: VarInt) -> (o: TxNonsegwitCombinator<'a>)
    ensures
        o@ == spec_tx_nonsegwit(txin_count@),
{
    TxNonsegwitCombinator(
        Mapped {
            inner: Depend {
                fst: (RepeatN(txin(), txin_count.ex_into()), BtcVarint),
                snd: TxNonsegwitCont0::new(),
                spec_snd: Ghost(|deps| spec_tx_nonsegwit_cont0(deps)),
            },
...
impl<'a> Continuation<&(RepeatResult<Txin<'a>>, VarInt)> for TxNonsegwitCont0<'a> {
    ...
    open spec fn requires(&self, deps: &(RepeatResult<Txin<'a>>, VarInt)) -> bool {
        true
    }
...
pub type SpecTxRestCombinatorAlias = Mapped<
    OrdChoice<Cond<SpecTxSegwitCombinator>, Cond<SpecTxNonsegwitCombinator>>,
    TxRestMapper<'static>,
>;
...
pub type TxRestCombinatorAlias<'a> = Mapped<
    OrdChoice<Cond<TxSegwitCombinator<'a>>, Cond<TxNonsegwitCombinator<'a>>>,
    TxRestMapper<'a>,
>;

pub closed spec fn spec_tx_rest(txin_count: VarInt) -> SpecTxRestCombinator {
    SpecTxRestCombinator(
        Mapped {
            inner: OrdChoice(
                Cond { cond: txin_count.spec_as_usize() == 0, inner: spec_tx_segwit() },
                Cond {
                    cond: !(txin_count.spec_as_usize() == 0),
                    inner: spec_tx_nonsegwit(txin_count),
                },
            ),
            mapper: TxRestMapper::spec_new(),
        },
    )
}
...
pub fn tx_rest<'a>(txin_count: VarInt) -> (o: TxRestCombinator<'a>)
    ensures
        o@ == spec_tx_rest(txin_count@),
{
    TxRestCombinator(
        Mapped {
            inner: OrdChoice::new(
                Cond { cond: txin_count.as_usize() == 0, inner: tx_segwit() },
                Cond { cond: !(txin_count.as_usize() == 0), inner: tx_nonsegwit(txin_count) },
            ),
            mapper: TxRestMapper::new(),
        },
    )
}
...
impl View for Tx<'_> {
    ...
    open spec fn view(&self) -> Self::V {
        SpecTx { version: self.version@, txin_count: self.txin_count@, rest: self.rest@ }
    }
}
...
pub type SpecTxCombinatorAlias = Mapped<
    SpecDepend<(U32Le, BtcVarint), SpecTxRestCombinator>,
    TxMapper<'static>,
>;
...
pub type TxCombinatorAlias<'a> = Mapped<
    Depend<&'a [u8], Vec<u8>, (U32Le, BtcVarint), TxRestCombinator<'a>, TxCont0<'a>>,
    TxMapper<'a>,
>;
    ...
    TxCombinator(
        Mapped {
            inner: Depend {
                fst: (U32Le, BtcVarint),
                snd: TxCont0::new(),
                spec_snd: Ghost(|deps| spec_tx_cont0(deps)),
            },
            mapper: TxMapper::new(),
        },
    )
...
impl<'a> Continuation<&(u32, VarInt)> for TxCont0<'a> {
    ...
    open spec fn requires(&self, deps: &(u32, VarInt)) -> bool {
        true
    }
...
impl View for Witness<'_> {
    ...
    open spec fn view(&self) -> Self::V {
        SpecWitness { count: self.count@, data: self.data@ }
    }
}
...
pub type SpecWitnessCombinatorAlias = Mapped<
    SpecDepend<BtcVarint, RepeatN<SpecWitnessComponentCombinator>>,
    WitnessMapper<'static>,
>;
...
pub type WitnessCombinatorAlias<'a> = Mapped<
    Depend<&'a [u8], Vec<u8>, BtcVarint, RepeatN<WitnessComponentCombinator<'a>>, WitnessCont0<'a>>,
    WitnessMapper<'a>,
>;
        ...
        o@ == spec_witness(),
{
    WitnessCombinator(
        Mapped {
            inner: Depend {
                fst: BtcVarint,
                snd: WitnessCont0::new(),
                spec_snd: Ghost(|deps| spec_witness_cont0(deps)),
            },
...
pub type SpecTxinCombinatorAlias = Mapped<
    (SpecOutpointCombinator, (SpecScriptSigCombinator, U32Le)),
    TxinMapper<'static>,
>;
...
pub type TxinCombinatorAlias<'a> = Mapped<
    (OutpointCombinator<'a>, (ScriptSigCombinator<'a>, U32Le)),
    TxinMapper<'a>,
>;
...
pub fn txin<'a>() -> (o: TxinCombinator<'a>)
    ensures
        o@ == spec_txin(),
{
    TxinCombinator(Mapped { inner: (outpoint(), (script_sig(), U32Le)), mapper: TxinMapper::new() })
}
