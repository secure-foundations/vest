...
pub type SpecMsgDCombinatorAlias = Mapped<(Refined<BytesN<4>, BytesPredicate16235736133663645624<'static>>, Refined<U16Be, TagPred<u16>>), MsgDMapper<'static>>;
...
pub type MsgDCombinatorAlias<'a> = Mapped<(Refined<BytesN<4>, BytesPredicate16235736133663645624<'a>>, Refined<U16Be, TagPred<u16>>), MsgDMapper<'a>>;


pub closed spec fn spec_msg_d() -> SpecMsgDCombinator {
    SpecMsgDCombinator(
    Mapped {
        inner: (Refined { inner: BytesN::<4>, predicate: BytesPredicate16235736133663645624::spec_new() }, Refined { inner: U16Be, predicate: TagPred(MSGD_F2) }),
    ...
    ensures o@ == spec_msg_d(),
{
    MsgDCombinator(
    Mapped {
        inner: (Refined { inner: BytesN::<4>, predicate: BytesPredicate16235736133663645624::new() }, Refined { inner: U16Be, predicate: TagPred(MSGD_F2) }),
