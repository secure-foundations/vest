...
pub struct SpecContent0Combinator(pub SpecContent0CombinatorAlias);
...
pub struct Content0Combinator(pub Content0CombinatorAlias);

impl View for Content0Combinator {
    type V = SpecContent0Combinator;
    open spec fn view(&self) -> Self::V { SpecContent0Combinator(self.0@) }
}
...
impl<'a> SecureSerialize<'a, &'a [u8], Vec<u8>> for Content0Combinator {
    fn secure_serialize(&self, v: Self::SType, data: &mut Vec<u8>, pos: usize) -> (o: SResult<usize, SerializeError>)
    { <_ as SecureSerialize<'a, &'a [u8], Vec<u8>>>::secure_serialize(&self.0, v, data, pos) }
}
...
pub fn parse_content_0<'a>(input: &'a [u8], num: u24) -> (res: PResult<<Content0Combinator as Combinator<'a, &'a [u8], Vec<u8>>>::Type, ParseError>)
    ...
    ensures
        ...
        res is Err ==> spec_content_0(num@).spec_parse(input@) is None,
        spec_content_0(num@).spec_parse(input@) is None ==> res is Err,
{
    let combinator = content_0( num );
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::parse(&combinator, input)
}

pub fn serialize_content_0<'a>(v: <Content0Combinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize, num: u24) -> (o: SResult<usize, SerializeError>)
    requires
...
pub fn serialize_content_0_infallible<'a>(v: <Content0Combinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize, num: u24) -> (n: usize)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_content_0(num@).wf(v@),
        spec_content_0(num@).spec_serialize(v@).len() <= usize::MAX,
        pos + spec_content_0(num@).spec_serialize(v@).len() <= old(data)@.len(),
    ensures
        data@.len() == old(data)@.len(),
        pos <= usize::MAX - n && pos + n <= data@.len(),
        n == spec_content_0(num@).spec_serialize(v@).len(),
...
impl<'a> SecureSerialize<'a, &'a [u8], Vec<u8>> for ContentTypeCombinator {
    fn secure_serialize(&self, v: Self::SType, data: &mut Vec<u8>, pos: usize) -> (o: SResult<usize, SerializeError>)
    { <_ as SecureSerialize<'a, &'a [u8], Vec<u8>>>::secure_serialize(&self.0, v, data, pos) }
}
...
pub fn content_type<'a>() -> (o: ContentTypeCombinator)
    ensures o@ == spec_content_type(),
            ...
            <_ as Combinator<'a, &'a [u8], Vec<u8>>>::ex_requires(&o),
{
    let combinator = ContentTypeCombinator(U8);
    // assert({
...
pub fn serialize_content_type_infallible<'a>(v: <ContentTypeCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize) -> (n: usize)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_content_type().wf(v@),
        spec_content_type().spec_serialize(v@).len() <= usize::MAX,
        pos + spec_content_type().spec_serialize(v@).len() <= old(data)@.len(),
    ensures
        data@.len() == old(data)@.len(),
        pos <= usize::MAX - n && pos + n <= data@.len(),
        n == spec_content_type().spec_serialize(v@).len(),
...
impl<'a> SecureSerialize<'a, &'a [u8], Vec<u8>> for MsgCF4Combinator {
    fn secure_serialize(&self, v: Self::SType, data: &mut Vec<u8>, pos: usize) -> (o: SResult<usize, SerializeError>)
    { <_ as SecureSerialize<'a, &'a [u8], Vec<u8>>>::secure_serialize(&self.0, v, data, pos) }
}
...
pub fn serialize_msg_c_f4_infallible<'a>(v: <MsgCF4Combinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize, f2: u8, f3: u24) -> (n: usize)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_msg_c_f4(f2@, f3@).wf(v@),
        spec_content_type().wf(f2@),
        spec_msg_c_f4(f2@, f3@).spec_serialize(v@).len() <= usize::MAX,
        pos + spec_msg_c_f4(f2@, f3@).spec_serialize(v@).len() <= old(data)@.len(),
    ensures
        data@.len() == old(data)@.len(),
        pos <= usize::MAX - n && pos + n <= data@.len(),
        n == spec_msg_c_f4(f2@, f3@).spec_serialize(v@).len(),
...
pub struct SpecMsgDCombinator(pub SpecMsgDCombinatorAlias);
...
pub struct MsgDCombinator1(pub MsgDCombinatorAlias1);
...
pub struct MsgDCombinator2(pub MsgDCombinatorAlias2);
...
pub struct MsgDCombinator(pub MsgDCombinatorAlias);

impl View for MsgDCombinator {
    type V = SpecMsgDCombinator;
    open spec fn view(&self) -> Self::V { SpecMsgDCombinator(self.0@) }
}
...
impl<'a> SecureSerialize<'a, &'a [u8], Vec<u8>> for MsgDCombinator {
    fn secure_serialize(&self, v: Self::SType, data: &mut Vec<u8>, pos: usize) -> (o: SResult<usize, SerializeError>)
    { <_ as SecureSerialize<'a, &'a [u8], Vec<u8>>>::secure_serialize(&self.0, v, data, pos) }
}
...
pub fn msg_d<'a>() -> (o: MsgDCombinator)
    ensures o@ == spec_msg_d(),
            o@.requires(),
            <_ as Combinator<'a, &'a [u8], Vec<u8>>>::ex_requires(&o),
{
    let combinator = MsgDCombinator(
    Mapped {
...
pub fn parse_msg_d<'a>(input: &'a [u8]) -> (res: PResult<<MsgDCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::Type, ParseError>)
    requires
        input.len() <= usize::MAX,
    ensures
        res matches Ok((n, v)) ==> spec_msg_d().spec_parse(input@) == Some((n as int, v@)),
        spec_msg_d().spec_parse(input@) matches Some((n, v))
            ==> res matches Ok((m, u)) && m == n && v == u@,
        res is Err ==> spec_msg_d().spec_parse(input@) is None,
        spec_msg_d().spec_parse(input@) is None ==> res is Err,
{
    let combinator = msg_d();
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::parse(&combinator, input)
}

pub fn serialize_msg_d<'a>(v: <MsgDCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize) -> (o: SResult<usize, SerializeError>)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_msg_d().wf(v@),
    ensures
...
pub fn serialize_msg_d_infallible<'a>(v: <MsgDCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize) -> (n: usize)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_msg_d().wf(v@),
        spec_msg_d().spec_serialize(v@).len() <= usize::MAX,
        pos + spec_msg_d().spec_serialize(v@).len() <= old(data)@.len(),
    ensures
        data@.len() == old(data)@.len(),
        pos <= usize::MAX - n && pos + n <= data@.len(),
        n == spec_msg_d().spec_serialize(v@).len(),
...
pub fn msg_d_len<'a>(v: <MsgDCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType) -> (serialize_len: usize)
    requires
        ...
        spec_msg_d().spec_serialize(v@).len() <= usize::MAX,
    ensures
        serialize_len == spec_msg_d().spec_serialize(v@).len(),
{
    let combinator = msg_d();
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::length(&combinator, v)
}
...
pub struct SpecMsgBCombinator(pub SpecMsgBCombinatorAlias);
...
pub struct MsgBCombinator(pub MsgBCombinatorAlias);

impl View for MsgBCombinator {
    type V = SpecMsgBCombinator;
    open spec fn view(&self) -> Self::V { SpecMsgBCombinator(self.0@) }
}
...
impl<'a> SecureSerialize<'a, &'a [u8], Vec<u8>> for MsgBCombinator {
    fn secure_serialize(&self, v: Self::SType, data: &mut Vec<u8>, pos: usize) -> (o: SResult<usize, SerializeError>)
    { <_ as SecureSerialize<'a, &'a [u8], Vec<u8>>>::secure_serialize(&self.0, v, data, pos) }
}
...
pub fn msg_b<'a>() -> (o: MsgBCombinator)
    ensures o@ == spec_msg_b(),
            o@.requires(),
            <_ as Combinator<'a, &'a [u8], Vec<u8>>>::ex_requires(&o),
{
    let combinator = MsgBCombinator(
    Mapped {
        inner: msg_d(),
        mapper: MsgBMapper,
    });
    // assert({
    //     &&& combinator@ == spec_msg_b()
    //     &&& combinator@.requires()
    //     &&& <_ as Combinator<'a, &'a [u8], Vec<u8>>>::ex_requires(&combinator)
    // });
    combinator
...
pub fn parse_msg_b<'a>(input: &'a [u8]) -> (res: PResult<<MsgBCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::Type, ParseError>)
    requires
        input.len() <= usize::MAX,
    ensures
        res matches Ok((n, v)) ==> spec_msg_b().spec_parse(input@) == Some((n as int, v@)),
        spec_msg_b().spec_parse(input@) matches Some((n, v))
            ==> res matches Ok((m, u)) && m == n && v == u@,
        res is Err ==> spec_msg_b().spec_parse(input@) is None,
        spec_msg_b().spec_parse(input@) is None ==> res is Err,
{
    let combinator = msg_b();
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::parse(&combinator, input)
}

pub fn serialize_msg_b<'a>(v: <MsgBCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize) -> (o: SResult<usize, SerializeError>)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_msg_b().wf(v@),
    ensures
...
pub fn serialize_msg_b_infallible<'a>(v: <MsgBCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize) -> (n: usize)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_msg_b().wf(v@),
        spec_msg_b().spec_serialize(v@).len() <= usize::MAX,
        pos + spec_msg_b().spec_serialize(v@).len() <= old(data)@.len(),
    ensures
        data@.len() == old(data)@.len(),
        pos <= usize::MAX - n && pos + n <= data@.len(),
        n == spec_msg_b().spec_serialize(v@).len(),
...
pub fn msg_b_len<'a>(v: <MsgBCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType) -> (serialize_len: usize)
    requires
        ...
        spec_msg_b().spec_serialize(v@).len() <= usize::MAX,
    ensures
        serialize_len == spec_msg_b().spec_serialize(v@).len(),
{
    let combinator = msg_b();
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::length(&combinator, v)
}
...
pub struct SpecMsgACombinator(pub SpecMsgACombinatorAlias);
...
pub struct MsgACombinator1(pub MsgACombinatorAlias1);
...
pub struct MsgACombinator(pub MsgACombinatorAlias);

impl View for MsgACombinator {
    type V = SpecMsgACombinator;
    open spec fn view(&self) -> Self::V { SpecMsgACombinator(self.0@) }
}
...
impl<'a> SecureSerialize<'a, &'a [u8], Vec<u8>> for MsgACombinator {
    fn secure_serialize(&self, v: Self::SType, data: &mut Vec<u8>, pos: usize) -> (o: SResult<usize, SerializeError>)
    { <_ as SecureSerialize<'a, &'a [u8], Vec<u8>>>::secure_serialize(&self.0, v, data, pos) }
}
...
pub fn msg_a<'a>() -> (o: MsgACombinator)
    ensures o@ == spec_msg_a(),
            o@.requires(),
            <_ as Combinator<'a, &'a [u8], Vec<u8>>>::ex_requires(&o),
{
    let combinator = MsgACombinator(
    Mapped {
        inner: MsgACombinator1((msg_b(), bytes::Tail)),
        mapper: MsgAMapper,
    });
    // assert({
    //     &&& combinator@ == spec_msg_a()
    //     &&& combinator@.requires()
    //     &&& <_ as Combinator<'a, &'a [u8], Vec<u8>>>::ex_requires(&combinator)
    // });
    combinator
...
pub fn parse_msg_a<'a>(input: &'a [u8]) -> (res: PResult<<MsgACombinator as Combinator<'a, &'a [u8], Vec<u8>>>::Type, ParseError>)
    requires
        input.len() <= usize::MAX,
    ensures
        res matches Ok((n, v)) ==> spec_msg_a().spec_parse(input@) == Some((n as int, v@)),
        spec_msg_a().spec_parse(input@) matches Some((n, v))
            ==> res matches Ok((m, u)) && m == n && v == u@,
        res is Err ==> spec_msg_a().spec_parse(input@) is None,
        spec_msg_a().spec_parse(input@) is None ==> res is Err,
{
    let combinator = msg_a();
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::parse(&combinator, input)
}

pub fn serialize_msg_a<'a>(v: <MsgACombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize) -> (o: SResult<usize, SerializeError>)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_msg_a().wf(v@),
    ensures
...
pub fn serialize_msg_a_infallible<'a>(v: <MsgACombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize) -> (n: usize)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_msg_a().wf(v@),
        spec_msg_a().spec_serialize(v@).len() <= usize::MAX,
        pos + spec_msg_a().spec_serialize(v@).len() <= old(data)@.len(),
    ensures
        data@.len() == old(data)@.len(),
        pos <= usize::MAX - n && pos + n <= data@.len(),
        n == spec_msg_a().spec_serialize(v@).len(),
...
pub fn msg_a_len<'a>(v: <MsgACombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType) -> (serialize_len: usize)
    requires
        ...
        spec_msg_a().spec_serialize(v@).len() <= usize::MAX,
    ensures
        serialize_len == spec_msg_a().spec_serialize(v@).len(),
{
    let combinator = msg_a();
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::length(&combinator, v)
}
...
pub struct SpecMsgCCombinator(pub SpecMsgCCombinatorAlias);
...
impl View for MsgCCombinator {
    ...
    open spec fn view(&self) -> Self::V { SpecMsgCCombinator(self.0@) }
}
...
impl<'a> SecureSerialize<'a, &'a [u8], Vec<u8>> for MsgCCombinator {
    fn secure_serialize(&self, v: Self::SType, data: &mut Vec<u8>, pos: usize) -> (o: SResult<usize, SerializeError>)
    { <_ as SecureSerialize<'a, &'a [u8], Vec<u8>>>::secure_serialize(&self.0, v, data, pos) }
}
...
pub fn msg_c<'a>() -> (o: MsgCCombinator)
    ensures o@ == spec_msg_c(),
            o@.requires(),
            <_ as Combinator<'a, &'a [u8], Vec<u8>>>::ex_requires(&o),
{
    let combinator = MsgCCombinator(
    Mapped {
        inner: Pair::new(Pair::new(content_type(), MsgCCont1), MsgCCont0),
        mapper: MsgCMapper,
    });
    // assert({
    //     &&& combinator@ == spec_msg_c()
    //     &&& combinator@.requires()
    //     &&& <_ as Combinator<'a, &'a [u8], Vec<u8>>>::ex_requires(&combinator)
    // });
    combinator
...
pub fn parse_msg_c<'a>(input: &'a [u8]) -> (res: PResult<<MsgCCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::Type, ParseError>)
    requires
        input.len() <= usize::MAX,
    ensures
        res matches Ok((n, v)) ==> spec_msg_c().spec_parse(input@) == Some((n as int, v@)),
        spec_msg_c().spec_parse(input@) matches Some((n, v))
            ==> res matches Ok((m, u)) && m == n && v == u@,
        res is Err ==> spec_msg_c().spec_parse(input@) is None,
        spec_msg_c().spec_parse(input@) is None ==> res is Err,
{
    let combinator = msg_c();
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::parse(&combinator, input)
}

pub fn serialize_msg_c<'a>(v: <MsgCCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize) -> (o: SResult<usize, SerializeError>)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_msg_c().wf(v@),
    ensures
...
pub fn serialize_msg_c_infallible<'a>(v: <MsgCCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize) -> (n: usize)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_msg_c().wf(v@),
        spec_msg_c().spec_serialize(v@).len() <= usize::MAX,
        pos + spec_msg_c().spec_serialize(v@).len() <= old(data)@.len(),
    ensures
        data@.len() == old(data)@.len(),
        pos <= usize::MAX - n && pos + n <= data@.len(),
        n == spec_msg_c().spec_serialize(v@).len(),
...
pub fn msg_c_len<'a>(v: <MsgCCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType) -> (serialize_len: usize)
    requires
        ...
        spec_msg_c().spec_serialize(v@).len() <= usize::MAX,
    ensures
        serialize_len == spec_msg_c().spec_serialize(v@).len(),
{
    let combinator = msg_c();
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::length(&combinator, v)
}
...
pub open spec fn spec_F5() -> SpecF5Combinator {
    Refined { inner: bytes::Fixed::<5>, predicate: TagPred(SPEC_F5_CONST) }
}

pub fn F5<'a>() -> (o: F5Combinator)
    ensures o@ == spec_F5(),
            o@.requires(),
            <_ as Combinator<'a, &'a [u8], Vec<u8>>>::ex_requires(&o),
{
    let combinator = Refined { inner: bytes::Fixed::<5>, predicate: TagPred(F5_CONST) };
    // assert({
    //     &&& combinator@ == spec_F5()
    //     &&& combinator@.requires()
    //     &&& <_ as Combinator<'a, &'a [u8], Vec<u8>>>::ex_requires(&combinator)
...
pub fn parse_F5<'a>(input: &'a [u8]) -> (res: PResult<<F5Combinator as Combinator<'a, &'a [u8], Vec<u8>>>::Type, ParseError>)
    requires
        input.len() <= usize::MAX,
    ensures
        res matches Ok((n, v)) ==> spec_F5().spec_parse(input@) == Some((n as int, v@)),
        spec_F5().spec_parse(input@) matches Some((n, v))
            ==> res matches Ok((m, u)) && m == n && v == u@,
        res is Err ==> spec_F5().spec_parse(input@) is None,
        spec_F5().spec_parse(input@) is None ==> res is Err,
{
    let combinator = F5();
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::parse(&combinator, input)
}

pub fn serialize_F5<'a>(v: <F5Combinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize) -> (o: SResult<usize, SerializeError>)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_F5().wf(v@),
    ensures
...
pub fn serialize_F5_infallible<'a>(v: <F5Combinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize) -> (n: usize)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_F5().wf(v@),
        spec_F5().spec_serialize(v@).len() <= usize::MAX,
        pos + spec_F5().spec_serialize(v@).len() <= old(data)@.len(),
    ensures
        data@.len() == old(data)@.len(),
        pos <= usize::MAX - n && pos + n <= data@.len(),
        n == spec_F5().spec_serialize(v@).len(),
...
pub fn F5_len<'a>(v: <F5Combinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType) -> (serialize_len: usize)
    requires
        ...
        spec_F5().spec_serialize(v@).len() <= usize::MAX,
    ensures
        serialize_len == spec_F5().spec_serialize(v@).len(),
{
    let combinator = F5();
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::length(&combinator, v)
}
