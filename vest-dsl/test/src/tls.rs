...
pub fn sever_hello_extension_extension_data<'a>(extension_type: ExtensionType, ext_len: u16) -> (o:
    SeverHelloExtensionExtensionDataCombinator)
    ensures
        o@ == spec_sever_hello_extension_extension_data(extension_type@, ext_len@),
{
    AndThen(
        Bytes(ext_len.ex_into()),
        Mapped {
