...
pub enum ClientHelloExtensionExtensionDataOwned {
    ...
    SessionTicket(SessionTicketOwned),
...
pub type ClientHelloExtensionExtensionDataOwnedInner = Either<EmptyOwned, Either<MaxFragmentLengthOwned, Either<EmptyOwned, Either<EcPointFormatListOwned, Either<UseSrtpDataOwned, Either<HeartbeatModeOwned, Either<ProtocolNameListOwned, Either<SignedCertificateTimestampListOwned, Either<ClientCertTypeClientExtensionOwned, Either<ServerCertTypeClientExtensionOwned, Either<PaddingExtensionOwned, Either<EmptyOwned, Either<EmptyOwned, Either<SessionTicketOwned, Either<PreSharedKeyClientExtensionOwned, Either<EmptyOwned, Either<SupportedVersionsClientOwned, Either<CookieOwned, Either<PskKeyExchangeModesOwned, Either<CertificateAuthoritiesExtensionOwned, Either<OidFilterExtensionOwned, Either<EmptyOwned, Either<SignatureSchemeListOwned, Either<KeyShareClientHelloOwned, UnknownExtensionOwned>>>>>>>>>>>>>>>>>>>>>>>>;
...
impl From<ClientHelloExtensionExtensionDataOwned> for ClientHelloExtensionExtensionDataOwnedInner {
    fn ex_from(m: ClientHelloExtensionExtensionDataOwned) -> ClientHelloExtensionExtensionDataOwnedInner {
        match m {
            ...
            ClientHelloExtensionExtensionDataOwned::ECPointFormats(m) => Either::Right(Either::Right(Either::Right(Either::Left(m)))),
            ClientHelloExtensionExtensionDataOwned::UseSRTP(m) => Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m))))),
            ClientHelloExtensionExtensionDataOwned::Heartbeat(m) => Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m)))))),
            ClientHelloExtensionExtensionDataOwned::ApplicationLayerProtocolNegotiation(m) => Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m))))))),
            ClientHelloExtensionExtensionDataOwned::SigedCertificateTimestamp(m) => Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m)))))))),
            ClientHelloExtensionExtensionDataOwned::ClientCertificateType(m) => Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m))))))))),
            ClientHelloExtensionExtensionDataOwned::ServerCertificateType(m) => Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m)))))))))),
            ClientHelloExtensionExtensionDataOwned::Padding(m) => Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m))))))))))),
            ClientHelloExtensionExtensionDataOwned::EncryptThenMac(m) => Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m)))))))))))),
            ClientHelloExtensionExtensionDataOwned::ExtendedMasterSecret(m) => Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m))))))))))))),
            ClientHelloExtensionExtensionDataOwned::SessionTicket(m) => Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m)))))))))))))),
            ClientHelloExtensionExtensionDataOwned::PreSharedKey(m) => Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m))))))))))))))),
            ClientHelloExtensionExtensionDataOwned::EarlyData(m) => Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m)))))))))))))))),
            ClientHelloExtensionExtensionDataOwned::SupportedVersions(m) => Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m))))))))))))))))),
            ClientHelloExtensionExtensionDataOwned::Cookie(m) => Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m)))))))))))))))))),
            ClientHelloExtensionExtensionDataOwned::PskKeyExchangeModes(m) => Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m))))))))))))))))))),
            ClientHelloExtensionExtensionDataOwned::CertificateAuthorities(m) => Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m)))))))))))))))))))),
            ClientHelloExtensionExtensionDataOwned::OidFilters(m) => Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m))))))))))))))))))))),
            ClientHelloExtensionExtensionDataOwned::PostHandshakeAuth(m) => Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m)))))))))))))))))))))),
            ...
            ClientHelloExtensionExtensionDataOwned::KeyShare(m) => Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m)))))))))))))))))))))))),
            ClientHelloExtensionExtensionDataOwned::Unrecognized(m) => Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(m)))))))))))))))))))))))),
        }
    }
}
impl From<ClientHelloExtensionExtensionDataOwnedInner> for ClientHelloExtensionExtensionDataOwned {
    fn ex_from(m: ClientHelloExtensionExtensionDataOwnedInner) -> ClientHelloExtensionExtensionDataOwned {
        match m {
            ...
            Either::Right(Either::Right(Either::Right(Either::Left(m)))) => ClientHelloExtensionExtensionDataOwned::ECPointFormats(m),
            Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m))))) => ClientHelloExtensionExtensionDataOwned::UseSRTP(m),
            Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m)))))) => ClientHelloExtensionExtensionDataOwned::Heartbeat(m),
            Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m))))))) => ClientHelloExtensionExtensionDataOwned::ApplicationLayerProtocolNegotiation(m),
            Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m)))))))) => ClientHelloExtensionExtensionDataOwned::SigedCertificateTimestamp(m),
            Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m))))))))) => ClientHelloExtensionExtensionDataOwned::ClientCertificateType(m),
            Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m)))))))))) => ClientHelloExtensionExtensionDataOwned::ServerCertificateType(m),
            Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m))))))))))) => ClientHelloExtensionExtensionDataOwned::Padding(m),
            Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m)))))))))))) => ClientHelloExtensionExtensionDataOwned::EncryptThenMac(m),
            Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m))))))))))))) => ClientHelloExtensionExtensionDataOwned::ExtendedMasterSecret(m),
            Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m)))))))))))))) => ClientHelloExtensionExtensionDataOwned::SessionTicket(m),
            Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m))))))))))))))) => ClientHelloExtensionExtensionDataOwned::PreSharedKey(m),
            Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m)))))))))))))))) => ClientHelloExtensionExtensionDataOwned::EarlyData(m),
            Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m))))))))))))))))) => ClientHelloExtensionExtensionDataOwned::SupportedVersions(m),
            Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Left(m)))))))))))))))))) => ClientHelloExtensionExtensionDataOwned::Cookie(m),
            ...
            Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(Either::Right(m)))))))))))))))))))))))) => ClientHelloExtensionExtensionDataOwned::Unrecognized(m),
        }
    }
}
...
pub type SpecOpaque1FfffCombinator = Mapped<SpecDepend<SpecUint1FfffCombinator, Bytes>, Opaque1FfffMapper>;

pub struct Opaque1FfffCont;pub type Opaque1FfffCombinator = Mapped<Depend<Uint1FfffCombinator, Bytes, Opaque1FfffCont>, Opaque1FfffMapper>;
...
pub type SpecPskIdentitiesCombinator = Mapped<SpecDepend<Refined<U16Be, Predicate17762240283561303569>, SpecPskIdentitiesIdentitiesCombinator>, PskIdentitiesMapper>;
...
pub struct PskIdentitiesCont;pub type PskIdentitiesCombinator = Mapped<Depend<Refined<U16Be, Predicate17762240283561303569>, PskIdentitiesIdentitiesCombinator, PskIdentitiesCont>, PskIdentitiesMapper>;
...
pub type SpecOpaque0FfffCombinator = Mapped<SpecDepend<SpecUint0FfffCombinator, Bytes>, Opaque0FfffMapper>;

pub struct Opaque0FfffCont;pub type Opaque0FfffCombinator = Mapped<Depend<Uint0FfffCombinator, Bytes, Opaque0FfffCont>, Opaque0FfffMapper>;


pub type SpecExtensionCombinator = Mapped<(SpecExtensionTypeCombinator, SpecOpaque0FfffCombinator), ExtensionMapper>;

pub type ExtensionCombinator = Mapped<(ExtensionTypeCombinator, Opaque0FfffCombinator), ExtensionMapper>;
...
pub type SpecClientExtensionsCombinator = Mapped<SpecDepend<Refined<U16Be, Predicate15770232246241775772>, SpecClientExtensionsExtensionsCombinator>, ClientExtensionsMapper>;
...
pub struct ClientExtensionsCont;pub type ClientExtensionsCombinator = Mapped<Depend<Refined<U16Be, Predicate15770232246241775772>, ClientExtensionsExtensionsCombinator, ClientExtensionsCont>, ClientExtensionsMapper>;

pub type SpecCertificateTypeCombinator = U8;
pub type CertificateTypeCombinator = U8;

pub type SpecServerCertTypeClientExtensionTypesCombinator = AndThen<Bytes, Repeat<SpecCertificateTypeCombinator>>;
pub type ServerCertTypeClientExtensionTypesCombinator = AndThen<Bytes, Repeat<CertificateTypeCombinator>>;
...
pub type SpecServerNameNameCombinator = Mapped<OrdChoice<Cond<SpecHostNameCombinator>, Cond<SpecUnknownNameCombinator>>, ServerNameNameMapper>;

pub type ServerNameNameCombinator = Mapped<OrdChoice<Cond<HostNameCombinator>, Cond<UnknownNameCombinator>>, ServerNameNameMapper>;


pub type SpecServerNameCombinator = Mapped<SpecDepend<SpecNameTypeCombinator, SpecServerNameNameCombinator>, ServerNameMapper>;

pub struct ServerNameCont;pub type ServerNameCombinator = Mapped<Depend<NameTypeCombinator, ServerNameNameCombinator, ServerNameCont>, ServerNameMapper>;
...
pub type SpecOpaque1FfCombinator = Mapped<SpecDepend<SpecUint1FfCombinator, Bytes>, Opaque1FfMapper>;

pub struct Opaque1FfCont;pub type Opaque1FfCombinator = Mapped<Depend<Uint1FfCombinator, Bytes, Opaque1FfCont>, Opaque1FfMapper>;

pub type SpecClientCertTypeServerExtensionCombinator = Mapped<SpecCertificateTypeCombinator, ClientCertTypeServerExtensionMapper>;
pub type ClientCertTypeServerExtensionCombinator = Mapped<CertificateTypeCombinator, ClientCertTypeServerExtensionMapper>;
...
pub type SpecSessionIdCombinator = Mapped<SpecDepend<Refined<U8, Predicate10693986609604791304>, Bytes>, SessionIdMapper>;
...
pub struct SessionIdCont;pub type SessionIdCombinator = Mapped<Depend<Refined<U8, Predicate10693986609604791304>, Bytes, SessionIdCont>, SessionIdMapper>;
...
pub type SpecCipherSuiteListCombinator = Mapped<SpecDepend<SpecUint2FffeCombinator, SpecCipherSuiteListListCombinator>, CipherSuiteListMapper>;

pub struct CipherSuiteListCont;pub type CipherSuiteListCombinator = Mapped<Depend<Uint2FffeCombinator, CipherSuiteListListCombinator, CipherSuiteListCont>, CipherSuiteListMapper>;
...
pub type SpecClientHelloCombinator = Mapped<(SpecProtocolVersionCombinator, (SpecRandomCombinator, (SpecSessionIdCombinator, (SpecCipherSuiteListCombinator, (SpecOpaque1FfCombinator, SpecClientExtensionsCombinator))))), ClientHelloMapper>;





pub type ClientHelloCombinator = Mapped<(ProtocolVersionCombinator, (RandomCombinator, (SessionIdCombinator, (CipherSuiteListCombinator, (Opaque1FfCombinator, ClientExtensionsCombinator))))), ClientHelloMapper>;
...
pub type SpecServerExtensionsCombinator = Mapped<SpecDepend<Refined<U16Be, Predicate503472032047519273>, SpecServerExtensionsExtensionsCombinator>, ServerExtensionsMapper>;
...
pub struct ServerExtensionsCont;pub type ServerExtensionsCombinator = Mapped<Depend<Refined<U16Be, Predicate503472032047519273>, ServerExtensionsExtensionsCombinator, ServerExtensionsCont>, ServerExtensionsMapper>;
...
pub type SpecServerHelloCombinator = Mapped<(SpecProtocolVersionCombinator, (SpecRandomCombinator, (SpecSessionIdCombinator, (SpecCipherSuiteCombinator, (Refined<U8, TagPred<u8>>, SpecServerExtensionsCombinator))))), ServerHelloMapper>;





pub type ServerHelloCombinator = Mapped<(ProtocolVersionCombinator, (RandomCombinator, (SessionIdCombinator, (CipherSuiteCombinator, (Refined<U8, TagPred<u8>>, ServerExtensionsCombinator))))), ServerHelloMapper>;

pub type SpecUint0FfCombinator = U8;
pub type Uint0FfCombinator = U8;


pub type SpecOpaque0FfCombinator = Mapped<SpecDepend<SpecUint0FfCombinator, Bytes>, Opaque0FfMapper>;

pub struct Opaque0FfCont;pub type Opaque0FfCombinator = Mapped<Depend<Uint0FfCombinator, Bytes, Opaque0FfCont>, Opaque0FfMapper>;
...
pub type SpecNewSessionTicketExtensionsExtensionsCombinator = AndThen<Bytes, Repeat<SpecExtensionCombinator>>;
pub type NewSessionTicketExtensionsExtensionsCombinator = AndThen<Bytes, Repeat<ExtensionCombinator>>;


pub type SpecNewSessionTicketExtensionsCombinator = Mapped<SpecDepend<SpecUint0FffeCombinator, SpecNewSessionTicketExtensionsExtensionsCombinator>, NewSessionTicketExtensionsMapper>;

pub struct NewSessionTicketExtensionsCont;pub type NewSessionTicketExtensionsCombinator = Mapped<Depend<Uint0FffeCombinator, NewSessionTicketExtensionsExtensionsCombinator, NewSessionTicketExtensionsCont>, NewSessionTicketExtensionsMapper>;





pub type SpecNewSessionTicketCombinator = Mapped<(U32Be, (U32Be, (SpecOpaque0FfCombinator, (SpecOpaque1FfffCombinator, SpecNewSessionTicketExtensionsCombinator)))), NewSessionTicketMapper>;




pub type NewSessionTicketCombinator = Mapped<(U32Be, (U32Be, (Opaque0FfCombinator, (Opaque1FfffCombinator, NewSessionTicketExtensionsCombinator)))), NewSessionTicketMapper>;

pub type SpecEmptyCombinator = BytesN<0>;
pub type EmptyCombinator = BytesN<0>;

pub type SpecEncryptedExtensionsExtensionsCombinator = AndThen<Bytes, Repeat<SpecExtensionCombinator>>;
pub type EncryptedExtensionsExtensionsCombinator = AndThen<Bytes, Repeat<ExtensionCombinator>>;


pub type SpecEncryptedExtensionsCombinator = Mapped<SpecDepend<SpecUint0FfffCombinator, SpecEncryptedExtensionsExtensionsCombinator>, EncryptedExtensionsMapper>;

pub struct EncryptedExtensionsCont;pub type EncryptedExtensionsCombinator = Mapped<Depend<Uint0FfffCombinator, EncryptedExtensionsExtensionsCombinator, EncryptedExtensionsCont>, EncryptedExtensionsMapper>;
...
pub type SpecOpaque1FfffffCombinator = Mapped<SpecDepend<Refined<U24Be, Predicate10565972399076720534>, Bytes>, Opaque1FfffffMapper>;
...
pub struct Opaque1FfffffCont;pub type Opaque1FfffffCombinator = Mapped<Depend<Refined<U24Be, Predicate10565972399076720534>, Bytes, Opaque1FfffffCont>, Opaque1FfffffMapper>;
...
pub type SpecCertificateEntryCombinator = Mapped<(SpecOpaque1FfffffCombinator, SpecCertificateExtensionsCombinator), CertificateEntryMapper>;

pub type CertificateEntryCombinator = Mapped<(Opaque1FfffffCombinator, CertificateExtensionsCombinator), CertificateEntryMapper>;
...
pub type SpecCertificateListCombinator = Mapped<SpecDepend<U24Be, SpecCertificateListListCombinator>, CertificateListMapper>;

pub struct CertificateListCont;pub type CertificateListCombinator = Mapped<Depend<U24Be, CertificateListListCombinator, CertificateListCont>, CertificateListMapper>;


pub type SpecCertificateCombinator = Mapped<(SpecOpaque0FfCombinator, SpecCertificateListCombinator), CertificateMapper>;

pub type CertificateCombinator = Mapped<(Opaque0FfCombinator, CertificateListCombinator), CertificateMapper>;
...
pub type SpecCertificateRequestExtensionsExtensionsCombinator = AndThen<Bytes, Repeat<SpecExtensionCombinator>>;
pub type CertificateRequestExtensionsExtensionsCombinator = AndThen<Bytes, Repeat<ExtensionCombinator>>;


pub type SpecCertificateRequestExtensionsCombinator = Mapped<SpecDepend<SpecUint2FfffCombinator, SpecCertificateRequestExtensionsExtensionsCombinator>, CertificateRequestExtensionsMapper>;

pub struct CertificateRequestExtensionsCont;pub type CertificateRequestExtensionsCombinator = Mapped<Depend<Uint2FfffCombinator, CertificateRequestExtensionsExtensionsCombinator, CertificateRequestExtensionsCont>, CertificateRequestExtensionsMapper>;


pub type SpecCertificateRequestCombinator = Mapped<(SpecOpaque0FfCombinator, SpecCertificateRequestExtensionsCombinator), CertificateRequestMapper>;

pub type CertificateRequestCombinator = Mapped<(Opaque0FfCombinator, CertificateRequestExtensionsCombinator), CertificateRequestMapper>;

pub type SpecSignatureSchemeCombinator = U16Be;
pub type SignatureSchemeCombinator = U16Be;


pub type SpecCertificateVerifyCombinator = Mapped<(SpecSignatureSchemeCombinator, SpecOpaque0FfffCombinator), CertificateVerifyMapper>;

pub type CertificateVerifyCombinator = Mapped<(SignatureSchemeCombinator, Opaque0FfffCombinator), CertificateVerifyMapper>;
...
pub type SpecHandshakeMsgCombinator = AndThen<Bytes, Mapped<OrdChoice<Cond<SpecClientHelloCombinator>, OrdChoice<Cond<SpecServerHelloCombinator>, OrdChoice<Cond<SpecNewSessionTicketCombinator>, OrdChoice<Cond<SpecEmptyCombinator>, OrdChoice<Cond<SpecEncryptedExtensionsCombinator>, OrdChoice<Cond<SpecCertificateCombinator>, OrdChoice<Cond<SpecCertificateRequestCombinator>, OrdChoice<Cond<SpecCertificateVerifyCombinator>, OrdChoice<Cond<SpecFinishedCombinator>, Cond<SpecKeyUpdateCombinator>>>>>>>>>>, HandshakeMsgMapper>>;
...
pub type SpecPskBinderEntryCombinator = Mapped<SpecDepend<Refined<U8, Predicate14956021864372697443>, Bytes>, PskBinderEntryMapper>;
...
pub struct PskBinderEntryCont;pub type PskBinderEntryCombinator = Mapped<Depend<Refined<U8, Predicate14956021864372697443>, Bytes, PskBinderEntryCont>, PskBinderEntryMapper>;

pub type SpecPskBinderEntriesBindersCombinator = AndThen<Bytes, Repeat<SpecPskBinderEntryCombinator>>;
...
pub type SpecSupportedVersionsClientVersionsCombinator = AndThen<Bytes, Repeat<SpecProtocolVersionCombinator>>;
pub type SupportedVersionsClientVersionsCombinator = AndThen<Bytes, Repeat<ProtocolVersionCombinator>>;
...
pub type SpecSupportedVersionsClientCombinator = Mapped<SpecDepend<Refined<U8, Predicate12026843412570934212>, SpecSupportedVersionsClientVersionsCombinator>, SupportedVersionsClientMapper>;
...
pub struct SupportedVersionsClientCont;pub type SupportedVersionsClientCombinator = Mapped<Depend<Refined<U8, Predicate12026843412570934212>, SupportedVersionsClientVersionsCombinator, SupportedVersionsClientCont>, SupportedVersionsClientMapper>;

pub type SpecHeartbeatExtensionCombinator = Mapped<SpecHeartbeatModeCombinator, HeartbeatExtensionMapper>;
...
pub type SpecProtocolNameListCombinator = Mapped<SpecDepend<SpecUint2FfffCombinator, SpecProtocolNameListListCombinator>, ProtocolNameListMapper>;

pub struct ProtocolNameListCont;pub type ProtocolNameListCombinator = Mapped<Depend<Uint2FfffCombinator, ProtocolNameListListCombinator, ProtocolNameListCont>, ProtocolNameListMapper>;

pub type SpecSupportedVersionsServerCombinator = Mapped<SpecProtocolVersionCombinator, SupportedVersionsServerMapper>;
pub type SupportedVersionsServerCombinator = Mapped<ProtocolVersionCombinator, SupportedVersionsServerMapper>;
...
pub type SpecEcPointFormatListCombinator = Mapped<SpecDepend<SpecUint1FfCombinator, SpecEcPointFormatListListCombinator>, EcPointFormatListMapper>;

pub struct EcPointFormatListCont;pub type EcPointFormatListCombinator = Mapped<Depend<Uint1FfCombinator, EcPointFormatListListCombinator, EcPointFormatListCont>, EcPointFormatListMapper>;

pub type SpecSrtpProtectionProfileCombinator = BytesN<2>;
pub type SrtpProtectionProfileCombinator = BytesN<2>;

pub type SpecSrtpProtectionProfilesListCombinator = AndThen<Bytes, Repeat<SpecSrtpProtectionProfileCombinator>>;
pub type SrtpProtectionProfilesListCombinator = AndThen<Bytes, Repeat<SrtpProtectionProfileCombinator>>;


pub type SpecSrtpProtectionProfilesCombinator = Mapped<SpecDepend<SpecUint2FfffCombinator, SpecSrtpProtectionProfilesListCombinator>, SrtpProtectionProfilesMapper>;

pub struct SrtpProtectionProfilesCont;pub type SrtpProtectionProfilesCombinator = Mapped<Depend<Uint2FfffCombinator, SrtpProtectionProfilesListCombinator, SrtpProtectionProfilesCont>, SrtpProtectionProfilesMapper>;


pub type SpecUseSrtpDataCombinator = Mapped<(SpecSrtpProtectionProfilesCombinator, SpecOpaque0FfCombinator), UseSrtpDataMapper>;

pub type UseSrtpDataCombinator = Mapped<(SrtpProtectionProfilesCombinator, Opaque0FfCombinator), UseSrtpDataMapper>;

pub type SpecSerializedSctCombinator = SpecOpaque1FfffCombinator;
pub type SerializedSctCombinator = Opaque1FfffCombinator;

pub type SpecSignedCertificateTimestampListListCombinator = AndThen<Bytes, Repeat<SpecSerializedSctCombinator>>;
pub type SignedCertificateTimestampListListCombinator = AndThen<Bytes, Repeat<SerializedSctCombinator>>;


pub type SpecSignedCertificateTimestampListCombinator = Mapped<SpecDepend<SpecUint1FfffCombinator, SpecSignedCertificateTimestampListListCombinator>, SignedCertificateTimestampListMapper>;

pub struct SignedCertificateTimestampListCont;pub type SignedCertificateTimestampListCombinator = Mapped<Depend<Uint1FfffCombinator, SignedCertificateTimestampListListCombinator, SignedCertificateTimestampListCont>, SignedCertificateTimestampListMapper>;

pub type SpecClientCertTypeClientExtensionTypesCombinator = AndThen<Bytes, Repeat<SpecCertificateTypeCombinator>>;
pub type ClientCertTypeClientExtensionTypesCombinator = AndThen<Bytes, Repeat<CertificateTypeCombinator>>;


pub type SpecClientCertTypeClientExtensionCombinator = Mapped<SpecDepend<SpecUint1FfCombinator, SpecClientCertTypeClientExtensionTypesCombinator>, ClientCertTypeClientExtensionMapper>;

pub struct ClientCertTypeClientExtensionCont;pub type ClientCertTypeClientExtensionCombinator = Mapped<Depend<Uint1FfCombinator, ClientCertTypeClientExtensionTypesCombinator, ClientCertTypeClientExtensionCont>, ClientCertTypeClientExtensionMapper>;


pub type SpecServerCertTypeClientExtensionCombinator = Mapped<SpecDepend<SpecUint1FfCombinator, SpecServerCertTypeClientExtensionTypesCombinator>, ServerCertTypeClientExtensionMapper>;

pub struct ServerCertTypeClientExtensionCont;pub type ServerCertTypeClientExtensionCombinator = Mapped<Depend<Uint1FfCombinator, ServerCertTypeClientExtensionTypesCombinator, ServerCertTypeClientExtensionCont>, ServerCertTypeClientExtensionMapper>;
...
pub type SpecPaddingExtensionCombinator = Mapped<SpecDepend<SpecUint0FfffCombinator, SpecPaddingExtensionPaddingCombinator>, PaddingExtensionMapper>;

pub struct PaddingExtensionCont;pub type PaddingExtensionCombinator = Mapped<Depend<Uint0FfffCombinator, PaddingExtensionPaddingCombinator, PaddingExtensionCont>, PaddingExtensionMapper>;
...
pub type SpecPskBinderEntriesCombinator = Mapped<SpecDepend<Refined<U16Be, Predicate14504484746533333987>, SpecPskBinderEntriesBindersCombinator>, PskBinderEntriesMapper>;
...
pub struct PskBinderEntriesCont;pub type PskBinderEntriesCombinator = Mapped<Depend<Refined<U16Be, Predicate14504484746533333987>, PskBinderEntriesBindersCombinator, PskBinderEntriesCont>, PskBinderEntriesMapper>;


pub type SpecOfferedPsksCombinator = Mapped<(SpecPskIdentitiesCombinator, SpecPskBinderEntriesCombinator), OfferedPsksMapper>;

pub type OfferedPsksCombinator = Mapped<(PskIdentitiesCombinator, PskBinderEntriesCombinator), OfferedPsksMapper>;

pub type SpecPreSharedKeyClientExtensionCombinator = Mapped<SpecOfferedPsksCombinator, PreSharedKeyClientExtensionMapper>;
pub type PreSharedKeyClientExtensionCombinator = Mapped<OfferedPsksCombinator, PreSharedKeyClientExtensionMapper>;

pub type SpecPskKeyExchangeModeCombinator = U8;
pub type PskKeyExchangeModeCombinator = U8;

pub type SpecPskKeyExchangeModesModesCombinator = AndThen<Bytes, Repeat<SpecPskKeyExchangeModeCombinator>>;
pub type PskKeyExchangeModesModesCombinator = AndThen<Bytes, Repeat<PskKeyExchangeModeCombinator>>;


pub type SpecPskKeyExchangeModesCombinator = Mapped<SpecDepend<SpecUint1FfCombinator, SpecPskKeyExchangeModesModesCombinator>, PskKeyExchangeModesMapper>;

pub struct PskKeyExchangeModesCont;pub type PskKeyExchangeModesCombinator = Mapped<Depend<Uint1FfCombinator, PskKeyExchangeModesModesCombinator, PskKeyExchangeModesCont>, PskKeyExchangeModesMapper>;
...
pub type SpecCertificateAuthoritiesExtensionAuthoritiesCombinator = AndThen<Bytes, Repeat<SpecDistinguishedNameCombinator>>;
pub type CertificateAuthoritiesExtensionAuthoritiesCombinator = AndThen<Bytes, Repeat<DistinguishedNameCombinator>>;
...
pub type SpecCertificateAuthoritiesExtensionCombinator = Mapped<SpecDepend<Refined<U16Be, Predicate17709910934222271310>, SpecCertificateAuthoritiesExtensionAuthoritiesCombinator>, CertificateAuthoritiesExtensionMapper>;
...
pub struct CertificateAuthoritiesExtensionCont;pub type CertificateAuthoritiesExtensionCombinator = Mapped<Depend<Refined<U16Be, Predicate17709910934222271310>, CertificateAuthoritiesExtensionAuthoritiesCombinator, CertificateAuthoritiesExtensionCont>, CertificateAuthoritiesExtensionMapper>;


pub type SpecOidFilterCombinator = Mapped<(SpecOpaque1FfCombinator, SpecOpaque0FfffCombinator), OidFilterMapper>;

pub type OidFilterCombinator = Mapped<(Opaque1FfCombinator, Opaque0FfffCombinator), OidFilterMapper>;
...
pub type SpecOidFilterExtensionCombinator = Mapped<SpecDepend<SpecUint0FfffCombinator, SpecOidFilterExtensionFiltersCombinator>, OidFilterExtensionMapper>;

pub struct OidFilterExtensionCont;pub type OidFilterExtensionCombinator = Mapped<Depend<Uint0FfffCombinator, OidFilterExtensionFiltersCombinator, OidFilterExtensionCont>, OidFilterExtensionMapper>;

pub type SpecSignatureSchemeListListCombinator = AndThen<Bytes, Repeat<SpecSignatureSchemeCombinator>>;
pub type SignatureSchemeListListCombinator = AndThen<Bytes, Repeat<SignatureSchemeCombinator>>;


pub type SpecSignatureSchemeListCombinator = Mapped<SpecDepend<SpecUint2FffeCombinator, SpecSignatureSchemeListListCombinator>, SignatureSchemeListMapper>;

pub struct SignatureSchemeListCont;pub type SignatureSchemeListCombinator = Mapped<Depend<Uint2FffeCombinator, SignatureSchemeListListCombinator, SignatureSchemeListCont>, SignatureSchemeListMapper>;
...
pub type SpecUncompressedPointRepresentation32Combinator = Mapped<(Refined<U8, TagPred<u8>>, (BytesN<32>, BytesN<32>)), UncompressedPointRepresentation32Mapper>;


pub type UncompressedPointRepresentation32Combinator = Mapped<(Refined<U8, TagPred<u8>>, (BytesN<32>, BytesN<32>)), UncompressedPointRepresentation32Mapper>;

pub const UNCOMPRESSEDPOINTREPRESENTATION48_LEGACY_FORM: u8 = 4;


pub type SpecUncompressedPointRepresentation48Combinator = Mapped<(Refined<U8, TagPred<u8>>, (BytesN<48>, BytesN<48>)), UncompressedPointRepresentation48Mapper>;


pub type UncompressedPointRepresentation48Combinator = Mapped<(Refined<U8, TagPred<u8>>, (BytesN<48>, BytesN<48>)), UncompressedPointRepresentation48Mapper>;

pub const UNCOMPRESSEDPOINTREPRESENTATION66_LEGACY_FORM: u8 = 4;


pub type SpecUncompressedPointRepresentation66Combinator = Mapped<(Refined<U8, TagPred<u8>>, (BytesN<66>, BytesN<66>)), UncompressedPointRepresentation66Mapper>;


pub type UncompressedPointRepresentation66Combinator = Mapped<(Refined<U8, TagPred<u8>>, (BytesN<66>, BytesN<66>)), UncompressedPointRepresentation66Mapper>;

pub const MONTGOMERYPOINT32_LEGACY_FORM: u8 = 4;

pub type SpecMontgomeryPoint32Combinator = Mapped<(Refined<U8, TagPred<u8>>, BytesN<32>), MontgomeryPoint32Mapper>;

pub type MontgomeryPoint32Combinator = Mapped<(Refined<U8, TagPred<u8>>, BytesN<32>), MontgomeryPoint32Mapper>;

pub const MONTGOMERYFORM56_LEGACY_FORM: u8 = 4;

pub type SpecMontgomeryForm56Combinator = Mapped<(Refined<U8, TagPred<u8>>, BytesN<56>), MontgomeryForm56Mapper>;

pub type MontgomeryForm56Combinator = Mapped<(Refined<U8, TagPred<u8>>, BytesN<56>), MontgomeryForm56Mapper>;



pub type SpecSeverDhParamsCombinator = Mapped<(SpecOpaque1FfffCombinator, (SpecOpaque1FfffCombinator, SpecOpaque1FfffCombinator)), SeverDhParamsMapper>;


pub type SeverDhParamsCombinator = Mapped<(Opaque1FfffCombinator, (Opaque1FfffCombinator, Opaque1FfffCombinator)), SeverDhParamsMapper>;
...
pub type KeyShareEntryKeyExchangeCombinator = Mapped<OrdChoice<Cond<UncompressedPointRepresentation32Combinator>, OrdChoice<Cond<UncompressedPointRepresentation48Combinator>, OrdChoice<Cond<UncompressedPointRepresentation66Combinator>, OrdChoice<Cond<MontgomeryPoint32Combinator>, OrdChoice<Cond<MontgomeryForm56Combinator>, OrdChoice<Cond<SeverDhParamsCombinator>, OrdChoice<Cond<SeverDhParamsCombinator>, OrdChoice<Cond<SeverDhParamsCombinator>, OrdChoice<Cond<SeverDhParamsCombinator>, OrdChoice<Cond<SeverDhParamsCombinator>, Cond<KeyExchangeDataCombinator>>>>>>>>>>>, KeyShareEntryKeyExchangeMapper>;


pub type SpecKeyShareEntryCombinator = Mapped<SpecDepend<SpecNamedGroupCombinator, SpecKeyShareEntryKeyExchangeCombinator>, KeyShareEntryMapper>;

pub struct KeyShareEntryCont;pub type KeyShareEntryCombinator = Mapped<Depend<NamedGroupCombinator, KeyShareEntryKeyExchangeCombinator, KeyShareEntryCont>, KeyShareEntryMapper>;

pub type SpecKeyShareClientHelloClientSharesCombinator = AndThen<Bytes, Repeat<SpecKeyShareEntryCombinator>>;
pub type KeyShareClientHelloClientSharesCombinator = AndThen<Bytes, Repeat<KeyShareEntryCombinator>>;


pub type SpecKeyShareClientHelloCombinator = Mapped<SpecDepend<SpecUint0FfffCombinator, SpecKeyShareClientHelloClientSharesCombinator>, KeyShareClientHelloMapper>;

pub struct KeyShareClientHelloCont;pub type KeyShareClientHelloCombinator = Mapped<Depend<Uint0FfffCombinator, KeyShareClientHelloClientSharesCombinator, KeyShareClientHelloCont>, KeyShareClientHelloMapper>;
...
pub type ClientHelloExtensionExtensionDataCombinator = AndThen<Bytes, Mapped<OrdChoice<Cond<EmptyCombinator>, OrdChoice<Cond<MaxFragmentLengthCombinator>, OrdChoice<Cond<EmptyCombinator>, OrdChoice<Cond<EcPointFormatListCombinator>, OrdChoice<Cond<UseSrtpDataCombinator>, OrdChoice<Cond<HeartbeatModeCombinator>, OrdChoice<Cond<ProtocolNameListCombinator>, OrdChoice<Cond<SignedCertificateTimestampListCombinator>, OrdChoice<Cond<ClientCertTypeClientExtensionCombinator>, OrdChoice<Cond<ServerCertTypeClientExtensionCombinator>, OrdChoice<Cond<PaddingExtensionCombinator>, OrdChoice<Cond<EmptyCombinator>, OrdChoice<Cond<EmptyCombinator>, OrdChoice<Cond<SessionTicketCombinator>, OrdChoice<Cond<PreSharedKeyClientExtensionCombinator>, OrdChoice<Cond<EmptyCombinator>, OrdChoice<Cond<SupportedVersionsClientCombinator>, OrdChoice<Cond<CookieCombinator>, OrdChoice<Cond<PskKeyExchangeModesCombinator>, OrdChoice<Cond<CertificateAuthoritiesExtensionCombinator>, OrdChoice<Cond<OidFilterExtensionCombinator>, OrdChoice<Cond<EmptyCombinator>, OrdChoice<Cond<SignatureSchemeListCombinator>, OrdChoice<Cond<KeyShareClientHelloCombinator>, Cond<UnknownExtensionCombinator>>>>>>>>>>>>>>>>>>>>>>>>>, ClientHelloExtensionExtensionDataMapper>>;



pub type SpecTlsCiphertextCombinator = Mapped<(SpecContentTypeCombinator, (SpecProtocolVersionCombinator, SpecOpaque0FfffCombinator)), TlsCiphertextMapper>;


pub type TlsCiphertextCombinator = Mapped<(ContentTypeCombinator, (ProtocolVersionCombinator, Opaque0FfffCombinator)), TlsCiphertextMapper>;
...
pub type SpecHandshakeCombinator = Mapped<SpecDepend<(SpecHandshakeTypeCombinator, U24Be), SpecHandshakeMsgCombinator>, HandshakeMapper>;


pub struct HandshakeCont;pub type HandshakeCombinator = Mapped<Depend<(HandshakeTypeCombinator, U24Be), HandshakeMsgCombinator, HandshakeCont>, HandshakeMapper>;
...
pub type SpecOpaque2FfffCombinator = Mapped<SpecDepend<SpecUint2FfffCombinator, Bytes>, Opaque2FfffMapper>;

pub struct Opaque2FfffCont;pub type Opaque2FfffCombinator = Mapped<Depend<Uint2FfffCombinator, Bytes, Opaque2FfffCont>, Opaque2FfffMapper>;


pub type SpecServerNameListCombinator = Mapped<SpecDepend<SpecUint1FfffCombinator, SpecServerNameListListCombinator>, ServerNameListMapper>;

pub struct ServerNameListCont;pub type ServerNameListCombinator = Mapped<Depend<Uint1FfffCombinator, ServerNameListListCombinator, ServerNameListCont>, ServerNameListMapper>;


pub type SpecResponderIdListCombinator = Mapped<SpecDepend<SpecUint0FfffCombinator, SpecResponderIdListListCombinator>, ResponderIdListMapper>;

pub struct ResponderIdListCont;pub type ResponderIdListCombinator = Mapped<Depend<Uint0FfffCombinator, ResponderIdListListCombinator, ResponderIdListCont>, ResponderIdListMapper>;


pub type SpecOscpStatusRequestCombinator = Mapped<(SpecResponderIdListCombinator, SpecOcspExtensionsCombinator), OscpStatusRequestMapper>;

pub type OscpStatusRequestCombinator = Mapped<(ResponderIdListCombinator, OcspExtensionsCombinator), OscpStatusRequestMapper>;

pub const CERTIFICATESTATUSREQUEST_STATUS_TYPE: u8 = 1;

pub type SpecCertificateStatusRequestCombinator = Mapped<(Refined<U8, TagPred<u8>>, SpecOscpStatusRequestCombinator), CertificateStatusRequestMapper>;

pub type CertificateStatusRequestCombinator = Mapped<(Refined<U8, TagPred<u8>>, OscpStatusRequestCombinator), CertificateStatusRequestMapper>;
...
pub type SpecNamedGroupListCombinator = Mapped<SpecDepend<SpecUint2FfffCombinator, SpecNamedGroupListListCombinator>, NamedGroupListMapper>;

pub struct NamedGroupListCont;pub type NamedGroupListCombinator = Mapped<Depend<Uint2FfffCombinator, NamedGroupListListCombinator, NamedGroupListCont>, NamedGroupListMapper>;
...
pub type SpecSeverHelloExtensionExtensionDataCombinator = AndThen<Bytes, Mapped<OrdChoice<Cond<SpecServerNameListCombinator>, OrdChoice<Cond<SpecMaxFragmentLengthCombinator>, OrdChoice<Cond<SpecCertificateStatusRequestCombinator>, OrdChoice<Cond<SpecNamedGroupListCombinator>, OrdChoice<Cond<SpecEcPointFormatListCombinator>, OrdChoice<Cond<SpecSignatureSchemeListCombinator>, OrdChoice<Cond<SpecSrtpProtectionProfilesCombinator>, OrdChoice<Cond<SpecHeartbeatModeCombinator>, OrdChoice<Cond<SpecProtocolNameListCombinator>, OrdChoice<Cond<SpecSignedCertificateTimestampListCombinator>, OrdChoice<Cond<SpecClientCertTypeClientExtensionCombinator>, OrdChoice<Cond<SpecServerCertTypeClientExtensionCombinator>, OrdChoice<Cond<SpecPaddingExtensionCombinator>, OrdChoice<Cond<SpecEmptyCombinator>, OrdChoice<Cond<SpecEmptyCombinator>, OrdChoice<Cond<SpecSessionTicketCombinator>, OrdChoice<Cond<SpecPreSharedKeyClientExtensionCombinator>, OrdChoice<Cond<SpecEmptyCombinator>, OrdChoice<Cond<SpecSupportedVersionsClientCombinator>, OrdChoice<Cond<SpecCookieCombinator>, OrdChoice<Cond<SpecPskKeyExchangeModesCombinator>, OrdChoice<Cond<SpecCertificateAuthoritiesExtensionCombinator>, OrdChoice<Cond<SpecOidFilterExtensionCombinator>, OrdChoice<Cond<SpecEmptyCombinator>, OrdChoice<Cond<SpecSignatureSchemeListCombinator>, OrdChoice<Cond<SpecKeyShareClientHelloCombinator>, Cond<SpecUnknownExtensionCombinator>>>>>>>>>>>>>>>>>>>>>>>>>>>, SeverHelloExtensionExtensionDataMapper>>;
...
pub type SeverHelloExtensionExtensionDataCombinator = AndThen<Bytes, Mapped<OrdChoice<Cond<ServerNameListCombinator>, OrdChoice<Cond<MaxFragmentLengthCombinator>, OrdChoice<Cond<CertificateStatusRequestCombinator>, OrdChoice<Cond<NamedGroupListCombinator>, OrdChoice<Cond<EcPointFormatListCombinator>, OrdChoice<Cond<SignatureSchemeListCombinator>, OrdChoice<Cond<SrtpProtectionProfilesCombinator>, OrdChoice<Cond<HeartbeatModeCombinator>, OrdChoice<Cond<ProtocolNameListCombinator>, OrdChoice<Cond<SignedCertificateTimestampListCombinator>, OrdChoice<Cond<ClientCertTypeClientExtensionCombinator>, OrdChoice<Cond<ServerCertTypeClientExtensionCombinator>, OrdChoice<Cond<PaddingExtensionCombinator>, OrdChoice<Cond<EmptyCombinator>, OrdChoice<Cond<EmptyCombinator>, OrdChoice<Cond<SessionTicketCombinator>, OrdChoice<Cond<PreSharedKeyClientExtensionCombinator>, OrdChoice<Cond<EmptyCombinator>, OrdChoice<Cond<SupportedVersionsClientCombinator>, OrdChoice<Cond<CookieCombinator>, OrdChoice<Cond<PskKeyExchangeModesCombinator>, OrdChoice<Cond<CertificateAuthoritiesExtensionCombinator>, OrdChoice<Cond<OidFilterExtensionCombinator>, OrdChoice<Cond<EmptyCombinator>, OrdChoice<Cond<SignatureSchemeListCombinator>, OrdChoice<Cond<KeyShareClientHelloCombinator>, Cond<UnknownExtensionCombinator>>>>>>>>>>>>>>>>>>>>>>>>>>>, SeverHelloExtensionExtensionDataMapper>>;



pub type SpecSeverHelloExtensionCombinator = Mapped<SpecDepend<(SpecExtensionTypeCombinator, U16Be), SpecSeverHelloExtensionExtensionDataCombinator>, SeverHelloExtensionMapper>;


pub struct SeverHelloExtensionCont;pub type SeverHelloExtensionCombinator = Mapped<Depend<(ExtensionTypeCombinator, U16Be), SeverHelloExtensionExtensionDataCombinator, SeverHelloExtensionCont>, SeverHelloExtensionMapper>;

pub type SpecEarlyDataIndicationNewSessionTicketCombinator = Mapped<U32Be, EarlyDataIndicationNewSessionTicketMapper>;
pub type EarlyDataIndicationNewSessionTicketCombinator = Mapped<U32Be, EarlyDataIndicationNewSessionTicketMapper>;

pub type SpecOcspResponseCombinator = SpecOpaque1FfffffCombinator;
pub type OcspResponseCombinator = Opaque1FfffffCombinator;

pub type SpecPreSharedKeyServerExtensionCombinator = Mapped<U16Be, PreSharedKeyServerExtensionMapper>;
...
pub type SpecAlertCombinator = Mapped<(SpecAlertLevelCombinator, SpecAlertDescriptionCombinator), AlertMapper>;

pub type AlertCombinator = Mapped<(AlertLevelCombinator, AlertDescriptionCombinator), AlertMapper>;

pub type SpecServerCertTypeServerExtensionCombinator = Mapped<SpecCertificateTypeCombinator, ServerCertTypeServerExtensionMapper>;
pub type ServerCertTypeServerExtensionCombinator = Mapped<CertificateTypeCombinator, ServerCertTypeServerExtensionMapper>;


pub type SpecOpaque0FfffffCombinator = Mapped<SpecDepend<U24Be, Bytes>, Opaque0FfffffMapper>;

pub struct Opaque0FfffffCont;pub type Opaque0FfffffCombinator = Mapped<Depend<U24Be, Bytes, Opaque0FfffffCont>, Opaque0FfffffMapper>;

pub const CERTIFICATESTATUS_STATUS_TYPE: u8 = 1;

pub type SpecCertificateStatusCombinator = Mapped<(Refined<U8, TagPred<u8>>, SpecOcspResponseCombinator), CertificateStatusMapper>;

pub type CertificateStatusCombinator = Mapped<(Refined<U8, TagPred<u8>>, OcspResponseCombinator), CertificateStatusMapper>;



pub type SpecClientHelloExtensionCombinator = Mapped<SpecDepend<(SpecExtensionTypeCombinator, U16Be), SpecClientHelloExtensionExtensionDataCombinator>, ClientHelloExtensionMapper>;


pub struct ClientHelloExtensionCont;pub type ClientHelloExtensionCombinator = Mapped<Depend<(ExtensionTypeCombinator, U16Be), ClientHelloExtensionExtensionDataCombinator, ClientHelloExtensionCont>, ClientHelloExtensionMapper>;



pub type SpecTlsPlaintextCombinator = Mapped<(SpecContentTypeCombinator, (SpecProtocolVersionCombinator, SpecOpaque0FfffCombinator)), TlsPlaintextMapper>;


pub type TlsPlaintextCombinator = Mapped<(ContentTypeCombinator, (ProtocolVersionCombinator, Opaque0FfffCombinator)), TlsPlaintextMapper>;
...
pub open spec fn spec_client_extensions_extensions(l: u16) -> SpecClientExtensionsExtensionsCombinator {
...
pub open spec fn spec_responder_id_list_list(l: SpecUint0Ffff) -> SpecResponderIdListListCombinator {
...
pub open spec fn spec_server_cert_type_client_extension_types(l: SpecUint1Ff) -> SpecServerCertTypeClientExtensionTypesCombinator {
...
Mapped { inner: OrdChoice(Cond { cond: name_type == 0, inner: spec_host_name() }, Cond { cond: !(name_type == 0), inner: spec_unknown_name() }), mapper: ServerNameNameMapper }}

pub fn server_name_name<'a>(name_type: NameType) -> (o: ServerNameNameCombinator)
    ensures o@ == spec_server_name_name(name_type@),
{
Mapped { inner: OrdChoice(Cond { cond: name_type == 0, inner: host_name() }, Cond { cond: !(name_type == 0), inner: unknown_name() }), mapper: ServerNameNameMapper }}
...
pub open spec fn spec_cipher_suite_list_list(l: SpecUint2Fffe) -> SpecCipherSuiteListListCombinator {
...
Mapped { inner: (spec_protocol_version(), (spec_random(), (spec_session_id(), (spec_cipher_suite_list(), (spec_opaque_1_ff(), spec_client_extensions()))))), mapper: ClientHelloMapper }}
...
{
Mapped { inner: (protocol_version(), (random(), (session_id(), (cipher_suite_list(), (opaque_1_ff(), client_extensions()))))), mapper: ClientHelloMapper }}
...
pub open spec fn spec_server_extensions_extensions(l: u16) -> SpecServerExtensionsExtensionsCombinator {
AndThen(Bytes(l.spec_into()), Repeat(spec_extension()))}
...
Mapped { inner: (spec_protocol_version(), (spec_random(), (spec_session_id(), (spec_cipher_suite(), (Refined { inner: U8, predicate: TagPred(SERVERHELLO_LEGACY_COMPRESSION_METHOD) }, spec_server_extensions()))))), mapper: ServerHelloMapper }}
...
{
Mapped { inner: (protocol_version(), (random(), (session_id(), (cipher_suite(), (Refined { inner: U8, predicate: TagPred(SERVERHELLO_LEGACY_COMPRESSION_METHOD) }, server_extensions()))))), mapper: ServerHelloMapper }}
...
pub open spec fn spec_new_session_ticket_extensions_extensions(l: SpecUint0Fffe) -> SpecNewSessionTicketExtensionsExtensionsCombinator {
AndThen(Bytes(l.spec_into()), Repeat(spec_extension()))}
...
Mapped { inner: (U32Be, (U32Be, (spec_opaque_0_ff(), (spec_opaque_1_ffff(), spec_new_session_ticket_extensions())))), mapper: NewSessionTicketMapper }}
...
{
Mapped { inner: (U32Be, (U32Be, (opaque_0_ff(), (opaque_1_ffff(), new_session_ticket_extensions())))), mapper: NewSessionTicketMapper }}
...
pub open spec fn spec_encrypted_extensions_extensions(l: SpecUint0Ffff) -> SpecEncryptedExtensionsExtensionsCombinator {
AndThen(Bytes(l.spec_into()), Repeat(spec_extension()))}
...
Mapped { inner: (spec_opaque_1_ffffff(), spec_certificate_extensions()), mapper: CertificateEntryMapper }}
...
pub open spec fn spec_certificate_request_extensions_extensions(l: SpecUint2Ffff) -> SpecCertificateRequestExtensionsExtensionsCombinator {
AndThen(Bytes(l.spec_into()), Repeat(spec_extension()))}
...
Mapped { inner: (spec_opaque_0_ff(), spec_certificate_request_extensions()), mapper: CertificateRequestMapper }}

pub fn certificate_request() -> (o: CertificateRequestCombinator)
    ensures o@ == spec_certificate_request(),
{
Mapped { inner: (opaque_0_ff(), certificate_request_extensions()), mapper: CertificateRequestMapper }}
...
Mapped { inner: (spec_signature_scheme(), spec_opaque_0_ffff()), mapper: CertificateVerifyMapper }}
...
pub open spec fn spec_handshake_msg(msg_type: SpecHandshakeType, length: u24) -> SpecHandshakeMsgCombinator {
...
pub open spec fn spec_supported_versions_client_versions(l: u8) -> SpecSupportedVersionsClientVersionsCombinator {
...
pub open spec fn spec_protocol_name_list_list(l: SpecUint2Ffff) -> SpecProtocolNameListListCombinator {
...
pub open spec fn spec_ec_point_format_list_list(l: SpecUint1Ff) -> SpecEcPointFormatListListCombinator {
...
pub open spec fn spec_srtp_protection_profiles_list(l: SpecUint2Ffff) -> SpecSrtpProtectionProfilesListCombinator {
...
Mapped { inner: (spec_srtp_protection_profiles(), spec_opaque_0_ff()), mapper: UseSrtpDataMapper }}
...
pub open spec fn spec_signed_certificate_timestamp_list_list(l: SpecUint1Ffff) -> SpecSignedCertificateTimestampListListCombinator {
...
pub open spec fn spec_client_cert_type_client_extension_types(l: SpecUint1Ff) -> SpecClientCertTypeClientExtensionTypesCombinator {
AndThen(Bytes(l.spec_into()), Repeat(spec_certificate_type()))}
...
Mapped { inner: Refined { inner: U8, predicate: TagPred(ZEROBYTE_ZERO) }, mapper: ZeroByteMapper }}
pub fn zero_byte() -> (o: ZeroByteCombinator)
    ensures o@ == spec_zero_byte(),
{
Mapped { inner: Refined { inner: U8, predicate: TagPred(ZEROBYTE_ZERO) }, mapper: ZeroByteMapper }}

pub open spec fn spec_padding_extension_padding(l: SpecUint0Ffff) -> SpecPaddingExtensionPaddingCombinator {
...
pub open spec fn spec_psk_key_exchange_modes_modes(l: SpecUint1Ff) -> SpecPskKeyExchangeModesModesCombinator {
...
pub open spec fn spec_certificate_authorities_extension_authorities(l: u16) -> SpecCertificateAuthoritiesExtensionAuthoritiesCombinator {
...
pub open spec fn spec_oid_filter_extension_filters(l: SpecUint0Ffff) -> SpecOidFilterExtensionFiltersCombinator {
...
pub open spec fn spec_signature_scheme_list_list(l: SpecUint2Fffe) -> SpecSignatureSchemeListListCombinator {
...
Mapped { inner: (Refined { inner: U8, predicate: TagPred(UNCOMPRESSEDPOINTREPRESENTATION32_LEGACY_FORM) }, (BytesN::<32>, BytesN::<32>)), mapper: UncompressedPointRepresentation32Mapper }}
...
Mapped { inner: (Refined { inner: U8, predicate: TagPred(UNCOMPRESSEDPOINTREPRESENTATION48_LEGACY_FORM) }, (BytesN::<48>, BytesN::<48>)), mapper: UncompressedPointRepresentation48Mapper }}
...
Mapped { inner: (Refined { inner: U8, predicate: TagPred(UNCOMPRESSEDPOINTREPRESENTATION66_LEGACY_FORM) }, (BytesN::<66>, BytesN::<66>)), mapper: UncompressedPointRepresentation66Mapper }}
...
Mapped { inner: (Refined { inner: U8, predicate: TagPred(MONTGOMERYPOINT32_LEGACY_FORM) }, BytesN::<32>), mapper: MontgomeryPoint32Mapper }}
...
Mapped { inner: (Refined { inner: U8, predicate: TagPred(MONTGOMERYFORM56_LEGACY_FORM) }, BytesN::<56>), mapper: MontgomeryForm56Mapper }}
...
Mapped { inner: (spec_opaque_1_ffff(), (spec_opaque_1_ffff(), spec_opaque_1_ffff())), mapper: SeverDhParamsMapper }}


pub fn sever_dh_params() -> (o: SeverDhParamsCombinator)
    ensures o@ == spec_sever_dh_params(),
{
Mapped { inner: (opaque_1_ffff(), (opaque_1_ffff(), opaque_1_ffff())), mapper: SeverDhParamsMapper }}
...
pub open spec fn spec_key_share_client_hello_client_shares(l: SpecUint0Ffff) -> SpecKeyShareClientHelloClientSharesCombinator {
...
pub open spec fn spec_client_hello_extension_extension_data(extension_type: SpecExtensionType, ext_len: u16) -> SpecClientHelloExtensionExtensionDataCombinator {
...
Mapped { inner: (spec_content_type(), (spec_protocol_version(), spec_opaque_0_ffff())), mapper: TlsCiphertextMapper }}


pub fn tls_ciphertext() -> (o: TlsCiphertextCombinator)
    ensures o@ == spec_tls_ciphertext(),
{
Mapped { inner: (content_type(), (protocol_version(), opaque_0_ffff())), mapper: TlsCiphertextMapper }}
...
Mapped { inner: (spec_responder_id_list(), spec_ocsp_extensions()), mapper: OscpStatusRequestMapper }}
...
Mapped { inner: (Refined { inner: U8, predicate: TagPred(CERTIFICATESTATUSREQUEST_STATUS_TYPE) }, spec_oscp_status_request()), mapper: CertificateStatusRequestMapper }}

pub fn certificate_status_request() -> (o: CertificateStatusRequestCombinator)
    ensures o@ == spec_certificate_status_request(),
{
Mapped { inner: (Refined { inner: U8, predicate: TagPred(CERTIFICATESTATUSREQUEST_STATUS_TYPE) }, oscp_status_request()), mapper: CertificateStatusRequestMapper }}
...
pub fn sever_hello_extension_extension_data<'a>(extension_type: ExtensionType, ext_len: u16) -> (o: SeverHelloExtensionExtensionDataCombinator)
    ensures o@ == spec_sever_hello_extension_extension_data(extension_type@, ext_len@),
{
AndThen(Bytes(ext_len.ex_into()), Mapped { inner: OrdChoice(Cond { cond: extension_type == 0, inner: server_name_list() }, OrdChoice(Cond { cond: extension_type == 1, inner: max_fragment_length() }, OrdChoice(Cond { cond: extension_type == 5, inner: certificate_status_request() }, OrdChoice(Cond { cond: extension_type == 10, inner: named_group_list() }, OrdChoice(Cond { cond: extension_type == 11, inner: ec_point_format_list() }, OrdChoice(Cond { cond: extension_type == 13, inner: signature_scheme_list() }, OrdChoice(Cond { cond: extension_type == 14, inner: srtp_protection_profiles() }, OrdChoice(Cond { cond: extension_type == 15, inner: heartbeat_mode() }, OrdChoice(Cond { cond: extension_type == 16, inner: protocol_name_list() }, OrdChoice(Cond { cond: extension_type == 18, inner: signed_certificate_timestamp_list() }, OrdChoice(Cond { cond: extension_type == 19, inner: client_cert_type_client_extension() }, OrdChoice(Cond { cond: extension_type == 20, inner: server_cert_type_client_extension() }, OrdChoice(Cond { cond: extension_type == 21, inner: padding_extension() }, OrdChoice(Cond { cond: extension_type == 22, inner: empty() }, OrdChoice(Cond { cond: extension_type == 23, inner: empty() }, OrdChoice(Cond { cond: extension_type == 35, inner: session_ticket() }, OrdChoice(Cond { cond: extension_type == 41, inner: pre_shared_key_client_extension() }, OrdChoice(Cond { cond: extension_type == 42, inner: empty() }, OrdChoice(Cond { cond: extension_type == 43, inner: supported_versions_client() }, OrdChoice(Cond { cond: extension_type == 44, inner: cookie() }, OrdChoice(Cond { cond: extension_type == 45, inner: psk_key_exchange_modes() }, OrdChoice(Cond { cond: extension_type == 47, inner: certificate_authorities_extension() }, OrdChoice(Cond { cond: extension_type == 48, inner: oid_filter_extension() }, OrdChoice(Cond { cond: extension_type == 49, inner: empty() }, OrdChoice(Cond { cond: extension_type == 50, inner: signature_scheme_list() }, OrdChoice(Cond { cond: extension_type == 51, inner: key_share_client_hello() }, Cond { cond: !(extension_type == 0 || extension_type == 1 || extension_type == 5 || extension_type == 10 || extension_type == 11 || extension_type == 13 || extension_type == 14 || extension_type == 15 || extension_type == 16 || extension_type == 18 || extension_type == 19 || extension_type == 20 || extension_type == 21 || extension_type == 22 || extension_type == 23 || extension_type == 35 || extension_type == 41 || extension_type == 42 || extension_type == 43 || extension_type == 44 || extension_type == 45 || extension_type == 47 || extension_type == 48 || extension_type == 49 || extension_type == 50 || extension_type == 51), inner: unknown_extension() })))))))))))))))))))))))))), mapper: SeverHelloExtensionExtensionDataMapper })}
...
Mapped { inner: (Refined { inner: U8, predicate: TagPred(CERTIFICATESTATUS_STATUS_TYPE) }, spec_ocsp_response()), mapper: CertificateStatusMapper }}

pub fn certificate_status() -> (o: CertificateStatusCombinator)
    ensures o@ == spec_certificate_status(),
{
Mapped { inner: (Refined { inner: U8, predicate: TagPred(CERTIFICATESTATUS_STATUS_TYPE) }, ocsp_response()), mapper: CertificateStatusMapper }}
...
Mapped { inner: (spec_content_type(), (spec_protocol_version(), spec_opaque_0_ffff())), mapper: TlsPlaintextMapper }}


pub fn tls_plaintext() -> (o: TlsPlaintextCombinator)
    ensures o@ == spec_tls_plaintext(),
{
Mapped { inner: (content_type(), (protocol_version(), opaque_0_ffff())), mapper: TlsPlaintextMapper }}
...
pub fn serialize_uint_1_ffff(msg: Uint1Ffff, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_opaque_1_ffff(msg: Opaque1Ffff<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_psk_identity(msg: PskIdentity<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_psk_identities_identities(i: Seq<u8>, l: u16) -> Result<(usize, SpecPskIdentitiesIdentities), ()> {
    spec_psk_identities_identities(l).spec_parse(i)
}
pub open spec fn serialize_spec_psk_identities_identities(msg: SpecPskIdentitiesIdentities, l: u16) -> Result<Seq<u8>, ()> {
    spec_psk_identities_identities(l).spec_serialize(msg)
}
pub fn parse_psk_identities_identities(i: &[u8], l: u16) -> (o: Result<(usize, PskIdentitiesIdentities<'_>), ParseError>)
    ensures
...
pub fn serialize_psk_identities_identities(msg: PskIdentitiesIdentities<'_>, data: &mut Vec<u8>, pos: usize, l: u16) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_psk_identities(msg: PskIdentities<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_extension_type(msg: ExtensionType, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_uint_0_ffff(msg: Uint0Ffff, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_opaque_0_ffff(msg: Opaque0Ffff<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_extension(msg: Extension<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_client_extensions_extensions(i: Seq<u8>, l: u16) -> Result<(usize, SpecClientExtensionsExtensions), ()> {
    spec_client_extensions_extensions(l).spec_parse(i)
}
pub open spec fn serialize_spec_client_extensions_extensions(msg: SpecClientExtensionsExtensions, l: u16) -> Result<Seq<u8>, ()> {
    spec_client_extensions_extensions(l).spec_serialize(msg)
}
pub fn parse_client_extensions_extensions(i: &[u8], l: u16) -> (o: Result<(usize, ClientExtensionsExtensions<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_client_extensions_extensions(i@, l@) matches Ok(r_) && r@ == r_,
{
    client_extensions_extensions(l).parse(i)
}

pub fn serialize_client_extensions_extensions(msg: ClientExtensionsExtensions<'_>, data: &mut Vec<u8>, pos: usize, l: u16) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_responder_id(msg: ResponderId<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_responder_id_list_list(i: Seq<u8>, l: SpecUint0Ffff) -> Result<(usize, SpecResponderIdListList), ()> {
    spec_responder_id_list_list(l).spec_parse(i)
}
pub open spec fn serialize_spec_responder_id_list_list(msg: SpecResponderIdListList, l: SpecUint0Ffff) -> Result<Seq<u8>, ()> {
    spec_responder_id_list_list(l).spec_serialize(msg)
}
pub fn parse_responder_id_list_list(i: &[u8], l: Uint0Ffff) -> (o: Result<(usize, ResponderIdListList<'_>), ParseError>)
    ensures
...
pub fn serialize_responder_id_list_list(msg: ResponderIdListList<'_>, data: &mut Vec<u8>, pos: usize, l: Uint0Ffff) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_cookie(msg: Cookie<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_unknown_extension(i: Seq<u8>) -> Result<(usize, SpecUnknownExtension), ()> {
    spec_unknown_extension().spec_parse(i)
}
pub open spec fn serialize_spec_unknown_extension(msg: SpecUnknownExtension) -> Result<Seq<u8>, ()> {
...
pub fn serialize_unknown_extension(msg: UnknownExtension<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_client_extensions(i: Seq<u8>) -> Result<(usize, SpecClientExtensions), ()> {
    spec_client_extensions().spec_parse(i)
}
pub open spec fn serialize_spec_client_extensions(msg: SpecClientExtensions) -> Result<Seq<u8>, ()> {
...
pub fn serialize_client_extensions(msg: ClientExtensions<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_certificate_type(i: Seq<u8>) -> Result<(usize, SpecCertificateType), ()> {
...
pub fn serialize_certificate_type(msg: CertificateType, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_server_cert_type_client_extension_types(i: Seq<u8>, l: SpecUint1Ff) -> Result<(usize, SpecServerCertTypeClientExtensionTypes), ()> {
    spec_server_cert_type_client_extension_types(l).spec_parse(i)
}
pub open spec fn serialize_spec_server_cert_type_client_extension_types(msg: SpecServerCertTypeClientExtensionTypes, l: SpecUint1Ff) -> Result<Seq<u8>, ()> {
    spec_server_cert_type_client_extension_types(l).spec_serialize(msg)
}
pub fn parse_server_cert_type_client_extension_types(i: &[u8], l: Uint1Ff) -> (o: Result<(usize, ServerCertTypeClientExtensionTypes), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_server_cert_type_client_extension_types(i@, l@) matches Ok(r_) && r@ == r_,
{
    server_cert_type_client_extension_types(l).parse(i)
}

pub fn serialize_server_cert_type_client_extension_types(msg: ServerCertTypeClientExtensionTypes, data: &mut Vec<u8>, pos: usize, l: Uint1Ff) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_session_ticket(msg: SessionTicket<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_name_type(msg: NameType, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_host_name(msg: HostName<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_unknown_name(msg: UnknownName<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_server_name_name(i: Seq<u8>, name_type: SpecNameType) -> Result<(usize, SpecServerNameName), ()> {
    spec_server_name_name(name_type).spec_parse(i)
}
pub open spec fn serialize_spec_server_name_name(msg: SpecServerNameName, name_type: SpecNameType) -> Result<Seq<u8>, ()> {
    spec_server_name_name(name_type).spec_serialize(msg)
}
pub fn parse_server_name_name(i: &[u8], name_type: NameType) -> (o: Result<(usize, ServerNameName<'_>), ParseError>)
    ensures
...
pub fn serialize_server_name_name(msg: ServerNameName<'_>, data: &mut Vec<u8>, pos: usize, name_type: NameType) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_server_name(msg: ServerName<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_uint_1_ff(msg: Uint1Ff, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_opaque_1_ff(msg: Opaque1Ff<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_client_cert_type_server_extension(i: Seq<u8>) -> Result<(usize, SpecClientCertTypeServerExtension), ()> {
    spec_client_cert_type_server_extension().spec_parse(i)
}
pub open spec fn serialize_spec_client_cert_type_server_extension(msg: SpecClientCertTypeServerExtension) -> Result<Seq<u8>, ()> {
    spec_client_cert_type_server_extension().spec_serialize(msg)
}
pub fn parse_client_cert_type_server_extension(i: &[u8]) -> (o: Result<(usize, ClientCertTypeServerExtension), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_client_cert_type_server_extension(i@) matches Ok(r_) && r@ == r_,
{
    client_cert_type_server_extension().parse(i)
}

pub fn serialize_client_cert_type_server_extension(msg: ClientCertTypeServerExtension, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_protocol_version(i: Seq<u8>) -> Result<(usize, SpecProtocolVersion), ()> {
...
pub fn serialize_protocol_version(msg: ProtocolVersion, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_random(msg: Random<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_session_id(msg: SessionId<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_uint_2_fffe(msg: Uint2Fffe, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_cipher_suite(msg: CipherSuite, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_cipher_suite_list_list(i: Seq<u8>, l: SpecUint2Fffe) -> Result<(usize, SpecCipherSuiteListList), ()> {
    spec_cipher_suite_list_list(l).spec_parse(i)
}
pub open spec fn serialize_spec_cipher_suite_list_list(msg: SpecCipherSuiteListList, l: SpecUint2Fffe) -> Result<Seq<u8>, ()> {
    spec_cipher_suite_list_list(l).spec_serialize(msg)
}
pub fn parse_cipher_suite_list_list(i: &[u8], l: Uint2Fffe) -> (o: Result<(usize, CipherSuiteListList), ParseError>)
    ensures
...
pub fn serialize_cipher_suite_list_list(msg: CipherSuiteListList, data: &mut Vec<u8>, pos: usize, l: Uint2Fffe) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_cipher_suite_list(i: Seq<u8>) -> Result<(usize, SpecCipherSuiteList), ()> {
...
pub fn serialize_cipher_suite_list(msg: CipherSuiteList, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_client_hello(msg: ClientHello<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_server_extensions_extensions(i: Seq<u8>, l: u16) -> Result<(usize, SpecServerExtensionsExtensions), ()> {
    spec_server_extensions_extensions(l).spec_parse(i)
}
pub open spec fn serialize_spec_server_extensions_extensions(msg: SpecServerExtensionsExtensions, l: u16) -> Result<Seq<u8>, ()> {
    spec_server_extensions_extensions(l).spec_serialize(msg)
}
pub fn parse_server_extensions_extensions(i: &[u8], l: u16) -> (o: Result<(usize, ServerExtensionsExtensions<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_server_extensions_extensions(i@, l@) matches Ok(r_) && r@ == r_,
{
    server_extensions_extensions(l).parse(i)
}

pub fn serialize_server_extensions_extensions(msg: ServerExtensionsExtensions<'_>, data: &mut Vec<u8>, pos: usize, l: u16) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_server_extensions(i: Seq<u8>) -> Result<(usize, SpecServerExtensions), ()> {
    spec_server_extensions().spec_parse(i)
}
pub open spec fn serialize_spec_server_extensions(msg: SpecServerExtensions) -> Result<Seq<u8>, ()> {
...
pub fn serialize_server_extensions(msg: ServerExtensions<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_server_hello(msg: ServerHello<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_uint_0_ff(msg: Uint0Ff, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_opaque_0_ff(msg: Opaque0Ff<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_uint_0_fffe(msg: Uint0Fffe, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_new_session_ticket_extensions_extensions(i: Seq<u8>, l: SpecUint0Fffe) -> Result<(usize, SpecNewSessionTicketExtensionsExtensions), ()> {
    spec_new_session_ticket_extensions_extensions(l).spec_parse(i)
}
pub open spec fn serialize_spec_new_session_ticket_extensions_extensions(msg: SpecNewSessionTicketExtensionsExtensions, l: SpecUint0Fffe) -> Result<Seq<u8>, ()> {
    spec_new_session_ticket_extensions_extensions(l).spec_serialize(msg)
}
pub fn parse_new_session_ticket_extensions_extensions(i: &[u8], l: Uint0Fffe) -> (o: Result<(usize, NewSessionTicketExtensionsExtensions<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_new_session_ticket_extensions_extensions(i@, l@) matches Ok(r_) && r@ == r_,
{
    new_session_ticket_extensions_extensions(l).parse(i)
}

pub fn serialize_new_session_ticket_extensions_extensions(msg: NewSessionTicketExtensionsExtensions<'_>, data: &mut Vec<u8>, pos: usize, l: Uint0Fffe) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_new_session_ticket_extensions(i: Seq<u8>) -> Result<(usize, SpecNewSessionTicketExtensions), ()> {
    spec_new_session_ticket_extensions().spec_parse(i)
}
pub open spec fn serialize_spec_new_session_ticket_extensions(msg: SpecNewSessionTicketExtensions) -> Result<Seq<u8>, ()> {
    spec_new_session_ticket_extensions().spec_serialize(msg)
}
pub fn parse_new_session_ticket_extensions(i: &[u8]) -> (o: Result<(usize, NewSessionTicketExtensions<'_>), ParseError>)
    ensures
...
pub fn serialize_new_session_ticket_extensions(msg: NewSessionTicketExtensions<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_new_session_ticket(i: Seq<u8>) -> Result<(usize, SpecNewSessionTicket), ()> {
    spec_new_session_ticket().spec_parse(i)
}
pub open spec fn serialize_spec_new_session_ticket(msg: SpecNewSessionTicket) -> Result<Seq<u8>, ()> {
...
pub fn serialize_new_session_ticket(msg: NewSessionTicket<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_empty(msg: Empty<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_encrypted_extensions_extensions(i: Seq<u8>, l: SpecUint0Ffff) -> Result<(usize, SpecEncryptedExtensionsExtensions), ()> {
    spec_encrypted_extensions_extensions(l).spec_parse(i)
}
pub open spec fn serialize_spec_encrypted_extensions_extensions(msg: SpecEncryptedExtensionsExtensions, l: SpecUint0Ffff) -> Result<Seq<u8>, ()> {
    spec_encrypted_extensions_extensions(l).spec_serialize(msg)
}
pub fn parse_encrypted_extensions_extensions(i: &[u8], l: Uint0Ffff) -> (o: Result<(usize, EncryptedExtensionsExtensions<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_encrypted_extensions_extensions(i@, l@) matches Ok(r_) && r@ == r_,
{
    encrypted_extensions_extensions(l).parse(i)
}

pub fn serialize_encrypted_extensions_extensions(msg: EncryptedExtensionsExtensions<'_>, data: &mut Vec<u8>, pos: usize, l: Uint0Ffff) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_encrypted_extensions(i: Seq<u8>) -> Result<(usize, SpecEncryptedExtensions), ()> {
    spec_encrypted_extensions().spec_parse(i)
}
pub open spec fn serialize_spec_encrypted_extensions(msg: SpecEncryptedExtensions) -> Result<Seq<u8>, ()> {
    spec_encrypted_extensions().spec_serialize(msg)
}
pub fn parse_encrypted_extensions(i: &[u8]) -> (o: Result<(usize, EncryptedExtensions<'_>), ParseError>)
    ensures
...
pub fn serialize_encrypted_extensions(msg: EncryptedExtensions<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_opaque_1_ffffff(msg: Opaque1Ffffff<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_certificate_extensions(i: Seq<u8>) -> Result<(usize, SpecCertificateExtensions), ()> {
    spec_certificate_extensions().spec_parse(i)
}
pub open spec fn serialize_spec_certificate_extensions(msg: SpecCertificateExtensions) -> Result<Seq<u8>, ()> {
    spec_certificate_extensions().spec_serialize(msg)
}
pub fn parse_certificate_extensions(i: &[u8]) -> (o: Result<(usize, CertificateExtensions<'_>), ParseError>)
    ensures
...
pub fn serialize_certificate_extensions(msg: CertificateExtensions<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_certificate_entry(i: Seq<u8>) -> Result<(usize, SpecCertificateEntry), ()> {
    spec_certificate_entry().spec_parse(i)
}
pub open spec fn serialize_spec_certificate_entry(msg: SpecCertificateEntry) -> Result<Seq<u8>, ()> {
...
pub fn serialize_certificate_entry(msg: CertificateEntry<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_certificate_list_list(i: Seq<u8>, l: u24) -> Result<(usize, SpecCertificateListList), ()> {
    spec_certificate_list_list(l).spec_parse(i)
}
pub open spec fn serialize_spec_certificate_list_list(msg: SpecCertificateListList, l: u24) -> Result<Seq<u8>, ()> {
    spec_certificate_list_list(l).spec_serialize(msg)
}
pub fn parse_certificate_list_list(i: &[u8], l: u24) -> (o: Result<(usize, CertificateListList<'_>), ParseError>)
    ensures
...
pub fn serialize_certificate_list_list(msg: CertificateListList<'_>, data: &mut Vec<u8>, pos: usize, l: u24) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_certificate_list(i: Seq<u8>) -> Result<(usize, SpecCertificateList), ()> {
...
pub fn serialize_certificate_list(msg: CertificateList<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_certificate(msg: Certificate<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_uint_2_ffff(msg: Uint2Ffff, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_certificate_request_extensions_extensions(i: Seq<u8>, l: SpecUint2Ffff) -> Result<(usize, SpecCertificateRequestExtensionsExtensions), ()> {
    spec_certificate_request_extensions_extensions(l).spec_parse(i)
}
pub open spec fn serialize_spec_certificate_request_extensions_extensions(msg: SpecCertificateRequestExtensionsExtensions, l: SpecUint2Ffff) -> Result<Seq<u8>, ()> {
    spec_certificate_request_extensions_extensions(l).spec_serialize(msg)
}
pub fn parse_certificate_request_extensions_extensions(i: &[u8], l: Uint2Ffff) -> (o: Result<(usize, CertificateRequestExtensionsExtensions<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_certificate_request_extensions_extensions(i@, l@) matches Ok(r_) && r@ == r_,
{
    certificate_request_extensions_extensions(l).parse(i)
}

pub fn serialize_certificate_request_extensions_extensions(msg: CertificateRequestExtensionsExtensions<'_>, data: &mut Vec<u8>, pos: usize, l: Uint2Ffff) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_certificate_request_extensions(i: Seq<u8>) -> Result<(usize, SpecCertificateRequestExtensions), ()> {
    spec_certificate_request_extensions().spec_parse(i)
}
pub open spec fn serialize_spec_certificate_request_extensions(msg: SpecCertificateRequestExtensions) -> Result<Seq<u8>, ()> {
    spec_certificate_request_extensions().spec_serialize(msg)
}
pub fn parse_certificate_request_extensions(i: &[u8]) -> (o: Result<(usize, CertificateRequestExtensions<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_certificate_request_extensions(i@) matches Ok(r_) && r@ == r_,
{
    certificate_request_extensions().parse(i)
}

pub fn serialize_certificate_request_extensions(msg: CertificateRequestExtensions<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_certificate_request(i: Seq<u8>) -> Result<(usize, SpecCertificateRequest), ()> {
    spec_certificate_request().spec_parse(i)
}
pub open spec fn serialize_spec_certificate_request(msg: SpecCertificateRequest) -> Result<Seq<u8>, ()> {
    spec_certificate_request().spec_serialize(msg)
}
pub fn parse_certificate_request(i: &[u8]) -> (o: Result<(usize, CertificateRequest<'_>), ParseError>)
    ensures
...
pub fn serialize_certificate_request(msg: CertificateRequest<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_signature_scheme(i: Seq<u8>) -> Result<(usize, SpecSignatureScheme), ()> {
...
pub fn serialize_signature_scheme(msg: SignatureScheme, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_certificate_verify(i: Seq<u8>) -> Result<(usize, SpecCertificateVerify), ()> {
    spec_certificate_verify().spec_parse(i)
}
pub open spec fn serialize_spec_certificate_verify(msg: SpecCertificateVerify) -> Result<Seq<u8>, ()> {
...
pub fn serialize_certificate_verify(msg: CertificateVerify<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_finished(i: Seq<u8>, digest_size: u24) -> Result<(usize, SpecFinished), ()> {
    spec_finished(digest_size).spec_parse(i)
}
pub open spec fn serialize_spec_finished(msg: SpecFinished, digest_size: u24) -> Result<Seq<u8>, ()> {
...
pub fn serialize_finished(msg: Finished<'_>, data: &mut Vec<u8>, pos: usize, digest_size: u24) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_key_update_request(i: Seq<u8>) -> Result<(usize, SpecKeyUpdateRequest), ()> {
    spec_key_update_request().spec_parse(i)
}
pub open spec fn serialize_spec_key_update_request(msg: SpecKeyUpdateRequest) -> Result<Seq<u8>, ()> {
...
pub fn serialize_key_update_request(msg: KeyUpdateRequest, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_key_update(msg: KeyUpdate, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_handshake_msg(i: Seq<u8>, msg_type: SpecHandshakeType, length: u24) -> Result<(usize, SpecHandshakeMsg), ()> {
    spec_handshake_msg(msg_type, length).spec_parse(i)
}
pub open spec fn serialize_spec_handshake_msg(msg: SpecHandshakeMsg, msg_type: SpecHandshakeType, length: u24) -> Result<Seq<u8>, ()> {
    spec_handshake_msg(msg_type, length).spec_serialize(msg)
}
pub fn parse_handshake_msg(i: &[u8], msg_type: HandshakeType, length: u24) -> (o: Result<(usize, HandshakeMsg<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_handshake_msg(i@, msg_type@, length@) matches Ok(r_) && r@ == r_,
{
    handshake_msg(msg_type, length).parse(i)
}

pub fn serialize_handshake_msg(msg: HandshakeMsg<'_>, data: &mut Vec<u8>, pos: usize, msg_type: HandshakeType, length: u24) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_content_type(msg: ContentType, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_psk_binder_entry(i: Seq<u8>) -> Result<(usize, SpecPskBinderEntry), ()> {
...
pub fn serialize_psk_binder_entry(msg: PskBinderEntry<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_psk_binder_entries_binders(i: Seq<u8>, l: u16) -> Result<(usize, SpecPskBinderEntriesBinders), ()> {
    spec_psk_binder_entries_binders(l).spec_parse(i)
}
pub open spec fn serialize_spec_psk_binder_entries_binders(msg: SpecPskBinderEntriesBinders, l: u16) -> Result<Seq<u8>, ()> {
    spec_psk_binder_entries_binders(l).spec_serialize(msg)
}
pub fn parse_psk_binder_entries_binders(i: &[u8], l: u16) -> (o: Result<(usize, PskBinderEntriesBinders<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_psk_binder_entries_binders(i@, l@) matches Ok(r_) && r@ == r_,
{
    psk_binder_entries_binders(l).parse(i)
}

pub fn serialize_psk_binder_entries_binders(msg: PskBinderEntriesBinders<'_>, data: &mut Vec<u8>, pos: usize, l: u16) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_heartbeat_mode(msg: HeartbeatMode, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_ocsp_extensions(msg: OcspExtensions<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_supported_versions_client_versions(i: Seq<u8>, l: u8) -> Result<(usize, SpecSupportedVersionsClientVersions), ()> {
    spec_supported_versions_client_versions(l).spec_parse(i)
}
pub open spec fn serialize_spec_supported_versions_client_versions(msg: SpecSupportedVersionsClientVersions, l: u8) -> Result<Seq<u8>, ()> {
    spec_supported_versions_client_versions(l).spec_serialize(msg)
}
pub fn parse_supported_versions_client_versions(i: &[u8], l: u8) -> (o: Result<(usize, SupportedVersionsClientVersions), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_supported_versions_client_versions(i@, l@) matches Ok(r_) && r@ == r_,
{
    supported_versions_client_versions(l).parse(i)
}

pub fn serialize_supported_versions_client_versions(msg: SupportedVersionsClientVersions, data: &mut Vec<u8>, pos: usize, l: u8) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_supported_versions_client(i: Seq<u8>) -> Result<(usize, SpecSupportedVersionsClient), ()> {
    spec_supported_versions_client().spec_parse(i)
}
pub open spec fn serialize_spec_supported_versions_client(msg: SpecSupportedVersionsClient) -> Result<Seq<u8>, ()> {
    spec_supported_versions_client().spec_serialize(msg)
}
pub fn parse_supported_versions_client(i: &[u8]) -> (o: Result<(usize, SupportedVersionsClient), ParseError>)
    ensures
...
pub fn serialize_supported_versions_client(msg: SupportedVersionsClient, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_heartbeat_extension(i: Seq<u8>) -> Result<(usize, SpecHeartbeatExtension), ()> {
    spec_heartbeat_extension().spec_parse(i)
}
pub open spec fn serialize_spec_heartbeat_extension(msg: SpecHeartbeatExtension) -> Result<Seq<u8>, ()> {
...
pub fn serialize_heartbeat_extension(msg: HeartbeatExtension, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_protocol_name(msg: ProtocolName<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_protocol_name_list_list(i: Seq<u8>, l: SpecUint2Ffff) -> Result<(usize, SpecProtocolNameListList), ()> {
    spec_protocol_name_list_list(l).spec_parse(i)
}
pub open spec fn serialize_spec_protocol_name_list_list(msg: SpecProtocolNameListList, l: SpecUint2Ffff) -> Result<Seq<u8>, ()> {
    spec_protocol_name_list_list(l).spec_serialize(msg)
}
pub fn parse_protocol_name_list_list(i: &[u8], l: Uint2Ffff) -> (o: Result<(usize, ProtocolNameListList<'_>), ParseError>)
    ensures
...
pub fn serialize_protocol_name_list_list(msg: ProtocolNameListList<'_>, data: &mut Vec<u8>, pos: usize, l: Uint2Ffff) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_protocol_name_list(i: Seq<u8>) -> Result<(usize, SpecProtocolNameList), ()> {
    spec_protocol_name_list().spec_parse(i)
}
pub open spec fn serialize_spec_protocol_name_list(msg: SpecProtocolNameList) -> Result<Seq<u8>, ()> {
...
pub fn serialize_protocol_name_list(msg: ProtocolNameList<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_supported_versions_server(i: Seq<u8>) -> Result<(usize, SpecSupportedVersionsServer), ()> {
    spec_supported_versions_server().spec_parse(i)
}
pub open spec fn serialize_spec_supported_versions_server(msg: SpecSupportedVersionsServer) -> Result<Seq<u8>, ()> {
    spec_supported_versions_server().spec_serialize(msg)
}
pub fn parse_supported_versions_server(i: &[u8]) -> (o: Result<(usize, SupportedVersionsServer), ParseError>)
    ensures
...
pub fn serialize_supported_versions_server(msg: SupportedVersionsServer, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_max_fragment_length(i: Seq<u8>) -> Result<(usize, SpecMaxFragmentLength), ()> {
    spec_max_fragment_length().spec_parse(i)
}
pub open spec fn serialize_spec_max_fragment_length(msg: SpecMaxFragmentLength) -> Result<Seq<u8>, ()> {
...
pub fn serialize_max_fragment_length(msg: MaxFragmentLength, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_ec_point_format(msg: EcPointFormat, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_ec_point_format_list_list(i: Seq<u8>, l: SpecUint1Ff) -> Result<(usize, SpecEcPointFormatListList), ()> {
    spec_ec_point_format_list_list(l).spec_parse(i)
}
pub open spec fn serialize_spec_ec_point_format_list_list(msg: SpecEcPointFormatListList, l: SpecUint1Ff) -> Result<Seq<u8>, ()> {
    spec_ec_point_format_list_list(l).spec_serialize(msg)
}
pub fn parse_ec_point_format_list_list(i: &[u8], l: Uint1Ff) -> (o: Result<(usize, EcPointFormatListList), ParseError>)
    ensures
...
pub fn serialize_ec_point_format_list_list(msg: EcPointFormatListList, data: &mut Vec<u8>, pos: usize, l: Uint1Ff) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_ec_point_format_list(i: Seq<u8>) -> Result<(usize, SpecEcPointFormatList), ()> {
    spec_ec_point_format_list().spec_parse(i)
}
pub open spec fn serialize_spec_ec_point_format_list(msg: SpecEcPointFormatList) -> Result<Seq<u8>, ()> {
...
pub fn serialize_ec_point_format_list(msg: EcPointFormatList, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_srtp_protection_profile(i: Seq<u8>) -> Result<(usize, SpecSrtpProtectionProfile), ()> {
    spec_srtp_protection_profile().spec_parse(i)
}
pub open spec fn serialize_spec_srtp_protection_profile(msg: SpecSrtpProtectionProfile) -> Result<Seq<u8>, ()> {
    spec_srtp_protection_profile().spec_serialize(msg)
}
pub fn parse_srtp_protection_profile(i: &[u8]) -> (o: Result<(usize, SrtpProtectionProfile<'_>), ParseError>)
    ensures
...
pub fn serialize_srtp_protection_profile(msg: SrtpProtectionProfile<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_srtp_protection_profiles_list(i: Seq<u8>, l: SpecUint2Ffff) -> Result<(usize, SpecSrtpProtectionProfilesList), ()> {
    spec_srtp_protection_profiles_list(l).spec_parse(i)
}
pub open spec fn serialize_spec_srtp_protection_profiles_list(msg: SpecSrtpProtectionProfilesList, l: SpecUint2Ffff) -> Result<Seq<u8>, ()> {
    spec_srtp_protection_profiles_list(l).spec_serialize(msg)
}
pub fn parse_srtp_protection_profiles_list(i: &[u8], l: Uint2Ffff) -> (o: Result<(usize, SrtpProtectionProfilesList<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_srtp_protection_profiles_list(i@, l@) matches Ok(r_) && r@ == r_,
{
    srtp_protection_profiles_list(l).parse(i)
}

pub fn serialize_srtp_protection_profiles_list(msg: SrtpProtectionProfilesList<'_>, data: &mut Vec<u8>, pos: usize, l: Uint2Ffff) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_srtp_protection_profiles(i: Seq<u8>) -> Result<(usize, SpecSrtpProtectionProfiles), ()> {
    spec_srtp_protection_profiles().spec_parse(i)
}
pub open spec fn serialize_spec_srtp_protection_profiles(msg: SpecSrtpProtectionProfiles) -> Result<Seq<u8>, ()> {
    spec_srtp_protection_profiles().spec_serialize(msg)
}
pub fn parse_srtp_protection_profiles(i: &[u8]) -> (o: Result<(usize, SrtpProtectionProfiles<'_>), ParseError>)
    ensures
...
pub fn serialize_srtp_protection_profiles(msg: SrtpProtectionProfiles<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_use_srtp_data(msg: UseSrtpData<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_serialized_sct(msg: SerializedSct<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_signed_certificate_timestamp_list_list(i: Seq<u8>, l: SpecUint1Ffff) -> Result<(usize, SpecSignedCertificateTimestampListList), ()> {
    spec_signed_certificate_timestamp_list_list(l).spec_parse(i)
}
pub open spec fn serialize_spec_signed_certificate_timestamp_list_list(msg: SpecSignedCertificateTimestampListList, l: SpecUint1Ffff) -> Result<Seq<u8>, ()> {
    spec_signed_certificate_timestamp_list_list(l).spec_serialize(msg)
}
pub fn parse_signed_certificate_timestamp_list_list(i: &[u8], l: Uint1Ffff) -> (o: Result<(usize, SignedCertificateTimestampListList<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_signed_certificate_timestamp_list_list(i@, l@) matches Ok(r_) && r@ == r_,
{
    signed_certificate_timestamp_list_list(l).parse(i)
}

pub fn serialize_signed_certificate_timestamp_list_list(msg: SignedCertificateTimestampListList<'_>, data: &mut Vec<u8>, pos: usize, l: Uint1Ffff) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_signed_certificate_timestamp_list(i: Seq<u8>) -> Result<(usize, SpecSignedCertificateTimestampList), ()> {
    spec_signed_certificate_timestamp_list().spec_parse(i)
}
pub open spec fn serialize_spec_signed_certificate_timestamp_list(msg: SpecSignedCertificateTimestampList) -> Result<Seq<u8>, ()> {
    spec_signed_certificate_timestamp_list().spec_serialize(msg)
}
pub fn parse_signed_certificate_timestamp_list(i: &[u8]) -> (o: Result<(usize, SignedCertificateTimestampList<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_signed_certificate_timestamp_list(i@) matches Ok(r_) && r@ == r_,
{
    signed_certificate_timestamp_list().parse(i)
}

pub fn serialize_signed_certificate_timestamp_list(msg: SignedCertificateTimestampList<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_client_cert_type_client_extension_types(i: Seq<u8>, l: SpecUint1Ff) -> Result<(usize, SpecClientCertTypeClientExtensionTypes), ()> {
    spec_client_cert_type_client_extension_types(l).spec_parse(i)
}
pub open spec fn serialize_spec_client_cert_type_client_extension_types(msg: SpecClientCertTypeClientExtensionTypes, l: SpecUint1Ff) -> Result<Seq<u8>, ()> {
    spec_client_cert_type_client_extension_types(l).spec_serialize(msg)
}
pub fn parse_client_cert_type_client_extension_types(i: &[u8], l: Uint1Ff) -> (o: Result<(usize, ClientCertTypeClientExtensionTypes), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_client_cert_type_client_extension_types(i@, l@) matches Ok(r_) && r@ == r_,
{
    client_cert_type_client_extension_types(l).parse(i)
}

pub fn serialize_client_cert_type_client_extension_types(msg: ClientCertTypeClientExtensionTypes, data: &mut Vec<u8>, pos: usize, l: Uint1Ff) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_client_cert_type_client_extension(i: Seq<u8>) -> Result<(usize, SpecClientCertTypeClientExtension), ()> {
    spec_client_cert_type_client_extension().spec_parse(i)
}
pub open spec fn serialize_spec_client_cert_type_client_extension(msg: SpecClientCertTypeClientExtension) -> Result<Seq<u8>, ()> {
    spec_client_cert_type_client_extension().spec_serialize(msg)
}
pub fn parse_client_cert_type_client_extension(i: &[u8]) -> (o: Result<(usize, ClientCertTypeClientExtension), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_client_cert_type_client_extension(i@) matches Ok(r_) && r@ == r_,
{
    client_cert_type_client_extension().parse(i)
}

pub fn serialize_client_cert_type_client_extension(msg: ClientCertTypeClientExtension, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_server_cert_type_client_extension(i: Seq<u8>) -> Result<(usize, SpecServerCertTypeClientExtension), ()> {
    spec_server_cert_type_client_extension().spec_parse(i)
}
pub open spec fn serialize_spec_server_cert_type_client_extension(msg: SpecServerCertTypeClientExtension) -> Result<Seq<u8>, ()> {
    spec_server_cert_type_client_extension().spec_serialize(msg)
}
pub fn parse_server_cert_type_client_extension(i: &[u8]) -> (o: Result<(usize, ServerCertTypeClientExtension), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_server_cert_type_client_extension(i@) matches Ok(r_) && r@ == r_,
{
    server_cert_type_client_extension().parse(i)
}

pub fn serialize_server_cert_type_client_extension(msg: ServerCertTypeClientExtension, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_zero_byte(msg: ZeroByte, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_padding_extension_padding(i: Seq<u8>, l: SpecUint0Ffff) -> Result<(usize, SpecPaddingExtensionPadding), ()> {
    spec_padding_extension_padding(l).spec_parse(i)
}
pub open spec fn serialize_spec_padding_extension_padding(msg: SpecPaddingExtensionPadding, l: SpecUint0Ffff) -> Result<Seq<u8>, ()> {
    spec_padding_extension_padding(l).spec_serialize(msg)
}
pub fn parse_padding_extension_padding(i: &[u8], l: Uint0Ffff) -> (o: Result<(usize, PaddingExtensionPadding), ParseError>)
    ensures
...
pub fn serialize_padding_extension_padding(msg: PaddingExtensionPadding, data: &mut Vec<u8>, pos: usize, l: Uint0Ffff) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_padding_extension(i: Seq<u8>) -> Result<(usize, SpecPaddingExtension), ()> {
    spec_padding_extension().spec_parse(i)
}
pub open spec fn serialize_spec_padding_extension(msg: SpecPaddingExtension) -> Result<Seq<u8>, ()> {
...
pub fn serialize_padding_extension(msg: PaddingExtension, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_psk_binder_entries(i: Seq<u8>) -> Result<(usize, SpecPskBinderEntries), ()> {
    spec_psk_binder_entries().spec_parse(i)
}
pub open spec fn serialize_spec_psk_binder_entries(msg: SpecPskBinderEntries) -> Result<Seq<u8>, ()> {
...
pub fn serialize_psk_binder_entries(msg: PskBinderEntries<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_offered_psks(msg: OfferedPsks<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_pre_shared_key_client_extension(i: Seq<u8>) -> Result<(usize, SpecPreSharedKeyClientExtension), ()> {
    spec_pre_shared_key_client_extension().spec_parse(i)
}
pub open spec fn serialize_spec_pre_shared_key_client_extension(msg: SpecPreSharedKeyClientExtension) -> Result<Seq<u8>, ()> {
    spec_pre_shared_key_client_extension().spec_serialize(msg)
}
pub fn parse_pre_shared_key_client_extension(i: &[u8]) -> (o: Result<(usize, PreSharedKeyClientExtension<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_pre_shared_key_client_extension(i@) matches Ok(r_) && r@ == r_,
{
    pre_shared_key_client_extension().parse(i)
}

pub fn serialize_pre_shared_key_client_extension(msg: PreSharedKeyClientExtension<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_psk_key_exchange_mode(i: Seq<u8>) -> Result<(usize, SpecPskKeyExchangeMode), ()> {
    spec_psk_key_exchange_mode().spec_parse(i)
}
pub open spec fn serialize_spec_psk_key_exchange_mode(msg: SpecPskKeyExchangeMode) -> Result<Seq<u8>, ()> {
...
pub fn serialize_psk_key_exchange_mode(msg: PskKeyExchangeMode, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_psk_key_exchange_modes_modes(i: Seq<u8>, l: SpecUint1Ff) -> Result<(usize, SpecPskKeyExchangeModesModes), ()> {
    spec_psk_key_exchange_modes_modes(l).spec_parse(i)
}
pub open spec fn serialize_spec_psk_key_exchange_modes_modes(msg: SpecPskKeyExchangeModesModes, l: SpecUint1Ff) -> Result<Seq<u8>, ()> {
    spec_psk_key_exchange_modes_modes(l).spec_serialize(msg)
}
pub fn parse_psk_key_exchange_modes_modes(i: &[u8], l: Uint1Ff) -> (o: Result<(usize, PskKeyExchangeModesModes), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_psk_key_exchange_modes_modes(i@, l@) matches Ok(r_) && r@ == r_,
{
    psk_key_exchange_modes_modes(l).parse(i)
}

pub fn serialize_psk_key_exchange_modes_modes(msg: PskKeyExchangeModesModes, data: &mut Vec<u8>, pos: usize, l: Uint1Ff) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_psk_key_exchange_modes(i: Seq<u8>) -> Result<(usize, SpecPskKeyExchangeModes), ()> {
    spec_psk_key_exchange_modes().spec_parse(i)
}
pub open spec fn serialize_spec_psk_key_exchange_modes(msg: SpecPskKeyExchangeModes) -> Result<Seq<u8>, ()> {
    spec_psk_key_exchange_modes().spec_serialize(msg)
}
pub fn parse_psk_key_exchange_modes(i: &[u8]) -> (o: Result<(usize, PskKeyExchangeModes), ParseError>)
    ensures
...
pub fn serialize_psk_key_exchange_modes(msg: PskKeyExchangeModes, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_distinguished_name(i: Seq<u8>) -> Result<(usize, SpecDistinguishedName), ()> {
    spec_distinguished_name().spec_parse(i)
}
pub open spec fn serialize_spec_distinguished_name(msg: SpecDistinguishedName) -> Result<Seq<u8>, ()> {
...
pub fn serialize_distinguished_name(msg: DistinguishedName<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_certificate_authorities_extension_authorities(i: Seq<u8>, l: u16) -> Result<(usize, SpecCertificateAuthoritiesExtensionAuthorities), ()> {
    spec_certificate_authorities_extension_authorities(l).spec_parse(i)
}
pub open spec fn serialize_spec_certificate_authorities_extension_authorities(msg: SpecCertificateAuthoritiesExtensionAuthorities, l: u16) -> Result<Seq<u8>, ()> {
    spec_certificate_authorities_extension_authorities(l).spec_serialize(msg)
}
pub fn parse_certificate_authorities_extension_authorities(i: &[u8], l: u16) -> (o: Result<(usize, CertificateAuthoritiesExtensionAuthorities<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_certificate_authorities_extension_authorities(i@, l@) matches Ok(r_) && r@ == r_,
{
    certificate_authorities_extension_authorities(l).parse(i)
}

pub fn serialize_certificate_authorities_extension_authorities(msg: CertificateAuthoritiesExtensionAuthorities<'_>, data: &mut Vec<u8>, pos: usize, l: u16) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
            &&& serialize_spec_certificate_authorities_extension_authorities(msg@, l@) matches Ok(buf)
            &&& n == buf.len() && data@ == seq_splice(old(data)@, pos, buf)
        },
{
    certificate_authorities_extension_authorities(l).serialize(msg, data, pos)
}
pub open spec fn parse_spec_certificate_authorities_extension(i: Seq<u8>) -> Result<(usize, SpecCertificateAuthoritiesExtension), ()> {
    spec_certificate_authorities_extension().spec_parse(i)
}
pub open spec fn serialize_spec_certificate_authorities_extension(msg: SpecCertificateAuthoritiesExtension) -> Result<Seq<u8>, ()> {
    spec_certificate_authorities_extension().spec_serialize(msg)
}
pub fn parse_certificate_authorities_extension(i: &[u8]) -> (o: Result<(usize, CertificateAuthoritiesExtension<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_certificate_authorities_extension(i@) matches Ok(r_) && r@ == r_,
{
    certificate_authorities_extension().parse(i)
}

pub fn serialize_certificate_authorities_extension(msg: CertificateAuthoritiesExtension<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_oid_filter(msg: OidFilter<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_oid_filter_extension_filters(i: Seq<u8>, l: SpecUint0Ffff) -> Result<(usize, SpecOidFilterExtensionFilters), ()> {
    spec_oid_filter_extension_filters(l).spec_parse(i)
}
pub open spec fn serialize_spec_oid_filter_extension_filters(msg: SpecOidFilterExtensionFilters, l: SpecUint0Ffff) -> Result<Seq<u8>, ()> {
    spec_oid_filter_extension_filters(l).spec_serialize(msg)
}
pub fn parse_oid_filter_extension_filters(i: &[u8], l: Uint0Ffff) -> (o: Result<(usize, OidFilterExtensionFilters<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_oid_filter_extension_filters(i@, l@) matches Ok(r_) && r@ == r_,
{
    oid_filter_extension_filters(l).parse(i)
}

pub fn serialize_oid_filter_extension_filters(msg: OidFilterExtensionFilters<'_>, data: &mut Vec<u8>, pos: usize, l: Uint0Ffff) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_oid_filter_extension(i: Seq<u8>) -> Result<(usize, SpecOidFilterExtension), ()> {
    spec_oid_filter_extension().spec_parse(i)
}
pub open spec fn serialize_spec_oid_filter_extension(msg: SpecOidFilterExtension) -> Result<Seq<u8>, ()> {
    spec_oid_filter_extension().spec_serialize(msg)
}
pub fn parse_oid_filter_extension(i: &[u8]) -> (o: Result<(usize, OidFilterExtension<'_>), ParseError>)
    ensures
...
pub fn serialize_oid_filter_extension(msg: OidFilterExtension<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_signature_scheme_list_list(i: Seq<u8>, l: SpecUint2Fffe) -> Result<(usize, SpecSignatureSchemeListList), ()> {
    spec_signature_scheme_list_list(l).spec_parse(i)
}
pub open spec fn serialize_spec_signature_scheme_list_list(msg: SpecSignatureSchemeListList, l: SpecUint2Fffe) -> Result<Seq<u8>, ()> {
    spec_signature_scheme_list_list(l).spec_serialize(msg)
}
pub fn parse_signature_scheme_list_list(i: &[u8], l: Uint2Fffe) -> (o: Result<(usize, SignatureSchemeListList), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_signature_scheme_list_list(i@, l@) matches Ok(r_) && r@ == r_,
{
    signature_scheme_list_list(l).parse(i)
}

pub fn serialize_signature_scheme_list_list(msg: SignatureSchemeListList, data: &mut Vec<u8>, pos: usize, l: Uint2Fffe) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_signature_scheme_list(i: Seq<u8>) -> Result<(usize, SpecSignatureSchemeList), ()> {
    spec_signature_scheme_list().spec_parse(i)
}
pub open spec fn serialize_spec_signature_scheme_list(msg: SpecSignatureSchemeList) -> Result<Seq<u8>, ()> {
    spec_signature_scheme_list().spec_serialize(msg)
}
pub fn parse_signature_scheme_list(i: &[u8]) -> (o: Result<(usize, SignatureSchemeList), ParseError>)
    ensures
...
pub fn serialize_signature_scheme_list(msg: SignatureSchemeList, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_named_group(msg: NamedGroup, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_uncompressed_point_representation32(i: Seq<u8>) -> Result<(usize, SpecUncompressedPointRepresentation32), ()> {
    spec_uncompressed_point_representation32().spec_parse(i)
}
pub open spec fn serialize_spec_uncompressed_point_representation32(msg: SpecUncompressedPointRepresentation32) -> Result<Seq<u8>, ()> {
    spec_uncompressed_point_representation32().spec_serialize(msg)
}
pub fn parse_uncompressed_point_representation32(i: &[u8]) -> (o: Result<(usize, UncompressedPointRepresentation32<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_uncompressed_point_representation32(i@) matches Ok(r_) && r@ == r_,
{
    uncompressed_point_representation32().parse(i)
}

pub fn serialize_uncompressed_point_representation32(msg: UncompressedPointRepresentation32<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_uncompressed_point_representation48(i: Seq<u8>) -> Result<(usize, SpecUncompressedPointRepresentation48), ()> {
    spec_uncompressed_point_representation48().spec_parse(i)
}
pub open spec fn serialize_spec_uncompressed_point_representation48(msg: SpecUncompressedPointRepresentation48) -> Result<Seq<u8>, ()> {
    spec_uncompressed_point_representation48().spec_serialize(msg)
}
pub fn parse_uncompressed_point_representation48(i: &[u8]) -> (o: Result<(usize, UncompressedPointRepresentation48<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_uncompressed_point_representation48(i@) matches Ok(r_) && r@ == r_,
{
    uncompressed_point_representation48().parse(i)
}

pub fn serialize_uncompressed_point_representation48(msg: UncompressedPointRepresentation48<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_uncompressed_point_representation66(i: Seq<u8>) -> Result<(usize, SpecUncompressedPointRepresentation66), ()> {
    spec_uncompressed_point_representation66().spec_parse(i)
}
pub open spec fn serialize_spec_uncompressed_point_representation66(msg: SpecUncompressedPointRepresentation66) -> Result<Seq<u8>, ()> {
    spec_uncompressed_point_representation66().spec_serialize(msg)
}
pub fn parse_uncompressed_point_representation66(i: &[u8]) -> (o: Result<(usize, UncompressedPointRepresentation66<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_uncompressed_point_representation66(i@) matches Ok(r_) && r@ == r_,
{
    uncompressed_point_representation66().parse(i)
}

pub fn serialize_uncompressed_point_representation66(msg: UncompressedPointRepresentation66<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_montgomery_point32(i: Seq<u8>) -> Result<(usize, SpecMontgomeryPoint32), ()> {
    spec_montgomery_point32().spec_parse(i)
}
pub open spec fn serialize_spec_montgomery_point32(msg: SpecMontgomeryPoint32) -> Result<Seq<u8>, ()> {
...
pub fn serialize_montgomery_point32(msg: MontgomeryPoint32<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_montgomery_form56(i: Seq<u8>) -> Result<(usize, SpecMontgomeryForm56), ()> {
    spec_montgomery_form56().spec_parse(i)
}
pub open spec fn serialize_spec_montgomery_form56(msg: SpecMontgomeryForm56) -> Result<Seq<u8>, ()> {
...
pub fn serialize_montgomery_form56(msg: MontgomeryForm56<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_sever_dh_params(msg: SeverDhParams<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_key_exchange_data(i: Seq<u8>) -> Result<(usize, SpecKeyExchangeData), ()> {
...
pub fn serialize_key_exchange_data(msg: KeyExchangeData<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_key_share_entry_key_exchange(i: Seq<u8>, group: SpecNamedGroup) -> Result<(usize, SpecKeyShareEntryKeyExchange), ()> {
    spec_key_share_entry_key_exchange(group).spec_parse(i)
}
pub open spec fn serialize_spec_key_share_entry_key_exchange(msg: SpecKeyShareEntryKeyExchange, group: SpecNamedGroup) -> Result<Seq<u8>, ()> {
    spec_key_share_entry_key_exchange(group).spec_serialize(msg)
}
pub fn parse_key_share_entry_key_exchange(i: &[u8], group: NamedGroup) -> (o: Result<(usize, KeyShareEntryKeyExchange<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_key_share_entry_key_exchange(i@, group@) matches Ok(r_) && r@ == r_,
{
    key_share_entry_key_exchange(group).parse(i)
}

pub fn serialize_key_share_entry_key_exchange(msg: KeyShareEntryKeyExchange<'_>, data: &mut Vec<u8>, pos: usize, group: NamedGroup) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_key_share_entry(msg: KeyShareEntry<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_key_share_client_hello_client_shares(i: Seq<u8>, l: SpecUint0Ffff) -> Result<(usize, SpecKeyShareClientHelloClientShares), ()> {
    spec_key_share_client_hello_client_shares(l).spec_parse(i)
}
pub open spec fn serialize_spec_key_share_client_hello_client_shares(msg: SpecKeyShareClientHelloClientShares, l: SpecUint0Ffff) -> Result<Seq<u8>, ()> {
    spec_key_share_client_hello_client_shares(l).spec_serialize(msg)
}
pub fn parse_key_share_client_hello_client_shares(i: &[u8], l: Uint0Ffff) -> (o: Result<(usize, KeyShareClientHelloClientShares<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_key_share_client_hello_client_shares(i@, l@) matches Ok(r_) && r@ == r_,
{
    key_share_client_hello_client_shares(l).parse(i)
}

pub fn serialize_key_share_client_hello_client_shares(msg: KeyShareClientHelloClientShares<'_>, data: &mut Vec<u8>, pos: usize, l: Uint0Ffff) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_key_share_client_hello(i: Seq<u8>) -> Result<(usize, SpecKeyShareClientHello), ()> {
    spec_key_share_client_hello().spec_parse(i)
}
pub open spec fn serialize_spec_key_share_client_hello(msg: SpecKeyShareClientHello) -> Result<Seq<u8>, ()> {
    spec_key_share_client_hello().spec_serialize(msg)
}
pub fn parse_key_share_client_hello(i: &[u8]) -> (o: Result<(usize, KeyShareClientHello<'_>), ParseError>)
    ensures
...
pub fn serialize_key_share_client_hello(msg: KeyShareClientHello<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_client_hello_extension_extension_data(i: Seq<u8>, extension_type: SpecExtensionType, ext_len: u16) -> Result<(usize, SpecClientHelloExtensionExtensionData), ()> {
    spec_client_hello_extension_extension_data(extension_type, ext_len).spec_parse(i)
}
pub open spec fn serialize_spec_client_hello_extension_extension_data(msg: SpecClientHelloExtensionExtensionData, extension_type: SpecExtensionType, ext_len: u16) -> Result<Seq<u8>, ()> {
    spec_client_hello_extension_extension_data(extension_type, ext_len).spec_serialize(msg)
}
pub fn parse_client_hello_extension_extension_data(i: &[u8], extension_type: ExtensionType, ext_len: u16) -> (o: Result<(usize, ClientHelloExtensionExtensionData<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_client_hello_extension_extension_data(i@, extension_type@, ext_len@) matches Ok(r_) && r@ == r_,
{
    client_hello_extension_extension_data(extension_type, ext_len).parse(i)
}

pub fn serialize_client_hello_extension_extension_data(msg: ClientHelloExtensionExtensionData<'_>, data: &mut Vec<u8>, pos: usize, extension_type: ExtensionType, ext_len: u16) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
            &&& serialize_spec_client_hello_extension_extension_data(msg@, extension_type@, ext_len@) matches Ok(buf)
            &&& n == buf.len() && data@ == seq_splice(old(data)@, pos, buf)
        },
{
    client_hello_extension_extension_data(extension_type, ext_len).serialize(msg, data, pos)
}
...
pub fn serialize_tls_ciphertext(msg: TlsCiphertext<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_handshake_type(msg: HandshakeType, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_handshake(msg: Handshake<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_server_name_list_list(i: Seq<u8>, l: SpecUint1Ffff) -> Result<(usize, SpecServerNameListList), ()> {
    spec_server_name_list_list(l).spec_parse(i)
}
pub open spec fn serialize_spec_server_name_list_list(msg: SpecServerNameListList, l: SpecUint1Ffff) -> Result<Seq<u8>, ()> {
    spec_server_name_list_list(l).spec_serialize(msg)
}
pub fn parse_server_name_list_list(i: &[u8], l: Uint1Ffff) -> (o: Result<(usize, ServerNameListList<'_>), ParseError>)
    ensures
...
pub fn serialize_server_name_list_list(msg: ServerNameListList<'_>, data: &mut Vec<u8>, pos: usize, l: Uint1Ffff) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_opaque_2_ffff(msg: Opaque2Ffff<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_server_name_list(i: Seq<u8>) -> Result<(usize, SpecServerNameList), ()> {
...
pub fn serialize_server_name_list(msg: ServerNameList<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_responder_id_list(i: Seq<u8>) -> Result<(usize, SpecResponderIdList), ()> {
...
pub fn serialize_responder_id_list(msg: ResponderIdList<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_oscp_status_request(i: Seq<u8>) -> Result<(usize, SpecOscpStatusRequest), ()> {
    spec_oscp_status_request().spec_parse(i)
}
pub open spec fn serialize_spec_oscp_status_request(msg: SpecOscpStatusRequest) -> Result<Seq<u8>, ()> {
    spec_oscp_status_request().spec_serialize(msg)
}
pub fn parse_oscp_status_request(i: &[u8]) -> (o: Result<(usize, OscpStatusRequest<'_>), ParseError>)
    ensures
...
pub fn serialize_oscp_status_request(msg: OscpStatusRequest<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_certificate_status_request(i: Seq<u8>) -> Result<(usize, SpecCertificateStatusRequest), ()> {
    spec_certificate_status_request().spec_parse(i)
}
pub open spec fn serialize_spec_certificate_status_request(msg: SpecCertificateStatusRequest) -> Result<Seq<u8>, ()> {
    spec_certificate_status_request().spec_serialize(msg)
}
pub fn parse_certificate_status_request(i: &[u8]) -> (o: Result<(usize, CertificateStatusRequest<'_>), ParseError>)
    ensures
...
pub fn serialize_certificate_status_request(msg: CertificateStatusRequest<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_named_group_list_list(i: Seq<u8>, l: SpecUint2Ffff) -> Result<(usize, SpecNamedGroupListList), ()> {
    spec_named_group_list_list(l).spec_parse(i)
}
pub open spec fn serialize_spec_named_group_list_list(msg: SpecNamedGroupListList, l: SpecUint2Ffff) -> Result<Seq<u8>, ()> {
    spec_named_group_list_list(l).spec_serialize(msg)
}
pub fn parse_named_group_list_list(i: &[u8], l: Uint2Ffff) -> (o: Result<(usize, NamedGroupListList), ParseError>)
    ensures
...
pub fn serialize_named_group_list_list(msg: NamedGroupListList, data: &mut Vec<u8>, pos: usize, l: Uint2Ffff) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_named_group_list(i: Seq<u8>) -> Result<(usize, SpecNamedGroupList), ()> {
...
pub fn serialize_named_group_list(msg: NamedGroupList, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_sever_hello_extension_extension_data(i: Seq<u8>, extension_type: SpecExtensionType, ext_len: u16) -> Result<(usize, SpecSeverHelloExtensionExtensionData), ()> {
    spec_sever_hello_extension_extension_data(extension_type, ext_len).spec_parse(i)
}
pub open spec fn serialize_spec_sever_hello_extension_extension_data(msg: SpecSeverHelloExtensionExtensionData, extension_type: SpecExtensionType, ext_len: u16) -> Result<Seq<u8>, ()> {
    spec_sever_hello_extension_extension_data(extension_type, ext_len).spec_serialize(msg)
}
pub fn parse_sever_hello_extension_extension_data(i: &[u8], extension_type: ExtensionType, ext_len: u16) -> (o: Result<(usize, SeverHelloExtensionExtensionData<'_>), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_sever_hello_extension_extension_data(i@, extension_type@, ext_len@) matches Ok(r_) && r@ == r_,
{
    sever_hello_extension_extension_data(extension_type, ext_len).parse(i)
}

pub fn serialize_sever_hello_extension_extension_data(msg: SeverHelloExtensionExtensionData<'_>, data: &mut Vec<u8>, pos: usize, extension_type: ExtensionType, ext_len: u16) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
            &&& serialize_spec_sever_hello_extension_extension_data(msg@, extension_type@, ext_len@) matches Ok(buf)
            &&& n == buf.len() && data@ == seq_splice(old(data)@, pos, buf)
        },
{
    sever_hello_extension_extension_data(extension_type, ext_len).serialize(msg, data, pos)
}
pub open spec fn parse_spec_sever_hello_extension(i: Seq<u8>) -> Result<(usize, SpecSeverHelloExtension), ()> {
    spec_sever_hello_extension().spec_parse(i)
}
pub open spec fn serialize_spec_sever_hello_extension(msg: SpecSeverHelloExtension) -> Result<Seq<u8>, ()> {
    spec_sever_hello_extension().spec_serialize(msg)
}
pub fn parse_sever_hello_extension(i: &[u8]) -> (o: Result<(usize, SeverHelloExtension<'_>), ParseError>)
    ensures
...
pub fn serialize_sever_hello_extension(msg: SeverHelloExtension<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_early_data_indication_new_session_ticket(i: Seq<u8>) -> Result<(usize, SpecEarlyDataIndicationNewSessionTicket), ()> {
    spec_early_data_indication_new_session_ticket().spec_parse(i)
}
pub open spec fn serialize_spec_early_data_indication_new_session_ticket(msg: SpecEarlyDataIndicationNewSessionTicket) -> Result<Seq<u8>, ()> {
    spec_early_data_indication_new_session_ticket().spec_serialize(msg)
}
pub fn parse_early_data_indication_new_session_ticket(i: &[u8]) -> (o: Result<(usize, EarlyDataIndicationNewSessionTicket), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_early_data_indication_new_session_ticket(i@) matches Ok(r_) && r@ == r_,
{
    early_data_indication_new_session_ticket().parse(i)
}

pub fn serialize_early_data_indication_new_session_ticket(msg: EarlyDataIndicationNewSessionTicket, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_ocsp_response(msg: OcspResponse<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_pre_shared_key_server_extension(i: Seq<u8>) -> Result<(usize, SpecPreSharedKeyServerExtension), ()> {
    spec_pre_shared_key_server_extension().spec_parse(i)
}
pub open spec fn serialize_spec_pre_shared_key_server_extension(msg: SpecPreSharedKeyServerExtension) -> Result<Seq<u8>, ()> {
    spec_pre_shared_key_server_extension().spec_serialize(msg)
}
pub fn parse_pre_shared_key_server_extension(i: &[u8]) -> (o: Result<(usize, PreSharedKeyServerExtension), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_pre_shared_key_server_extension(i@) matches Ok(r_) && r@ == r_,
{
    pre_shared_key_server_extension().parse(i)
}

pub fn serialize_pre_shared_key_server_extension(msg: PreSharedKeyServerExtension, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_alert_level(msg: AlertLevel, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_alert_description(i: Seq<u8>) -> Result<(usize, SpecAlertDescription), ()> {
    spec_alert_description().spec_parse(i)
}
pub open spec fn serialize_spec_alert_description(msg: SpecAlertDescription) -> Result<Seq<u8>, ()> {
...
pub fn serialize_alert_description(msg: AlertDescription, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_alert(msg: Alert, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_server_cert_type_server_extension(i: Seq<u8>) -> Result<(usize, SpecServerCertTypeServerExtension), ()> {
    spec_server_cert_type_server_extension().spec_parse(i)
}
pub open spec fn serialize_spec_server_cert_type_server_extension(msg: SpecServerCertTypeServerExtension) -> Result<Seq<u8>, ()> {
    spec_server_cert_type_server_extension().spec_serialize(msg)
}
pub fn parse_server_cert_type_server_extension(i: &[u8]) -> (o: Result<(usize, ServerCertTypeServerExtension), ParseError>)
    ensures
        o matches Ok(r) ==> parse_spec_server_cert_type_server_extension(i@) matches Ok(r_) && r@ == r_,
{
    server_cert_type_server_extension().parse(i)
}

pub fn serialize_server_cert_type_server_extension(msg: ServerCertTypeServerExtension, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_opaque_0_ffffff(msg: Opaque0Ffffff<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_certificate_status(i: Seq<u8>) -> Result<(usize, SpecCertificateStatus), ()> {
    spec_certificate_status().spec_parse(i)
}
pub open spec fn serialize_spec_certificate_status(msg: SpecCertificateStatus) -> Result<Seq<u8>, ()> {
...
pub fn serialize_certificate_status(msg: CertificateStatus<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub open spec fn parse_spec_client_hello_extension(i: Seq<u8>) -> Result<(usize, SpecClientHelloExtension), ()> {
    spec_client_hello_extension().spec_parse(i)
}
pub open spec fn serialize_spec_client_hello_extension(msg: SpecClientHelloExtension) -> Result<Seq<u8>, ()> {
    spec_client_hello_extension().spec_serialize(msg)
}
pub fn parse_client_hello_extension(i: &[u8]) -> (o: Result<(usize, ClientHelloExtension<'_>), ParseError>)
    ensures
...
pub fn serialize_client_hello_extension(msg: ClientHelloExtension<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
...
pub fn serialize_tls_plaintext(msg: TlsPlaintext<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    ensures
        o matches Ok(n) ==> {
