...
pub struct SpecAlertDescriptionCombinator(TryMap<U8, AlertDescriptionMapper>);
...
pub struct AlertDescriptionCombinator(TryMap<U8, AlertDescriptionMapper>);

impl View for AlertDescriptionCombinator {
    type V = SpecAlertDescriptionCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecAlertDescriptionCombinator(self.0@)
    }
}
...
pub struct SpecSessionIdCombinator(Mapped<SpecDepend<Refined<U8, Predicate10693986609604791304>, Bytes>, SessionIdMapper>);
...
pub struct SessionIdCombinator(Mapped<Depend<Refined<U8, Predicate10693986609604791304>, Bytes, SessionIdCont>, SessionIdMapper>);

impl View for SessionIdCombinator {
    type V = SpecSessionIdCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecSessionIdCombinator(self.0@)
    }
}
...
pub struct SpecUncompressedPointRepresentation32Combinator(Mapped<(Refined<U8, TagPred<u8>>, (BytesN<32>, BytesN<32>)), UncompressedPointRepresentation32Mapper>);
...
pub struct UncompressedPointRepresentation32Combinator(Mapped<(Refined<U8, TagPred<u8>>, (BytesN<32>, BytesN<32>)), UncompressedPointRepresentation32Mapper>);

impl View for UncompressedPointRepresentation32Combinator {
    type V = SpecUncompressedPointRepresentation32Combinator;

    closed spec fn view(&self) -> Self::V {
        SpecUncompressedPointRepresentation32Combinator(self.0@)
    }
}
...
pub struct SpecUncompressedPointRepresentation48Combinator(Mapped<(Refined<U8, TagPred<u8>>, (BytesN<48>, BytesN<48>)), UncompressedPointRepresentation48Mapper>);
...
pub struct UncompressedPointRepresentation48Combinator(Mapped<(Refined<U8, TagPred<u8>>, (BytesN<48>, BytesN<48>)), UncompressedPointRepresentation48Mapper>);

impl View for UncompressedPointRepresentation48Combinator {
    type V = SpecUncompressedPointRepresentation48Combinator;

    closed spec fn view(&self) -> Self::V {
        SpecUncompressedPointRepresentation48Combinator(self.0@)
    }
}
...
pub struct SpecUncompressedPointRepresentation66Combinator(Mapped<(Refined<U8, TagPred<u8>>, (BytesN<66>, BytesN<66>)), UncompressedPointRepresentation66Mapper>);
...
pub struct UncompressedPointRepresentation66Combinator(Mapped<(Refined<U8, TagPred<u8>>, (BytesN<66>, BytesN<66>)), UncompressedPointRepresentation66Mapper>);

impl View for UncompressedPointRepresentation66Combinator {
    type V = SpecUncompressedPointRepresentation66Combinator;

    closed spec fn view(&self) -> Self::V {
        SpecUncompressedPointRepresentation66Combinator(self.0@)
    }
}
...
pub struct SpecMontgomeryPoint32Combinator(Mapped<(Refined<U8, TagPred<u8>>, BytesN<32>), MontgomeryPoint32Mapper>);
...
impl SecureSpecCombinator for SpecMontgomeryPoint32Combinator {
    ...
    proof fn lemma_prefix_secure(&self, s1: Seq<u8>, s2: Seq<u8>)
    {
        self.0.lemma_prefix_secure(s1, s2)
                ...
                pub type SpecMontgomeryPoint32CombinatorAlias = Mapped<(Refined<U8, TagPred<u8>>, BytesN<32>), MontgomeryPoint32Mapper>;


pub struct MontgomeryPoint32Combinator(Mapped<(Refined<U8, TagPred<u8>>, BytesN<32>), MontgomeryPoint32Mapper>);

impl View for MontgomeryPoint32Combinator {
    type V = SpecMontgomeryPoint32Combinator;

    closed spec fn view(&self) -> Self::V {
        SpecMontgomeryPoint32Combinator(self.0@)
    }
}
impl Combinator for MontgomeryPoint32Combinator {
    ...
    fn serialize(&self, v: Self::Result<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    {
        self.0.serialize(v, data, pos)
                ...
                pub type MontgomeryPoint32CombinatorAlias = Mapped<(Refined<U8, TagPred<u8>>, BytesN<32>), MontgomeryPoint32Mapper>;

pub const MONTGOMERYFORM56_LEGACY_FORM: u8 = 4;


pub struct SpecMontgomeryForm56Combinator(Mapped<(Refined<U8, TagPred<u8>>, BytesN<56>), MontgomeryForm56Mapper>);
...
impl SecureSpecCombinator for SpecMontgomeryForm56Combinator {
    ...
    proof fn lemma_prefix_secure(&self, s1: Seq<u8>, s2: Seq<u8>)
    {
        self.0.lemma_prefix_secure(s1, s2)
                ...
                pub type SpecMontgomeryForm56CombinatorAlias = Mapped<(Refined<U8, TagPred<u8>>, BytesN<56>), MontgomeryForm56Mapper>;


pub struct MontgomeryForm56Combinator(Mapped<(Refined<U8, TagPred<u8>>, BytesN<56>), MontgomeryForm56Mapper>);

impl View for MontgomeryForm56Combinator {
    type V = SpecMontgomeryForm56Combinator;

    closed spec fn view(&self) -> Self::V {
        SpecMontgomeryForm56Combinator(self.0@)
    }
}
impl Combinator for MontgomeryForm56Combinator {
    ...
    fn serialize(&self, v: Self::Result<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    {
        self.0.serialize(v, data, pos)
                ...
                pub type MontgomeryForm56CombinatorAlias = Mapped<(Refined<U8, TagPred<u8>>, BytesN<56>), MontgomeryForm56Mapper>;
...
pub struct SpecUint1FfffCombinator(Refined<U16Be, Predicate11955646336730306823>);
...
pub struct Uint1FfffCombinator(Refined<U16Be, Predicate11955646336730306823>);

impl View for Uint1FfffCombinator {
    type V = SpecUint1FfffCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecUint1FfffCombinator(self.0@)
    }
}
...
pub struct SpecOpaque1FfffCombinator(Mapped<SpecDepend<SpecUint1FfffCombinator, Bytes>, Opaque1FfffMapper>);
...
pub struct Opaque1FfffCombinator(Mapped<Depend<Uint1FfffCombinator, Bytes, Opaque1FfffCont>, Opaque1FfffMapper>);

impl View for Opaque1FfffCombinator {
    type V = SpecOpaque1FfffCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecOpaque1FfffCombinator(self.0@)
    }
}
...
pub struct SpecSeverDhParamsCombinator(Mapped<(SpecOpaque1FfffCombinator, (SpecOpaque1FfffCombinator, SpecOpaque1FfffCombinator)), SeverDhParamsMapper>);
...
pub struct SeverDhParamsCombinator(Mapped<(Opaque1FfffCombinator, (Opaque1FfffCombinator, Opaque1FfffCombinator)), SeverDhParamsMapper>);

impl View for SeverDhParamsCombinator {
    type V = SpecSeverDhParamsCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecSeverDhParamsCombinator(self.0@)
    }
}
...
pub struct SpecKeyExchangeDataCombinator(SpecOpaque1FfffCombinator);
...
pub struct KeyExchangeDataCombinator(Opaque1FfffCombinator);

impl View for KeyExchangeDataCombinator {
    type V = SpecKeyExchangeDataCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecKeyExchangeDataCombinator(self.0@)
    }
}
...
pub struct SpecUint0FfffCombinator(U16Be);
...
pub struct Uint0FfffCombinator(U16Be);

impl View for Uint0FfffCombinator {
    type V = SpecUint0FfffCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecUint0FfffCombinator(self.0@)
    }
}
...
pub struct SpecOpaque0FfffCombinator(Mapped<SpecDepend<SpecUint0FfffCombinator, Bytes>, Opaque0FfffMapper>);
...
pub struct Opaque0FfffCombinator(Mapped<Depend<Uint0FfffCombinator, Bytes, Opaque0FfffCont>, Opaque0FfffMapper>);

impl View for Opaque0FfffCombinator {
    type V = SpecOpaque0FfffCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecOpaque0FfffCombinator(self.0@)
    }
}
...
pub struct SpecOcspExtensionsCombinator(SpecOpaque0FfffCombinator);
...
pub struct OcspExtensionsCombinator(Opaque0FfffCombinator);

impl View for OcspExtensionsCombinator {
    type V = SpecOcspExtensionsCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecOcspExtensionsCombinator(self.0@)
    }
}
...
pub struct SpecPskIdentityCombinator(Mapped<(SpecOpaque1FfffCombinator, U32Be), PskIdentityMapper>);
...
pub struct PskIdentityCombinator(Mapped<(Opaque1FfffCombinator, U32Be), PskIdentityMapper>);

impl View for PskIdentityCombinator {
    type V = SpecPskIdentityCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecPskIdentityCombinator(self.0@)
    }
}
...
pub struct SpecPskIdentitiesIdentitiesCombinator(AndThen<Bytes, Repeat<SpecPskIdentityCombinator>>);
...
pub struct PskIdentitiesIdentitiesCombinator(AndThen<Bytes, Repeat<PskIdentityCombinator>>);

impl View for PskIdentitiesIdentitiesCombinator {
    type V = SpecPskIdentitiesIdentitiesCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecPskIdentitiesIdentitiesCombinator(self.0@)
    }
}
...
pub struct SpecUint1FfCombinator(Refined<U8, Predicate13930216038658429813>);
...
pub struct Uint1FfCombinator(Refined<U8, Predicate13930216038658429813>);

impl View for Uint1FfCombinator {
    type V = SpecUint1FfCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecUint1FfCombinator(self.0@)
    }
}
...
pub struct SpecCertificateTypeCombinator(U8);
...
pub struct CertificateTypeCombinator(U8);

impl View for CertificateTypeCombinator {
    type V = SpecCertificateTypeCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecCertificateTypeCombinator(self.0@)
    }
}
...
pub struct SpecServerCertTypeClientExtensionTypesCombinator(AndThen<Bytes, Repeat<SpecCertificateTypeCombinator>>);
...
pub struct ServerCertTypeClientExtensionTypesCombinator(AndThen<Bytes, Repeat<CertificateTypeCombinator>>);

impl View for ServerCertTypeClientExtensionTypesCombinator {
    type V = SpecServerCertTypeClientExtensionTypesCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecServerCertTypeClientExtensionTypesCombinator(self.0@)
    }
}
...
pub struct SpecServerCertTypeClientExtensionCombinator(Mapped<SpecDepend<SpecUint1FfCombinator, SpecServerCertTypeClientExtensionTypesCombinator>, ServerCertTypeClientExtensionMapper>);
...
pub struct ServerCertTypeClientExtensionCombinator(Mapped<Depend<Uint1FfCombinator, ServerCertTypeClientExtensionTypesCombinator, ServerCertTypeClientExtensionCont>, ServerCertTypeClientExtensionMapper>);

impl View for ServerCertTypeClientExtensionCombinator {
    type V = SpecServerCertTypeClientExtensionCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecServerCertTypeClientExtensionCombinator(self.0@)
    }
}
...
pub struct SpecProtocolVersionCombinator(U16Be);
...
pub struct ProtocolVersionCombinator(U16Be);

impl View for ProtocolVersionCombinator {
    type V = SpecProtocolVersionCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecProtocolVersionCombinator(self.0@)
    }
}
...
pub struct SpecRandomCombinator(BytesN<32>);
...
pub struct RandomCombinator(BytesN<32>);

impl View for RandomCombinator {
    type V = SpecRandomCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecRandomCombinator(self.0@)
    }
}
...
pub struct SpecUint2FffeCombinator(Refined<U16Be, Predicate13238841935489611399>);
...
pub struct Uint2FffeCombinator(Refined<U16Be, Predicate13238841935489611399>);

impl View for Uint2FffeCombinator {
    type V = SpecUint2FffeCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecUint2FffeCombinator(self.0@)
    }
}
...
pub struct SpecCipherSuiteCombinator(U16Be);
...
pub struct CipherSuiteCombinator(U16Be);

impl View for CipherSuiteCombinator {
    type V = SpecCipherSuiteCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecCipherSuiteCombinator(self.0@)
    }
}
...
pub struct SpecCipherSuiteListListCombinator(AndThen<Bytes, Repeat<SpecCipherSuiteCombinator>>);
...
pub struct CipherSuiteListListCombinator(AndThen<Bytes, Repeat<CipherSuiteCombinator>>);

impl View for CipherSuiteListListCombinator {
    type V = SpecCipherSuiteListListCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecCipherSuiteListListCombinator(self.0@)
    }
}
...
pub struct SpecCipherSuiteListCombinator(Mapped<SpecDepend<SpecUint2FffeCombinator, SpecCipherSuiteListListCombinator>, CipherSuiteListMapper>);
...
pub struct CipherSuiteListCombinator(Mapped<Depend<Uint2FffeCombinator, CipherSuiteListListCombinator, CipherSuiteListCont>, CipherSuiteListMapper>);

impl View for CipherSuiteListCombinator {
    type V = SpecCipherSuiteListCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecCipherSuiteListCombinator(self.0@)
    }
}
...
pub struct SpecOpaque1FfCombinator(Mapped<SpecDepend<SpecUint1FfCombinator, Bytes>, Opaque1FfMapper>);
...
pub struct Opaque1FfCombinator(Mapped<Depend<Uint1FfCombinator, Bytes, Opaque1FfCont>, Opaque1FfMapper>);

impl View for Opaque1FfCombinator {
    type V = SpecOpaque1FfCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecOpaque1FfCombinator(self.0@)
    }
}
...
pub struct SpecExtensionTypeCombinator(U8);
...
pub struct ExtensionTypeCombinator(U8);

impl View for ExtensionTypeCombinator {
    type V = SpecExtensionTypeCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecExtensionTypeCombinator(self.0@)
    }
}
...
pub struct SpecEmptyCombinator(BytesN<0>);
...
pub struct EmptyCombinator(BytesN<0>);

impl View for EmptyCombinator {
    type V = SpecEmptyCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecEmptyCombinator(self.0@)
    }
}
...
pub struct SpecMaxFragmentLengthCombinator(U8);
...
pub struct MaxFragmentLengthCombinator(U8);

impl View for MaxFragmentLengthCombinator {
    type V = SpecMaxFragmentLengthCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecMaxFragmentLengthCombinator(self.0@)
    }
}
...
pub struct SpecEcPointFormatCombinator(U8);
...
pub struct EcPointFormatCombinator(U8);

impl View for EcPointFormatCombinator {
    type V = SpecEcPointFormatCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecEcPointFormatCombinator(self.0@)
    }
}
...
pub struct SpecEcPointFormatListListCombinator(AndThen<Bytes, Repeat<SpecEcPointFormatCombinator>>);
...
pub struct EcPointFormatListListCombinator(AndThen<Bytes, Repeat<EcPointFormatCombinator>>);

impl View for EcPointFormatListListCombinator {
    type V = SpecEcPointFormatListListCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecEcPointFormatListListCombinator(self.0@)
    }
}
...
pub struct SpecEcPointFormatListCombinator(Mapped<SpecDepend<SpecUint1FfCombinator, SpecEcPointFormatListListCombinator>, EcPointFormatListMapper>);
...
pub struct EcPointFormatListCombinator(Mapped<Depend<Uint1FfCombinator, EcPointFormatListListCombinator, EcPointFormatListCont>, EcPointFormatListMapper>);

impl View for EcPointFormatListCombinator {
    type V = SpecEcPointFormatListCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecEcPointFormatListCombinator(self.0@)
    }
}
...
pub struct SpecUint2FfffCombinator(Refined<U16Be, Predicate5950696943328973166>);
...
pub struct Uint2FfffCombinator(Refined<U16Be, Predicate5950696943328973166>);

impl View for Uint2FfffCombinator {
    type V = SpecUint2FfffCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecUint2FfffCombinator(self.0@)
    }
}
...
pub struct SpecSrtpProtectionProfileCombinator(BytesN<2>);
...
pub struct SrtpProtectionProfileCombinator(BytesN<2>);

impl View for SrtpProtectionProfileCombinator {
    type V = SpecSrtpProtectionProfileCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecSrtpProtectionProfileCombinator(self.0@)
    }
}
...
pub struct SpecSrtpProtectionProfilesListCombinator(AndThen<Bytes, Repeat<SpecSrtpProtectionProfileCombinator>>);
...
pub struct SrtpProtectionProfilesListCombinator(AndThen<Bytes, Repeat<SrtpProtectionProfileCombinator>>);

impl View for SrtpProtectionProfilesListCombinator {
    type V = SpecSrtpProtectionProfilesListCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecSrtpProtectionProfilesListCombinator(self.0@)
    }
}
...
pub struct SpecSrtpProtectionProfilesCombinator(Mapped<SpecDepend<SpecUint2FfffCombinator, SpecSrtpProtectionProfilesListCombinator>, SrtpProtectionProfilesMapper>);
...
pub struct SrtpProtectionProfilesCombinator(Mapped<Depend<Uint2FfffCombinator, SrtpProtectionProfilesListCombinator, SrtpProtectionProfilesCont>, SrtpProtectionProfilesMapper>);

impl View for SrtpProtectionProfilesCombinator {
    type V = SpecSrtpProtectionProfilesCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecSrtpProtectionProfilesCombinator(self.0@)
    }
}
...
pub struct SpecUint0FfCombinator(U8);
...
pub struct Uint0FfCombinator(U8);

impl View for Uint0FfCombinator {
    type V = SpecUint0FfCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecUint0FfCombinator(self.0@)
    }
}
...
pub struct SpecOpaque0FfCombinator(Mapped<SpecDepend<SpecUint0FfCombinator, Bytes>, Opaque0FfMapper>);
...
pub struct Opaque0FfCombinator(Mapped<Depend<Uint0FfCombinator, Bytes, Opaque0FfCont>, Opaque0FfMapper>);

impl View for Opaque0FfCombinator {
    type V = SpecOpaque0FfCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecOpaque0FfCombinator(self.0@)
    }
}
...
pub struct SpecUseSrtpDataCombinator(Mapped<(SpecSrtpProtectionProfilesCombinator, SpecOpaque0FfCombinator), UseSrtpDataMapper>);
...
pub struct UseSrtpDataCombinator(Mapped<(SrtpProtectionProfilesCombinator, Opaque0FfCombinator), UseSrtpDataMapper>);

impl View for UseSrtpDataCombinator {
    type V = SpecUseSrtpDataCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecUseSrtpDataCombinator(self.0@)
    }
}
...
pub struct SpecHeartbeatModeCombinator(U8);
...
pub struct HeartbeatModeCombinator(U8);

impl View for HeartbeatModeCombinator {
    type V = SpecHeartbeatModeCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecHeartbeatModeCombinator(self.0@)
    }
}
...
pub struct SpecProtocolNameCombinator(SpecOpaque1FfCombinator);
...
pub struct ProtocolNameCombinator(Opaque1FfCombinator);

impl View for ProtocolNameCombinator {
    type V = SpecProtocolNameCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecProtocolNameCombinator(self.0@)
    }
}
...
pub struct SpecProtocolNameListListCombinator(AndThen<Bytes, Repeat<SpecProtocolNameCombinator>>);
...
pub struct ProtocolNameListListCombinator(AndThen<Bytes, Repeat<ProtocolNameCombinator>>);

impl View for ProtocolNameListListCombinator {
    type V = SpecProtocolNameListListCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecProtocolNameListListCombinator(self.0@)
    }
}
...
pub struct SpecProtocolNameListCombinator(Mapped<SpecDepend<SpecUint2FfffCombinator, SpecProtocolNameListListCombinator>, ProtocolNameListMapper>);
...
pub struct ProtocolNameListCombinator(Mapped<Depend<Uint2FfffCombinator, ProtocolNameListListCombinator, ProtocolNameListCont>, ProtocolNameListMapper>);

impl View for ProtocolNameListCombinator {
    type V = SpecProtocolNameListCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecProtocolNameListCombinator(self.0@)
    }
}
...
pub struct SpecSerializedSctCombinator(SpecOpaque1FfffCombinator);
...
pub struct SerializedSctCombinator(Opaque1FfffCombinator);

impl View for SerializedSctCombinator {
    type V = SpecSerializedSctCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecSerializedSctCombinator(self.0@)
    }
}
...
pub struct SpecSignedCertificateTimestampListListCombinator(AndThen<Bytes, Repeat<SpecSerializedSctCombinator>>);
...
pub struct SignedCertificateTimestampListListCombinator(AndThen<Bytes, Repeat<SerializedSctCombinator>>);

impl View for SignedCertificateTimestampListListCombinator {
    type V = SpecSignedCertificateTimestampListListCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecSignedCertificateTimestampListListCombinator(self.0@)
    }
}
...
pub struct SpecSignedCertificateTimestampListCombinator(Mapped<SpecDepend<SpecUint1FfffCombinator, SpecSignedCertificateTimestampListListCombinator>, SignedCertificateTimestampListMapper>);
...
pub struct SignedCertificateTimestampListCombinator(Mapped<Depend<Uint1FfffCombinator, SignedCertificateTimestampListListCombinator, SignedCertificateTimestampListCont>, SignedCertificateTimestampListMapper>);

impl View for SignedCertificateTimestampListCombinator {
    type V = SpecSignedCertificateTimestampListCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecSignedCertificateTimestampListCombinator(self.0@)
    }
}
...
pub struct SpecClientCertTypeClientExtensionTypesCombinator(AndThen<Bytes, Repeat<SpecCertificateTypeCombinator>>);
...
pub struct ClientCertTypeClientExtensionTypesCombinator(AndThen<Bytes, Repeat<CertificateTypeCombinator>>);

impl View for ClientCertTypeClientExtensionTypesCombinator {
    type V = SpecClientCertTypeClientExtensionTypesCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecClientCertTypeClientExtensionTypesCombinator(self.0@)
    }
}
...
pub struct SpecClientCertTypeClientExtensionCombinator(Mapped<SpecDepend<SpecUint1FfCombinator, SpecClientCertTypeClientExtensionTypesCombinator>, ClientCertTypeClientExtensionMapper>);
...
pub struct ClientCertTypeClientExtensionCombinator(Mapped<Depend<Uint1FfCombinator, ClientCertTypeClientExtensionTypesCombinator, ClientCertTypeClientExtensionCont>, ClientCertTypeClientExtensionMapper>);

impl View for ClientCertTypeClientExtensionCombinator {
    type V = SpecClientCertTypeClientExtensionCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecClientCertTypeClientExtensionCombinator(self.0@)
    }
}
...
pub struct SpecZeroByteCombinator(Mapped<Refined<U8, TagPred<u8>>, ZeroByteMapper>);
...
pub struct ZeroByteCombinator(Mapped<Refined<U8, TagPred<u8>>, ZeroByteMapper>);

impl View for ZeroByteCombinator {
    type V = SpecZeroByteCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecZeroByteCombinator(self.0@)
    }
}
...
pub struct SpecPaddingExtensionPaddingCombinator(AndThen<Bytes, Repeat<SpecZeroByteCombinator>>);
...
pub struct PaddingExtensionPaddingCombinator(AndThen<Bytes, Repeat<ZeroByteCombinator>>);

impl View for PaddingExtensionPaddingCombinator {
    type V = SpecPaddingExtensionPaddingCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecPaddingExtensionPaddingCombinator(self.0@)
    }
}
...
pub struct SpecPaddingExtensionCombinator(Mapped<SpecDepend<SpecUint0FfffCombinator, SpecPaddingExtensionPaddingCombinator>, PaddingExtensionMapper>);
...
pub struct PaddingExtensionCombinator(Mapped<Depend<Uint0FfffCombinator, PaddingExtensionPaddingCombinator, PaddingExtensionCont>, PaddingExtensionMapper>);

impl View for PaddingExtensionCombinator {
    type V = SpecPaddingExtensionCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecPaddingExtensionCombinator(self.0@)
    }
}
...
pub struct SpecSessionTicketCombinator(SpecOpaque0FfffCombinator);
...
pub struct SessionTicketCombinator(Opaque0FfffCombinator);

impl View for SessionTicketCombinator {
    type V = SpecSessionTicketCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecSessionTicketCombinator(self.0@)
    }
}
impl Combinator for SessionTicketCombinator {
    type Result<'a> = SessionTicket<'a>;

    type Owned = SessionTicketOwned;
    ...
    fn serialize(&self, v: Self::Result<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    {
        self.0.serialize(v, data, pos)
                ...
                pub type SessionTicketCombinatorAlias = Opaque0FfffCombinator;
...
pub struct SpecPskIdentitiesCombinator(Mapped<SpecDepend<Refined<U16Be, Predicate17762240283561303569>, SpecPskIdentitiesIdentitiesCombinator>, PskIdentitiesMapper>);
...
pub struct PskIdentitiesCombinator(Mapped<Depend<Refined<U16Be, Predicate17762240283561303569>, PskIdentitiesIdentitiesCombinator, PskIdentitiesCont>, PskIdentitiesMapper>);

impl View for PskIdentitiesCombinator {
    type V = SpecPskIdentitiesCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecPskIdentitiesCombinator(self.0@)
    }
}
...
pub struct SpecPskBinderEntryCombinator(Mapped<SpecDepend<Refined<U8, Predicate14956021864372697443>, Bytes>, PskBinderEntryMapper>);
...
pub struct PskBinderEntryCombinator(Mapped<Depend<Refined<U8, Predicate14956021864372697443>, Bytes, PskBinderEntryCont>, PskBinderEntryMapper>);

impl View for PskBinderEntryCombinator {
    type V = SpecPskBinderEntryCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecPskBinderEntryCombinator(self.0@)
    }
}
...
pub struct SpecPskBinderEntriesBindersCombinator(AndThen<Bytes, Repeat<SpecPskBinderEntryCombinator>>);
...
pub struct PskBinderEntriesBindersCombinator(AndThen<Bytes, Repeat<PskBinderEntryCombinator>>);

impl View for PskBinderEntriesBindersCombinator {
    type V = SpecPskBinderEntriesBindersCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecPskBinderEntriesBindersCombinator(self.0@)
    }
}
...
pub struct SpecPskBinderEntriesCombinator(Mapped<SpecDepend<Refined<U16Be, Predicate14504484746533333987>, SpecPskBinderEntriesBindersCombinator>, PskBinderEntriesMapper>);
...
pub struct PskBinderEntriesCombinator(Mapped<Depend<Refined<U16Be, Predicate14504484746533333987>, PskBinderEntriesBindersCombinator, PskBinderEntriesCont>, PskBinderEntriesMapper>);

impl View for PskBinderEntriesCombinator {
    type V = SpecPskBinderEntriesCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecPskBinderEntriesCombinator(self.0@)
    }
}
...
pub struct SpecOfferedPsksCombinator(Mapped<(SpecPskIdentitiesCombinator, SpecPskBinderEntriesCombinator), OfferedPsksMapper>);
...
pub struct OfferedPsksCombinator(Mapped<(PskIdentitiesCombinator, PskBinderEntriesCombinator), OfferedPsksMapper>);

impl View for OfferedPsksCombinator {
    type V = SpecOfferedPsksCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecOfferedPsksCombinator(self.0@)
    }
}
...
pub struct SpecPreSharedKeyClientExtensionCombinator(Mapped<SpecOfferedPsksCombinator, PreSharedKeyClientExtensionMapper>);
...
pub struct PreSharedKeyClientExtensionCombinator(Mapped<OfferedPsksCombinator, PreSharedKeyClientExtensionMapper>);

impl View for PreSharedKeyClientExtensionCombinator {
    type V = SpecPreSharedKeyClientExtensionCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecPreSharedKeyClientExtensionCombinator(self.0@)
    }
}
...
pub struct SpecSupportedVersionsClientVersionsCombinator(AndThen<Bytes, Repeat<SpecProtocolVersionCombinator>>);
...
pub struct SupportedVersionsClientVersionsCombinator(AndThen<Bytes, Repeat<ProtocolVersionCombinator>>);

impl View for SupportedVersionsClientVersionsCombinator {
    type V = SpecSupportedVersionsClientVersionsCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecSupportedVersionsClientVersionsCombinator(self.0@)
    }
}
...
pub struct SpecSupportedVersionsClientCombinator(Mapped<SpecDepend<Refined<U8, Predicate12026843412570934212>, SpecSupportedVersionsClientVersionsCombinator>, SupportedVersionsClientMapper>);
...
pub struct SupportedVersionsClientCombinator(Mapped<Depend<Refined<U8, Predicate12026843412570934212>, SupportedVersionsClientVersionsCombinator, SupportedVersionsClientCont>, SupportedVersionsClientMapper>);

impl View for SupportedVersionsClientCombinator {
    type V = SpecSupportedVersionsClientCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecSupportedVersionsClientCombinator(self.0@)
    }
}
...
pub struct SpecCookieCombinator(SpecOpaque1FfffCombinator);
...
pub struct CookieCombinator(Opaque1FfffCombinator);

impl View for CookieCombinator {
    type V = SpecCookieCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecCookieCombinator(self.0@)
    }
}
...
pub struct SpecPskKeyExchangeModeCombinator(U8);
...
pub struct PskKeyExchangeModeCombinator(U8);

impl View for PskKeyExchangeModeCombinator {
    type V = SpecPskKeyExchangeModeCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecPskKeyExchangeModeCombinator(self.0@)
    }
}
...
pub struct SpecPskKeyExchangeModesModesCombinator(AndThen<Bytes, Repeat<SpecPskKeyExchangeModeCombinator>>);
...
pub struct PskKeyExchangeModesModesCombinator(AndThen<Bytes, Repeat<PskKeyExchangeModeCombinator>>);

impl View for PskKeyExchangeModesModesCombinator {
    type V = SpecPskKeyExchangeModesModesCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecPskKeyExchangeModesModesCombinator(self.0@)
    }
}
...
pub struct SpecPskKeyExchangeModesCombinator(Mapped<SpecDepend<SpecUint1FfCombinator, SpecPskKeyExchangeModesModesCombinator>, PskKeyExchangeModesMapper>);
...
pub struct PskKeyExchangeModesCombinator(Mapped<Depend<Uint1FfCombinator, PskKeyExchangeModesModesCombinator, PskKeyExchangeModesCont>, PskKeyExchangeModesMapper>);

impl View for PskKeyExchangeModesCombinator {
    type V = SpecPskKeyExchangeModesCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecPskKeyExchangeModesCombinator(self.0@)
    }
}
...
pub struct SpecDistinguishedNameCombinator(SpecOpaque1FfffCombinator);
...
pub struct DistinguishedNameCombinator(Opaque1FfffCombinator);

impl View for DistinguishedNameCombinator {
    type V = SpecDistinguishedNameCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecDistinguishedNameCombinator(self.0@)
    }
}
...
pub struct SpecCertificateAuthoritiesExtensionAuthoritiesCombinator(AndThen<Bytes, Repeat<SpecDistinguishedNameCombinator>>);
...
pub struct CertificateAuthoritiesExtensionAuthoritiesCombinator(AndThen<Bytes, Repeat<DistinguishedNameCombinator>>);
...
impl View for CertificateAuthoritiesExtensionAuthoritiesCombinator {
    ...
    closed spec fn view(&self) -> Self::V {
        SpecCertificateAuthoritiesExtensionAuthoritiesCombinator(self.0@)
    }
}
...
pub struct SpecCertificateAuthoritiesExtensionCombinator(Mapped<SpecDepend<Refined<U16Be, Predicate17709910934222271310>, SpecCertificateAuthoritiesExtensionAuthoritiesCombinator>, CertificateAuthoritiesExtensionMapper>);
...
pub struct CertificateAuthoritiesExtensionCombinator(Mapped<Depend<Refined<U16Be, Predicate17709910934222271310>, CertificateAuthoritiesExtensionAuthoritiesCombinator, CertificateAuthoritiesExtensionCont>, CertificateAuthoritiesExtensionMapper>);

impl View for CertificateAuthoritiesExtensionCombinator {
    type V = SpecCertificateAuthoritiesExtensionCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecCertificateAuthoritiesExtensionCombinator(self.0@)
    }
}
...
pub struct SpecOidFilterCombinator(Mapped<(SpecOpaque1FfCombinator, SpecOpaque0FfffCombinator), OidFilterMapper>);
...
pub struct OidFilterCombinator(Mapped<(Opaque1FfCombinator, Opaque0FfffCombinator), OidFilterMapper>);

impl View for OidFilterCombinator {
    type V = SpecOidFilterCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecOidFilterCombinator(self.0@)
    }
}
...
pub struct SpecOidFilterExtensionFiltersCombinator(AndThen<Bytes, Repeat<SpecOidFilterCombinator>>);
...
pub struct OidFilterExtensionFiltersCombinator(AndThen<Bytes, Repeat<OidFilterCombinator>>);

impl View for OidFilterExtensionFiltersCombinator {
    type V = SpecOidFilterExtensionFiltersCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecOidFilterExtensionFiltersCombinator(self.0@)
    }
}
...
pub struct SpecOidFilterExtensionCombinator(Mapped<SpecDepend<SpecUint0FfffCombinator, SpecOidFilterExtensionFiltersCombinator>, OidFilterExtensionMapper>);
...
pub struct OidFilterExtensionCombinator(Mapped<Depend<Uint0FfffCombinator, OidFilterExtensionFiltersCombinator, OidFilterExtensionCont>, OidFilterExtensionMapper>);

impl View for OidFilterExtensionCombinator {
    type V = SpecOidFilterExtensionCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecOidFilterExtensionCombinator(self.0@)
    }
}
...
pub struct SpecSignatureSchemeCombinator(U16Be);
...
pub struct SignatureSchemeCombinator(U16Be);

impl View for SignatureSchemeCombinator {
    type V = SpecSignatureSchemeCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecSignatureSchemeCombinator(self.0@)
    }
}
...
pub struct SpecSignatureSchemeListListCombinator(AndThen<Bytes, Repeat<SpecSignatureSchemeCombinator>>);
...
pub struct SignatureSchemeListListCombinator(AndThen<Bytes, Repeat<SignatureSchemeCombinator>>);

impl View for SignatureSchemeListListCombinator {
    type V = SpecSignatureSchemeListListCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecSignatureSchemeListListCombinator(self.0@)
    }
}
...
pub struct SpecSignatureSchemeListCombinator(Mapped<SpecDepend<SpecUint2FffeCombinator, SpecSignatureSchemeListListCombinator>, SignatureSchemeListMapper>);
...
pub struct SignatureSchemeListCombinator(Mapped<Depend<Uint2FffeCombinator, SignatureSchemeListListCombinator, SignatureSchemeListCont>, SignatureSchemeListMapper>);

impl View for SignatureSchemeListCombinator {
    type V = SpecSignatureSchemeListCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecSignatureSchemeListCombinator(self.0@)
    }
}
...
pub struct SpecNamedGroupCombinator(U16Be);
...
pub struct NamedGroupCombinator(U16Be);

impl View for NamedGroupCombinator {
    type V = SpecNamedGroupCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecNamedGroupCombinator(self.0@)
    }
}
...
pub struct SpecKeyShareEntryCombinator(Mapped<SpecDepend<SpecNamedGroupCombinator, SpecKeyShareEntryKeyExchangeCombinator>, KeyShareEntryMapper>);
...
impl SecureSpecCombinator for SpecKeyShareEntryCombinator {
    ...
    proof fn lemma_prefix_secure(&self, s1: Seq<u8>, s2: Seq<u8>)
    {
        self.0.lemma_prefix_secure(s1, s2)
                ...
                pub type SpecKeyShareEntryCombinatorAlias = Mapped<SpecDepend<SpecNamedGroupCombinator, SpecKeyShareEntryKeyExchangeCombinator>, KeyShareEntryMapper>;

pub struct KeyShareEntryCont;
pub struct KeyShareEntryCombinator(Mapped<Depend<NamedGroupCombinator, KeyShareEntryKeyExchangeCombinator, KeyShareEntryCont>, KeyShareEntryMapper>);

impl View for KeyShareEntryCombinator {
    type V = SpecKeyShareEntryCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecKeyShareEntryCombinator(self.0@)
    }
}
impl Combinator for KeyShareEntryCombinator {
    ...
    fn serialize(&self, v: Self::Result<'_>, data: &mut Vec<u8>, pos: usize) -> (o: Result<usize, SerializeError>)
    {
        self.0.serialize(v, data, pos)
                ...
                pub type KeyShareEntryCombinatorAlias = Mapped<Depend<NamedGroupCombinator, KeyShareEntryKeyExchangeCombinator, KeyShareEntryCont>, KeyShareEntryMapper>;


pub struct SpecKeyShareClientHelloClientSharesCombinator(AndThen<Bytes, Repeat<SpecKeyShareEntryCombinator>>);
...
pub struct KeyShareClientHelloClientSharesCombinator(AndThen<Bytes, Repeat<KeyShareEntryCombinator>>);

impl View for KeyShareClientHelloClientSharesCombinator {
    type V = SpecKeyShareClientHelloClientSharesCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecKeyShareClientHelloClientSharesCombinator(self.0@)
    }
}
...
pub struct SpecKeyShareClientHelloCombinator(Mapped<SpecDepend<SpecUint0FfffCombinator, SpecKeyShareClientHelloClientSharesCombinator>, KeyShareClientHelloMapper>);
...
pub struct KeyShareClientHelloCombinator(Mapped<Depend<Uint0FfffCombinator, KeyShareClientHelloClientSharesCombinator, KeyShareClientHelloCont>, KeyShareClientHelloMapper>);

impl View for KeyShareClientHelloCombinator {
    type V = SpecKeyShareClientHelloCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecKeyShareClientHelloCombinator(self.0@)
    }
}
...
pub struct SpecUnknownExtensionCombinator(SpecOpaque0FfffCombinator);
...
pub struct UnknownExtensionCombinator(Opaque0FfffCombinator);

impl View for UnknownExtensionCombinator {
    type V = SpecUnknownExtensionCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecUnknownExtensionCombinator(self.0@)
    }
}
...
pub struct SpecClientHelloExtensionCombinator(Mapped<SpecDepend<(SpecExtensionTypeCombinator, U16Be), SpecClientHelloExtensionExtensionDataCombinator>, ClientHelloExtensionMapper>);
...
pub struct ClientHelloExtensionCombinator(Mapped<Depend<(ExtensionTypeCombinator, U16Be), ClientHelloExtensionExtensionDataCombinator, ClientHelloExtensionCont>, ClientHelloExtensionMapper>);

impl View for ClientHelloExtensionCombinator {
    type V = SpecClientHelloExtensionCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecClientHelloExtensionCombinator(self.0@)
    }
}
...
pub struct SpecClientExtensionsExtensionsCombinator(AndThen<Bytes, Repeat<SpecClientHelloExtensionCombinator>>);
...
pub struct ClientExtensionsExtensionsCombinator(AndThen<Bytes, Repeat<ClientHelloExtensionCombinator>>);

impl View for ClientExtensionsExtensionsCombinator {
    type V = SpecClientExtensionsExtensionsCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecClientExtensionsExtensionsCombinator(self.0@)
    }
}
...
pub struct SpecClientExtensionsCombinator(Mapped<SpecDepend<Refined<U16Be, Predicate15770232246241775772>, SpecClientExtensionsExtensionsCombinator>, ClientExtensionsMapper>);
...
pub struct ClientExtensionsCombinator(Mapped<Depend<Refined<U16Be, Predicate15770232246241775772>, ClientExtensionsExtensionsCombinator, ClientExtensionsCont>, ClientExtensionsMapper>);

impl View for ClientExtensionsCombinator {
    type V = SpecClientExtensionsCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecClientExtensionsCombinator(self.0@)
    }
}
...
pub struct SpecClientHelloCombinator(Mapped<(SpecProtocolVersionCombinator, (SpecRandomCombinator, (SpecSessionIdCombinator, (SpecCipherSuiteListCombinator, (SpecOpaque1FfCombinator, SpecClientExtensionsCombinator))))), ClientHelloMapper>);
...
pub struct ClientHelloCombinator(Mapped<(ProtocolVersionCombinator, (RandomCombinator, (SessionIdCombinator, (CipherSuiteListCombinator, (Opaque1FfCombinator, ClientExtensionsCombinator))))), ClientHelloMapper>);

impl View for ClientHelloCombinator {
    type V = SpecClientHelloCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecClientHelloCombinator(self.0@)
    }
}
...
pub struct SpecNameTypeCombinator(U8);
...
pub struct NameTypeCombinator(U8);

impl View for NameTypeCombinator {
    type V = SpecNameTypeCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecNameTypeCombinator(self.0@)
    }
}
...
pub struct SpecHostNameCombinator(SpecOpaque1FfffCombinator);
...
pub struct HostNameCombinator(Opaque1FfffCombinator);

impl View for HostNameCombinator {
    type V = SpecHostNameCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecHostNameCombinator(self.0@)
    }
}
...
pub struct SpecUnknownNameCombinator(SpecOpaque1FfffCombinator);
...
pub struct UnknownNameCombinator(Opaque1FfffCombinator);

impl View for UnknownNameCombinator {
    type V = SpecUnknownNameCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecUnknownNameCombinator(self.0@)
    }
}
...
pub struct SpecServerNameNameCombinator(Mapped<OrdChoice<Cond<SpecHostNameCombinator>, Cond<SpecUnknownNameCombinator>>, ServerNameNameMapper>);
...
pub struct ServerNameNameCombinator(Mapped<OrdChoice<Cond<HostNameCombinator>, Cond<UnknownNameCombinator>>, ServerNameNameMapper>);

impl View for ServerNameNameCombinator {
    type V = SpecServerNameNameCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecServerNameNameCombinator(self.0@)
    }
}
...
pub struct SpecServerNameCombinator(Mapped<SpecDepend<SpecNameTypeCombinator, SpecServerNameNameCombinator>, ServerNameMapper>);
...
pub struct ServerNameCombinator(Mapped<Depend<NameTypeCombinator, ServerNameNameCombinator, ServerNameCont>, ServerNameMapper>);

impl View for ServerNameCombinator {
    type V = SpecServerNameCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecServerNameCombinator(self.0@)
    }
}
...
pub struct SpecServerNameListListCombinator(AndThen<Bytes, Repeat<SpecServerNameCombinator>>);
...
pub struct ServerNameListListCombinator(AndThen<Bytes, Repeat<ServerNameCombinator>>);

impl View for ServerNameListListCombinator {
    type V = SpecServerNameListListCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecServerNameListListCombinator(self.0@)
    }
}
...
pub struct SpecServerNameListCombinator(Mapped<SpecDepend<SpecUint1FfffCombinator, SpecServerNameListListCombinator>, ServerNameListMapper>);
...
pub struct ServerNameListCombinator(Mapped<Depend<Uint1FfffCombinator, ServerNameListListCombinator, ServerNameListCont>, ServerNameListMapper>);

impl View for ServerNameListCombinator {
    type V = SpecServerNameListCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecServerNameListCombinator(self.0@)
    }
}
...
pub struct SpecResponderIdCombinator(SpecOpaque1FfffCombinator);
...
pub struct ResponderIdCombinator(Opaque1FfffCombinator);
...
pub struct SpecResponderIdListCombinator(Mapped<SpecDepend<SpecUint0FfffCombinator, SpecResponderIdListListCombinator>, ResponderIdListMapper>);
...
pub struct ResponderIdListCombinator(Mapped<Depend<Uint0FfffCombinator, ResponderIdListListCombinator, ResponderIdListCont>, ResponderIdListMapper>);
...
pub struct SpecOscpStatusRequestCombinator(Mapped<(SpecResponderIdListCombinator, SpecOcspExtensionsCombinator), OscpStatusRequestMapper>);
...
pub struct OscpStatusRequestCombinator(Mapped<(ResponderIdListCombinator, OcspExtensionsCombinator), OscpStatusRequestMapper>);

impl View for OscpStatusRequestCombinator {
    type V = SpecOscpStatusRequestCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecOscpStatusRequestCombinator(self.0@)
    }
}
...
pub struct SpecCertificateStatusRequestCombinator(Mapped<(Refined<U8, TagPred<u8>>, SpecOscpStatusRequestCombinator), CertificateStatusRequestMapper>);
...
pub struct CertificateStatusRequestCombinator(Mapped<(Refined<U8, TagPred<u8>>, OscpStatusRequestCombinator), CertificateStatusRequestMapper>);

impl View for CertificateStatusRequestCombinator {
    type V = SpecCertificateStatusRequestCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecCertificateStatusRequestCombinator(self.0@)
    }
}
...
pub struct SpecNamedGroupListListCombinator(AndThen<Bytes, Repeat<SpecNamedGroupCombinator>>);
...
pub struct NamedGroupListListCombinator(AndThen<Bytes, Repeat<NamedGroupCombinator>>);

impl View for NamedGroupListListCombinator {
    type V = SpecNamedGroupListListCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecNamedGroupListListCombinator(self.0@)
    }
}
...
pub struct SpecNamedGroupListCombinator(Mapped<SpecDepend<SpecUint2FfffCombinator, SpecNamedGroupListListCombinator>, NamedGroupListMapper>);
...
pub struct NamedGroupListCombinator(Mapped<Depend<Uint2FfffCombinator, NamedGroupListListCombinator, NamedGroupListCont>, NamedGroupListMapper>);

impl View for NamedGroupListCombinator {
    type V = SpecNamedGroupListCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecNamedGroupListCombinator(self.0@)
    }
}
...
pub struct SpecSeverHelloExtensionExtensionDataCombinator(AndThen<Bytes, Mapped<OrdChoice<Cond<SpecServerNameListCombinator>, OrdChoice<Cond<SpecMaxFragmentLengthCombinator>, OrdChoice<Cond<SpecCertificateStatusRequestCombinator>, OrdChoice<Cond<SpecNamedGroupListCombinator>, OrdChoice<Cond<SpecEcPointFormatListCombinator>, OrdChoice<Cond<SpecSignatureSchemeListCombinator>, OrdChoice<Cond<SpecSrtpProtectionProfilesCombinator>, OrdChoice<Cond<SpecHeartbeatModeCombinator>, OrdChoice<Cond<SpecProtocolNameListCombinator>, OrdChoice<Cond<SpecSignedCertificateTimestampListCombinator>, OrdChoice<Cond<SpecClientCertTypeClientExtensionCombinator>, OrdChoice<Cond<SpecServerCertTypeClientExtensionCombinator>, OrdChoice<Cond<SpecPaddingExtensionCombinator>, OrdChoice<Cond<SpecEmptyCombinator>, OrdChoice<Cond<SpecEmptyCombinator>, OrdChoice<Cond<SpecSessionTicketCombinator>, OrdChoice<Cond<SpecPreSharedKeyClientExtensionCombinator>, OrdChoice<Cond<SpecEmptyCombinator>, OrdChoice<Cond<SpecSupportedVersionsClientCombinator>, OrdChoice<Cond<SpecCookieCombinator>, OrdChoice<Cond<SpecPskKeyExchangeModesCombinator>, OrdChoice<Cond<SpecCertificateAuthoritiesExtensionCombinator>, OrdChoice<Cond<SpecOidFilterExtensionCombinator>, OrdChoice<Cond<SpecEmptyCombinator>, OrdChoice<Cond<SpecSignatureSchemeListCombinator>, OrdChoice<Cond<SpecKeyShareClientHelloCombinator>, Cond<SpecUnknownExtensionCombinator>>>>>>>>>>>>>>>>>>>>>>>>>>>, SeverHelloExtensionExtensionDataMapper>>);
...
pub struct SpecSeverHelloExtensionCombinator(Mapped<SpecDepend<(SpecExtensionTypeCombinator, U16Be), SpecSeverHelloExtensionExtensionDataCombinator>, SeverHelloExtensionMapper>);
...
pub struct SeverHelloExtensionCombinator(Mapped<Depend<(ExtensionTypeCombinator, U16Be), SeverHelloExtensionExtensionDataCombinator, SeverHelloExtensionCont>, SeverHelloExtensionMapper>);

impl View for SeverHelloExtensionCombinator {
    type V = SpecSeverHelloExtensionCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecSeverHelloExtensionCombinator(self.0@)
    }
}
...
pub struct SpecServerExtensionsExtensionsCombinator(AndThen<Bytes, Repeat<SpecSeverHelloExtensionCombinator>>);
...
pub struct ServerExtensionsExtensionsCombinator(AndThen<Bytes, Repeat<SeverHelloExtensionCombinator>>);

impl View for ServerExtensionsExtensionsCombinator {
    type V = SpecServerExtensionsExtensionsCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecServerExtensionsExtensionsCombinator(self.0@)
    }
}
...
pub struct SpecServerExtensionsCombinator(Mapped<SpecDepend<Refined<U16Be, Predicate503472032047519273>, SpecServerExtensionsExtensionsCombinator>, ServerExtensionsMapper>);
...
pub struct ServerExtensionsCombinator(Mapped<Depend<Refined<U16Be, Predicate503472032047519273>, ServerExtensionsExtensionsCombinator, ServerExtensionsCont>, ServerExtensionsMapper>);

impl View for ServerExtensionsCombinator {
    type V = SpecServerExtensionsCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecServerExtensionsCombinator(self.0@)
    }
}
...
pub struct SpecServerHelloCombinator(Mapped<(SpecProtocolVersionCombinator, (SpecRandomCombinator, (SpecSessionIdCombinator, (SpecCipherSuiteCombinator, (Refined<U8, TagPred<u8>>, SpecServerExtensionsCombinator))))), ServerHelloMapper>);
...
pub struct ServerHelloCombinator(Mapped<(ProtocolVersionCombinator, (RandomCombinator, (SessionIdCombinator, (CipherSuiteCombinator, (Refined<U8, TagPred<u8>>, ServerExtensionsCombinator))))), ServerHelloMapper>);
...
pub struct SpecUint0FffeCombinator(Refined<U16Be, Predicate184937773087435626>);
...
pub struct Uint0FffeCombinator(Refined<U16Be, Predicate184937773087435626>);

impl View for Uint0FffeCombinator {
    type V = SpecUint0FffeCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecUint0FffeCombinator(self.0@)
    }
}
...
pub struct SpecExtensionCombinator(Mapped<(SpecExtensionTypeCombinator, SpecOpaque0FfffCombinator), ExtensionMapper>);
...
pub struct ExtensionCombinator(Mapped<(ExtensionTypeCombinator, Opaque0FfffCombinator), ExtensionMapper>);

impl View for ExtensionCombinator {
    type V = SpecExtensionCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecExtensionCombinator(self.0@)
    }
}
...
pub struct SpecNewSessionTicketExtensionsExtensionsCombinator(AndThen<Bytes, Repeat<SpecExtensionCombinator>>);
...
pub struct NewSessionTicketExtensionsExtensionsCombinator(AndThen<Bytes, Repeat<ExtensionCombinator>>);

impl View for NewSessionTicketExtensionsExtensionsCombinator {
    type V = SpecNewSessionTicketExtensionsExtensionsCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecNewSessionTicketExtensionsExtensionsCombinator(self.0@)
    }
}
...
pub struct SpecNewSessionTicketExtensionsCombinator(Mapped<SpecDepend<SpecUint0FffeCombinator, SpecNewSessionTicketExtensionsExtensionsCombinator>, NewSessionTicketExtensionsMapper>);
...
pub struct NewSessionTicketExtensionsCombinator(Mapped<Depend<Uint0FffeCombinator, NewSessionTicketExtensionsExtensionsCombinator, NewSessionTicketExtensionsCont>, NewSessionTicketExtensionsMapper>);

impl View for NewSessionTicketExtensionsCombinator {
    type V = SpecNewSessionTicketExtensionsCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecNewSessionTicketExtensionsCombinator(self.0@)
    }
}
...
pub struct SpecNewSessionTicketCombinator(Mapped<(U32Be, (U32Be, (SpecOpaque0FfCombinator, (SpecOpaque1FfffCombinator, SpecNewSessionTicketExtensionsCombinator)))), NewSessionTicketMapper>);
...
pub struct NewSessionTicketCombinator(Mapped<(U32Be, (U32Be, (Opaque0FfCombinator, (Opaque1FfffCombinator, NewSessionTicketExtensionsCombinator)))), NewSessionTicketMapper>);

impl View for NewSessionTicketCombinator {
    type V = SpecNewSessionTicketCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecNewSessionTicketCombinator(self.0@)
    }
}
...
pub struct SpecEncryptedExtensionsExtensionsCombinator(AndThen<Bytes, Repeat<SpecExtensionCombinator>>);
...
pub struct EncryptedExtensionsExtensionsCombinator(AndThen<Bytes, Repeat<ExtensionCombinator>>);

impl View for EncryptedExtensionsExtensionsCombinator {
    type V = SpecEncryptedExtensionsExtensionsCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecEncryptedExtensionsExtensionsCombinator(self.0@)
    }
}
...
pub struct SpecEncryptedExtensionsCombinator(Mapped<SpecDepend<SpecUint0FfffCombinator, SpecEncryptedExtensionsExtensionsCombinator>, EncryptedExtensionsMapper>);
...
pub struct EncryptedExtensionsCombinator(Mapped<Depend<Uint0FfffCombinator, EncryptedExtensionsExtensionsCombinator, EncryptedExtensionsCont>, EncryptedExtensionsMapper>);

impl View for EncryptedExtensionsCombinator {
    type V = SpecEncryptedExtensionsCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecEncryptedExtensionsCombinator(self.0@)
    }
}
...
pub struct SpecOpaque1FfffffCombinator(Mapped<SpecDepend<Refined<U24Be, Predicate10565972399076720534>, Bytes>, Opaque1FfffffMapper>);
...
pub struct Opaque1FfffffCombinator(Mapped<Depend<Refined<U24Be, Predicate10565972399076720534>, Bytes, Opaque1FfffffCont>, Opaque1FfffffMapper>);

impl View for Opaque1FfffffCombinator {
    type V = SpecOpaque1FfffffCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecOpaque1FfffffCombinator(self.0@)
    }
}
...
pub struct SpecCertificateExtensionsCombinator(SpecEncryptedExtensionsCombinator);
...
pub struct CertificateExtensionsCombinator(EncryptedExtensionsCombinator);

impl View for CertificateExtensionsCombinator {
    type V = SpecCertificateExtensionsCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecCertificateExtensionsCombinator(self.0@)
    }
}
...
pub struct SpecCertificateEntryCombinator(Mapped<(SpecOpaque1FfffffCombinator, SpecCertificateExtensionsCombinator), CertificateEntryMapper>);
...
pub struct CertificateEntryCombinator(Mapped<(Opaque1FfffffCombinator, CertificateExtensionsCombinator), CertificateEntryMapper>);

impl View for CertificateEntryCombinator {
    type V = SpecCertificateEntryCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecCertificateEntryCombinator(self.0@)
    }
}
...
pub struct SpecCertificateListListCombinator(AndThen<Bytes, Repeat<SpecCertificateEntryCombinator>>);
...
pub struct CertificateListListCombinator(AndThen<Bytes, Repeat<CertificateEntryCombinator>>);

impl View for CertificateListListCombinator {
    type V = SpecCertificateListListCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecCertificateListListCombinator(self.0@)
    }
}
...
pub struct SpecCertificateListCombinator(Mapped<SpecDepend<U24Be, SpecCertificateListListCombinator>, CertificateListMapper>);
...
pub struct CertificateListCombinator(Mapped<Depend<U24Be, CertificateListListCombinator, CertificateListCont>, CertificateListMapper>);

impl View for CertificateListCombinator {
    type V = SpecCertificateListCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecCertificateListCombinator(self.0@)
    }
}
...
pub struct SpecCertificateCombinator(Mapped<(SpecOpaque0FfCombinator, SpecCertificateListCombinator), CertificateMapper>);
...
pub struct CertificateCombinator(Mapped<(Opaque0FfCombinator, CertificateListCombinator), CertificateMapper>);

impl View for CertificateCombinator {
    type V = SpecCertificateCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecCertificateCombinator(self.0@)
    }
}
...
pub struct SpecCertificateRequestExtensionsExtensionsCombinator(AndThen<Bytes, Repeat<SpecExtensionCombinator>>);
...
pub struct CertificateRequestExtensionsExtensionsCombinator(AndThen<Bytes, Repeat<ExtensionCombinator>>);
...
impl View for CertificateRequestExtensionsExtensionsCombinator {
    ...
    closed spec fn view(&self) -> Self::V {
        SpecCertificateRequestExtensionsExtensionsCombinator(self.0@)
    }
}
...
pub struct SpecCertificateRequestExtensionsCombinator(Mapped<SpecDepend<SpecUint2FfffCombinator, SpecCertificateRequestExtensionsExtensionsCombinator>, CertificateRequestExtensionsMapper>);
...
pub struct CertificateRequestExtensionsCombinator(Mapped<Depend<Uint2FfffCombinator, CertificateRequestExtensionsExtensionsCombinator, CertificateRequestExtensionsCont>, CertificateRequestExtensionsMapper>);

impl View for CertificateRequestExtensionsCombinator {
    type V = SpecCertificateRequestExtensionsCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecCertificateRequestExtensionsCombinator(self.0@)
    }
}
...
pub struct SpecCertificateRequestCombinator(Mapped<(SpecOpaque0FfCombinator, SpecCertificateRequestExtensionsCombinator), CertificateRequestMapper>);
...
pub struct CertificateRequestCombinator(Mapped<(Opaque0FfCombinator, CertificateRequestExtensionsCombinator), CertificateRequestMapper>);

impl View for CertificateRequestCombinator {
    type V = SpecCertificateRequestCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecCertificateRequestCombinator(self.0@)
    }
}
...
pub struct SpecCertificateVerifyCombinator(Mapped<(SpecSignatureSchemeCombinator, SpecOpaque0FfffCombinator), CertificateVerifyMapper>);
...
pub struct CertificateVerifyCombinator(Mapped<(SignatureSchemeCombinator, Opaque0FfffCombinator), CertificateVerifyMapper>);

impl View for CertificateVerifyCombinator {
    type V = SpecCertificateVerifyCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecCertificateVerifyCombinator(self.0@)
    }
}
...
pub struct SpecFinishedCombinator(Bytes);
...
pub struct FinishedCombinator(Bytes);

impl View for FinishedCombinator {
    type V = SpecFinishedCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecFinishedCombinator(self.0@)
    }
}
...
pub struct SpecKeyUpdateRequestCombinator(TryMap<U8, KeyUpdateRequestMapper>);
...
pub struct KeyUpdateRequestCombinator(TryMap<U8, KeyUpdateRequestMapper>);

impl View for KeyUpdateRequestCombinator {
    type V = SpecKeyUpdateRequestCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecKeyUpdateRequestCombinator(self.0@)
    }
}
...
pub struct SpecKeyUpdateCombinator(Mapped<SpecKeyUpdateRequestCombinator, KeyUpdateMapper>);
...
pub struct KeyUpdateCombinator(Mapped<KeyUpdateRequestCombinator, KeyUpdateMapper>);

impl View for KeyUpdateCombinator {
    type V = SpecKeyUpdateCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecKeyUpdateCombinator(self.0@)
    }
}
...
pub struct SpecPreSharedKeyServerExtensionCombinator(Mapped<U16Be, PreSharedKeyServerExtensionMapper>);
...
pub struct PreSharedKeyServerExtensionCombinator(Mapped<U16Be, PreSharedKeyServerExtensionMapper>);

impl View for PreSharedKeyServerExtensionCombinator {
    type V = SpecPreSharedKeyServerExtensionCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecPreSharedKeyServerExtensionCombinator(self.0@)
    }
}
...
pub struct SpecHandshakeTypeCombinator(TryMap<U8, HandshakeTypeMapper>);
...
pub struct HandshakeTypeCombinator(TryMap<U8, HandshakeTypeMapper>);

impl View for HandshakeTypeCombinator {
    type V = SpecHandshakeTypeCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecHandshakeTypeCombinator(self.0@)
    }
}
...
pub struct SpecServerCertTypeServerExtensionCombinator(Mapped<SpecCertificateTypeCombinator, ServerCertTypeServerExtensionMapper>);
...
pub struct ServerCertTypeServerExtensionCombinator(Mapped<CertificateTypeCombinator, ServerCertTypeServerExtensionMapper>);

impl View for ServerCertTypeServerExtensionCombinator {
    type V = SpecServerCertTypeServerExtensionCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecServerCertTypeServerExtensionCombinator(self.0@)
    }
}
...
pub struct SpecSupportedVersionsServerCombinator(Mapped<SpecProtocolVersionCombinator, SupportedVersionsServerMapper>);
...
pub struct SupportedVersionsServerCombinator(Mapped<ProtocolVersionCombinator, SupportedVersionsServerMapper>);

impl View for SupportedVersionsServerCombinator {
    type V = SpecSupportedVersionsServerCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecSupportedVersionsServerCombinator(self.0@)
    }
}
...
pub struct SpecOcspResponseCombinator(SpecOpaque1FfffffCombinator);
...
pub struct OcspResponseCombinator(Opaque1FfffffCombinator);

impl View for OcspResponseCombinator {
    type V = SpecOcspResponseCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecOcspResponseCombinator(self.0@)
    }
}
...
pub struct SpecCertificateStatusCombinator(Mapped<(Refined<U8, TagPred<u8>>, SpecOcspResponseCombinator), CertificateStatusMapper>);
...
pub struct CertificateStatusCombinator(Mapped<(Refined<U8, TagPred<u8>>, OcspResponseCombinator), CertificateStatusMapper>);

impl View for CertificateStatusCombinator {
    type V = SpecCertificateStatusCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecCertificateStatusCombinator(self.0@)
    }
}
...
pub struct SpecOpaque2FfffCombinator(Mapped<SpecDepend<SpecUint2FfffCombinator, Bytes>, Opaque2FfffMapper>);
...
pub struct Opaque2FfffCombinator(Mapped<Depend<Uint2FfffCombinator, Bytes, Opaque2FfffCont>, Opaque2FfffMapper>);

impl View for Opaque2FfffCombinator {
    type V = SpecOpaque2FfffCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecOpaque2FfffCombinator(self.0@)
    }
}
...
pub struct SpecAlertLevelCombinator(TryMap<U8, AlertLevelMapper>);
...
pub struct AlertLevelCombinator(TryMap<U8, AlertLevelMapper>);

impl View for AlertLevelCombinator {
    type V = SpecAlertLevelCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecAlertLevelCombinator(self.0@)
    }
}
...
pub struct SpecEarlyDataIndicationNewSessionTicketCombinator(Mapped<U32Be, EarlyDataIndicationNewSessionTicketMapper>);
...
pub struct EarlyDataIndicationNewSessionTicketCombinator(Mapped<U32Be, EarlyDataIndicationNewSessionTicketMapper>);

impl View for EarlyDataIndicationNewSessionTicketCombinator {
    type V = SpecEarlyDataIndicationNewSessionTicketCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecEarlyDataIndicationNewSessionTicketCombinator(self.0@)
    }
}
...
pub struct SpecContentTypeCombinator(TryMap<U8, ContentTypeMapper>);
...
pub struct ContentTypeCombinator(TryMap<U8, ContentTypeMapper>);
...
pub struct SpecTlsPlaintextCombinator(Mapped<(SpecContentTypeCombinator, (SpecProtocolVersionCombinator, SpecOpaque0FfffCombinator)), TlsPlaintextMapper>);
...
pub struct TlsPlaintextCombinator(Mapped<(ContentTypeCombinator, (ProtocolVersionCombinator, Opaque0FfffCombinator)), TlsPlaintextMapper>);

impl View for TlsPlaintextCombinator {
    type V = SpecTlsPlaintextCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecTlsPlaintextCombinator(self.0@)
    }
}
...
pub struct SpecHeartbeatExtensionCombinator(Mapped<SpecHeartbeatModeCombinator, HeartbeatExtensionMapper>);
...
pub struct HeartbeatExtensionCombinator(Mapped<HeartbeatModeCombinator, HeartbeatExtensionMapper>);

impl View for HeartbeatExtensionCombinator {
    type V = SpecHeartbeatExtensionCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecHeartbeatExtensionCombinator(self.0@)
    }
}
...
pub struct SpecTlsCiphertextCombinator(Mapped<(SpecContentTypeCombinator, (SpecProtocolVersionCombinator, SpecOpaque0FfffCombinator)), TlsCiphertextMapper>);
...
pub struct TlsCiphertextCombinator(Mapped<(ContentTypeCombinator, (ProtocolVersionCombinator, Opaque0FfffCombinator)), TlsCiphertextMapper>);

impl View for TlsCiphertextCombinator {
    type V = SpecTlsCiphertextCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecTlsCiphertextCombinator(self.0@)
    }
}
...
pub struct SpecAlertCombinator(Mapped<(SpecAlertLevelCombinator, SpecAlertDescriptionCombinator), AlertMapper>);
...
pub struct AlertCombinator(Mapped<(AlertLevelCombinator, AlertDescriptionCombinator), AlertMapper>);

impl View for AlertCombinator {
    type V = SpecAlertCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecAlertCombinator(self.0@)
    }
}
...
pub struct SpecHandshakeCombinator(Mapped<SpecDepend<(SpecHandshakeTypeCombinator, U24Be), SpecHandshakeMsgCombinator>, HandshakeMapper>);
...
pub struct HandshakeCombinator(Mapped<Depend<(HandshakeTypeCombinator, U24Be), HandshakeMsgCombinator, HandshakeCont>, HandshakeMapper>);

impl View for HandshakeCombinator {
    type V = SpecHandshakeCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecHandshakeCombinator(self.0@)
    }
}
...
pub struct SpecOpaque0FfffffCombinator(Mapped<SpecDepend<U24Be, Bytes>, Opaque0FfffffMapper>);
...
pub struct Opaque0FfffffCombinator(Mapped<Depend<U24Be, Bytes, Opaque0FfffffCont>, Opaque0FfffffMapper>);

impl View for Opaque0FfffffCombinator {
    type V = SpecOpaque0FfffffCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecOpaque0FfffffCombinator(self.0@)
    }
}
...
pub struct SpecClientCertTypeServerExtensionCombinator(Mapped<SpecCertificateTypeCombinator, ClientCertTypeServerExtensionMapper>);
...
pub struct ClientCertTypeServerExtensionCombinator(Mapped<CertificateTypeCombinator, ClientCertTypeServerExtensionMapper>);

impl View for ClientCertTypeServerExtensionCombinator {
    type V = SpecClientCertTypeServerExtensionCombinator;

    closed spec fn view(&self) -> Self::V {
        SpecClientCertTypeServerExtensionCombinator(self.0@)
    }
}
...
pub closed spec fn spec_session_id() -> SpecSessionIdCombinator {
    ...
    SpecSessionIdCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: SessionIdMapper })
}
    ...
    ensures o@ == spec_session_id(),
{
    ...
    SessionIdCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: SessionIdMapper })
}
...
pub closed spec fn spec_montgomery_point32() -> SpecMontgomeryPoint32Combinator {
    SpecMontgomeryPoint32Combinator(Mapped { inner: (Refined { inner: U8, predicate: TagPred(MONTGOMERYPOINT32_LEGACY_FORM) }, BytesN::<32>), mapper: MontgomeryPoint32Mapper })
}
...
{
    MontgomeryPoint32Combinator(Mapped { inner: (Refined { inner: U8, predicate: TagPred(MONTGOMERYPOINT32_LEGACY_FORM) }, BytesN::<32>), mapper: MontgomeryPoint32Mapper })
}
...
pub closed spec fn spec_montgomery_form56() -> SpecMontgomeryForm56Combinator {
    SpecMontgomeryForm56Combinator(Mapped { inner: (Refined { inner: U8, predicate: TagPred(MONTGOMERYFORM56_LEGACY_FORM) }, BytesN::<56>), mapper: MontgomeryForm56Mapper })
}
...
{
    MontgomeryForm56Combinator(Mapped { inner: (Refined { inner: U8, predicate: TagPred(MONTGOMERYFORM56_LEGACY_FORM) }, BytesN::<56>), mapper: MontgomeryForm56Mapper })
}
...
pub closed spec fn spec_opaque_1_ffff() -> SpecOpaque1FfffCombinator {
    ...
    SpecOpaque1FfffCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: Opaque1FfffMapper })
}
    ...
    ensures o@ == spec_opaque_1_ffff(),
{
    ...
    Opaque1FfffCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: Opaque1FfffMapper })
}
...
pub closed spec fn spec_opaque_0_ffff() -> SpecOpaque0FfffCombinator {
    ...
    SpecOpaque0FfffCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: Opaque0FfffMapper })
}
    ...
    ensures o@ == spec_opaque_0_ffff(),
{
    ...
    Opaque0FfffCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: Opaque0FfffMapper })
}
...
pub closed spec fn spec_server_cert_type_client_extension() -> SpecServerCertTypeClientExtensionCombinator {
    ...
    SpecServerCertTypeClientExtensionCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: ServerCertTypeClientExtensionMapper })
}
    ...
    ensures o@ == spec_server_cert_type_client_extension(),
{
    ...
    ServerCertTypeClientExtensionCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: ServerCertTypeClientExtensionMapper })
}
...
pub closed spec fn spec_cipher_suite_list() -> SpecCipherSuiteListCombinator {
    ...
    SpecCipherSuiteListCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: CipherSuiteListMapper })
}
    ...
    ensures o@ == spec_cipher_suite_list(),
{
    ...
    CipherSuiteListCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: CipherSuiteListMapper })
}
...
pub closed spec fn spec_opaque_1_ff() -> SpecOpaque1FfCombinator {
    ...
    SpecOpaque1FfCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: Opaque1FfMapper })
}
    ...
    ensures o@ == spec_opaque_1_ff(),
{
    ...
    Opaque1FfCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: Opaque1FfMapper })
}
...
pub closed spec fn spec_ec_point_format_list() -> SpecEcPointFormatListCombinator {
    ...
    SpecEcPointFormatListCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: EcPointFormatListMapper })
}
    ...
    ensures o@ == spec_ec_point_format_list(),
{
    ...
    EcPointFormatListCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: EcPointFormatListMapper })
}
...
pub closed spec fn spec_srtp_protection_profiles() -> SpecSrtpProtectionProfilesCombinator {
    ...
    SpecSrtpProtectionProfilesCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: SrtpProtectionProfilesMapper })
}
    ...
    ensures o@ == spec_srtp_protection_profiles(),
{
    ...
    SrtpProtectionProfilesCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: SrtpProtectionProfilesMapper })
}
...
pub closed spec fn spec_opaque_0_ff() -> SpecOpaque0FfCombinator {
    ...
    SpecOpaque0FfCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: Opaque0FfMapper })
}
    ...
    ensures o@ == spec_opaque_0_ff(),
{
    ...
    Opaque0FfCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: Opaque0FfMapper })
}
...
pub closed spec fn spec_protocol_name_list() -> SpecProtocolNameListCombinator {
    ...
    SpecProtocolNameListCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: ProtocolNameListMapper })
}
    ...
    ensures o@ == spec_protocol_name_list(),
{
    ...
    ProtocolNameListCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: ProtocolNameListMapper })
}
...
pub closed spec fn spec_signed_certificate_timestamp_list() -> SpecSignedCertificateTimestampListCombinator {
    ...
    SpecSignedCertificateTimestampListCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: SignedCertificateTimestampListMapper })
}
    ...
    ensures o@ == spec_signed_certificate_timestamp_list(),
{
    ...
    SignedCertificateTimestampListCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: SignedCertificateTimestampListMapper })
}
...
pub closed spec fn spec_client_cert_type_client_extension() -> SpecClientCertTypeClientExtensionCombinator {
    ...
    SpecClientCertTypeClientExtensionCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: ClientCertTypeClientExtensionMapper })
}
    ...
    ensures o@ == spec_client_cert_type_client_extension(),
{
    ...
    ClientCertTypeClientExtensionCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: ClientCertTypeClientExtensionMapper })
}
...
pub closed spec fn spec_padding_extension() -> SpecPaddingExtensionCombinator {
    ...
    SpecPaddingExtensionCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: PaddingExtensionMapper })
}
    ...
    ensures o@ == spec_padding_extension(),
{
    ...
    PaddingExtensionCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: PaddingExtensionMapper })
}
...
pub closed spec fn spec_psk_identities() -> SpecPskIdentitiesCombinator {
    ...
    SpecPskIdentitiesCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: PskIdentitiesMapper })
}
    ...
    ensures o@ == spec_psk_identities(),
{
    ...
    PskIdentitiesCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: PskIdentitiesMapper })
}
...
pub closed spec fn spec_psk_binder_entry() -> SpecPskBinderEntryCombinator {
    ...
    SpecPskBinderEntryCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: PskBinderEntryMapper })
}
    ...
    ensures o@ == spec_psk_binder_entry(),
{
    ...
    PskBinderEntryCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: PskBinderEntryMapper })
}
...
pub closed spec fn spec_psk_binder_entries() -> SpecPskBinderEntriesCombinator {
    ...
    SpecPskBinderEntriesCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: PskBinderEntriesMapper })
}
    ...
    ensures o@ == spec_psk_binder_entries(),
{
    ...
    PskBinderEntriesCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: PskBinderEntriesMapper })
}
...
pub closed spec fn spec_supported_versions_client() -> SpecSupportedVersionsClientCombinator {
    ...
    SpecSupportedVersionsClientCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: SupportedVersionsClientMapper })
}
    ...
    ensures o@ == spec_supported_versions_client(),
{
    ...
    SupportedVersionsClientCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: SupportedVersionsClientMapper })
}
...
pub closed spec fn spec_psk_key_exchange_modes() -> SpecPskKeyExchangeModesCombinator {
    ...
    SpecPskKeyExchangeModesCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: PskKeyExchangeModesMapper })
}
    ...
    ensures o@ == spec_psk_key_exchange_modes(),
{
    ...
    PskKeyExchangeModesCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: PskKeyExchangeModesMapper })
}
...
pub closed spec fn spec_certificate_authorities_extension() -> SpecCertificateAuthoritiesExtensionCombinator {
    ...
    SpecCertificateAuthoritiesExtensionCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: CertificateAuthoritiesExtensionMapper })
}
    ...
    ensures o@ == spec_certificate_authorities_extension(),
{
    ...
    CertificateAuthoritiesExtensionCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: CertificateAuthoritiesExtensionMapper })
}
...
pub closed spec fn spec_oid_filter_extension() -> SpecOidFilterExtensionCombinator {
    ...
    SpecOidFilterExtensionCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: OidFilterExtensionMapper })
}
    ...
    ensures o@ == spec_oid_filter_extension(),
{
    ...
    OidFilterExtensionCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: OidFilterExtensionMapper })
}
...
pub closed spec fn spec_signature_scheme_list() -> SpecSignatureSchemeListCombinator {
    ...
    SpecSignatureSchemeListCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: SignatureSchemeListMapper })
}
    ...
    ensures o@ == spec_signature_scheme_list(),
{
    ...
    SignatureSchemeListCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: SignatureSchemeListMapper })
}
...
pub closed spec fn spec_key_share_entry() -> SpecKeyShareEntryCombinator {
    ...
    SpecKeyShareEntryCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: KeyShareEntryMapper })
}
    ...
    ensures o@ == spec_key_share_entry(),
{
    ...
    KeyShareEntryCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: KeyShareEntryMapper })
}
...
pub closed spec fn spec_key_share_client_hello() -> SpecKeyShareClientHelloCombinator {
    ...
    SpecKeyShareClientHelloCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: KeyShareClientHelloMapper })
}
    ...
    ensures o@ == spec_key_share_client_hello(),
{
    ...
    KeyShareClientHelloCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: KeyShareClientHelloMapper })
}
...
pub closed spec fn spec_client_hello_extension() -> SpecClientHelloExtensionCombinator {
    ...
    SpecClientHelloExtensionCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: ClientHelloExtensionMapper })
}
    ...
    ensures o@ == spec_client_hello_extension(),
{
    ...
    ClientHelloExtensionCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: ClientHelloExtensionMapper })
}
...
pub closed spec fn spec_client_extensions() -> SpecClientExtensionsCombinator {
    ...
    SpecClientExtensionsCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: ClientExtensionsMapper })
}
    ...
    ensures o@ == spec_client_extensions(),
{
    ...
    ClientExtensionsCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: ClientExtensionsMapper })
}
...
pub closed spec fn spec_server_name() -> SpecServerNameCombinator {
    ...
    SpecServerNameCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: ServerNameMapper })
}
    ...
    ensures o@ == spec_server_name(),
{
    ...
    ServerNameCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: ServerNameMapper })
}
...
pub closed spec fn spec_server_name_list() -> SpecServerNameListCombinator {
    ...
    SpecServerNameListCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: ServerNameListMapper })
}
    ...
    ensures o@ == spec_server_name_list(),
{
    ...
    ServerNameListCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: ServerNameListMapper })
}
...
pub closed spec fn spec_responder_id_list() -> SpecResponderIdListCombinator {
    ...
    SpecResponderIdListCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: ResponderIdListMapper })
}
    ...
    ensures o@ == spec_responder_id_list(),
{
    ...
    ResponderIdListCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: ResponderIdListMapper })
}
...
pub closed spec fn spec_named_group_list() -> SpecNamedGroupListCombinator {
    ...
    SpecNamedGroupListCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: NamedGroupListMapper })
}
    ...
    ensures o@ == spec_named_group_list(),
{
    ...
    NamedGroupListCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: NamedGroupListMapper })
}
...
pub closed spec fn spec_sever_hello_extension() -> SpecSeverHelloExtensionCombinator {
    ...
    SpecSeverHelloExtensionCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: SeverHelloExtensionMapper })
}
    ...
    ensures o@ == spec_sever_hello_extension(),
{
    ...
    SeverHelloExtensionCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: SeverHelloExtensionMapper })
}
...
pub closed spec fn spec_server_extensions() -> SpecServerExtensionsCombinator {
    ...
    SpecServerExtensionsCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: ServerExtensionsMapper })
}
    ...
    ensures o@ == spec_server_extensions(),
{
    ...
    ServerExtensionsCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: ServerExtensionsMapper })
}
...
pub closed spec fn spec_new_session_ticket_extensions() -> SpecNewSessionTicketExtensionsCombinator {
    ...
    SpecNewSessionTicketExtensionsCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: NewSessionTicketExtensionsMapper })
}
    ...
    ensures o@ == spec_new_session_ticket_extensions(),
{
    ...
    NewSessionTicketExtensionsCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: NewSessionTicketExtensionsMapper })
}
...
pub closed spec fn spec_encrypted_extensions() -> SpecEncryptedExtensionsCombinator {
    ...
    SpecEncryptedExtensionsCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: EncryptedExtensionsMapper })
}
    ...
    ensures o@ == spec_encrypted_extensions(),
{
    ...
    EncryptedExtensionsCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: EncryptedExtensionsMapper })
}
...
pub closed spec fn spec_opaque_1_ffffff() -> SpecOpaque1FfffffCombinator {
    ...
    SpecOpaque1FfffffCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: Opaque1FfffffMapper })
}
    ...
    ensures o@ == spec_opaque_1_ffffff(),
{
    ...
    Opaque1FfffffCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: Opaque1FfffffMapper })
}
...
pub closed spec fn spec_certificate_list() -> SpecCertificateListCombinator {
    ...
    SpecCertificateListCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: CertificateListMapper })
}
    ...
    ensures o@ == spec_certificate_list(),
{
    ...
    CertificateListCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: CertificateListMapper })
}
...
pub closed spec fn spec_certificate_request_extensions() -> SpecCertificateRequestExtensionsCombinator {
    ...
    SpecCertificateRequestExtensionsCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: CertificateRequestExtensionsMapper })
}
    ...
    ensures o@ == spec_certificate_request_extensions(),
{
    ...
    CertificateRequestExtensionsCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: CertificateRequestExtensionsMapper })
}
...
pub closed spec fn spec_handshake_msg(msg_type: SpecHandshakeType, length: u24) -> SpecHandshakeMsgCombinator {
...
pub closed spec fn spec_opaque_2_ffff() -> SpecOpaque2FfffCombinator {
    ...
    SpecOpaque2FfffCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: Opaque2FfffMapper })
}
    ...
    ensures o@ == spec_opaque_2_ffff(),
{
    ...
    Opaque2FfffCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: Opaque2FfffMapper })
}
...
pub closed spec fn spec_handshake() -> SpecHandshakeCombinator {
    ...
    SpecHandshakeCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: HandshakeMapper })
}
    ...
    ensures o@ == spec_handshake(),
{
    ...
    HandshakeCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: HandshakeMapper })
}
...
pub closed spec fn spec_opaque_0_ffffff() -> SpecOpaque0FfffffCombinator {
    ...
    SpecOpaque0FfffffCombinator(Mapped { inner: SpecDepend { fst, snd }, mapper: Opaque0FfffffMapper })
}
    ...
    ensures o@ == spec_opaque_0_ffffff(),
{
    ...
    Opaque0FfffffCombinator(Mapped { inner: Depend { fst, snd, spec_snd }, mapper: Opaque0FfffffMapper })
}
