...
pub type SpecMsg1CombinatorAlias = Mapped<(Refined<U8, Predicate15164968237706789291>, (U16Le, bytes::Fixed<3>)), Msg1Mapper>;
...
pub type Msg1CombinatorAlias = Mapped<(Refined<U8, Predicate15164968237706789291>, (U16Le, bytes::Fixed<3>)), Msg1Mapper>;
...
pub type SpecMsg4VCombinatorAlias = Mapped<Choice<Cond<SpecMsg1Combinator>, Choice<Cond<SpecMsg2Combinator>, Cond<SpecMsg3Combinator>>>, Msg4VMapper>;
...
pub type Msg4VCombinatorAlias = Mapped<Choice<Cond<Msg1Combinator>, Choice<Cond<Msg2Combinator>, Cond<Msg3Combinator>>>, Msg4VMapper>;
...
{
    Msg4VCombinator(Mapped { inner: Choice::new(Cond { cond: t == AType::A, inner: msg1() }, Choice::new(Cond { cond: t == AType::B, inner: msg2() }, Cond { cond: t == AType::C, inner: msg3() })), mapper: Msg4VMapper })
}
