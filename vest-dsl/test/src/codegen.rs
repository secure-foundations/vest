...
{
    Msg4VCombinator(Mapped { inner: Msg4VCombinator2(Choice::new(Cond { cond: t == AType::A, inner: msg1() }, Msg4VCombinator1(Choice::new(Cond { cond: t == AType::B, inner: msg2() }, Cond { cond: t == AType::C, inner: msg3() })))), mapper: Msg4VMapper })
}
