...
pub struct SpecMsg5ContentCombinator(pub SpecMsg5ContentCombinatorAlias);
...
pub struct Msg5ContentCombinator1(pub Msg5ContentCombinatorAlias1);
...
pub struct Msg5ContentCombinator(pub Msg5ContentCombinatorAlias);

impl View for Msg5ContentCombinator {
    type V = SpecMsg5ContentCombinator;
    open spec fn view(&self) -> Self::V { SpecMsg5ContentCombinator(self.0@) }
}
...
impl<'a> SecureSerialize<'a, &'a [u8], Vec<u8>> for Msg5ContentCombinator {
    fn secure_serialize(&self, v: Self::SType, data: &mut Vec<u8>, pos: usize) -> (o: SResult<usize, SerializeError>)
    { <_ as SecureSerialize<'a, &'a [u8], Vec<u8>>>::secure_serialize(&self.0, v, data, pos) }
}
...
pub open spec fn spec_msg5_content(i: VarInt) -> SpecMsg5ContentCombinator {
...
{
    let combinator = Msg5ContentCombinator(Mapped { inner: Msg5ContentCombinator1(Choice::new(Cond { cond: i.as_usize() == 1, inner: U16Le }, Cond { cond: !(i.as_usize() == 1), inner: bytes::Tail })), mapper: Msg5ContentMapper });
    // assert({
    //     &&& combinator@ == spec_msg5_content(i@)
    //     &&& combinator@.requires()
...
pub fn parse_msg5_content<'a>(input: &'a [u8], i: VarInt) -> (res: PResult<<Msg5ContentCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::Type, ParseError>)
    ...
    ensures
        ...
        res is Err ==> spec_msg5_content(i@).spec_parse(input@) is None,
        spec_msg5_content(i@).spec_parse(input@) is None ==> res is Err,
{
    let combinator = msg5_content( i );
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::parse(&combinator, input)
}

pub fn serialize_msg5_content<'a>(v: <Msg5ContentCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize, i: VarInt) -> (o: SResult<usize, SerializeError>)
    requires
...
pub fn serialize_msg5_content_infallible<'a>(v: <Msg5ContentCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize, i: VarInt) -> (n: usize)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_msg5_content(i@).wf(v@),
        spec_msg5_content(i@).spec_serialize(v@).len() <= usize::MAX,
        pos + spec_msg5_content(i@).spec_serialize(v@).len() <= old(data)@.len(),
    ensures
        data@.len() == old(data)@.len(),
        pos <= usize::MAX - n && pos + n <= data@.len(),
        n == spec_msg5_content(i@).spec_serialize(v@).len(),
...
impl<'a> SecureSerialize<'a, &'a [u8], Vec<u8>> for HelloRetryRequestCombinator {
    fn secure_serialize(&self, v: Self::SType, data: &mut Vec<u8>, pos: usize) -> (o: SResult<usize, SerializeError>)
    { <_ as SecureSerialize<'a, &'a [u8], Vec<u8>>>::secure_serialize(&self.0, v, data, pos) }
}
...
pub fn serialize_hello_retry_request_infallible<'a>(v: <HelloRetryRequestCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize) -> (n: usize)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_hello_retry_request().wf(v@),
        spec_hello_retry_request().spec_serialize(v@).len() <= usize::MAX,
        pos + spec_hello_retry_request().spec_serialize(v@).len() <= old(data)@.len(),
    ensures
        data@.len() == old(data)@.len(),
        pos <= usize::MAX - n && pos + n <= data@.len(),
        n == spec_hello_retry_request().spec_serialize(v@).len(),
...
impl<'a> SecureSerialize<'a, &'a [u8], Vec<u8>> for ServerHelloCombinator {
    fn secure_serialize(&self, v: Self::SType, data: &mut Vec<u8>, pos: usize) -> (o: SResult<usize, SerializeError>)
    { <_ as SecureSerialize<'a, &'a [u8], Vec<u8>>>::secure_serialize(&self.0, v, data, pos) }
}
...
pub fn serialize_server_hello_infallible<'a>(v: <ServerHelloCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize) -> (n: usize)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_server_hello().wf(v@),
        spec_server_hello().spec_serialize(v@).len() <= usize::MAX,
        pos + spec_server_hello().spec_serialize(v@).len() <= old(data)@.len(),
    ensures
        data@.len() == old(data)@.len(),
        pos <= usize::MAX - n && pos + n <= data@.len(),
        n == spec_server_hello().spec_serialize(v@).len(),
...
pub struct SpecMsg1PayloadCombinator(pub SpecMsg1PayloadCombinatorAlias);
...
pub struct Msg1PayloadCombinator1(pub Msg1PayloadCombinatorAlias1);
...
pub struct Msg1PayloadCombinator(pub Msg1PayloadCombinatorAlias);

impl View for Msg1PayloadCombinator {
    type V = SpecMsg1PayloadCombinator;
    open spec fn view(&self) -> Self::V { SpecMsg1PayloadCombinator(self.0@) }
}
...
impl<'a> SecureSerialize<'a, &'a [u8], Vec<u8>> for Msg1PayloadCombinator {
    fn secure_serialize(&self, v: Self::SType, data: &mut Vec<u8>, pos: usize) -> (o: SResult<usize, SerializeError>)
    { <_ as SecureSerialize<'a, &'a [u8], Vec<u8>>>::secure_serialize(&self.0, v, data, pos) }
}
...
pub open spec fn spec_msg1_payload(b: Seq<u8>) -> SpecMsg1PayloadCombinator {
...
pub fn parse_msg1_payload<'a>(input: &'a [u8], b: &'a [u8]) -> (res: PResult<<Msg1PayloadCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::Type, ParseError>)
    ...
    ensures
        ...
        spec_msg1_payload(b@).spec_parse(input@) matches Some((n, v))
            ==> res matches Ok((m, u)) && m == n && v == u@,
        res is Err ==> spec_msg1_payload(b@).spec_parse(input@) is None,
        spec_msg1_payload(b@).spec_parse(input@) is None ==> res is Err,
{
    let combinator = msg1_payload( b );
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::parse(&combinator, input)
}

pub fn serialize_msg1_payload<'a>(v: <Msg1PayloadCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize, b: &'a [u8]) -> (o: SResult<usize, SerializeError>)
    requires
        pos <= old(data)@.len() <= usize::MAX,
...
pub fn serialize_msg1_payload_infallible<'a>(v: <Msg1PayloadCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize, b: &'a [u8]) -> (n: usize)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_msg1_payload(b@).wf(v@),
        spec_msg1_payload(b@).spec_serialize(v@).len() <= usize::MAX,
        pos + spec_msg1_payload(b@).spec_serialize(v@).len() <= old(data)@.len(),
    ensures
        data@.len() == old(data)@.len(),
        pos <= usize::MAX - n && pos + n <= data@.len(),
        n == spec_msg1_payload(b@).spec_serialize(v@).len(),
...
pub struct SpecMsg4ContentCombinator(pub SpecMsg4ContentCombinatorAlias);
...
pub struct Msg4ContentCombinator1(pub Msg4ContentCombinatorAlias1);
...
pub struct Msg4ContentCombinator(pub Msg4ContentCombinatorAlias);

impl View for Msg4ContentCombinator {
    type V = SpecMsg4ContentCombinator;
    open spec fn view(&self) -> Self::V { SpecMsg4ContentCombinator(self.0@) }
}
...
impl<'a> SecureSerialize<'a, &'a [u8], Vec<u8>> for Msg4ContentCombinator {
    fn secure_serialize(&self, v: Self::SType, data: &mut Vec<u8>, pos: usize) -> (o: SResult<usize, SerializeError>)
    { <_ as SecureSerialize<'a, &'a [u8], Vec<u8>>>::secure_serialize(&self.0, v, data, pos) }
}
...
pub open spec fn spec_msg4_content(i: u24) -> SpecMsg4ContentCombinator {
...
pub fn msg4_content<'a>(i: u24) -> (o: Msg4ContentCombinator)
    ...
    ensures o@ == spec_msg4_content(i@),
            ...
            <_ as Combinator<'a, &'a [u8], Vec<u8>>>::ex_requires(&o),
{
    let combinator = Msg4ContentCombinator(Mapped { inner: Msg4ContentCombinator1(Choice::new(Cond { cond: i.as_u32() == 1, inner: U16Le }, Cond { cond: !(i.as_u32() == 1), inner: bytes::Tail })), mapper: Msg4ContentMapper });
    // assert({
    //     &&& combinator@ == spec_msg4_content(i@)
    //     &&& combinator@.requires()
    //     &&& <_ as Combinator<'a, &'a [u8], Vec<u8>>>::ex_requires(&combinator)
    // });
    combinator
...
pub fn parse_msg4_content<'a>(input: &'a [u8], i: u24) -> (res: PResult<<Msg4ContentCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::Type, ParseError>)
    ...
    ensures
        ...
        spec_msg4_content(i@).spec_parse(input@) matches Some((n, v))
            ==> res matches Ok((m, u)) && m == n && v == u@,
        res is Err ==> spec_msg4_content(i@).spec_parse(input@) is None,
        spec_msg4_content(i@).spec_parse(input@) is None ==> res is Err,
{
    let combinator = msg4_content( i );
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::parse(&combinator, input)
}

pub fn serialize_msg4_content<'a>(v: <Msg4ContentCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize, i: u24) -> (o: SResult<usize, SerializeError>)
    requires
        pos <= old(data)@.len() <= usize::MAX,
...
pub fn serialize_msg4_content_infallible<'a>(v: <Msg4ContentCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize, i: u24) -> (n: usize)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_msg4_content(i@).wf(v@),
        spec_msg4_content(i@).spec_serialize(v@).len() <= usize::MAX,
        pos + spec_msg4_content(i@).spec_serialize(v@).len() <= old(data)@.len(),
    ensures
        data@.len() == old(data)@.len(),
        pos <= usize::MAX - n && pos + n <= data@.len(),
        n == spec_msg4_content(i@).spec_serialize(v@).len(),
...
pub struct SpecMsg3ContentCombinator(pub SpecMsg3ContentCombinatorAlias);
...
pub struct Msg3ContentCombinator1(pub Msg3ContentCombinatorAlias1);
...
pub struct Msg3ContentCombinator2(pub Msg3ContentCombinatorAlias2);
...
pub struct Msg3ContentCombinator3(pub Msg3ContentCombinatorAlias3);
...
pub struct Msg3ContentCombinator(pub Msg3ContentCombinatorAlias);

impl View for Msg3ContentCombinator {
    type V = SpecMsg3ContentCombinator;
    open spec fn view(&self) -> Self::V { SpecMsg3ContentCombinator(self.0@) }
}
...
impl<'a> SecureSerialize<'a, &'a [u8], Vec<u8>> for Msg3ContentCombinator {
    fn secure_serialize(&self, v: Self::SType, data: &mut Vec<u8>, pos: usize) -> (o: SResult<usize, SerializeError>)
    { <_ as SecureSerialize<'a, &'a [u8], Vec<u8>>>::secure_serialize(&self.0, v, data, pos) }
}
...
pub open spec fn spec_msg3_content(i: u8) -> SpecMsg3ContentCombinator {
...
pub fn msg3_content<'a>(i: u8) -> (o: Msg3ContentCombinator)
    ...
    ensures o@ == spec_msg3_content(i@),
            ...
            <_ as Combinator<'a, &'a [u8], Vec<u8>>>::ex_requires(&o),
{
    let combinator = Msg3ContentCombinator(Mapped { inner: Msg3ContentCombinator3(Choice::new(Cond { cond: i == 1, inner: U16Le }, Msg3ContentCombinator2(Choice::new(Cond { cond: i == 2, inner: U32Le }, Msg3ContentCombinator1(Choice::new(Cond { cond: i == 3, inner: U32Le }, Cond { cond: !(i == 1 || i == 2 || i == 3), inner: bytes::Tail })))))), mapper: Msg3ContentMapper });
    // assert({
    //     &&& combinator@ == spec_msg3_content(i@)
    //     &&& combinator@.requires()
    //     &&& <_ as Combinator<'a, &'a [u8], Vec<u8>>>::ex_requires(&combinator)
    // });
    combinator
...
pub fn parse_msg3_content<'a>(input: &'a [u8], i: u8) -> (res: PResult<<Msg3ContentCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::Type, ParseError>)
    ...
    ensures
        ...
        spec_msg3_content(i@).spec_parse(input@) matches Some((n, v))
            ==> res matches Ok((m, u)) && m == n && v == u@,
        res is Err ==> spec_msg3_content(i@).spec_parse(input@) is None,
        spec_msg3_content(i@).spec_parse(input@) is None ==> res is Err,
{
    let combinator = msg3_content( i );
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::parse(&combinator, input)
}

pub fn serialize_msg3_content<'a>(v: <Msg3ContentCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize, i: u8) -> (o: SResult<usize, SerializeError>)
    requires
        pos <= old(data)@.len() <= usize::MAX,
...
pub fn serialize_msg3_content_infallible<'a>(v: <Msg3ContentCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize, i: u8) -> (n: usize)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_msg3_content(i@).wf(v@),
        spec_msg3_content(i@).spec_serialize(v@).len() <= usize::MAX,
        pos + spec_msg3_content(i@).spec_serialize(v@).len() <= old(data)@.len(),
    ensures
        data@.len() == old(data)@.len(),
        pos <= usize::MAX - n && pos + n <= data@.len(),
        n == spec_msg3_content(i@).spec_serialize(v@).len(),
...
pub fn serialize_msg3_infallible<'a>(v: <Msg3Combinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize) -> (n: usize)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_msg3().wf(v@),
        spec_msg3().spec_serialize(v@).len() <= usize::MAX,
        pos + spec_msg3().spec_serialize(v@).len() <= old(data)@.len(),
    ensures
        data@.len() == old(data)@.len(),
        pos <= usize::MAX - n && pos + n <= data@.len(),
        n == spec_msg3().spec_serialize(v@).len(),
...
impl<'a> SecureSerialize<'a, &'a [u8], Vec<u8>> for Msg5Combinator {
    fn secure_serialize(&self, v: Self::SType, data: &mut Vec<u8>, pos: usize) -> (o: SResult<usize, SerializeError>)
    { <_ as SecureSerialize<'a, &'a [u8], Vec<u8>>>::secure_serialize(&self.0, v, data, pos) }
}
...
pub fn serialize_msg5_infallible<'a>(v: <Msg5Combinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize) -> (n: usize)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_msg5().wf(v@),
        spec_msg5().spec_serialize(v@).len() <= usize::MAX,
        pos + spec_msg5().spec_serialize(v@).len() <= old(data)@.len(),
    ensures
        data@.len() == old(data)@.len(),
        pos <= usize::MAX - n && pos + n <= data@.len(),
        n == spec_msg5().spec_serialize(v@).len(),
...
pub struct SpecMsg2ContentCombinator(pub SpecMsg2ContentCombinatorAlias);
...
pub struct Msg2ContentCombinator1(pub Msg2ContentCombinatorAlias1);
...
pub struct Msg2ContentCombinator(pub Msg2ContentCombinatorAlias);

impl View for Msg2ContentCombinator {
    type V = SpecMsg2ContentCombinator;
    open spec fn view(&self) -> Self::V { SpecMsg2ContentCombinator(self.0@) }
}
...
impl<'a> SecureSerialize<'a, &'a [u8], Vec<u8>> for Msg2ContentCombinator {
    fn secure_serialize(&self, v: Self::SType, data: &mut Vec<u8>, pos: usize) -> (o: SResult<usize, SerializeError>)
    { <_ as SecureSerialize<'a, &'a [u8], Vec<u8>>>::secure_serialize(&self.0, v, data, pos) }
}
...
pub open spec fn spec_msg2_content(b: Seq<u8>) -> SpecMsg2ContentCombinator {
...
pub fn parse_msg2_content<'a>(input: &'a [u8], b: &'a [u8]) -> (res: PResult<<Msg2ContentCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::Type, ParseError>)
    ...
    ensures
        ...
        spec_msg2_content(b@).spec_parse(input@) matches Some((n, v))
            ==> res matches Ok((m, u)) && m == n && v == u@,
        res is Err ==> spec_msg2_content(b@).spec_parse(input@) is None,
        spec_msg2_content(b@).spec_parse(input@) is None ==> res is Err,
{
    let combinator = msg2_content( b );
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::parse(&combinator, input)
}

pub fn serialize_msg2_content<'a>(v: <Msg2ContentCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize, b: &'a [u8]) -> (o: SResult<usize, SerializeError>)
    requires
        pos <= old(data)@.len() <= usize::MAX,
...
pub fn serialize_msg2_content_infallible<'a>(v: <Msg2ContentCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize, b: &'a [u8]) -> (n: usize)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_msg2_content(b@).wf(v@),
        spec_msg2_content(b@).spec_serialize(v@).len() <= usize::MAX,
        pos + spec_msg2_content(b@).spec_serialize(v@).len() <= old(data)@.len(),
    ensures
        data@.len() == old(data)@.len(),
        pos <= usize::MAX - n && pos + n <= data@.len(),
        n == spec_msg2_content(b@).spec_serialize(v@).len(),
...
pub fn serialize_msg1_infallible<'a>(v: <Msg1Combinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize) -> (n: usize)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_msg1().wf(v@),
        spec_msg1().spec_serialize(v@).len() <= usize::MAX,
        pos + spec_msg1().spec_serialize(v@).len() <= old(data)@.len(),
    ensures
        data@.len() == old(data)@.len(),
        pos <= usize::MAX - n && pos + n <= data@.len(),
        n == spec_msg1().spec_serialize(v@).len(),
...
pub fn serialize_msg2_infallible<'a>(v: <Msg2Combinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize) -> (n: usize)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_msg2().wf(v@),
        spec_msg2().spec_serialize(v@).len() <= usize::MAX,
        pos + spec_msg2().spec_serialize(v@).len() <= old(data)@.len(),
    ensures
        data@.len() == old(data)@.len(),
        pos <= usize::MAX - n && pos + n <= data@.len(),
        n == spec_msg2().spec_serialize(v@).len(),
...
pub fn serialize_msg4_infallible<'a>(v: <Msg4Combinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, data: &mut Vec<u8>, pos: usize) -> (n: usize)
    requires
        pos <= old(data)@.len() <= usize::MAX,
        spec_msg4().wf(v@),
        spec_msg4().spec_serialize(v@).len() <= usize::MAX,
        pos + spec_msg4().spec_serialize(v@).len() <= old(data)@.len(),
    ensures
        data@.len() == old(data)@.len(),
        pos <= usize::MAX - n && pos + n <= data@.len(),
        n == spec_msg4().spec_serialize(v@).len(),
