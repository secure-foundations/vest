...
pub fn hello_retry_request_len<'a>(v: <HelloRetryRequestCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType) -> (len: usize)
    requires
        spec_hello_retry_request().wf(v@),
        spec_hello_retry_request().spec_serialize(v@).len() <= usize::MAX,
    ensures
        len == spec_hello_retry_request().spec_serialize(v@).len(),
{
    let combinator = hello_retry_request();
...
pub fn server_hello_len<'a>(v: <ServerHelloCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType) -> (len: usize)
    requires
        spec_server_hello().wf(v@),
        spec_server_hello().spec_serialize(v@).len() <= usize::MAX,
    ensures
        len == spec_server_hello().spec_serialize(v@).len(),
{
    let combinator = server_hello();
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::length(&combinator, v)
}
...
pub fn msg1_payload_len<'a>(v: <Msg1PayloadCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, b: &'a [u8]) -> (len: usize)
    requires
        spec_msg1_payload(b@).wf(v@),
        spec_msg1_payload(b@).spec_serialize(v@).len() <= usize::MAX,
    ensures
        len == spec_msg1_payload(b@).spec_serialize(v@).len(),
{
    let combinator = msg1_payload( b );
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::length(&combinator, v)
}
...
pub fn msg2_content_len<'a>(v: <Msg2ContentCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, b: &'a [u8]) -> (len: usize)
    requires
        spec_msg2_content(b@).wf(v@),
        spec_msg2_content(b@).spec_serialize(v@).len() <= usize::MAX,
    ensures
        len == spec_msg2_content(b@).spec_serialize(v@).len(),
{
    let combinator = msg2_content( b );
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::length(&combinator, v)
}
...
pub fn msg4_content_len<'a>(v: <Msg4ContentCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, i: u24) -> (len: usize)
    requires
        spec_msg4_content(i@).wf(v@),
        spec_msg4_content(i@).spec_serialize(v@).len() <= usize::MAX,
    ensures
        len == spec_msg4_content(i@).spec_serialize(v@).len(),
{
    let combinator = msg4_content( i );
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::length(&combinator, v)
}
...
pub fn msg5_content_len<'a>(v: <Msg5ContentCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, i: VarInt) -> (len: usize)
    requires
        spec_msg5_content(i@).wf(v@),
        spec_msg5_content(i@).spec_serialize(v@).len() <= usize::MAX,
    ensures
        len == spec_msg5_content(i@).spec_serialize(v@).len(),
{
    let combinator = msg5_content( i );
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::length(&combinator, v)
}
...
pub fn msg5_len<'a>(v: <Msg5Combinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType) -> (len: usize)
    requires
        spec_msg5().wf(v@),
        spec_msg5().spec_serialize(v@).len() <= usize::MAX,
    ensures
        len == spec_msg5().spec_serialize(v@).len(),
{
    let combinator = msg5();
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::length(&combinator, v)
}
...
pub fn msg3_content_len<'a>(v: <Msg3ContentCombinator as Combinator<'a, &'a [u8], Vec<u8>>>::SType, i: u8) -> (len: usize)
    requires
        spec_msg3_content(i@).wf(v@),
        spec_msg3_content(i@).spec_serialize(v@).len() <= usize::MAX,
    ensures
        len == spec_msg3_content(i@).spec_serialize(v@).len(),
{
    let combinator = msg3_content( i );
    <_ as Combinator<'a, &'a [u8], Vec<u8>>>::length(&combinator, v)
}
