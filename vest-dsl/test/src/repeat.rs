...
pub type OpaqueU16CombinatorAlias<'a> = Mapped<Depend<&'a [u8], Vec<u8>, Refined<U16Le, Predicate17626095872143391426>, Bytes, OpaqueU16Cont<'a>>, OpaqueU16Mapper<'a>>;
...
pub type ResponderIdListCombinatorAlias<'a> = Mapped<Depend<&'a [u8], Vec<u8>, Refined<U16Le, Predicate2984462868727922620>, ResponderIdListListCombinator<'a>, ResponderIdListCont<'a>>, ResponderIdListMapper<'a>>;
