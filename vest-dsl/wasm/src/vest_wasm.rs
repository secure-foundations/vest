...
struct CustomCombinator1(CustomCombinatorAlias1);
...
struct InstrVariableCombinator1(InstrVariableCombinatorAlias1);
...
struct InstrVariableCombinator2(InstrVariableCombinatorAlias2);
...
struct InstrVariableCombinator3(InstrVariableCombinatorAlias3);
...
struct InstrVariableCombinator4(InstrVariableCombinatorAlias4);
...
{
    InstrVariableCombinator(Mapped { inner: InstrVariableCombinator4(Choice::new(Cond { cond: opcode == 32, inner: localidx() }, InstrVariableCombinator3(Choice::new(Cond { cond: opcode == 33, inner: localidx() }, InstrVariableCombinator2(Choice::new(Cond { cond: opcode == 34, inner: localidx() }, InstrVariableCombinator1(Choice::new(Cond { cond: opcode == 35, inner: globalidx() }, Cond { cond: opcode == 36, inner: globalidx() })))))))), mapper: InstrVariableMapper })
}
...
struct BrTableCombinator1(BrTableCombinatorAlias1);
...
struct CallIndirectCombinator1(CallIndirectCombinatorAlias1);
...
struct InstrControl2Combinator1(InstrControl2CombinatorAlias1);
...
struct InstrControl2Combinator2(InstrControl2CombinatorAlias2);
...
struct InstrControl2Combinator3(InstrControl2CombinatorAlias3);
...
struct InstrControl2Combinator4(InstrControl2CombinatorAlias4);
...
struct InstrControl2Combinator5(InstrControl2CombinatorAlias5);
...
struct InstrControl2Combinator6(InstrControl2CombinatorAlias6);
...
{
    InstrControl2Combinator(Mapped { inner: InstrControl2Combinator6(Choice::new(Cond { cond: opcode == 11, inner: empty() }, InstrControl2Combinator5(Choice::new(Cond { cond: opcode == 13, inner: labelidx() }, InstrControl2Combinator4(Choice::new(Cond { cond: opcode == 12, inner: labelidx() }, InstrControl2Combinator3(Choice::new(Cond { cond: opcode == 16, inner: funcidx() }, InstrControl2Combinator2(Choice::new(Cond { cond: opcode == 15, inner: empty() }, InstrControl2Combinator1(Choice::new(Cond { cond: opcode == 14, inner: br_table() }, Cond { cond: opcode == 17, inner: call_indirect() })))))))))))), mapper: InstrControl2Mapper })
}
...
struct EmptyBlockCombinator1(EmptyBlockCombinatorAlias1);
...
struct ValtypeBlockCombinator1(ValtypeBlockCombinatorAlias1);
...
struct TypeidxBlockCombinator1(TypeidxBlockCombinatorAlias1);
...
struct BlocktypeCombinator1(BlocktypeCombinatorAlias1);
...
struct BlocktypeCombinator2(BlocktypeCombinatorAlias2);
...
{
    BlocktypeCombinator(Mapped { inner: BlocktypeCombinator2(Choice::new(empty_block(), BlocktypeCombinator1(Choice::new(valtype_block(), typeidx_block())))), mapper: BlocktypeMapper })
}
...
struct InstrControl1Combinator1(InstrControl1CombinatorAlias1);
...
struct InstrControl1Combinator2(InstrControl1CombinatorAlias2);
...
struct InstrControl1Combinator3(InstrControl1CombinatorAlias3);
...
struct InstrControl1Combinator4(InstrControl1CombinatorAlias4);
...
struct InstrControl1Combinator5(InstrControl1CombinatorAlias5);
...
{
    InstrControl1Combinator(Mapped { inner: InstrControl1Combinator5(Choice::new(Cond { cond: opcode == 4, inner: blocktype() }, InstrControl1Combinator4(Choice::new(Cond { cond: opcode == 2, inner: blocktype() }, InstrControl1Combinator3(Choice::new(Cond { cond: opcode == 3, inner: blocktype() }, InstrControl1Combinator2(Choice::new(Cond { cond: opcode == 5, inner: empty() }, InstrControl1Combinator1(Choice::new(Cond { cond: opcode == 0, inner: empty() }, Cond { cond: opcode == 1, inner: empty() })))))))))), mapper: InstrControl1Mapper })
}
...
struct MemargCombinator1(MemargCombinatorAlias1);
...
struct InstrMemoryCombinator1(InstrMemoryCombinatorAlias1);
...
struct InstrMemoryCombinator2(InstrMemoryCombinatorAlias2);
...
struct InstrMemoryCombinator3(InstrMemoryCombinatorAlias3);
...
struct InstrMemoryCombinator4(InstrMemoryCombinatorAlias4);
...
struct InstrMemoryCombinator5(InstrMemoryCombinatorAlias5);
...
struct InstrMemoryCombinator6(InstrMemoryCombinatorAlias6);
...
{
    InstrMemoryCombinator(Mapped { inner: InstrMemoryCombinator6(Choice::new(Cond { cond: opcode == 54, inner: memarg() }, InstrMemoryCombinator5(Choice::new(Cond { cond: opcode == 40, inner: memarg() }, InstrMemoryCombinator4(Choice::new(Cond { cond: opcode == 55, inner: memarg() }, InstrMemoryCombinator3(Choice::new(Cond { cond: opcode == 41, inner: memarg() }, InstrMemoryCombinator2(Choice::new(Cond { cond: opcode == 63, inner: byte_zero() }, InstrMemoryCombinator1(Choice::new(Cond { cond: opcode == 64, inner: byte_zero() }, Cond { cond: !(opcode == 54 || opcode == 40 || opcode == 55 || opcode == 41 || opcode == 63 || opcode == 64), inner: memarg() })))))))))))), mapper: InstrMemoryMapper })
}
...
struct InstrReferenceCombinator1(InstrReferenceCombinatorAlias1);
...
struct InstrReferenceCombinator2(InstrReferenceCombinatorAlias2);
...
{
    InstrReferenceCombinator(Mapped { inner: InstrReferenceCombinator2(Choice::new(Cond { cond: opcode == 208, inner: reftype() }, InstrReferenceCombinator1(Choice::new(Cond { cond: opcode == 209, inner: empty() }, Cond { cond: opcode == 210, inner: funcidx() })))), mapper: InstrReferenceMapper })
}
...
struct ValtypeCombinator1(ValtypeCombinatorAlias1);
...
struct ValtypeCombinator2(ValtypeCombinatorAlias2);
...
{
    ValtypeCombinator(Mapped { inner: ValtypeCombinator2(Choice::new(numtype(), ValtypeCombinator1(Choice::new(vectype(), reftype())))), mapper: ValtypeMapper })
}
...
struct InstrParametricCombinator1(InstrParametricCombinatorAlias1);
...
struct InstrParametricCombinator2(InstrParametricCombinatorAlias2);
...
{
    InstrParametricCombinator(Mapped { inner: InstrParametricCombinator2(Choice::new(Cond { cond: opcode == 26, inner: empty() }, InstrParametricCombinator1(Choice::new(Cond { cond: opcode == 27, inner: empty() }, Cond { cond: opcode == 28, inner: select_t() })))), mapper: InstrParametricMapper })
}
...
struct InstrTableCombinator1(InstrTableCombinatorAlias1);
...
{
    InstrTableCombinator(Mapped { inner: InstrTableCombinator1(Choice::new(Cond { cond: opcode == 37, inner: tableidx() }, Cond { cond: opcode == 38, inner: tableidx() })), mapper: InstrTableMapper })
}
...
struct InstrNumericCombinator1(InstrNumericCombinatorAlias1);
...
struct InstrNumericCombinator2(InstrNumericCombinatorAlias2);
...
struct InstrNumericCombinator3(InstrNumericCombinatorAlias3);
...
struct InstrNumericCombinator4(InstrNumericCombinatorAlias4);
...
{
    InstrNumericCombinator(Mapped { inner: InstrNumericCombinator4(Choice::new(Cond { cond: opcode == 65, inner: UnsignedLEB128 }, InstrNumericCombinator3(Choice::new(Cond { cond: opcode == 66, inner: UnsignedLEB128 }, InstrNumericCombinator2(Choice::new(Cond { cond: opcode == 67, inner: f32() }, InstrNumericCombinator1(Choice::new(Cond { cond: opcode == 68, inner: f64() }, Cond { cond: !(opcode == 65 || opcode == 66 || opcode == 67 || opcode == 68), inner: empty() })))))))), mapper: InstrNumericMapper })
}
...
struct TableInitCombinator1(TableInitCombinatorAlias1);
...
struct TableCopyCombinator1(TableCopyCombinatorAlias1);
...
struct InstrWithFcRestCombinator1(InstrWithFcRestCombinatorAlias1);
...
struct InstrWithFcRestCombinator2(InstrWithFcRestCombinatorAlias2);
...
struct InstrWithFcRestCombinator3(InstrWithFcRestCombinatorAlias3);
...
struct InstrWithFcRestCombinator4(InstrWithFcRestCombinatorAlias4);
...
struct InstrWithFcRestCombinator5(InstrWithFcRestCombinatorAlias5);
...
struct InstrWithFcRestCombinator6(InstrWithFcRestCombinatorAlias6);
...
struct InstrWithFcRestCombinator7(InstrWithFcRestCombinatorAlias7);
...
struct InstrWithFcRestCombinator8(InstrWithFcRestCombinatorAlias8);
...
struct InstrWithFcRestCombinator9(InstrWithFcRestCombinatorAlias9);
...
struct InstrWithFcRestCombinator10(InstrWithFcRestCombinatorAlias10);
...
struct V128LaneCombinator1(V128LaneCombinatorAlias1);
...
struct InstrWithFdRestCombinator1(InstrWithFdRestCombinatorAlias1);
...
struct InstrWithFdRestCombinator2(InstrWithFdRestCombinatorAlias2);
...
struct InstrWithFdRestCombinator3(InstrWithFdRestCombinatorAlias3);
...
struct InstrWithFdRestCombinator4(InstrWithFdRestCombinatorAlias4);
...
struct InstrWithFdRestCombinator5(InstrWithFdRestCombinatorAlias5);
...
struct InstrWithFdRestCombinator6(InstrWithFdRestCombinatorAlias6);
...
struct InstrWithFdRestCombinator7(InstrWithFdRestCombinatorAlias7);
...
struct InstrRestCombinator1(InstrRestCombinatorAlias1);
...
struct InstrRestCombinator2(InstrRestCombinatorAlias2);
...
struct InstrRestCombinator3(InstrRestCombinatorAlias3);
...
struct InstrRestCombinator4(InstrRestCombinatorAlias4);
...
struct InstrRestCombinator5(InstrRestCombinatorAlias5);
...
struct InstrRestCombinator6(InstrRestCombinatorAlias6);
...
struct InstrRestCombinator7(InstrRestCombinatorAlias7);
...
struct InstrRestCombinator8(InstrRestCombinatorAlias8);
...
struct InstrRestCombinator9(InstrRestCombinatorAlias9);
...
struct InstrRestCombinator10(InstrRestCombinatorAlias10);
...
struct ActiveData0Combinator1(ActiveData0CombinatorAlias1);
...
struct ActiveDataxCombinator1(ActiveDataxCombinatorAlias1);
...
struct ActiveDataxCombinator2(ActiveDataxCombinatorAlias2);
...
struct DataCombinator1(DataCombinatorAlias1);
...
struct DataCombinator2(DataCombinatorAlias2);
...
pub fn data() -> (o: DataCombinator)
    ensures o@ == spec_data(),
{
    DataCombinator(Mapped { inner: DataCombinator2(Choice::new(Preceded(Tag::new(UnsignedLEB128, DATAACTIVEDATA0_0_FRONT_CONST), active_data0()), DataCombinator1(Choice::new(Preceded(Tag::new(UnsignedLEB128, DATAPASSIVEDATA_0_FRONT_CONST), passive_data()), Preceded(Tag::new(UnsignedLEB128, DATAACTIVEDATAX_0_FRONT_CONST), active_datax()))))), mapper: DataMapper })
}
...
struct LimitMinMaxCombinator1(LimitMinMaxCombinatorAlias1);
...
struct LimitsCombinator1(LimitsCombinatorAlias1);
...
{
    LimitsCombinator(Mapped { inner: LimitsCombinator1(Choice::new(Preceded(Tag::new(U8, LIMITSNOMAX_0_FRONT_CONST), limit_min()), Preceded(Tag::new(U8, LIMITSMAX_0_FRONT_CONST), limit_min_max()))), mapper: LimitsMapper })
}
...
struct ParsedElem0Combinator1(ParsedElem0CombinatorAlias1);
...
struct ParsedElem1Combinator1(ParsedElem1CombinatorAlias1);
...
struct ParsedElem2Combinator1(ParsedElem2CombinatorAlias1);
...
struct ParsedElem2Combinator2(ParsedElem2CombinatorAlias2);
...
struct ParsedElem2Combinator3(ParsedElem2CombinatorAlias3);
...
struct ParsedElem4Combinator1(ParsedElem4CombinatorAlias1);
...
struct ParsedElem5Combinator1(ParsedElem5CombinatorAlias1);
...
struct ParsedElem6Combinator1(ParsedElem6CombinatorAlias1);
...
struct ParsedElem6Combinator2(ParsedElem6CombinatorAlias2);
...
struct ParsedElem6Combinator3(ParsedElem6CombinatorAlias3);
...
struct ParsedElem7Combinator1(ParsedElem7CombinatorAlias1);
...
struct ElemCombinator1(ElemCombinatorAlias1);
...
struct ElemCombinator2(ElemCombinatorAlias2);
...
struct ElemCombinator3(ElemCombinatorAlias3);
...
struct ElemCombinator4(ElemCombinatorAlias4);
...
struct ElemCombinator5(ElemCombinatorAlias5);
...
struct ElemCombinator6(ElemCombinatorAlias6);
...
struct ElemCombinator7(ElemCombinatorAlias7);
...
pub fn elem() -> (o: ElemCombinator)
    ensures o@ == spec_elem(),
{
    ElemCombinator(Mapped { inner: ElemCombinator7(Choice::new(Preceded(Tag::new(UnsignedLEB128, ELEMELEM0_0_FRONT_CONST), parsed_elem0()), ElemCombinator6(Choice::new(Preceded(Tag::new(UnsignedLEB128, ELEMELEM1_0_FRONT_CONST), parsed_elem1()), ElemCombinator5(Choice::new(Preceded(Tag::new(UnsignedLEB128, ELEMELEM2_0_FRONT_CONST), parsed_elem2()), ElemCombinator4(Choice::new(Preceded(Tag::new(UnsignedLEB128, ELEMELEM3_0_FRONT_CONST), parsed_elem3()), ElemCombinator3(Choice::new(Preceded(Tag::new(UnsignedLEB128, ELEMELEM4_0_FRONT_CONST), parsed_elem4()), ElemCombinator2(Choice::new(Preceded(Tag::new(UnsignedLEB128, ELEMELEM5_0_FRONT_CONST), parsed_elem5()), ElemCombinator1(Choice::new(Preceded(Tag::new(UnsignedLEB128, ELEMELEM6_0_FRONT_CONST), parsed_elem6()), Preceded(Tag::new(UnsignedLEB128, ELEMELEM7_0_FRONT_CONST), parsed_elem7()))))))))))))))), mapper: ElemMapper })
}
...
struct TabletypeCombinator1(TabletypeCombinatorAlias1);
...
struct FunctypeCombinator1(FunctypeCombinatorAlias1);
...
struct FunctypeCombinator2(FunctypeCombinatorAlias2);
...
struct LocalCompressedCombinator1(LocalCompressedCombinatorAlias1);
...
struct FuncCombinator1(FuncCombinatorAlias1);
...
struct ExportdescCombinator1(ExportdescCombinatorAlias1);
...
struct ExportdescCombinator2(ExportdescCombinatorAlias2);
...
struct ExportdescCombinator3(ExportdescCombinatorAlias3);
...
struct ExportCombinator1(ExportCombinatorAlias1);
...
struct GlobaltypeCombinator1(GlobaltypeCombinatorAlias1);
...
struct GlobalCombinator1(GlobalCombinatorAlias1);
...
struct ImportdescCombinator1(ImportdescCombinatorAlias1);
...
struct ImportdescCombinator2(ImportdescCombinatorAlias2);
...
struct ImportdescCombinator3(ImportdescCombinatorAlias3);
...
{
    ImportdescCombinator(Mapped { inner: ImportdescCombinator3(Choice::new(Preceded(Tag::new(U8, IMPORTDESCFUNC_0_FRONT_CONST), typeidx()), ImportdescCombinator2(Choice::new(Preceded(Tag::new(U8, IMPORTDESCTABLE_0_FRONT_CONST), tabletype()), ImportdescCombinator1(Choice::new(Preceded(Tag::new(U8, IMPORTDESCMEM_0_FRONT_CONST), memtype()), Preceded(Tag::new(U8, IMPORTDESCGLOBAL_0_FRONT_CONST), globaltype()))))))), mapper: ImportdescMapper })
}
...
struct ImportCombinator1(ImportCombinatorAlias1);
...
struct ImportCombinator2(ImportCombinatorAlias2);
...
struct ModuleCombinator1(ModuleCombinatorAlias1);
...
struct ModuleCombinator2(ModuleCombinatorAlias2);
...
struct ModuleCombinator3(ModuleCombinatorAlias3);
...
struct ModuleCombinator4(ModuleCombinatorAlias4);
...
struct ModuleCombinator5(ModuleCombinatorAlias5);
...
struct ModuleCombinator6(ModuleCombinatorAlias6);
...
struct ModuleCombinator7(ModuleCombinatorAlias7);
...
struct ModuleCombinator8(ModuleCombinatorAlias8);
...
struct ModuleCombinator9(ModuleCombinatorAlias9);
...
struct ModuleCombinator10(ModuleCombinatorAlias10);
...
struct ModuleCombinator11(ModuleCombinatorAlias11);
...
struct ModuleCombinator12(ModuleCombinatorAlias12);
...
struct ModuleCombinator13(ModuleCombinatorAlias13);
