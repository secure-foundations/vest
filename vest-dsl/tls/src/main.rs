...
//             if let Ok(rustls_parsed) = rustls::internal::msgs::message::MessagePayload::new(
//                 rustls::ContentType::Handshake,
//                 rustls::ProtocolVersion::TLSv1_3,
//                 msg,
//             ) {
...
//     }
//     println!(
//         "Rustls successfully parsed {} client messages",
//         rustls_success_client
//     );
//     println!(
//         "Vestls Successfully parsed {} client messages",
//         vestls_success_client
//     );
