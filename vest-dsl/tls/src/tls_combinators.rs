...
impl SpecCombinator for SpecHelloRetryExtensionsExtensionsCombinator {
    type Type = SpecHelloRetryExtensionsExtensions;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for HelloRetryExtensionsExtensionsCombinator<'a> {
    type Type = HelloRetryExtensionsExtensions<'a>;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    HelloRetryExtensionsExtensionsCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(hello_retry_extension())))
}
...
impl SpecCombinator for SpecEcPointFormatListListCombinator {
    type Type = SpecEcPointFormatListList;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for EcPointFormatListListCombinator {
    type Type = EcPointFormatListList;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    EcPointFormatListListCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(ec_point_format())))
}
...
impl SpecCombinator for SpecNamedGroupListListCombinator {
    type Type = SpecNamedGroupListList;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
{
    NamedGroupListListCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(named_group())))
}
...
impl SpecCombinator for SpecProtocolNameListListCombinator {
    type Type = SpecProtocolNameListList;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for ProtocolNameListListCombinator<'a> {
    type Type = ProtocolNameListList<'a>;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    ProtocolNameListListCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(protocol_name())))
}
...
impl SpecCombinator for SpecClientCertTypeClientExtensionTypesCombinator {
    type Type = SpecClientCertTypeClientExtensionTypes;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for ClientCertTypeClientExtensionTypesCombinator {
    type Type = ClientCertTypeClientExtensionTypes;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    ClientCertTypeClientExtensionTypesCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(certificate_type())))
}
...
impl SpecCombinator for SpecServerCertTypeClientExtensionTypesCombinator {
    type Type = SpecServerCertTypeClientExtensionTypes;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for ServerCertTypeClientExtensionTypesCombinator {
    type Type = ServerCertTypeClientExtensionTypes;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    ServerCertTypeClientExtensionTypesCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(certificate_type())))
}
...
impl SpecCombinator for SpecServerNameListListCombinator {
    type Type = SpecServerNameListList;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for ServerNameListListCombinator<'a> {
    type Type = ServerNameListList<'a>;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    ServerNameListListCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(server_name())))
}
...
impl SpecCombinator for SpecSignatureSchemeListListCombinator {
    type Type = SpecSignatureSchemeListList;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for SignatureSchemeListListCombinator {
    type Type = SignatureSchemeListList;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    SignatureSchemeListListCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(signature_scheme())))
}
...
impl SpecCombinator for SpecSignedCertificateTimestampListListCombinator {
    type Type = SpecSignedCertificateTimestampListList;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for SignedCertificateTimestampListListCombinator<'a> {
    type Type = SignedCertificateTimestampListList<'a>;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    SignedCertificateTimestampListListCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(serialized_sct())))
}
...
impl SpecCombinator for SpecPaddingExtensionPaddingCombinator {
    type Type = SpecPaddingExtensionPadding;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for PaddingExtensionPaddingCombinator {
    type Type = PaddingExtensionPadding;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    PaddingExtensionPaddingCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(zero_byte())))
}
...
impl SpecCombinator for SpecPskIdentitiesIdentitiesCombinator {
    type Type = SpecPskIdentitiesIdentities;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for PskIdentitiesIdentitiesCombinator<'a> {
    type Type = PskIdentitiesIdentities<'a>;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    PskIdentitiesIdentitiesCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(psk_identity())))
}
...
impl SpecCombinator for SpecPskBinderEntriesBindersCombinator {
    type Type = SpecPskBinderEntriesBinders;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for PskBinderEntriesBindersCombinator<'a> {
    type Type = PskBinderEntriesBinders<'a>;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    PskBinderEntriesBindersCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(psk_binder_entry())))
}
...
impl SpecCombinator for SpecKeyShareClientHelloClientSharesCombinator {
    type Type = SpecKeyShareClientHelloClientShares;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for KeyShareClientHelloClientSharesCombinator<'a> {
    type Type = KeyShareClientHelloClientShares<'a>;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    KeyShareClientHelloClientSharesCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(key_share_entry())))
}
...
impl SpecCombinator for SpecPskKeyExchangeModesModesCombinator {
    type Type = SpecPskKeyExchangeModesModes;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for PskKeyExchangeModesModesCombinator {
    type Type = PskKeyExchangeModesModes;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    PskKeyExchangeModesModesCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(psk_key_exchange_mode())))
}
...
impl SpecCombinator for SpecSupportedVersionsClientVersionsCombinator {
    type Type = SpecSupportedVersionsClientVersions;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for SupportedVersionsClientVersionsCombinator {
    type Type = SupportedVersionsClientVersions;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    SupportedVersionsClientVersionsCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(protocol_version())))
}
...
impl SpecCombinator for SpecCertificateAuthoritiesExtensionAuthoritiesCombinator {
    type Type = SpecCertificateAuthoritiesExtensionAuthorities;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for CertificateAuthoritiesExtensionAuthoritiesCombinator<'a> {
    type Type = CertificateAuthoritiesExtensionAuthorities<'a>;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    CertificateAuthoritiesExtensionAuthoritiesCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(distinguished_name())))
}
...
impl SpecCombinator for SpecOidFilterExtensionFiltersCombinator {
    type Type = SpecOidFilterExtensionFilters;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for OidFilterExtensionFiltersCombinator<'a> {
    type Type = OidFilterExtensionFilters<'a>;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    OidFilterExtensionFiltersCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(oid_filter())))
}
...
impl SpecCombinator for SpecClientExtensionsExtensionsCombinator {
    type Type = SpecClientExtensionsExtensions;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for ClientExtensionsExtensionsCombinator<'a> {
    type Type = ClientExtensionsExtensions<'a>;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    ClientExtensionsExtensionsCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(client_hello_extension())))
}
...
impl SpecCombinator for SpecCertificateRequestExtensionsExtensionsCombinator {
    type Type = SpecCertificateRequestExtensionsExtensions;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for CertificateRequestExtensionsExtensionsCombinator<'a> {
    type Type = CertificateRequestExtensionsExtensions<'a>;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    CertificateRequestExtensionsExtensionsCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(certificate_request_extension())))
}
...
impl SpecCombinator for SpecCertificateExtensionsExtensionsCombinator {
    type Type = SpecCertificateExtensionsExtensions;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for CertificateExtensionsExtensionsCombinator<'a> {
    type Type = CertificateExtensionsExtensions<'a>;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    CertificateExtensionsExtensionsCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(certificate_extension())))
}
...
impl SpecCombinator for SpecCertificateListListCombinator {
    type Type = SpecCertificateListList;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for CertificateListListCombinator<'a> {
    type Type = CertificateListList<'a>;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    CertificateListListCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(certificate_entry())))
}
...
impl SpecCombinator for SpecMontgomeryPoint32Combinator {
    type Type = SpecMontgomeryPoint32;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl SpecCombinator for SpecMontgomeryForm56Combinator {
    type Type = SpecMontgomeryForm56;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl SpecCombinator for SpecSrtpProtectionProfilesListCombinator {
    type Type = SpecSrtpProtectionProfilesList;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for SrtpProtectionProfilesListCombinator {
    type Type = SrtpProtectionProfilesList<'a>;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    SrtpProtectionProfilesListCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(srtp_protection_profile())))
}
...
impl SpecCombinator for SpecCipherSuiteListListCombinator {
    type Type = SpecCipherSuiteListList;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
{
    CipherSuiteListListCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(cipher_suite())))
}
...
impl SpecCombinator for SpecServerExtensionsExtensionsCombinator {
    type Type = SpecServerExtensionsExtensions;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for ServerExtensionsExtensionsCombinator<'a> {
    type Type = ServerExtensionsExtensions<'a>;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    ServerExtensionsExtensionsCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(sever_hello_extension())))
}
...
impl SpecCombinator for SpecNewSessionTicketExtensionsExtensionsCombinator {
    type Type = SpecNewSessionTicketExtensionsExtensions;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for NewSessionTicketExtensionsExtensionsCombinator<'a> {
    type Type = NewSessionTicketExtensionsExtensions<'a>;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    NewSessionTicketExtensionsExtensionsCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(new_session_ticket_extension())))
}
...
impl SpecCombinator for SpecEncryptedExtensionsExtensionsCombinator {
    type Type = SpecEncryptedExtensionsExtensions;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for EncryptedExtensionsExtensionsCombinator<'a> {
    type Type = EncryptedExtensionsExtensions<'a>;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
{
    EncryptedExtensionsExtensionsCombinator(AndThen(Bytes(l.ex_into()), Repeat::new(encrypted_extension())))
}
...
impl SpecCombinator for SpecUncompressedPointRepresentation32Combinator {
    type Type = SpecUncompressedPointRepresentation32;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for UncompressedPointRepresentation32Combinator<'a> {
    type Type = UncompressedPointRepresentation32<'a>;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
impl SpecCombinator for SpecUncompressedPointRepresentation66Combinator {
    type Type = SpecUncompressedPointRepresentation66;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for UncompressedPointRepresentation66Combinator<'a> {
    type Type = UncompressedPointRepresentation66<'a>;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
...
impl SpecCombinator for SpecUncompressedPointRepresentation48Combinator {
    type Type = SpecUncompressedPointRepresentation48;
    closed spec fn spec_parse(&self, s: Seq<u8>) -> Result<(usize, Self::Type), ()> 
    { self.0.spec_parse(s) }
    closed spec fn spec_serialize(&self, v: Self::Type) -> Result<Seq<u8>, ()> 
    { self.0.spec_serialize(v) }
...
impl<'a> Combinator<&'a [u8], Vec<u8>> for UncompressedPointRepresentation48Combinator<'a> {
    type Type = UncompressedPointRepresentation48<'a>;
    closed spec fn spec_length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::spec_length(&self.0) }
    fn length(&self) -> Option<usize> 
    { <_ as Combinator<&[u8], Vec<u8>>>::length(&self.0) }
