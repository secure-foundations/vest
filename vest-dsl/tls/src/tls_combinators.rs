...
pub type SpecFinishedCombinatorAlias = Mapped<Choice<Cond<bytes::Fixed<12>>, Choice<Cond<bytes::Fixed<20>>, Choice<Cond<bytes::Fixed<32>>, Choice<Cond<bytes::Fixed<48>>, Choice<Cond<bytes::Fixed<64>>, Cond<bytes::Variable>>>>>>, FinishedMapper>;
...
pub type FinishedCombinatorAlias = Mapped<Choice<Cond<bytes::Fixed<12>>, Choice<Cond<bytes::Fixed<20>>, Choice<Cond<bytes::Fixed<32>>, Choice<Cond<bytes::Fixed<48>>, Choice<Cond<bytes::Fixed<64>>, Cond<bytes::Variable>>>>>>, FinishedMapper>;
...
{
    FinishedCombinator(Mapped { inner: Choice::new(Cond { cond: size.as_u32() == 12, inner: bytes::Fixed::<12> }, Choice::new(Cond { cond: size.as_u32() == 20, inner: bytes::Fixed::<20> }, Choice::new(Cond { cond: size.as_u32() == 32, inner: bytes::Fixed::<32> }, Choice::new(Cond { cond: size.as_u32() == 48, inner: bytes::Fixed::<48> }, Choice::new(Cond { cond: size.as_u32() == 64, inner: bytes::Fixed::<64> }, Cond { cond: !(size.as_u32() == 12 || size.as_u32() == 20 || size.as_u32() == 32 || size.as_u32() == 48 || size.as_u32() == 64), inner: bytes::Variable(size.ex_into()) }))))), mapper: FinishedMapper })
}
...
pub type SpecServerNameNameCombinatorAlias = Mapped<Choice<Cond<SpecHostNameCombinator>, Cond<SpecUnknownNameCombinator>>, ServerNameNameMapper>;
...
pub type ServerNameNameCombinatorAlias = Mapped<Choice<Cond<HostNameCombinator>, Cond<UnknownNameCombinator>>, ServerNameNameMapper>;
...
{
    ServerNameNameCombinator(Mapped { inner: Choice::new(Cond { cond: name_type == 0, inner: host_name() }, Cond { cond: !(name_type == 0), inner: unknown_name() }), mapper: ServerNameNameMapper })
}
...
pub type SpecClientHelloExtensionRestCombinatorAlias = Mapped<Choice<Cond<SpecMaxFragmentLengthCombinator>, Choice<Cond<SpecHeartbeatModeCombinator>, Choice<Cond<SpecSignedCertificateTimestampListCombinator>, Choice<Cond<SpecClientCertTypeClientExtensionCombinator>, Choice<Cond<SpecServerCertTypeClientExtensionCombinator>, Choice<Cond<SpecPaddingExtensionCombinator>, Choice<Cond<SpecCookieCombinator>, Choice<Cond<SpecCertificateAuthoritiesExtensionCombinator>, Choice<Cond<SpecOidFilterExtensionCombinator>, Choice<Cond<SpecSignatureSchemeListCombinator>, Cond<bytes::Variable>>>>>>>>>>>, ClientHelloExtensionRestMapper>;
...
pub type ClientHelloExtensionRestCombinatorAlias = Mapped<Choice<Cond<MaxFragmentLengthCombinator>, Choice<Cond<HeartbeatModeCombinator>, Choice<Cond<SignedCertificateTimestampListCombinator>, Choice<Cond<ClientCertTypeClientExtensionCombinator>, Choice<Cond<ServerCertTypeClientExtensionCombinator>, Choice<Cond<PaddingExtensionCombinator>, Choice<Cond<CookieCombinator>, Choice<Cond<CertificateAuthoritiesExtensionCombinator>, Choice<Cond<OidFilterExtensionCombinator>, Choice<Cond<SignatureSchemeListCombinator>, Cond<bytes::Variable>>>>>>>>>>>, ClientHelloExtensionRestMapper>;
...
{
    ClientHelloExtensionRestCombinator(Mapped { inner: Choice::new(Cond { cond: extension_type == 1, inner: max_fragment_length() }, Choice::new(Cond { cond: extension_type == 15, inner: heartbeat_mode() }, Choice::new(Cond { cond: extension_type == 18, inner: signed_certificate_timestamp_list() }, Choice::new(Cond { cond: extension_type == 19, inner: client_cert_type_client_extension() }, Choice::new(Cond { cond: extension_type == 20, inner: server_cert_type_client_extension() }, Choice::new(Cond { cond: extension_type == 21, inner: padding_extension() }, Choice::new(Cond { cond: extension_type == 44, inner: cookie() }, Choice::new(Cond { cond: extension_type == 47, inner: certificate_authorities_extension() }, Choice::new(Cond { cond: extension_type == 48, inner: oid_filter_extension() }, Choice::new(Cond { cond: extension_type == 50, inner: signature_scheme_list() }, Cond { cond: !(extension_type == 1 || extension_type == 15 || extension_type == 18 || extension_type == 19 || extension_type == 20 || extension_type == 21 || extension_type == 44 || extension_type == 47 || extension_type == 48 || extension_type == 50), inner: bytes::Variable(ext_len.ex_into()) })))))))))), mapper: ClientHelloExtensionRestMapper })
}
...
pub type SpecClientHelloExtensionExtensionDataCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<SpecServerNameListCombinator>, Choice<Cond<SpecSignatureSchemeListCombinator>, Choice<Cond<SpecNamedGroupListCombinator>, Choice<Cond<SpecCertificateStatusRequestCombinator>, Choice<Cond<SpecProtocolNameListCombinator>, Choice<Cond<SpecSupportedVersionsClientCombinator>, Choice<Cond<SpecKeyShareClientHelloCombinator>, Choice<Cond<SpecPskKeyExchangeModesCombinator>, Choice<Cond<SpecPreSharedKeyClientExtensionCombinator>, Cond<SpecClientHelloExtensionRestCombinator>>>>>>>>>>, ClientHelloExtensionExtensionDataMapper>>;
...
pub type ClientHelloExtensionExtensionDataCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<ServerNameListCombinator>, Choice<Cond<SignatureSchemeListCombinator>, Choice<Cond<NamedGroupListCombinator>, Choice<Cond<CertificateStatusRequestCombinator>, Choice<Cond<ProtocolNameListCombinator>, Choice<Cond<SupportedVersionsClientCombinator>, Choice<Cond<KeyShareClientHelloCombinator>, Choice<Cond<PskKeyExchangeModesCombinator>, Choice<Cond<PreSharedKeyClientExtensionCombinator>, Cond<ClientHelloExtensionRestCombinator>>>>>>>>>>, ClientHelloExtensionExtensionDataMapper>>;
...
pub fn client_hello_extension_extension_data<'a>(ext_len: u16, extension_type: ExtensionType) -> (o: ClientHelloExtensionExtensionDataCombinator)
    ensures o@ == spec_client_hello_extension_extension_data(ext_len@, extension_type@),
{
    ClientHelloExtensionExtensionDataCombinator(AndThen(bytes::Variable(ext_len.ex_into()), Mapped { inner: Choice::new(Cond { cond: extension_type == 0, inner: server_name_list() }, Choice::new(Cond { cond: extension_type == 13, inner: signature_scheme_list() }, Choice::new(Cond { cond: extension_type == 10, inner: named_group_list() }, Choice::new(Cond { cond: extension_type == 5, inner: certificate_status_request() }, Choice::new(Cond { cond: extension_type == 16, inner: protocol_name_list() }, Choice::new(Cond { cond: extension_type == 43, inner: supported_versions_client() }, Choice::new(Cond { cond: extension_type == 51, inner: key_share_client_hello() }, Choice::new(Cond { cond: extension_type == 45, inner: psk_key_exchange_modes() }, Choice::new(Cond { cond: extension_type == 41, inner: pre_shared_key_client_extension() }, Cond { cond: !(extension_type == 0 || extension_type == 13 || extension_type == 10 || extension_type == 5 || extension_type == 16 || extension_type == 43 || extension_type == 51 || extension_type == 45 || extension_type == 41), inner: client_hello_extension_rest(ext_len, extension_type) }))))))))), mapper: ClientHelloExtensionExtensionDataMapper }))
}
...
pub type SpecCertificateExtensionExtensionDataCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<SpecCertificateStatusCombinator>, Choice<Cond<SpecSignedCertificateTimestampListCombinator>, Cond<bytes::Variable>>>, CertificateExtensionExtensionDataMapper>>;
...
pub type CertificateExtensionExtensionDataCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<CertificateStatusCombinator>, Choice<Cond<SignedCertificateTimestampListCombinator>, Cond<bytes::Variable>>>, CertificateExtensionExtensionDataMapper>>;
...
pub fn certificate_extension_extension_data<'a>(ext_len: u16, extension_type: ExtensionType) -> (o: CertificateExtensionExtensionDataCombinator)
    ensures o@ == spec_certificate_extension_extension_data(ext_len@, extension_type@),
{
    CertificateExtensionExtensionDataCombinator(AndThen(bytes::Variable(ext_len.ex_into()), Mapped { inner: Choice::new(Cond { cond: extension_type == 5, inner: certificate_status() }, Choice::new(Cond { cond: extension_type == 18, inner: signed_certificate_timestamp_list() }, Cond { cond: !(extension_type == 5 || extension_type == 18), inner: bytes::Variable(ext_len.ex_into()) })), mapper: CertificateExtensionExtensionDataMapper }))
}
...
pub type SpecCertificateEntryOpaqueCombinatorAlias = Mapped<(SpecOpaque1FfffffCombinator, SpecCertificateExtensionsCombinator), CertificateEntryOpaqueMapper>;
...
pub type CertificateEntryOpaqueCombinatorAlias = Mapped<(Opaque1FfffffCombinator, CertificateExtensionsCombinator), CertificateEntryOpaqueMapper>;
...
pub type SpecHelloRetryExtensionExtensionDataCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<SpecSupportedVersionsServerCombinator>, Choice<Cond<SpecCookieCombinator>, Choice<Cond<SpecNamedGroupCombinator>, Cond<bytes::Variable>>>>, HelloRetryExtensionExtensionDataMapper>>;
...
pub type HelloRetryExtensionExtensionDataCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<SupportedVersionsServerCombinator>, Choice<Cond<CookieCombinator>, Choice<Cond<NamedGroupCombinator>, Cond<bytes::Variable>>>>, HelloRetryExtensionExtensionDataMapper>>;
...
{
    HelloRetryExtensionExtensionDataCombinator(AndThen(bytes::Variable(ext_len.ex_into()), Mapped { inner: Choice::new(Cond { cond: extension_type == 43, inner: supported_versions_server() }, Choice::new(Cond { cond: extension_type == 44, inner: cookie() }, Choice::new(Cond { cond: extension_type == 51, inner: named_group() }, Cond { cond: !(extension_type == 43 || extension_type == 44 || extension_type == 51), inner: bytes::Variable(ext_len.ex_into()) }))), mapper: HelloRetryExtensionExtensionDataMapper }))
}
...
pub type SpecHelloRetryRequestCombinatorAlias = Mapped<(SpecSessionIdCombinator, (SpecCipherSuiteCombinator, (Refined<U8, TagPred<u8>>, SpecHelloRetryExtensionsCombinator))), HelloRetryRequestMapper>;
...
pub type HelloRetryRequestCombinatorAlias = Mapped<(SessionIdCombinator, (CipherSuiteCombinator, (Refined<U8, TagPred<u8>>, HelloRetryExtensionsCombinator))), HelloRetryRequestMapper>;
...
pub type SpecNewSessionTicketExtensionExtensionDataCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<SpecEarlyDataIndicationNewSessionTicketCombinator>, Cond<bytes::Variable>>, NewSessionTicketExtensionExtensionDataMapper>>;
...
pub type NewSessionTicketExtensionExtensionDataCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<EarlyDataIndicationNewSessionTicketCombinator>, Cond<bytes::Variable>>, NewSessionTicketExtensionExtensionDataMapper>>;
...
pub fn new_session_ticket_extension_extension_data<'a>(extension_type: ExtensionType, ext_len: u16) -> (o: NewSessionTicketExtensionExtensionDataCombinator)
    ensures o@ == spec_new_session_ticket_extension_extension_data(extension_type@, ext_len@),
{
    NewSessionTicketExtensionExtensionDataCombinator(AndThen(bytes::Variable(ext_len.ex_into()), Mapped { inner: Choice::new(Cond { cond: extension_type == 42, inner: early_data_indication_new_session_ticket() }, Cond { cond: !(extension_type == 42), inner: bytes::Variable(ext_len.ex_into()) }), mapper: NewSessionTicketExtensionExtensionDataMapper }))
}
...
pub type SpecSeverHelloExtensionExtensionDataCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<SpecPreSharedKeyServerExtensionCombinator>, Choice<Cond<SpecSupportedVersionsServerCombinator>, Choice<Cond<SpecKeyShareEntryCombinator>, Cond<bytes::Variable>>>>, SeverHelloExtensionExtensionDataMapper>>;
...
pub type SeverHelloExtensionExtensionDataCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<PreSharedKeyServerExtensionCombinator>, Choice<Cond<SupportedVersionsServerCombinator>, Choice<Cond<KeyShareEntryCombinator>, Cond<bytes::Variable>>>>, SeverHelloExtensionExtensionDataMapper>>;
...
{
    SeverHelloExtensionExtensionDataCombinator(AndThen(bytes::Variable(ext_len.ex_into()), Mapped { inner: Choice::new(Cond { cond: extension_type == 41, inner: pre_shared_key_server_extension() }, Choice::new(Cond { cond: extension_type == 43, inner: supported_versions_server() }, Choice::new(Cond { cond: extension_type == 51, inner: key_share_entry() }, Cond { cond: !(extension_type == 41 || extension_type == 43 || extension_type == 51), inner: bytes::Variable(ext_len.ex_into()) }))), mapper: SeverHelloExtensionExtensionDataMapper }))
}
...
pub type SpecServerHelloCombinatorAlias = Mapped<(SpecSessionIdCombinator, (SpecCipherSuiteCombinator, (Refined<U8, TagPred<u8>>, SpecServerExtensionsCombinator))), ServerHelloMapper>;
...
pub type ServerHelloCombinatorAlias = Mapped<(SessionIdCombinator, (CipherSuiteCombinator, (Refined<U8, TagPred<u8>>, ServerExtensionsCombinator))), ServerHelloMapper>;
...
pub type CertificateRequestExtensionExtensionDataCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<SignatureSchemeListCombinator>, Choice<Cond<CertificateAuthoritiesExtensionCombinator>, Choice<Cond<SignatureSchemeListCombinator>, Choice<Cond<CertificateStatusRequestCombinator>, Choice<Cond<SignedCertificateTimestampListCombinator>, Choice<Cond<OidFilterExtensionCombinator>, Cond<bytes::Variable>>>>>>>, CertificateRequestExtensionExtensionDataMapper>>;
...
pub fn certificate_request_extension_extension_data<'a>(ext_len: u16, extension_type: ExtensionType) -> (o: CertificateRequestExtensionExtensionDataCombinator)
...
pub type SpecCertificateEntryDataCombinatorAlias = Mapped<Choice<Cond<SpecOpaque1FfffffCombinator>, Cond<SpecOpaque1FfffffCombinator>>, CertificateEntryDataMapper>;
...
pub type CertificateEntryDataCombinatorAlias = Mapped<Choice<Cond<Opaque1FfffffCombinator>, Cond<Opaque1FfffffCombinator>>, CertificateEntryDataMapper>;
...
{
    CertificateEntryDataCombinator(Mapped { inner: Choice::new(Cond { cond: cert_type == 0, inner: opaque_1_ffffff() }, Cond { cond: cert_type == 2, inner: opaque_1_ffffff() }), mapper: CertificateEntryDataMapper })
}
...
pub type SpecCertificateEntryCombinatorAlias = Mapped<(SpecCertificateEntryDataCombinator, SpecCertificateExtensionsCombinator), CertificateEntryMapper>;
...
pub type CertificateEntryCombinatorAlias = Mapped<(CertificateEntryDataCombinator, CertificateExtensionsCombinator), CertificateEntryMapper>;
...
pub type SpecClientHelloCombinatorAlias = Mapped<(Refined<U16Be, TagPred<u16>>, (bytes::Fixed<32>, (SpecSessionIdCombinator, (SpecCipherSuiteListCombinator, (SpecOpaque1FfCombinator, SpecClientExtensionsCombinator))))), ClientHelloMapper>;
...
pub type ClientHelloCombinatorAlias = Mapped<(Refined<U16Be, TagPred<u16>>, (bytes::Fixed<32>, (SessionIdCombinator, (CipherSuiteListCombinator, (Opaque1FfCombinator, ClientExtensionsCombinator))))), ClientHelloMapper>;
...
pub type EncryptedExtensionExtensionDataCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<EmptyCombinator>, Choice<Cond<MaxFragmentLengthCombinator>, Choice<Cond<NamedGroupListCombinator>, Choice<Cond<HeartbeatModeCombinator>, Choice<Cond<ProtocolNameListCombinator>, Choice<Cond<ClientCertTypeClientExtensionCombinator>, Choice<Cond<ServerCertTypeClientExtensionCombinator>, Choice<Cond<EmptyCombinator>, Cond<bytes::Variable>>>>>>>>>, EncryptedExtensionExtensionDataMapper>>;
...
pub fn encrypted_extension_extension_data<'a>(ext_len: u16, extension_type: ExtensionType) -> (o: EncryptedExtensionExtensionDataCombinator)
...
pub type SpecShOrHrrPayloadCombinatorAlias = Mapped<Choice<Cond<SpecHelloRetryRequestCombinator>, Cond<SpecServerHelloCombinator>>, ShOrHrrPayloadMapper>;
...
pub type ShOrHrrPayloadCombinatorAlias = Mapped<Choice<Cond<HelloRetryRequestCombinator>, Cond<ServerHelloCombinator>>, ShOrHrrPayloadMapper>;
...
{
    ShOrHrrPayloadCombinator(Mapped { inner: Choice::new(Cond { cond: compare_slice(random, [207, 33, 173, 116, 229, 154, 97, 17, 190, 29, 140, 2, 30, 101, 184, 145, 194, 162, 17, 22, 122, 187, 140, 94, 7, 158, 9, 226, 200, 168, 51, 156].as_slice()), inner: hello_retry_request() }, Cond { cond: !(compare_slice(random, [207, 33, 173, 116, 229, 154, 97, 17, 190, 29, 140, 2, 30, 101, 184, 145, 194, 162, 17, 22, 122, 187, 140, 94, 7, 158, 9, 226, 200, 168, 51, 156].as_slice())), inner: server_hello() }), mapper: ShOrHrrPayloadMapper })
}
...
pub type HandshakeMsgCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<ClientHelloCombinator>, Choice<Cond<ShOrHrrCombinator>, Choice<Cond<NewSessionTicketCombinator>, Choice<Cond<EmptyCombinator>, Choice<Cond<EncryptedExtensionsCombinator>, Choice<Cond<CertificateCombinator>, Choice<Cond<CertificateRequestCombinator>, Choice<Cond<CertificateVerifyCombinator>, Choice<Cond<FinishedCombinator>, Cond<KeyUpdateCombinator>>>>>>>>>>, HandshakeMsgMapper>>;
