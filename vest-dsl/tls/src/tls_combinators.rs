...
pub closed spec fn spec_certificate_extension_extension_data(ext_len: u16, extension_type: u16) -> SpecCertificateExtensionExtensionDataCombinator {
...
pub closed spec fn spec_server_name_name(name_type: u8) -> SpecServerNameNameCombinator {
...
{
    ServerNameNameCombinator(Mapped { inner: ServerNameNameCombinator1(Choice::new(Cond { cond: name_type == NameType::HostName, inner: host_name() }, Cond { cond: !(name_type == NameType::HostName), inner: unknown_name() })), mapper: ServerNameNameMapper })
}
...
pub closed spec fn spec_hello_retry_extension_extension_data(ext_len: u16, extension_type: u16) -> SpecHelloRetryExtensionExtensionDataCombinator {
...
pub closed spec fn spec_sever_hello_extension_extension_data(extension_type: u16, ext_len: u16) -> SpecSeverHelloExtensionExtensionDataCombinator {
...
pub closed spec fn spec_encrypted_extension_extension_data(extension_type: u16, ext_len: u16) -> SpecEncryptedExtensionExtensionDataCombinator {
...
pub closed spec fn spec_new_session_ticket_extension_extension_data(ext_len: u16, extension_type: u16) -> SpecNewSessionTicketExtensionExtensionDataCombinator {
...
{
    NewSessionTicketExtensionExtensionDataCombinator(AndThen(bytes::Variable(ext_len.ex_into()), Mapped { inner: NewSessionTicketExtensionExtensionDataCombinator1(Choice::new(Cond { cond: extension_type == ExtensionType::EarlyData, inner: early_data_indication_new_session_ticket() }, Cond { cond: !(extension_type == ExtensionType::EarlyData), inner: bytes::Variable(ext_len.ex_into()) })), mapper: NewSessionTicketExtensionExtensionDataMapper }))
}
...
pub closed spec fn spec_client_hello_extension_rest(ext_len: u16, extension_type: u16) -> SpecClientHelloExtensionRestCombinator {
...
pub closed spec fn spec_client_hello_extension_extension_data(extension_type: u16, ext_len: u16) -> SpecClientHelloExtensionExtensionDataCombinator {
...
pub closed spec fn spec_certificate_request_extension_extension_data(ext_len: u16, extension_type: u16) -> SpecCertificateRequestExtensionExtensionDataCombinator {
...
pub closed spec fn spec_finished(size: u24) -> SpecFinishedCombinator {
...
pub closed spec fn spec_certificate_entry_data(cert_type: u8) -> SpecCertificateEntryDataCombinator {
...
{
    CertificateEntryDataCombinator(Mapped { inner: CertificateEntryDataCombinator1(Choice::new(Cond { cond: cert_type == CertificateType::X509, inner: opaque_1_ffffff() }, Cond { cond: cert_type == CertificateType::RawPublicKey, inner: opaque_1_ffffff() })), mapper: CertificateEntryDataMapper })
}
...
pub closed spec fn spec_certificate_entry(cert_type: u8) -> SpecCertificateEntryCombinator {
