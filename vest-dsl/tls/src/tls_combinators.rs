...
pub type SpecOpaque1FfffCombinatorAlias = Mapped<SpecPair<Refined<U16Be, Predicate17626095872143391426>, bytes::Variable>, Opaque1FfffMapper<'static>>;
...
pub type Opaque1FfffCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U16Be, Predicate17626095872143391426>, bytes::Variable, Opaque1FfffCont0<'a>>, Opaque1FfffMapper<'a>>;


pub closed spec fn spec_opaque_1_ffff() -> SpecOpaque1FfffCombinator {
    SpecOpaque1FfffCombinator(
    Mapped {
        inner: SpecPair { fst: Refined { inner: U16Be, predicate: Predicate17626095872143391426 }, snd: |deps| spec_opaque1_ffff_cont0(deps) },
    ...
    ensures o@ == spec_opaque_1_ffff(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U16Be, predicate: Predicate17626095872143391426 }, snd: Opaque1FfffCont0::new(), spec_snd: Ghost(|deps| spec_opaque1_ffff_cont0(deps)) },
...
pub type SpecHelloRetryExtensionExtensionDataCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<SpecSupportedVersionsServerCombinator>, Choice<Cond<SpecCookieCombinator>, Choice<Cond<SpecNamedGroupCombinator>, Cond<bytes::Variable>>>>, HelloRetryExtensionExtensionDataMapper<'static>>>;
...
pub type HelloRetryExtensionExtensionDataCombinatorAlias<'a> = AndThen<bytes::Variable, Mapped<Choice<Cond<SupportedVersionsServerCombinator>, Choice<Cond<CookieCombinator<'a>>, Choice<Cond<NamedGroupCombinator>, Cond<bytes::Variable>>>>, HelloRetryExtensionExtensionDataMapper<'a>>>;
...
pub closed spec fn spec_hello_retry_extension_extension_data(extension_type: SpecExtensionType, ext_len: u16) -> SpecHelloRetryExtensionExtensionDataCombinator {
    SpecHelloRetryExtensionExtensionDataCombinator(AndThen(bytes::Variable(ext_len.spec_into()), Mapped { inner: Choice(Cond { cond: extension_type == 43, inner: spec_supported_versions_server() }, Choice(Cond { cond: extension_type == 44, inner: spec_cookie() }, Choice(Cond { cond: extension_type == 51, inner: spec_named_group() }, Cond { cond: !(extension_type == 43 || extension_type == 44 || extension_type == 51), inner: bytes::Variable(ext_len.spec_into()) }))), mapper: HelloRetryExtensionExtensionDataMapper::spec_new() }))
}
...
{
    HelloRetryExtensionExtensionDataCombinator(AndThen(bytes::Variable(ext_len.ex_into()), Mapped { inner: Choice::new(Cond { cond: extension_type == 43, inner: supported_versions_server() }, Choice::new(Cond { cond: extension_type == 44, inner: cookie() }, Choice::new(Cond { cond: extension_type == 51, inner: named_group() }, Cond { cond: !(extension_type == 43 || extension_type == 44 || extension_type == 51), inner: bytes::Variable(ext_len.ex_into()) }))), mapper: HelloRetryExtensionExtensionDataMapper::new() }))
}
...
pub type SpecHelloRetryExtensionCombinatorAlias = Mapped<SpecPair<SpecPair<SpecExtensionTypeCombinator, U16Be>, SpecHelloRetryExtensionExtensionDataCombinator>, HelloRetryExtensionMapper<'static>>;
...
pub type HelloRetryExtensionCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Pair<&'a [u8], Vec<u8>, ExtensionTypeCombinator, U16Be, HelloRetryExtensionCont1<'a>>, HelloRetryExtensionExtensionDataCombinator<'a>, HelloRetryExtensionCont0<'a>>, HelloRetryExtensionMapper<'a>>;


pub closed spec fn spec_hello_retry_extension() -> SpecHelloRetryExtensionCombinator {
    SpecHelloRetryExtensionCombinator(
    Mapped {
        inner: SpecPair { fst: SpecPair { fst: spec_extension_type(), snd: |deps| spec_hello_retry_extension_cont1(deps) }, snd: |deps| spec_hello_retry_extension_cont0(deps) },
    ...
    ensures o@ == spec_hello_retry_extension(),
{
    ...
    Mapped {
        inner: Pair { fst: Pair { fst: extension_type(), snd: HelloRetryExtensionCont1::new(), spec_snd: Ghost(|deps| spec_hello_retry_extension_cont1(deps)) }, snd: HelloRetryExtensionCont0::new(), spec_snd: Ghost(|deps| spec_hello_retry_extension_cont0(deps)) },
...
pub type SpecFinishedCombinatorAlias = Mapped<Choice<Cond<bytes::Fixed<12>>, Choice<Cond<bytes::Fixed<20>>, Choice<Cond<bytes::Fixed<32>>, Choice<Cond<bytes::Fixed<48>>, Choice<Cond<bytes::Fixed<64>>, Cond<bytes::Variable>>>>>>, FinishedMapper<'static>>;
...
pub type FinishedCombinatorAlias<'a> = Mapped<Choice<Cond<bytes::Fixed<12>>, Choice<Cond<bytes::Fixed<20>>, Choice<Cond<bytes::Fixed<32>>, Choice<Cond<bytes::Fixed<48>>, Choice<Cond<bytes::Fixed<64>>, Cond<bytes::Variable>>>>>>, FinishedMapper<'a>>;


pub closed spec fn spec_finished(size: SpecDigestSize) -> SpecFinishedCombinator {
    SpecFinishedCombinator(Mapped { inner: Choice(Cond { cond: size.spec_as_u32() == 12, inner: bytes::Fixed::<12> }, Choice(Cond { cond: size.spec_as_u32() == 20, inner: bytes::Fixed::<20> }, Choice(Cond { cond: size.spec_as_u32() == 32, inner: bytes::Fixed::<32> }, Choice(Cond { cond: size.spec_as_u32() == 48, inner: bytes::Fixed::<48> }, Choice(Cond { cond: size.spec_as_u32() == 64, inner: bytes::Fixed::<64> }, Cond { cond: !(size.spec_as_u32() == 12 || size.spec_as_u32() == 20 || size.spec_as_u32() == 32 || size.spec_as_u32() == 48 || size.spec_as_u32() == 64), inner: bytes::Variable(size.spec_into()) }))))), mapper: FinishedMapper::spec_new() })
}

pub fn finished<'a>(size: DigestSize) -> (o: FinishedCombinator<'a>)
    ensures o@ == spec_finished(size@),
{
    FinishedCombinator(Mapped { inner: Choice::new(Cond { cond: size.as_u32() == 12, inner: bytes::Fixed::<12> }, Choice::new(Cond { cond: size.as_u32() == 20, inner: bytes::Fixed::<20> }, Choice::new(Cond { cond: size.as_u32() == 32, inner: bytes::Fixed::<32> }, Choice::new(Cond { cond: size.as_u32() == 48, inner: bytes::Fixed::<48> }, Choice::new(Cond { cond: size.as_u32() == 64, inner: bytes::Fixed::<64> }, Cond { cond: !(size.as_u32() == 12 || size.as_u32() == 20 || size.as_u32() == 32 || size.as_u32() == 48 || size.as_u32() == 64), inner: bytes::Variable(size.ex_into()) }))))), mapper: FinishedMapper::new() })
}
...
pub type SpecResponderIdListCombinatorAlias = Mapped<SpecPair<U16Be, AndThen<bytes::Variable, Repeat<SpecResponderIdCombinator>>>, ResponderIdListMapper<'static>>;
...
pub type ResponderIdListCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, U16Be, AndThen<bytes::Variable, Repeat<ResponderIdCombinator<'a>>>, ResponderIdListCont0<'a>>, ResponderIdListMapper<'a>>;


pub closed spec fn spec_responder_id_list() -> SpecResponderIdListCombinator {
    SpecResponderIdListCombinator(
    Mapped {
        inner: SpecPair { fst: U16Be, snd: |deps| spec_responder_id_list_cont0(deps) },
    ...
    ensures o@ == spec_responder_id_list(),
{
    ...
    Mapped {
        inner: Pair { fst: U16Be, snd: ResponderIdListCont0::new(), spec_snd: Ghost(|deps| spec_responder_id_list_cont0(deps)) },
...
pub type SpecOpaque0FfffCombinatorAlias = Mapped<SpecPair<U16Be, bytes::Variable>, Opaque0FfffMapper<'static>>;
...
pub type Opaque0FfffCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, U16Be, bytes::Variable, Opaque0FfffCont0<'a>>, Opaque0FfffMapper<'a>>;


pub closed spec fn spec_opaque_0_ffff() -> SpecOpaque0FfffCombinator {
    SpecOpaque0FfffCombinator(
    Mapped {
        inner: SpecPair { fst: U16Be, snd: |deps| spec_opaque0_ffff_cont0(deps) },
    ...
    ensures o@ == spec_opaque_0_ffff(),
{
    ...
    Mapped {
        inner: Pair { fst: U16Be, snd: Opaque0FfffCont0::new(), spec_snd: Ghost(|deps| spec_opaque0_ffff_cont0(deps)) },
...
pub type SpecOpaque1FfffffCombinatorAlias = Mapped<SpecPair<Refined<U24Be, Predicate15036445817960576151>, bytes::Variable>, Opaque1FfffffMapper<'static>>;
...
pub type Opaque1FfffffCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U24Be, Predicate15036445817960576151>, bytes::Variable, Opaque1FfffffCont0<'a>>, Opaque1FfffffMapper<'a>>;


pub closed spec fn spec_opaque_1_ffffff() -> SpecOpaque1FfffffCombinator {
    SpecOpaque1FfffffCombinator(
    Mapped {
        inner: SpecPair { fst: Refined { inner: U24Be, predicate: Predicate15036445817960576151 }, snd: |deps| spec_opaque1_ffffff_cont0(deps) },
    ...
    ensures o@ == spec_opaque_1_ffffff(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U24Be, predicate: Predicate15036445817960576151 }, snd: Opaque1FfffffCont0::new(), spec_snd: Ghost(|deps| spec_opaque1_ffffff_cont0(deps)) },
...
pub type SpecCertificateEntryDataCombinatorAlias = Mapped<Choice<Cond<SpecOpaque1FfffffCombinator>, Cond<SpecOpaque1FfffffCombinator>>, CertificateEntryDataMapper<'static>>;
...
pub type CertificateEntryDataCombinatorAlias<'a> = Mapped<Choice<Cond<Opaque1FfffffCombinator<'a>>, Cond<Opaque1FfffffCombinator<'a>>>, CertificateEntryDataMapper<'a>>;


pub closed spec fn spec_certificate_entry_data(cert_type: SpecCertificateType) -> SpecCertificateEntryDataCombinator {
    SpecCertificateEntryDataCombinator(Mapped { inner: Choice(Cond { cond: cert_type == 0, inner: spec_opaque_1_ffffff() }, Cond { cond: cert_type == 2, inner: spec_opaque_1_ffffff() }), mapper: CertificateEntryDataMapper::spec_new() })
}
...
{
    CertificateEntryDataCombinator(Mapped { inner: Choice::new(Cond { cond: cert_type == 0, inner: opaque_1_ffffff() }, Cond { cond: cert_type == 2, inner: opaque_1_ffffff() }), mapper: CertificateEntryDataMapper::new() })
}
...
pub type SpecSignedCertificateTimestampListCombinatorAlias = Mapped<SpecPair<Refined<U16Be, Predicate16977634203518580913>, AndThen<bytes::Variable, Repeat<SpecSerializedSctCombinator>>>, SignedCertificateTimestampListMapper<'static>>;
...
pub type SignedCertificateTimestampListCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U16Be, Predicate16977634203518580913>, AndThen<bytes::Variable, Repeat<SerializedSctCombinator<'a>>>, SignedCertificateTimestampListCont0<'a>>, SignedCertificateTimestampListMapper<'a>>;
...
pub closed spec fn spec_signed_certificate_timestamp_list() -> SpecSignedCertificateTimestampListCombinator {
    ...
    Mapped {
        inner: SpecPair { fst: Refined { inner: U16Be, predicate: Predicate16977634203518580913 }, snd: |deps| spec_signed_certificate_timestamp_list_cont0(deps) },
    ...
    ensures o@ == spec_signed_certificate_timestamp_list(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U16Be, predicate: Predicate16977634203518580913 }, snd: SignedCertificateTimestampListCont0::new(), spec_snd: Ghost(|deps| spec_signed_certificate_timestamp_list_cont0(deps)) },
...
impl<'a> Continuation<&u16> for SignedCertificateTimestampListCont0<'a> {
    type Output = AndThen<bytes::Variable, Repeat<SerializedSctCombinator<'a>>>;
...
pub type SpecCertificateExtensionExtensionDataCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<SpecCertificateStatusCombinator>, Choice<Cond<SpecSignedCertificateTimestampListCombinator>, Cond<bytes::Variable>>>, CertificateExtensionExtensionDataMapper<'static>>>;
...
pub type CertificateExtensionExtensionDataCombinatorAlias<'a> = AndThen<bytes::Variable, Mapped<Choice<Cond<CertificateStatusCombinator<'a>>, Choice<Cond<SignedCertificateTimestampListCombinator<'a>>, Cond<bytes::Variable>>>, CertificateExtensionExtensionDataMapper<'a>>>;
...
{
    CertificateExtensionExtensionDataCombinator(AndThen(bytes::Variable(ext_len.ex_into()), Mapped { inner: Choice::new(Cond { cond: extension_type == 5, inner: certificate_status() }, Choice::new(Cond { cond: extension_type == 18, inner: signed_certificate_timestamp_list() }, Cond { cond: !(extension_type == 5 || extension_type == 18), inner: bytes::Variable(ext_len.ex_into()) })), mapper: CertificateExtensionExtensionDataMapper::new() }))
}
...
pub type SpecCertificateExtensionCombinatorAlias = Mapped<SpecPair<SpecPair<SpecExtensionTypeCombinator, U16Be>, SpecCertificateExtensionExtensionDataCombinator>, CertificateExtensionMapper<'static>>;
...
pub type CertificateExtensionCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Pair<&'a [u8], Vec<u8>, ExtensionTypeCombinator, U16Be, CertificateExtensionCont1<'a>>, CertificateExtensionExtensionDataCombinator<'a>, CertificateExtensionCont0<'a>>, CertificateExtensionMapper<'a>>;


pub closed spec fn spec_certificate_extension() -> SpecCertificateExtensionCombinator {
    SpecCertificateExtensionCombinator(
    Mapped {
        inner: SpecPair { fst: SpecPair { fst: spec_extension_type(), snd: |deps| spec_certificate_extension_cont1(deps) }, snd: |deps| spec_certificate_extension_cont0(deps) },
    ...
    ensures o@ == spec_certificate_extension(),
{
    ...
    Mapped {
        inner: Pair { fst: Pair { fst: extension_type(), snd: CertificateExtensionCont1::new(), spec_snd: Ghost(|deps| spec_certificate_extension_cont1(deps)) }, snd: CertificateExtensionCont0::new(), spec_snd: Ghost(|deps| spec_certificate_extension_cont0(deps)) },
...
pub type SpecCertificateExtensionsCombinatorAlias = Mapped<SpecPair<U16Be, AndThen<bytes::Variable, Repeat<SpecCertificateExtensionCombinator>>>, CertificateExtensionsMapper<'static>>;
...
pub type CertificateExtensionsCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, U16Be, AndThen<bytes::Variable, Repeat<CertificateExtensionCombinator<'a>>>, CertificateExtensionsCont0<'a>>, CertificateExtensionsMapper<'a>>;


pub closed spec fn spec_certificate_extensions() -> SpecCertificateExtensionsCombinator {
    SpecCertificateExtensionsCombinator(
    Mapped {
        inner: SpecPair { fst: U16Be, snd: |deps| spec_certificate_extensions_cont0(deps) },
    ...
    ensures o@ == spec_certificate_extensions(),
{
    ...
    Mapped {
        inner: Pair { fst: U16Be, snd: CertificateExtensionsCont0::new(), spec_snd: Ghost(|deps| spec_certificate_extensions_cont0(deps)) },
...
impl<'a> Continuation<&u16> for CertificateExtensionsCont0<'a> {
    type Output = AndThen<bytes::Variable, Repeat<CertificateExtensionCombinator<'a>>>;
...
pub type SpecNewSessionTicketExtensionExtensionDataCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<SpecEarlyDataIndicationNewSessionTicketCombinator>, Cond<bytes::Variable>>, NewSessionTicketExtensionExtensionDataMapper<'static>>>;
...
pub type NewSessionTicketExtensionExtensionDataCombinatorAlias<'a> = AndThen<bytes::Variable, Mapped<Choice<Cond<EarlyDataIndicationNewSessionTicketCombinator>, Cond<bytes::Variable>>, NewSessionTicketExtensionExtensionDataMapper<'a>>>;
...
pub closed spec fn spec_new_session_ticket_extension_extension_data(ext_len: u16, extension_type: SpecExtensionType) -> SpecNewSessionTicketExtensionExtensionDataCombinator {
    SpecNewSessionTicketExtensionExtensionDataCombinator(AndThen(bytes::Variable(ext_len.spec_into()), Mapped { inner: Choice(Cond { cond: extension_type == 42, inner: spec_early_data_indication_new_session_ticket() }, Cond { cond: !(extension_type == 42), inner: bytes::Variable(ext_len.spec_into()) }), mapper: NewSessionTicketExtensionExtensionDataMapper::spec_new() }))
}
...
{
    NewSessionTicketExtensionExtensionDataCombinator(AndThen(bytes::Variable(ext_len.ex_into()), Mapped { inner: Choice::new(Cond { cond: extension_type == 42, inner: early_data_indication_new_session_ticket() }, Cond { cond: !(extension_type == 42), inner: bytes::Variable(ext_len.ex_into()) }), mapper: NewSessionTicketExtensionExtensionDataMapper::new() }))
}
...
pub type SignatureSchemeListCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U16Be, Predicate15206902916018849611>, AndThen<bytes::Variable, Repeat<SignatureSchemeCombinator>>, SignatureSchemeListCont0<'a>>, SignatureSchemeListMapper>;


pub closed spec fn spec_signature_scheme_list() -> SpecSignatureSchemeListCombinator {
    SpecSignatureSchemeListCombinator(
    Mapped {
        inner: SpecPair { fst: Refined { inner: U16Be, predicate: Predicate15206902916018849611 }, snd: |deps| spec_signature_scheme_list_cont0(deps) },
    ...
    ensures o@ == spec_signature_scheme_list(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U16Be, predicate: Predicate15206902916018849611 }, snd: SignatureSchemeListCont0::new(), spec_snd: Ghost(|deps| spec_signature_scheme_list_cont0(deps)) },
...
pub type SpecCertificateAuthoritiesExtensionCombinatorAlias = Mapped<SpecPair<Refined<U16Be, Predicate7402808336413996182>, AndThen<bytes::Variable, Repeat<SpecDistinguishedNameCombinator>>>, CertificateAuthoritiesExtensionMapper<'static>>;
...
pub type CertificateAuthoritiesExtensionCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U16Be, Predicate7402808336413996182>, AndThen<bytes::Variable, Repeat<DistinguishedNameCombinator<'a>>>, CertificateAuthoritiesExtensionCont0<'a>>, CertificateAuthoritiesExtensionMapper<'a>>;
...
pub closed spec fn spec_certificate_authorities_extension() -> SpecCertificateAuthoritiesExtensionCombinator {
    ...
    Mapped {
        inner: SpecPair { fst: Refined { inner: U16Be, predicate: Predicate7402808336413996182 }, snd: |deps| spec_certificate_authorities_extension_cont0(deps) },
    ...
    ensures o@ == spec_certificate_authorities_extension(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U16Be, predicate: Predicate7402808336413996182 }, snd: CertificateAuthoritiesExtensionCont0::new(), spec_snd: Ghost(|deps| spec_certificate_authorities_extension_cont0(deps)) },
...
impl<'a> Continuation<&u16> for CertificateAuthoritiesExtensionCont0<'a> {
    type Output = AndThen<bytes::Variable, Repeat<DistinguishedNameCombinator<'a>>>;
...
pub type SpecOpaque1FfCombinatorAlias = Mapped<SpecPair<Refined<U8, Predicate3651688686135228051>, bytes::Variable>, Opaque1FfMapper<'static>>;
...
pub type Opaque1FfCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U8, Predicate3651688686135228051>, bytes::Variable, Opaque1FfCont0<'a>>, Opaque1FfMapper<'a>>;


pub closed spec fn spec_opaque_1_ff() -> SpecOpaque1FfCombinator {
    SpecOpaque1FfCombinator(
    Mapped {
        inner: SpecPair { fst: Refined { inner: U8, predicate: Predicate3651688686135228051 }, snd: |deps| spec_opaque1_ff_cont0(deps) },
    ...
    ensures o@ == spec_opaque_1_ff(),
{
    Opaque1FfCombinator(
    Mapped {
        inner: Pair { fst: Refined { inner: U8, predicate: Predicate3651688686135228051 }, snd: Opaque1FfCont0::new(), spec_snd: Ghost(|deps| spec_opaque1_ff_cont0(deps)) },
...
pub type SpecOidFilterExtensionCombinatorAlias = Mapped<SpecPair<U16Be, AndThen<bytes::Variable, Repeat<SpecOidFilterCombinator>>>, OidFilterExtensionMapper<'static>>;
...
pub type OidFilterExtensionCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, U16Be, AndThen<bytes::Variable, Repeat<OidFilterCombinator<'a>>>, OidFilterExtensionCont0<'a>>, OidFilterExtensionMapper<'a>>;


pub closed spec fn spec_oid_filter_extension() -> SpecOidFilterExtensionCombinator {
    SpecOidFilterExtensionCombinator(
    Mapped {
        inner: SpecPair { fst: U16Be, snd: |deps| spec_oid_filter_extension_cont0(deps) },
    ...
    ensures o@ == spec_oid_filter_extension(),
{
    ...
    Mapped {
        inner: Pair { fst: U16Be, snd: OidFilterExtensionCont0::new(), spec_snd: Ghost(|deps| spec_oid_filter_extension_cont0(deps)) },
...
impl<'a> Continuation<&u16> for OidFilterExtensionCont0<'a> {
    type Output = AndThen<bytes::Variable, Repeat<OidFilterCombinator<'a>>>;
...
pub type SpecCertificateRequestExtensionExtensionDataCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<SpecSignatureSchemeListCombinator>, Choice<Cond<SpecCertificateAuthoritiesExtensionCombinator>, Choice<Cond<SpecSignatureSchemeListCombinator>, Choice<Cond<SpecCertificateStatusRequestCombinator>, Choice<Cond<SpecSignedCertificateTimestampListCombinator>, Choice<Cond<SpecOidFilterExtensionCombinator>, Cond<bytes::Variable>>>>>>>, CertificateRequestExtensionExtensionDataMapper<'static>>>;
...
pub type CertificateRequestExtensionExtensionDataCombinatorAlias<'a> = AndThen<bytes::Variable, Mapped<Choice<Cond<SignatureSchemeListCombinator<'a>>, Choice<Cond<CertificateAuthoritiesExtensionCombinator<'a>>, Choice<Cond<SignatureSchemeListCombinator<'a>>, Choice<Cond<CertificateStatusRequestCombinator<'a>>, Choice<Cond<SignedCertificateTimestampListCombinator<'a>>, Choice<Cond<OidFilterExtensionCombinator<'a>>, Cond<bytes::Variable>>>>>>>, CertificateRequestExtensionExtensionDataMapper<'a>>>;
...
{
    CertificateRequestExtensionExtensionDataCombinator(AndThen(bytes::Variable(ext_len.ex_into()), Mapped { inner: Choice::new(Cond { cond: extension_type == 13, inner: signature_scheme_list() }, Choice::new(Cond { cond: extension_type == 47, inner: certificate_authorities_extension() }, Choice::new(Cond { cond: extension_type == 50, inner: signature_scheme_list() }, Choice::new(Cond { cond: extension_type == 5, inner: certificate_status_request() }, Choice::new(Cond { cond: extension_type == 18, inner: signed_certificate_timestamp_list() }, Choice::new(Cond { cond: extension_type == 48, inner: oid_filter_extension() }, Cond { cond: !(extension_type == 13 || extension_type == 47 || extension_type == 50 || extension_type == 5 || extension_type == 18 || extension_type == 48), inner: bytes::Variable(ext_len.ex_into()) })))))), mapper: CertificateRequestExtensionExtensionDataMapper::new() }))
}
...
pub type SpecOpaque0FfffffCombinatorAlias = Mapped<SpecPair<U24Be, bytes::Variable>, Opaque0FfffffMapper<'static>>;
...
pub type Opaque0FfffffCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, U24Be, bytes::Variable, Opaque0FfffffCont0<'a>>, Opaque0FfffffMapper<'a>>;


pub closed spec fn spec_opaque_0_ffffff() -> SpecOpaque0FfffffCombinator {
    SpecOpaque0FfffffCombinator(
    Mapped {
        inner: SpecPair { fst: U24Be, snd: |deps| spec_opaque0_ffffff_cont0(deps) },
    ...
    ensures o@ == spec_opaque_0_ffffff(),
{
    ...
    Mapped {
        inner: Pair { fst: U24Be, snd: Opaque0FfffffCont0::new(), spec_snd: Ghost(|deps| spec_opaque0_ffffff_cont0(deps)) },
...
pub type NamedGroupListCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U16Be, Predicate8195707947578446211>, AndThen<bytes::Variable, Repeat<NamedGroupCombinator>>, NamedGroupListCont0<'a>>, NamedGroupListMapper>;


pub closed spec fn spec_named_group_list() -> SpecNamedGroupListCombinator {
    SpecNamedGroupListCombinator(
    Mapped {
        inner: SpecPair { fst: Refined { inner: U16Be, predicate: Predicate8195707947578446211 }, snd: |deps| spec_named_group_list_cont0(deps) },
    ...
    ensures o@ == spec_named_group_list(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U16Be, predicate: Predicate8195707947578446211 }, snd: NamedGroupListCont0::new(), spec_snd: Ghost(|deps| spec_named_group_list_cont0(deps)) },
...
pub type SpecProtocolNameListCombinatorAlias = Mapped<SpecPair<Refined<U16Be, Predicate8195707947578446211>, AndThen<bytes::Variable, Repeat<SpecProtocolNameCombinator>>>, ProtocolNameListMapper<'static>>;
...
pub type ProtocolNameListCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U16Be, Predicate8195707947578446211>, AndThen<bytes::Variable, Repeat<ProtocolNameCombinator<'a>>>, ProtocolNameListCont0<'a>>, ProtocolNameListMapper<'a>>;


pub closed spec fn spec_protocol_name_list() -> SpecProtocolNameListCombinator {
    SpecProtocolNameListCombinator(
    Mapped {
        inner: SpecPair { fst: Refined { inner: U16Be, predicate: Predicate8195707947578446211 }, snd: |deps| spec_protocol_name_list_cont0(deps) },
    ...
    ensures o@ == spec_protocol_name_list(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U16Be, predicate: Predicate8195707947578446211 }, snd: ProtocolNameListCont0::new(), spec_snd: Ghost(|deps| spec_protocol_name_list_cont0(deps)) },
...
impl<'a> Continuation<&u16> for ProtocolNameListCont0<'a> {
    type Output = AndThen<bytes::Variable, Repeat<ProtocolNameCombinator<'a>>>;
...
pub type ClientCertTypeClientExtensionCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U8, Predicate13984338198318635021>, AndThen<bytes::Variable, Repeat<CertificateTypeCombinator>>, ClientCertTypeClientExtensionCont0<'a>>, ClientCertTypeClientExtensionMapper>;
...
pub closed spec fn spec_client_cert_type_client_extension() -> SpecClientCertTypeClientExtensionCombinator {
    ...
    Mapped {
        inner: SpecPair { fst: Refined { inner: U8, predicate: Predicate13984338198318635021 }, snd: |deps| spec_client_cert_type_client_extension_cont0(deps) },
    ...
    ensures o@ == spec_client_cert_type_client_extension(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U8, predicate: Predicate13984338198318635021 }, snd: ClientCertTypeClientExtensionCont0::new(), spec_snd: Ghost(|deps| spec_client_cert_type_client_extension_cont0(deps)) },
...
pub type ServerCertTypeClientExtensionCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U8, Predicate13984338198318635021>, AndThen<bytes::Variable, Repeat<CertificateTypeCombinator>>, ServerCertTypeClientExtensionCont0<'a>>, ServerCertTypeClientExtensionMapper>;
...
pub closed spec fn spec_server_cert_type_client_extension() -> SpecServerCertTypeClientExtensionCombinator {
    ...
    Mapped {
        inner: SpecPair { fst: Refined { inner: U8, predicate: Predicate13984338198318635021 }, snd: |deps| spec_server_cert_type_client_extension_cont0(deps) },
    ...
    ensures o@ == spec_server_cert_type_client_extension(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U8, predicate: Predicate13984338198318635021 }, snd: ServerCertTypeClientExtensionCont0::new(), spec_snd: Ghost(|deps| spec_server_cert_type_client_extension_cont0(deps)) },
...
pub type SpecEncryptedExtensionExtensionDataCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<SpecEmptyCombinator>, Choice<Cond<SpecMaxFragmentLengthCombinator>, Choice<Cond<SpecNamedGroupListCombinator>, Choice<Cond<SpecHeartbeatModeCombinator>, Choice<Cond<SpecProtocolNameListCombinator>, Choice<Cond<SpecClientCertTypeClientExtensionCombinator>, Choice<Cond<SpecServerCertTypeClientExtensionCombinator>, Choice<Cond<SpecEmptyCombinator>, Cond<bytes::Variable>>>>>>>>>, EncryptedExtensionExtensionDataMapper<'static>>>;
...
pub type EncryptedExtensionExtensionDataCombinatorAlias<'a> = AndThen<bytes::Variable, Mapped<Choice<Cond<EmptyCombinator>, Choice<Cond<MaxFragmentLengthCombinator>, Choice<Cond<NamedGroupListCombinator<'a>>, Choice<Cond<HeartbeatModeCombinator>, Choice<Cond<ProtocolNameListCombinator<'a>>, Choice<Cond<ClientCertTypeClientExtensionCombinator<'a>>, Choice<Cond<ServerCertTypeClientExtensionCombinator<'a>>, Choice<Cond<EmptyCombinator>, Cond<bytes::Variable>>>>>>>>>, EncryptedExtensionExtensionDataMapper<'a>>>;
...
{
    EncryptedExtensionExtensionDataCombinator(AndThen(bytes::Variable(ext_len.ex_into()), Mapped { inner: Choice::new(Cond { cond: extension_type == 0, inner: empty() }, Choice::new(Cond { cond: extension_type == 1, inner: max_fragment_length() }, Choice::new(Cond { cond: extension_type == 10, inner: named_group_list() }, Choice::new(Cond { cond: extension_type == 15, inner: heartbeat_mode() }, Choice::new(Cond { cond: extension_type == 16, inner: protocol_name_list() }, Choice::new(Cond { cond: extension_type == 19, inner: client_cert_type_client_extension() }, Choice::new(Cond { cond: extension_type == 20, inner: server_cert_type_client_extension() }, Choice::new(Cond { cond: extension_type == 42, inner: empty() }, Cond { cond: !(extension_type == 0 || extension_type == 1 || extension_type == 10 || extension_type == 15 || extension_type == 16 || extension_type == 19 || extension_type == 20 || extension_type == 42), inner: bytes::Variable(ext_len.ex_into()) })))))))), mapper: EncryptedExtensionExtensionDataMapper::new() }))
}
...
pub type SpecEncryptedExtensionCombinatorAlias = Mapped<SpecPair<SpecPair<SpecExtensionTypeCombinator, U16Be>, SpecEncryptedExtensionExtensionDataCombinator>, EncryptedExtensionMapper<'static>>;
...
pub type EncryptedExtensionCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Pair<&'a [u8], Vec<u8>, ExtensionTypeCombinator, U16Be, EncryptedExtensionCont1<'a>>, EncryptedExtensionExtensionDataCombinator<'a>, EncryptedExtensionCont0<'a>>, EncryptedExtensionMapper<'a>>;


pub closed spec fn spec_encrypted_extension() -> SpecEncryptedExtensionCombinator {
    SpecEncryptedExtensionCombinator(
    Mapped {
        inner: SpecPair { fst: SpecPair { fst: spec_extension_type(), snd: |deps| spec_encrypted_extension_cont1(deps) }, snd: |deps| spec_encrypted_extension_cont0(deps) },
    ...
    ensures o@ == spec_encrypted_extension(),
{
    ...
    Mapped {
        inner: Pair { fst: Pair { fst: extension_type(), snd: EncryptedExtensionCont1::new(), spec_snd: Ghost(|deps| spec_encrypted_extension_cont1(deps)) }, snd: EncryptedExtensionCont0::new(), spec_snd: Ghost(|deps| spec_encrypted_extension_cont0(deps)) },
...
pub type SpecEncryptedExtensionsCombinatorAlias = Mapped<SpecPair<U16Be, AndThen<bytes::Variable, Repeat<SpecEncryptedExtensionCombinator>>>, EncryptedExtensionsMapper<'static>>;
...
pub type EncryptedExtensionsCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, U16Be, AndThen<bytes::Variable, Repeat<EncryptedExtensionCombinator<'a>>>, EncryptedExtensionsCont0<'a>>, EncryptedExtensionsMapper<'a>>;


pub closed spec fn spec_encrypted_extensions() -> SpecEncryptedExtensionsCombinator {
    SpecEncryptedExtensionsCombinator(
    Mapped {
        inner: SpecPair { fst: U16Be, snd: |deps| spec_encrypted_extensions_cont0(deps) },
    ...
    ensures o@ == spec_encrypted_extensions(),
{
    ...
    Mapped {
        inner: Pair { fst: U16Be, snd: EncryptedExtensionsCont0::new(), spec_snd: Ghost(|deps| spec_encrypted_extensions_cont0(deps)) },
...
impl<'a> Continuation<&u16> for EncryptedExtensionsCont0<'a> {
    type Output = AndThen<bytes::Variable, Repeat<EncryptedExtensionCombinator<'a>>>;
...
pub type SpecPskBinderEntryCombinatorAlias = Mapped<SpecPair<Refined<U8, Predicate12415296748708102903>, bytes::Variable>, PskBinderEntryMapper<'static>>;
...
pub type PskBinderEntryCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U8, Predicate12415296748708102903>, bytes::Variable, PskBinderEntryCont0<'a>>, PskBinderEntryMapper<'a>>;


pub closed spec fn spec_psk_binder_entry() -> SpecPskBinderEntryCombinator {
    SpecPskBinderEntryCombinator(
    Mapped {
        inner: SpecPair { fst: Refined { inner: U8, predicate: Predicate12415296748708102903 }, snd: |deps| spec_psk_binder_entry_cont0(deps) },
    ...
    ensures o@ == spec_psk_binder_entry(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U8, predicate: Predicate12415296748708102903 }, snd: PskBinderEntryCont0::new(), spec_snd: Ghost(|deps| spec_psk_binder_entry_cont0(deps)) },
...
pub type SpecPskBinderEntriesCombinatorAlias = Mapped<SpecPair<Refined<U16Be, Predicate2895184764579107747>, AndThen<bytes::Variable, Repeat<SpecPskBinderEntryCombinator>>>, PskBinderEntriesMapper<'static>>;
...
pub type PskBinderEntriesCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U16Be, Predicate2895184764579107747>, AndThen<bytes::Variable, Repeat<PskBinderEntryCombinator<'a>>>, PskBinderEntriesCont0<'a>>, PskBinderEntriesMapper<'a>>;


pub closed spec fn spec_psk_binder_entries() -> SpecPskBinderEntriesCombinator {
    SpecPskBinderEntriesCombinator(
    Mapped {
        inner: SpecPair { fst: Refined { inner: U16Be, predicate: Predicate2895184764579107747 }, snd: |deps| spec_psk_binder_entries_cont0(deps) },
    ...
    ensures o@ == spec_psk_binder_entries(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U16Be, predicate: Predicate2895184764579107747 }, snd: PskBinderEntriesCont0::new(), spec_snd: Ghost(|deps| spec_psk_binder_entries_cont0(deps)) },
...
impl<'a> Continuation<&u16> for PskBinderEntriesCont0<'a> {
    type Output = AndThen<bytes::Variable, Repeat<PskBinderEntryCombinator<'a>>>;
...
pub type SpecKeyShareEntryCombinatorAlias = Mapped<SpecPair<SpecPair<SpecNamedGroupCombinator, Refined<U16Be, Predicate16977634203518580913>>, bytes::Variable>, KeyShareEntryMapper<'static>>;
...
pub type KeyShareEntryCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Pair<&'a [u8], Vec<u8>, NamedGroupCombinator, Refined<U16Be, Predicate16977634203518580913>, KeyShareEntryCont1<'a>>, bytes::Variable, KeyShareEntryCont0<'a>>, KeyShareEntryMapper<'a>>;


pub closed spec fn spec_key_share_entry() -> SpecKeyShareEntryCombinator {
    SpecKeyShareEntryCombinator(
    Mapped {
        inner: SpecPair { fst: SpecPair { fst: spec_named_group(), snd: |deps| spec_key_share_entry_cont1(deps) }, snd: |deps| spec_key_share_entry_cont0(deps) },
    ...
    ensures o@ == spec_key_share_entry(),
{
    ...
    Mapped {
        inner: Pair { fst: Pair { fst: named_group(), snd: KeyShareEntryCont1::new(), spec_snd: Ghost(|deps| spec_key_share_entry_cont1(deps)) }, snd: KeyShareEntryCont0::new(), spec_snd: Ghost(|deps| spec_key_share_entry_cont0(deps)) },
...
pub type SpecSeverHelloExtensionExtensionDataCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<SpecPreSharedKeyServerExtensionCombinator>, Choice<Cond<SpecSupportedVersionsServerCombinator>, Choice<Cond<SpecKeyShareEntryCombinator>, Cond<bytes::Variable>>>>, SeverHelloExtensionExtensionDataMapper<'static>>>;
...
pub type SeverHelloExtensionExtensionDataCombinatorAlias<'a> = AndThen<bytes::Variable, Mapped<Choice<Cond<PreSharedKeyServerExtensionCombinator>, Choice<Cond<SupportedVersionsServerCombinator>, Choice<Cond<KeyShareEntryCombinator<'a>>, Cond<bytes::Variable>>>>, SeverHelloExtensionExtensionDataMapper<'a>>>;
...
pub closed spec fn spec_sever_hello_extension_extension_data(ext_len: u16, extension_type: SpecExtensionType) -> SpecSeverHelloExtensionExtensionDataCombinator {
    SpecSeverHelloExtensionExtensionDataCombinator(AndThen(bytes::Variable(ext_len.spec_into()), Mapped { inner: Choice(Cond { cond: extension_type == 41, inner: spec_pre_shared_key_server_extension() }, Choice(Cond { cond: extension_type == 43, inner: spec_supported_versions_server() }, Choice(Cond { cond: extension_type == 51, inner: spec_key_share_entry() }, Cond { cond: !(extension_type == 41 || extension_type == 43 || extension_type == 51), inner: bytes::Variable(ext_len.spec_into()) }))), mapper: SeverHelloExtensionExtensionDataMapper::spec_new() }))
}
...
{
    SeverHelloExtensionExtensionDataCombinator(AndThen(bytes::Variable(ext_len.ex_into()), Mapped { inner: Choice::new(Cond { cond: extension_type == 41, inner: pre_shared_key_server_extension() }, Choice::new(Cond { cond: extension_type == 43, inner: supported_versions_server() }, Choice::new(Cond { cond: extension_type == 51, inner: key_share_entry() }, Cond { cond: !(extension_type == 41 || extension_type == 43 || extension_type == 51), inner: bytes::Variable(ext_len.ex_into()) }))), mapper: SeverHelloExtensionExtensionDataMapper::new() }))
}
...
pub type SpecSeverHelloExtensionCombinatorAlias = Mapped<SpecPair<SpecPair<SpecExtensionTypeCombinator, U16Be>, SpecSeverHelloExtensionExtensionDataCombinator>, SeverHelloExtensionMapper<'static>>;
...
pub type SeverHelloExtensionCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Pair<&'a [u8], Vec<u8>, ExtensionTypeCombinator, U16Be, SeverHelloExtensionCont1<'a>>, SeverHelloExtensionExtensionDataCombinator<'a>, SeverHelloExtensionCont0<'a>>, SeverHelloExtensionMapper<'a>>;


pub closed spec fn spec_sever_hello_extension() -> SpecSeverHelloExtensionCombinator {
    SpecSeverHelloExtensionCombinator(
    Mapped {
        inner: SpecPair { fst: SpecPair { fst: spec_extension_type(), snd: |deps| spec_sever_hello_extension_cont1(deps) }, snd: |deps| spec_sever_hello_extension_cont0(deps) },
    ...
    ensures o@ == spec_sever_hello_extension(),
{
    ...
    Mapped {
        inner: Pair { fst: Pair { fst: extension_type(), snd: SeverHelloExtensionCont1::new(), spec_snd: Ghost(|deps| spec_sever_hello_extension_cont1(deps)) }, snd: SeverHelloExtensionCont0::new(), spec_snd: Ghost(|deps| spec_sever_hello_extension_cont0(deps)) },
...
pub type SpecServerExtensionsCombinatorAlias = Mapped<SpecPair<Refined<U16Be, Predicate14496530480760116989>, AndThen<bytes::Variable, Repeat<SpecSeverHelloExtensionCombinator>>>, ServerExtensionsMapper<'static>>;
...
pub type ServerExtensionsCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U16Be, Predicate14496530480760116989>, AndThen<bytes::Variable, Repeat<SeverHelloExtensionCombinator<'a>>>, ServerExtensionsCont0<'a>>, ServerExtensionsMapper<'a>>;


pub closed spec fn spec_server_extensions() -> SpecServerExtensionsCombinator {
    SpecServerExtensionsCombinator(
    Mapped {
        inner: SpecPair { fst: Refined { inner: U16Be, predicate: Predicate14496530480760116989 }, snd: |deps| spec_server_extensions_cont0(deps) },
    ...
    ensures o@ == spec_server_extensions(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U16Be, predicate: Predicate14496530480760116989 }, snd: ServerExtensionsCont0::new(), spec_snd: Ghost(|deps| spec_server_extensions_cont0(deps)) },
...
impl<'a> Continuation<&u16> for ServerExtensionsCont0<'a> {
    type Output = AndThen<bytes::Variable, Repeat<SeverHelloExtensionCombinator<'a>>>;
...
pub type SpecSessionIdCombinatorAlias = Mapped<SpecPair<Refined<U8, Predicate14254733753739482027>, bytes::Variable>, SessionIdMapper<'static>>;
...
pub type SessionIdCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U8, Predicate14254733753739482027>, bytes::Variable, SessionIdCont0<'a>>, SessionIdMapper<'a>>;


pub closed spec fn spec_session_id() -> SpecSessionIdCombinator {
    SpecSessionIdCombinator(
    Mapped {
        inner: SpecPair { fst: Refined { inner: U8, predicate: Predicate14254733753739482027 }, snd: |deps| spec_session_id_cont0(deps) },
    ...
    ensures o@ == spec_session_id(),
{
    SessionIdCombinator(
    Mapped {
        inner: Pair { fst: Refined { inner: U8, predicate: Predicate14254733753739482027 }, snd: SessionIdCont0::new(), spec_snd: Ghost(|deps| spec_session_id_cont0(deps)) },
...
pub type CipherSuiteListCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U16Be, Predicate15206902916018849611>, AndThen<bytes::Variable, Repeat<CipherSuiteCombinator>>, CipherSuiteListCont0<'a>>, CipherSuiteListMapper>;


pub closed spec fn spec_cipher_suite_list() -> SpecCipherSuiteListCombinator {
    SpecCipherSuiteListCombinator(
    Mapped {
        inner: SpecPair { fst: Refined { inner: U16Be, predicate: Predicate15206902916018849611 }, snd: |deps| spec_cipher_suite_list_cont0(deps) },
    ...
    ensures o@ == spec_cipher_suite_list(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U16Be, predicate: Predicate15206902916018849611 }, snd: CipherSuiteListCont0::new(), spec_snd: Ghost(|deps| spec_cipher_suite_list_cont0(deps)) },
...
pub type SpecServerNameNameCombinatorAlias = Mapped<Choice<Cond<SpecHostNameCombinator>, Cond<SpecUnknownNameCombinator>>, ServerNameNameMapper<'static>>;
...
pub type ServerNameNameCombinatorAlias<'a> = Mapped<Choice<Cond<HostNameCombinator<'a>>, Cond<UnknownNameCombinator<'a>>>, ServerNameNameMapper<'a>>;


pub closed spec fn spec_server_name_name(name_type: SpecNameType) -> SpecServerNameNameCombinator {
    SpecServerNameNameCombinator(Mapped { inner: Choice(Cond { cond: name_type == 0, inner: spec_host_name() }, Cond { cond: !(name_type == 0), inner: spec_unknown_name() }), mapper: ServerNameNameMapper::spec_new() })
}

pub fn server_name_name<'a>(name_type: NameType) -> (o: ServerNameNameCombinator<'a>)
    ensures o@ == spec_server_name_name(name_type@),
{
    ServerNameNameCombinator(Mapped { inner: Choice::new(Cond { cond: name_type == 0, inner: host_name() }, Cond { cond: !(name_type == 0), inner: unknown_name() }), mapper: ServerNameNameMapper::new() })
}
...
pub type SpecServerNameCombinatorAlias = Mapped<SpecPair<SpecNameTypeCombinator, SpecServerNameNameCombinator>, ServerNameMapper<'static>>;
...
pub type ServerNameCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, NameTypeCombinator, ServerNameNameCombinator<'a>, ServerNameCont0<'a>>, ServerNameMapper<'a>>;


pub closed spec fn spec_server_name() -> SpecServerNameCombinator {
    SpecServerNameCombinator(
    Mapped {
        inner: SpecPair { fst: spec_name_type(), snd: |deps| spec_server_name_cont0(deps) },
    ...
    ensures o@ == spec_server_name(),
{
    ...
    Mapped {
        inner: Pair { fst: name_type(), snd: ServerNameCont0::new(), spec_snd: Ghost(|deps| spec_server_name_cont0(deps)) },
...
pub type SpecServerNameListCombinatorAlias = Mapped<SpecPair<Refined<U16Be, Predicate16977634203518580913>, AndThen<bytes::Variable, Repeat<SpecServerNameCombinator>>>, ServerNameListMapper<'static>>;
...
pub type ServerNameListCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U16Be, Predicate16977634203518580913>, AndThen<bytes::Variable, Repeat<ServerNameCombinator<'a>>>, ServerNameListCont0<'a>>, ServerNameListMapper<'a>>;


pub closed spec fn spec_server_name_list() -> SpecServerNameListCombinator {
    SpecServerNameListCombinator(
    Mapped {
        inner: SpecPair { fst: Refined { inner: U16Be, predicate: Predicate16977634203518580913 }, snd: |deps| spec_server_name_list_cont0(deps) },
    ...
    ensures o@ == spec_server_name_list(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U16Be, predicate: Predicate16977634203518580913 }, snd: ServerNameListCont0::new(), spec_snd: Ghost(|deps| spec_server_name_list_cont0(deps)) },
...
impl<'a> Continuation<&u16> for ServerNameListCont0<'a> {
    type Output = AndThen<bytes::Variable, Repeat<ServerNameCombinator<'a>>>;
...
pub type EcPointFormatListCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U8, Predicate13984338198318635021>, AndThen<bytes::Variable, Repeat<EcPointFormatCombinator>>, EcPointFormatListCont0<'a>>, EcPointFormatListMapper>;


pub closed spec fn spec_ec_point_format_list() -> SpecEcPointFormatListCombinator {
    SpecEcPointFormatListCombinator(
    Mapped {
        inner: SpecPair { fst: Refined { inner: U8, predicate: Predicate13984338198318635021 }, snd: |deps| spec_ec_point_format_list_cont0(deps) },
    ...
    ensures o@ == spec_ec_point_format_list(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U8, predicate: Predicate13984338198318635021 }, snd: EcPointFormatListCont0::new(), spec_snd: Ghost(|deps| spec_ec_point_format_list_cont0(deps)) },
...
pub type PaddingExtensionCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, U16Be, AndThen<bytes::Variable, Repeat<ZeroByteCombinator>>, PaddingExtensionCont0<'a>>, PaddingExtensionMapper>;


pub closed spec fn spec_padding_extension() -> SpecPaddingExtensionCombinator {
    SpecPaddingExtensionCombinator(
    Mapped {
        inner: SpecPair { fst: U16Be, snd: |deps| spec_padding_extension_cont0(deps) },
    ...
    ensures o@ == spec_padding_extension(),
{
    ...
    Mapped {
        inner: Pair { fst: U16Be, snd: PaddingExtensionCont0::new(), spec_snd: Ghost(|deps| spec_padding_extension_cont0(deps)) },
...
pub type SpecPskIdentitiesCombinatorAlias = Mapped<SpecPair<Refined<U16Be, Predicate22012019403780218>, AndThen<bytes::Variable, Repeat<SpecPskIdentityCombinator>>>, PskIdentitiesMapper<'static>>;
...
pub type PskIdentitiesCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U16Be, Predicate22012019403780218>, AndThen<bytes::Variable, Repeat<PskIdentityCombinator<'a>>>, PskIdentitiesCont0<'a>>, PskIdentitiesMapper<'a>>;


pub closed spec fn spec_psk_identities() -> SpecPskIdentitiesCombinator {
    SpecPskIdentitiesCombinator(
    Mapped {
        inner: SpecPair { fst: Refined { inner: U16Be, predicate: Predicate22012019403780218 }, snd: |deps| spec_psk_identities_cont0(deps) },
    ...
    ensures o@ == spec_psk_identities(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U16Be, predicate: Predicate22012019403780218 }, snd: PskIdentitiesCont0::new(), spec_snd: Ghost(|deps| spec_psk_identities_cont0(deps)) },
...
impl<'a> Continuation<&u16> for PskIdentitiesCont0<'a> {
    type Output = AndThen<bytes::Variable, Repeat<PskIdentityCombinator<'a>>>;
...
pub type SpecKeyShareClientHelloCombinatorAlias = Mapped<SpecPair<U16Be, AndThen<bytes::Variable, Repeat<SpecKeyShareEntryCombinator>>>, KeyShareClientHelloMapper<'static>>;
...
pub type KeyShareClientHelloCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, U16Be, AndThen<bytes::Variable, Repeat<KeyShareEntryCombinator<'a>>>, KeyShareClientHelloCont0<'a>>, KeyShareClientHelloMapper<'a>>;


pub closed spec fn spec_key_share_client_hello() -> SpecKeyShareClientHelloCombinator {
    SpecKeyShareClientHelloCombinator(
    Mapped {
        inner: SpecPair { fst: U16Be, snd: |deps| spec_key_share_client_hello_cont0(deps) },
    ...
    ensures o@ == spec_key_share_client_hello(),
{
    ...
    Mapped {
        inner: Pair { fst: U16Be, snd: KeyShareClientHelloCont0::new(), spec_snd: Ghost(|deps| spec_key_share_client_hello_cont0(deps)) },
...
impl<'a> Continuation<&u16> for KeyShareClientHelloCont0<'a> {
    type Output = AndThen<bytes::Variable, Repeat<KeyShareEntryCombinator<'a>>>;
...
pub type PskKeyExchangeModesCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U8, Predicate13984338198318635021>, AndThen<bytes::Variable, Repeat<PskKeyExchangeModeCombinator>>, PskKeyExchangeModesCont0<'a>>, PskKeyExchangeModesMapper>;


pub closed spec fn spec_psk_key_exchange_modes() -> SpecPskKeyExchangeModesCombinator {
    SpecPskKeyExchangeModesCombinator(
    Mapped {
        inner: SpecPair { fst: Refined { inner: U8, predicate: Predicate13984338198318635021 }, snd: |deps| spec_psk_key_exchange_modes_cont0(deps) },
    ...
    ensures o@ == spec_psk_key_exchange_modes(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U8, predicate: Predicate13984338198318635021 }, snd: PskKeyExchangeModesCont0::new(), spec_snd: Ghost(|deps| spec_psk_key_exchange_modes_cont0(deps)) },
...
pub type SupportedVersionsClientCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U8, Predicate7470776374180795781>, AndThen<bytes::Variable, Repeat<ProtocolVersionCombinator>>, SupportedVersionsClientCont0<'a>>, SupportedVersionsClientMapper>;
...
pub closed spec fn spec_supported_versions_client() -> SpecSupportedVersionsClientCombinator {
    ...
    Mapped {
        inner: SpecPair { fst: Refined { inner: U8, predicate: Predicate7470776374180795781 }, snd: |deps| spec_supported_versions_client_cont0(deps) },
    ...
    ensures o@ == spec_supported_versions_client(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U8, predicate: Predicate7470776374180795781 }, snd: SupportedVersionsClientCont0::new(), spec_snd: Ghost(|deps| spec_supported_versions_client_cont0(deps)) },
...
pub type SpecClientHelloExtensionExtensionDataCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<SpecServerNameListCombinator>, Choice<Cond<SpecMaxFragmentLengthCombinator>, Choice<Cond<SpecCertificateStatusRequestCombinator>, Choice<Cond<SpecNamedGroupListCombinator>, Choice<Cond<SpecEcPointFormatListCombinator>, Choice<Cond<SpecSignatureSchemeListCombinator>, Choice<Cond<SpecHeartbeatModeCombinator>, Choice<Cond<SpecProtocolNameListCombinator>, Choice<Cond<SpecSignedCertificateTimestampListCombinator>, Choice<Cond<SpecClientCertTypeClientExtensionCombinator>, Choice<Cond<SpecServerCertTypeClientExtensionCombinator>, Choice<Cond<SpecPaddingExtensionCombinator>, Choice<Cond<SpecEmptyCombinator>, Choice<Cond<SpecEmptyCombinator>, Choice<Cond<bytes::Variable>, Choice<Cond<SpecPreSharedKeyClientExtensionCombinator>, Choice<Cond<SpecKeyShareClientHelloCombinator>, Choice<Cond<SpecPskKeyExchangeModesCombinator>, Choice<Cond<SpecEmptyCombinator>, Choice<Cond<SpecSupportedVersionsClientCombinator>, Choice<Cond<SpecCookieCombinator>, Choice<Cond<SpecCertificateAuthoritiesExtensionCombinator>, Choice<Cond<SpecOidFilterExtensionCombinator>, Choice<Cond<SpecEmptyCombinator>, Choice<Cond<SpecSignatureSchemeListCombinator>, Cond<bytes::Variable>>>>>>>>>>>>>>>>>>>>>>>>>>, ClientHelloExtensionExtensionDataMapper<'static>>>;
...
pub type ClientHelloExtensionExtensionDataCombinatorAlias<'a> = AndThen<bytes::Variable, Mapped<Choice<Cond<ServerNameListCombinator<'a>>, Choice<Cond<MaxFragmentLengthCombinator>, Choice<Cond<CertificateStatusRequestCombinator<'a>>, Choice<Cond<NamedGroupListCombinator<'a>>, Choice<Cond<EcPointFormatListCombinator<'a>>, Choice<Cond<SignatureSchemeListCombinator<'a>>, Choice<Cond<HeartbeatModeCombinator>, Choice<Cond<ProtocolNameListCombinator<'a>>, Choice<Cond<SignedCertificateTimestampListCombinator<'a>>, Choice<Cond<ClientCertTypeClientExtensionCombinator<'a>>, Choice<Cond<ServerCertTypeClientExtensionCombinator<'a>>, Choice<Cond<PaddingExtensionCombinator<'a>>, Choice<Cond<EmptyCombinator>, Choice<Cond<EmptyCombinator>, Choice<Cond<bytes::Variable>, Choice<Cond<PreSharedKeyClientExtensionCombinator<'a>>, Choice<Cond<KeyShareClientHelloCombinator<'a>>, Choice<Cond<PskKeyExchangeModesCombinator<'a>>, Choice<Cond<EmptyCombinator>, Choice<Cond<SupportedVersionsClientCombinator<'a>>, Choice<Cond<CookieCombinator<'a>>, Choice<Cond<CertificateAuthoritiesExtensionCombinator<'a>>, Choice<Cond<OidFilterExtensionCombinator<'a>>, Choice<Cond<EmptyCombinator>, Choice<Cond<SignatureSchemeListCombinator<'a>>, Cond<bytes::Variable>>>>>>>>>>>>>>>>>>>>>>>>>>, ClientHelloExtensionExtensionDataMapper<'a>>>;
...
pub closed spec fn spec_client_hello_extension_extension_data(ext_len: u16, extension_type: SpecExtensionType) -> SpecClientHelloExtensionExtensionDataCombinator {
    SpecClientHelloExtensionExtensionDataCombinator(AndThen(bytes::Variable(ext_len.spec_into()), Mapped { inner: Choice(Cond { cond: extension_type == 0, inner: spec_server_name_list() }, Choice(Cond { cond: extension_type == 1, inner: spec_max_fragment_length() }, Choice(Cond { cond: extension_type == 5, inner: spec_certificate_status_request() }, Choice(Cond { cond: extension_type == 10, inner: spec_named_group_list() }, Choice(Cond { cond: extension_type == 11, inner: spec_ec_point_format_list() }, Choice(Cond { cond: extension_type == 13, inner: spec_signature_scheme_list() }, Choice(Cond { cond: extension_type == 15, inner: spec_heartbeat_mode() }, Choice(Cond { cond: extension_type == 16, inner: spec_protocol_name_list() }, Choice(Cond { cond: extension_type == 18, inner: spec_signed_certificate_timestamp_list() }, Choice(Cond { cond: extension_type == 19, inner: spec_client_cert_type_client_extension() }, Choice(Cond { cond: extension_type == 20, inner: spec_server_cert_type_client_extension() }, Choice(Cond { cond: extension_type == 21, inner: spec_padding_extension() }, Choice(Cond { cond: extension_type == 22, inner: spec_empty() }, Choice(Cond { cond: extension_type == 23, inner: spec_empty() }, Choice(Cond { cond: extension_type == 35, inner: bytes::Variable(ext_len.spec_into()) }, Choice(Cond { cond: extension_type == 41, inner: spec_pre_shared_key_client_extension() }, Choice(Cond { cond: extension_type == 51, inner: spec_key_share_client_hello() }, Choice(Cond { cond: extension_type == 45, inner: spec_psk_key_exchange_modes() }, Choice(Cond { cond: extension_type == 42, inner: spec_empty() }, Choice(Cond { cond: extension_type == 43, inner: spec_supported_versions_client() }, Choice(Cond { cond: extension_type == 44, inner: spec_cookie() }, Choice(Cond { cond: extension_type == 47, inner: spec_certificate_authorities_extension() }, Choice(Cond { cond: extension_type == 48, inner: spec_oid_filter_extension() }, Choice(Cond { cond: extension_type == 49, inner: spec_empty() }, Choice(Cond { cond: extension_type == 50, inner: spec_signature_scheme_list() }, Cond { cond: !(extension_type == 0 || extension_type == 1 || extension_type == 5 || extension_type == 10 || extension_type == 11 || extension_type == 13 || extension_type == 15 || extension_type == 16 || extension_type == 18 || extension_type == 19 || extension_type == 20 || extension_type == 21 || extension_type == 22 || extension_type == 23 || extension_type == 35 || extension_type == 41 || extension_type == 51 || extension_type == 45 || extension_type == 42 || extension_type == 43 || extension_type == 44 || extension_type == 47 || extension_type == 48 || extension_type == 49 || extension_type == 50), inner: bytes::Variable(ext_len.spec_into()) }))))))))))))))))))))))))), mapper: ClientHelloExtensionExtensionDataMapper::spec_new() }))
}
...
{
    ClientHelloExtensionExtensionDataCombinator(AndThen(bytes::Variable(ext_len.ex_into()), Mapped { inner: Choice::new(Cond { cond: extension_type == 0, inner: server_name_list() }, Choice::new(Cond { cond: extension_type == 1, inner: max_fragment_length() }, Choice::new(Cond { cond: extension_type == 5, inner: certificate_status_request() }, Choice::new(Cond { cond: extension_type == 10, inner: named_group_list() }, Choice::new(Cond { cond: extension_type == 11, inner: ec_point_format_list() }, Choice::new(Cond { cond: extension_type == 13, inner: signature_scheme_list() }, Choice::new(Cond { cond: extension_type == 15, inner: heartbeat_mode() }, Choice::new(Cond { cond: extension_type == 16, inner: protocol_name_list() }, Choice::new(Cond { cond: extension_type == 18, inner: signed_certificate_timestamp_list() }, Choice::new(Cond { cond: extension_type == 19, inner: client_cert_type_client_extension() }, Choice::new(Cond { cond: extension_type == 20, inner: server_cert_type_client_extension() }, Choice::new(Cond { cond: extension_type == 21, inner: padding_extension() }, Choice::new(Cond { cond: extension_type == 22, inner: empty() }, Choice::new(Cond { cond: extension_type == 23, inner: empty() }, Choice::new(Cond { cond: extension_type == 35, inner: bytes::Variable(ext_len.ex_into()) }, Choice::new(Cond { cond: extension_type == 41, inner: pre_shared_key_client_extension() }, Choice::new(Cond { cond: extension_type == 51, inner: key_share_client_hello() }, Choice::new(Cond { cond: extension_type == 45, inner: psk_key_exchange_modes() }, Choice::new(Cond { cond: extension_type == 42, inner: empty() }, Choice::new(Cond { cond: extension_type == 43, inner: supported_versions_client() }, Choice::new(Cond { cond: extension_type == 44, inner: cookie() }, Choice::new(Cond { cond: extension_type == 47, inner: certificate_authorities_extension() }, Choice::new(Cond { cond: extension_type == 48, inner: oid_filter_extension() }, Choice::new(Cond { cond: extension_type == 49, inner: empty() }, Choice::new(Cond { cond: extension_type == 50, inner: signature_scheme_list() }, Cond { cond: !(extension_type == 0 || extension_type == 1 || extension_type == 5 || extension_type == 10 || extension_type == 11 || extension_type == 13 || extension_type == 15 || extension_type == 16 || extension_type == 18 || extension_type == 19 || extension_type == 20 || extension_type == 21 || extension_type == 22 || extension_type == 23 || extension_type == 35 || extension_type == 41 || extension_type == 51 || extension_type == 45 || extension_type == 42 || extension_type == 43 || extension_type == 44 || extension_type == 47 || extension_type == 48 || extension_type == 49 || extension_type == 50), inner: bytes::Variable(ext_len.ex_into()) }))))))))))))))))))))))))), mapper: ClientHelloExtensionExtensionDataMapper::new() }))
}
...
pub type SpecClientHelloExtensionCombinatorAlias = Mapped<SpecPair<SpecPair<SpecExtensionTypeCombinator, U16Be>, SpecClientHelloExtensionExtensionDataCombinator>, ClientHelloExtensionMapper<'static>>;
...
pub type ClientHelloExtensionCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Pair<&'a [u8], Vec<u8>, ExtensionTypeCombinator, U16Be, ClientHelloExtensionCont1<'a>>, ClientHelloExtensionExtensionDataCombinator<'a>, ClientHelloExtensionCont0<'a>>, ClientHelloExtensionMapper<'a>>;


pub closed spec fn spec_client_hello_extension() -> SpecClientHelloExtensionCombinator {
    SpecClientHelloExtensionCombinator(
    Mapped {
        inner: SpecPair { fst: SpecPair { fst: spec_extension_type(), snd: |deps| spec_client_hello_extension_cont1(deps) }, snd: |deps| spec_client_hello_extension_cont0(deps) },
    ...
    ensures o@ == spec_client_hello_extension(),
{
    ...
    Mapped {
        inner: Pair { fst: Pair { fst: extension_type(), snd: ClientHelloExtensionCont1::new(), spec_snd: Ghost(|deps| spec_client_hello_extension_cont1(deps)) }, snd: ClientHelloExtensionCont0::new(), spec_snd: Ghost(|deps| spec_client_hello_extension_cont0(deps)) },
...
pub type SpecClientExtensionsCombinatorAlias = Mapped<SpecPair<Refined<U16Be, Predicate9952414989822543135>, AndThen<bytes::Variable, Repeat<SpecClientHelloExtensionCombinator>>>, ClientExtensionsMapper<'static>>;
...
pub type ClientExtensionsCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U16Be, Predicate9952414989822543135>, AndThen<bytes::Variable, Repeat<ClientHelloExtensionCombinator<'a>>>, ClientExtensionsCont0<'a>>, ClientExtensionsMapper<'a>>;


pub closed spec fn spec_client_extensions() -> SpecClientExtensionsCombinator {
    SpecClientExtensionsCombinator(
    Mapped {
        inner: SpecPair { fst: Refined { inner: U16Be, predicate: Predicate9952414989822543135 }, snd: |deps| spec_client_extensions_cont0(deps) },
    ...
    ensures o@ == spec_client_extensions(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U16Be, predicate: Predicate9952414989822543135 }, snd: ClientExtensionsCont0::new(), spec_snd: Ghost(|deps| spec_client_extensions_cont0(deps)) },
...
impl<'a> Continuation<&u16> for ClientExtensionsCont0<'a> {
    type Output = AndThen<bytes::Variable, Repeat<ClientHelloExtensionCombinator<'a>>>;
...
pub type SpecClientHelloCombinatorAlias = Mapped<(Refined<U16Be, TagPred<u16>>, (bytes::Fixed<32>, (SpecSessionIdCombinator, (SpecCipherSuiteListCombinator, (SpecOpaque1FfCombinator, SpecClientExtensionsCombinator))))), ClientHelloMapper<'static>>;
...
pub type ClientHelloCombinatorAlias<'a> = Mapped<(Refined<U16Be, TagPred<u16>>, (bytes::Fixed<32>, (SessionIdCombinator<'a>, (CipherSuiteListCombinator<'a>, (Opaque1FfCombinator<'a>, ClientExtensionsCombinator<'a>))))), ClientHelloMapper<'a>>;
    ...
    ensures o@ == spec_client_hello(),
{
    ...
    Mapped {
        inner: (Refined { inner: U16Be, predicate: TagPred(CLIENTHELLOLEGACY_VERSION_CONST) }, (bytes::Fixed::<32>, (session_id(), (cipher_suite_list(), (opaque_1_ff(), client_extensions()))))),
...
pub type SpecSrtpProtectionProfilesCombinatorAlias = Mapped<SpecPair<Refined<U16Be, Predicate8195707947578446211>, AndThen<bytes::Variable, Repeat<SpecSrtpProtectionProfileCombinator>>>, SrtpProtectionProfilesMapper<'static>>;
...
pub type SrtpProtectionProfilesCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U16Be, Predicate8195707947578446211>, AndThen<bytes::Variable, Repeat<SrtpProtectionProfileCombinator>>, SrtpProtectionProfilesCont0<'a>>, SrtpProtectionProfilesMapper<'a>>;
...
pub closed spec fn spec_srtp_protection_profiles() -> SpecSrtpProtectionProfilesCombinator {
    ...
    Mapped {
        inner: SpecPair { fst: Refined { inner: U16Be, predicate: Predicate8195707947578446211 }, snd: |deps| spec_srtp_protection_profiles_cont0(deps) },
    ...
    ensures o@ == spec_srtp_protection_profiles(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U16Be, predicate: Predicate8195707947578446211 }, snd: SrtpProtectionProfilesCont0::new(), spec_snd: Ghost(|deps| spec_srtp_protection_profiles_cont0(deps)) },
...
pub type SpecOpaque0FfCombinatorAlias = Mapped<SpecPair<U8, bytes::Variable>, Opaque0FfMapper<'static>>;
...
pub type Opaque0FfCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, U8, bytes::Variable, Opaque0FfCont0<'a>>, Opaque0FfMapper<'a>>;


pub closed spec fn spec_opaque_0_ff() -> SpecOpaque0FfCombinator {
    SpecOpaque0FfCombinator(
    Mapped {
        inner: SpecPair { fst: U8, snd: |deps| spec_opaque0_ff_cont0(deps) },
    ...
    ensures o@ == spec_opaque_0_ff(),
{
    Opaque0FfCombinator(
    Mapped {
        inner: Pair { fst: U8, snd: Opaque0FfCont0::new(), spec_snd: Ghost(|deps| spec_opaque0_ff_cont0(deps)) },
...
pub type SpecNewSessionTicketExtensionCombinatorAlias = Mapped<SpecPair<SpecPair<SpecExtensionTypeCombinator, U16Be>, SpecNewSessionTicketExtensionExtensionDataCombinator>, NewSessionTicketExtensionMapper<'static>>;
...
pub type NewSessionTicketExtensionCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Pair<&'a [u8], Vec<u8>, ExtensionTypeCombinator, U16Be, NewSessionTicketExtensionCont1<'a>>, NewSessionTicketExtensionExtensionDataCombinator<'a>, NewSessionTicketExtensionCont0<'a>>, NewSessionTicketExtensionMapper<'a>>;
...
pub closed spec fn spec_new_session_ticket_extension() -> SpecNewSessionTicketExtensionCombinator {
    ...
    Mapped {
        inner: SpecPair { fst: SpecPair { fst: spec_extension_type(), snd: |deps| spec_new_session_ticket_extension_cont1(deps) }, snd: |deps| spec_new_session_ticket_extension_cont0(deps) },
    ...
    ensures o@ == spec_new_session_ticket_extension(),
{
    ...
    Mapped {
        inner: Pair { fst: Pair { fst: extension_type(), snd: NewSessionTicketExtensionCont1::new(), spec_snd: Ghost(|deps| spec_new_session_ticket_extension_cont1(deps)) }, snd: NewSessionTicketExtensionCont0::new(), spec_snd: Ghost(|deps| spec_new_session_ticket_extension_cont0(deps)) },
...
pub type SpecNewSessionTicketExtensionsCombinatorAlias = Mapped<SpecPair<Refined<U16Be, Predicate14514213152276180162>, AndThen<bytes::Variable, Repeat<SpecNewSessionTicketExtensionCombinator>>>, NewSessionTicketExtensionsMapper<'static>>;
...
pub type NewSessionTicketExtensionsCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U16Be, Predicate14514213152276180162>, AndThen<bytes::Variable, Repeat<NewSessionTicketExtensionCombinator<'a>>>, NewSessionTicketExtensionsCont0<'a>>, NewSessionTicketExtensionsMapper<'a>>;
...
pub closed spec fn spec_new_session_ticket_extensions() -> SpecNewSessionTicketExtensionsCombinator {
    ...
    Mapped {
        inner: SpecPair { fst: Refined { inner: U16Be, predicate: Predicate14514213152276180162 }, snd: |deps| spec_new_session_ticket_extensions_cont0(deps) },
    ...
    ensures o@ == spec_new_session_ticket_extensions(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U16Be, predicate: Predicate14514213152276180162 }, snd: NewSessionTicketExtensionsCont0::new(), spec_snd: Ghost(|deps| spec_new_session_ticket_extensions_cont0(deps)) },
...
impl<'a> Continuation<&u16> for NewSessionTicketExtensionsCont0<'a> {
    type Output = AndThen<bytes::Variable, Repeat<NewSessionTicketExtensionCombinator<'a>>>;
...
pub type SpecHelloRetryExtensionsCombinatorAlias = Mapped<SpecPair<Refined<U16Be, Predicate14496530480760116989>, AndThen<bytes::Variable, Repeat<SpecHelloRetryExtensionCombinator>>>, HelloRetryExtensionsMapper<'static>>;
...
pub type HelloRetryExtensionsCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U16Be, Predicate14496530480760116989>, AndThen<bytes::Variable, Repeat<HelloRetryExtensionCombinator<'a>>>, HelloRetryExtensionsCont0<'a>>, HelloRetryExtensionsMapper<'a>>;


pub closed spec fn spec_heartbeat_extension() -> SpecHeartbeatExtensionCombinator {
    SpecHeartbeatExtensionCombinator(
    Mapped {
        inner: SpecPair { fst: Refined { inner: U16Be, predicate: Predicate14496530480760116989 }, snd: |deps| spec_hello_retry_extensions_cont0(deps) },
    ...
    ensures o@ == spec_heartbeat_extension(),
{
    HeartbeatExtensionCombinator(
    Mapped {
        inner: Pair { fst: Refined { inner: U16Be, predicate: Predicate14496530480760116989 }, snd: HelloRetryExtensionsCont0::new(), spec_snd: Ghost(|deps| spec_hello_retry_extensions_cont0(deps)) },
...
impl<'a> Continuation<&u16> for HelloRetryExtensionsCont0<'a> {
    type Output = AndThen<bytes::Variable, Repeat<HelloRetryExtensionCombinator<'a>>>;
...
pub type SpecShOrHrrPayloadCombinatorAlias = Mapped<Choice<Cond<SpecHelloRetryRequestCombinator>, Cond<SpecServerHelloCombinator>>, ShOrHrrPayloadMapper<'static>>;
...
pub type ShOrHrrPayloadCombinatorAlias<'a> = Mapped<Choice<Cond<HelloRetryRequestCombinator<'a>>, Cond<ServerHelloCombinator<'a>>>, ShOrHrrPayloadMapper<'a>>;
...
pub fn finished<'a>(size: DigestSize) -> (o: FinishedCombinator<'a>)
    ensures o@ == spec_finished(size@),
{
    ShOrHrrPayloadCombinator(Mapped { inner: Choice::new(Cond { cond: compare_slice(random, [207, 33, 173, 116, 229, 154, 97, 17, 190, 29, 140, 2, 30, 101, 184, 145, 194, 162, 17, 22, 122, 187, 140, 94, 7, 158, 9, 226, 200, 168, 51, 156].as_slice()), inner: hello_retry_request() }, Cond { cond: !(compare_slice(random, [207, 33, 173, 116, 229, 154, 97, 17, 190, 29, 140, 2, 30, 101, 184, 145, 194, 162, 17, 22, 122, 187, 140, 94, 7, 158, 9, 226, 200, 168, 51, 156].as_slice())), inner: server_hello() }), mapper: ShOrHrrPayloadMapper::new() })
}
...
pub type SpecShOrHrrCombinatorAlias = Mapped<SpecPair<(Refined<U16Be, TagPred<u16>>, bytes::Fixed<32>), SpecShOrHrrPayloadCombinator>, ShOrHrrMapper<'static>>;
...
pub type ShOrHrrCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, (Refined<U16Be, TagPred<u16>>, bytes::Fixed<32>), ShOrHrrPayloadCombinator<'a>, ShOrHrrCont0<'a>>, ShOrHrrMapper<'a>>;


pub closed spec fn spec_sh_or_hrr() -> SpecShOrHrrCombinator {
    SpecShOrHrrCombinator(
    Mapped {
        inner: SpecPair { fst: (Refined { inner: U16Be, predicate: TagPred(SHORHRRLEGACY_VERSION_CONST) }, bytes::Fixed::<32>), snd: |deps| spec_sh_or_hrr_cont0(deps) },
    ...
    ensures o@ == spec_sh_or_hrr(),
{
    ShOrHrrCombinator(
    Mapped {
        inner: Pair { fst: (Refined { inner: U16Be, predicate: TagPred(SHORHRRLEGACY_VERSION_CONST) }, bytes::Fixed::<32>), snd: ShOrHrrCont0::new(), spec_snd: Ghost(|deps| spec_sh_or_hrr_cont0(deps)) },
...
pub type SpecCertificateRequestExtensionCombinatorAlias = Mapped<SpecPair<SpecPair<SpecExtensionTypeCombinator, U16Be>, SpecCertificateRequestExtensionExtensionDataCombinator>, CertificateRequestExtensionMapper<'static>>;
...
pub type CertificateRequestExtensionCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Pair<&'a [u8], Vec<u8>, ExtensionTypeCombinator, U16Be, CertificateRequestExtensionCont1<'a>>, CertificateRequestExtensionExtensionDataCombinator<'a>, CertificateRequestExtensionCont0<'a>>, CertificateRequestExtensionMapper<'a>>;
...
pub closed spec fn spec_certificate_request_extension() -> SpecCertificateRequestExtensionCombinator {
    ...
    Mapped {
        inner: SpecPair { fst: SpecPair { fst: spec_extension_type(), snd: |deps| spec_certificate_request_extension_cont1(deps) }, snd: |deps| spec_certificate_request_extension_cont0(deps) },
    ...
    ensures o@ == spec_certificate_request_extension(),
{
    ...
    Mapped {
        inner: Pair { fst: Pair { fst: extension_type(), snd: CertificateRequestExtensionCont1::new(), spec_snd: Ghost(|deps| spec_certificate_request_extension_cont1(deps)) }, snd: CertificateRequestExtensionCont0::new(), spec_snd: Ghost(|deps| spec_certificate_request_extension_cont0(deps)) },
...
pub type SpecCertificateRequestExtensionsCombinatorAlias = Mapped<SpecPair<Refined<U16Be, Predicate8195707947578446211>, AndThen<bytes::Variable, Repeat<SpecCertificateRequestExtensionCombinator>>>, CertificateRequestExtensionsMapper<'static>>;
...
pub type CertificateRequestExtensionsCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U16Be, Predicate8195707947578446211>, AndThen<bytes::Variable, Repeat<CertificateRequestExtensionCombinator<'a>>>, CertificateRequestExtensionsCont0<'a>>, CertificateRequestExtensionsMapper<'a>>;
...
pub closed spec fn spec_certificate_request_extensions() -> SpecCertificateRequestExtensionsCombinator {
    ...
    Mapped {
        inner: SpecPair { fst: Refined { inner: U16Be, predicate: Predicate8195707947578446211 }, snd: |deps| spec_certificate_request_extensions_cont0(deps) },
    ...
    ensures o@ == spec_certificate_request_extensions(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U16Be, predicate: Predicate8195707947578446211 }, snd: CertificateRequestExtensionsCont0::new(), spec_snd: Ghost(|deps| spec_certificate_request_extensions_cont0(deps)) },
...
impl<'a> Continuation<&u16> for CertificateRequestExtensionsCont0<'a> {
    type Output = AndThen<bytes::Variable, Repeat<CertificateRequestExtensionCombinator<'a>>>;
...
pub type SpecCertificateListCombinatorAlias = Mapped<SpecPair<U24Be, AndThen<bytes::Variable, Repeat<SpecCertificateEntryOpaqueCombinator>>>, CertificateListMapper<'static>>;
...
pub type CertificateListCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, U24Be, AndThen<bytes::Variable, Repeat<CertificateEntryOpaqueCombinator<'a>>>, CertificateListCont0<'a>>, CertificateListMapper<'a>>;


pub closed spec fn spec_certificate_list() -> SpecCertificateListCombinator {
    SpecCertificateListCombinator(
    Mapped {
        inner: SpecPair { fst: U24Be, snd: |deps| spec_certificate_list_cont0(deps) },
    ...
    ensures o@ == spec_certificate_list(),
{
    ...
    Mapped {
        inner: Pair { fst: U24Be, snd: CertificateListCont0::new(), spec_snd: Ghost(|deps| spec_certificate_list_cont0(deps)) },
...
impl<'a> Continuation<&u24> for CertificateListCont0<'a> {
    type Output = AndThen<bytes::Variable, Repeat<CertificateEntryOpaqueCombinator<'a>>>;
...
pub type SpecOpaque2FfffCombinatorAlias = Mapped<SpecPair<Refined<U16Be, Predicate3016150102856496288>, bytes::Variable>, Opaque2FfffMapper<'static>>;
...
pub type Opaque2FfffCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Refined<U16Be, Predicate3016150102856496288>, bytes::Variable, Opaque2FfffCont0<'a>>, Opaque2FfffMapper<'a>>;


pub closed spec fn spec_opaque_2_ffff() -> SpecOpaque2FfffCombinator {
    SpecOpaque2FfffCombinator(
    Mapped {
        inner: SpecPair { fst: Refined { inner: U16Be, predicate: Predicate3016150102856496288 }, snd: |deps| spec_opaque2_ffff_cont0(deps) },
    ...
    ensures o@ == spec_opaque_2_ffff(),
{
    ...
    Mapped {
        inner: Pair { fst: Refined { inner: U16Be, predicate: Predicate3016150102856496288 }, snd: Opaque2FfffCont0::new(), spec_snd: Ghost(|deps| spec_opaque2_ffff_cont0(deps)) },
...
pub type SpecHandshakeMsgCombinatorAlias = AndThen<bytes::Variable, Mapped<Choice<Cond<SpecClientHelloCombinator>, Choice<Cond<SpecShOrHrrCombinator>, Choice<Cond<SpecNewSessionTicketCombinator>, Choice<Cond<SpecEmptyCombinator>, Choice<Cond<SpecEncryptedExtensionsCombinator>, Choice<Cond<SpecCertificateCombinator>, Choice<Cond<SpecCertificateRequestCombinator>, Choice<Cond<SpecCertificateVerifyCombinator>, Choice<Cond<SpecFinishedCombinator>, Cond<SpecKeyUpdateCombinator>>>>>>>>>>, HandshakeMsgMapper<'static>>>;
...
pub type HandshakeMsgCombinatorAlias<'a> = AndThen<bytes::Variable, Mapped<Choice<Cond<ClientHelloCombinator<'a>>, Choice<Cond<ShOrHrrCombinator<'a>>, Choice<Cond<NewSessionTicketCombinator<'a>>, Choice<Cond<EmptyCombinator>, Choice<Cond<EncryptedExtensionsCombinator<'a>>, Choice<Cond<CertificateCombinator<'a>>, Choice<Cond<CertificateRequestCombinator<'a>>, Choice<Cond<CertificateVerifyCombinator<'a>>, Choice<Cond<FinishedCombinator<'a>>, Cond<KeyUpdateCombinator>>>>>>>>>>, HandshakeMsgMapper<'a>>>;
...
pub fn handshake_msg<'a>(msg_type: HandshakeType, length: u24) -> (o: HandshakeMsgCombinator<'a>)
    ensures o@ == spec_handshake_msg(msg_type@, length@),
{
    HandshakeMsgCombinator(AndThen(bytes::Variable(length.ex_into()), Mapped { inner: Choice::new(Cond { cond: msg_type == HandshakeType::ClientHello, inner: client_hello() }, Choice::new(Cond { cond: msg_type == HandshakeType::ServerHello, inner: sh_or_hrr() }, Choice::new(Cond { cond: msg_type == HandshakeType::NewSessionTicket, inner: new_session_ticket() }, Choice::new(Cond { cond: msg_type == HandshakeType::EndOfEarlyData, inner: empty() }, Choice::new(Cond { cond: msg_type == HandshakeType::EncryptedExtensions, inner: encrypted_extensions() }, Choice::new(Cond { cond: msg_type == HandshakeType::Certificate, inner: certificate() }, Choice::new(Cond { cond: msg_type == HandshakeType::CertificateRequest, inner: certificate_request() }, Choice::new(Cond { cond: msg_type == HandshakeType::CertificateVerify, inner: certificate_verify() }, Choice::new(Cond { cond: msg_type == HandshakeType::Finished, inner: finished(length) }, Cond { cond: msg_type == HandshakeType::KeyUpdate, inner: key_update() }))))))))), mapper: HandshakeMsgMapper::new() }))
}
...
pub type SpecHandshakeCombinatorAlias = Mapped<SpecPair<SpecPair<SpecHandshakeTypeCombinator, U24Be>, SpecHandshakeMsgCombinator>, HandshakeMapper<'static>>;
...
pub type HandshakeCombinatorAlias<'a> = Mapped<Pair<&'a [u8], Vec<u8>, Pair<&'a [u8], Vec<u8>, HandshakeTypeCombinator, U24Be, HandshakeCont1<'a>>, HandshakeMsgCombinator<'a>, HandshakeCont0<'a>>, HandshakeMapper<'a>>;


pub closed spec fn spec_handshake() -> SpecHandshakeCombinator {
    SpecHandshakeCombinator(
    Mapped {
        inner: SpecPair { fst: SpecPair { fst: spec_handshake_type(), snd: |deps| spec_handshake_cont1(deps) }, snd: |deps| spec_handshake_cont0(deps) },
    ...
    ensures o@ == spec_handshake(),
{
    HandshakeCombinator(
    Mapped {
        inner: Pair { fst: Pair { fst: handshake_type(), snd: HandshakeCont1::new(), spec_snd: Ghost(|deps| spec_handshake_cont1(deps)) }, snd: HandshakeCont0::new(), spec_snd: Ghost(|deps| spec_handshake_cont0(deps)) },
