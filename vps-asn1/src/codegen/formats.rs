...
"
    ...
    pub(super) fn exec_type(
        ...
        Ok(match ty {
            ...
            Type::Integer(_, _) => format!("vps_lib::asn1::Integer<{lifetime}>"),
            ...
            Type::BitString(_) => match rule {
                EncodingRules::Der => {
                    format!("vps_lib::asn1::BitString<{lifetime}, DER>")
                }
                EncodingRules::Ber => "vps_lib::asn1::BitStringOwned".to_string(),
            },
            Type::ObjectIdentifier => "vps_lib::asn1::ObjectIdentifier".to_string(),
            Type::Real => format!("vps_lib::asn1::Real<{lifetime}, {}>", rule.display()),
            Type::Null => "()".to_string(),
            ...
            Type::PrintableString(_) => match rule {
                EncodingRules::Der => {
                    format!("vps_lib::asn1::PrintableString<{lifetime}>")
                }
                EncodingRules::Ber => "vps_lib::asn1::PrintableStringOwned".to_string(),
            },
            Type::IA5String(_) => match rule {
                EncodingRules::Der => format!("vps_lib::asn1::Ia5String<{lifetime}>"),
                EncodingRules::Ber => "vps_lib::asn1::Ia5StringOwned".to_string(),
            },
            Type::TeletexString(_) => match rule {
                EncodingRules::Der => {
                    format!("vps_lib::asn1::TeletexString<{lifetime}>")
                }
                EncodingRules::Ber => "vps_lib::asn1::TeletexStringOwned".to_string(),
            },
            Type::BmpString(_) => "vps_lib::asn1::BmpString".to_string(),
            Type::NumericString(_) => match rule {
                EncodingRules::Der => format!("vps_lib::asn1::NumericString<{lifetime}>"),
                EncodingRules::Ber => "vps_lib::asn1::NumericStringOwned".to_string(),
            },
            Type::UniversalString(_) => "vps_lib::asn1::UniversalString".to_string(),
            Type::UtcTime => "vps_lib::asn1::UtcTime".to_string(),
            Type::GeneralizedTime => {
                format!("vps_lib::asn1::GeneralizedTime<{lifetime}>")
            }
            Type::Any => match rule {
                EncodingRules::Der => format!("vps_lib::asn1::Any<{lifetime}>"),
                EncodingRules::Ber => "vps_lib::asn1::AnyOwned".to_string(),
            },
    ...
    pub(super) fn spec_type(&self, ty: &Type) -> Result<String, CodegenError> {
        Ok(match ty {
            ...
            Type::BitString(_) => "vps_lib::asn1::BitStringSpec".to_string(),
            Type::ObjectIdentifier => "vps_lib::asn1::ObjectIdentifierSpec".to_string(),
            Type::Real => "vps_lib::asn1::RealSpec".to_string(),
            Type::Null => "()".to_string(),
            Type::Utf8String(_) => "Seq<char>".to_string(),
            Type::PrintableString(_) => "vps_lib::asn1::PrintableStringSpec".to_string(),
            Type::IA5String(_) => "vps_lib::asn1::Ia5StringSpec".to_string(),
            Type::TeletexString(_) => "vps_lib::asn1::TeletexStringSpec".to_string(),
            Type::BmpString(_) => "vps_lib::asn1::BmpStringSpec".to_string(),
            Type::NumericString(_) => "vps_lib::asn1::NumericStringSpec".to_string(),
            Type::UniversalString(_) => "vps_lib::asn1::UniversalStringSpec".to_string(),
            Type::UtcTime => "vps_lib::asn1::UtcTime".to_string(),
            Type::GeneralizedTime => "vps_lib::asn1::GeneralizedTimeSpec".to_string(),
            Type::Any => "vps_lib::asn1::AnySpec".to_string(),
            Type::SequenceOf(inner, _) | Type::SetOf(inner, _) => {
