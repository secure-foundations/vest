//! Nominal Rust/VPS backend for the lossless ASN.1 frontend.
...
impl<'a> Generator<'a> {
    pub(super) fn generate(&self) -> Result<String, CodegenError> {
        ...
        output.line(format_args!(
            "// @generated by vps-asn1 from ASN.1 module `{}`.",
            self.module.name
        ));
        output.line(format_args!(
        ...
        output.blank_line();
        output.line(format_args!("use vps_lib::asn1::*;"));
        output.line(format_args!(
        ...
        output.line(format_args!("use vps_lib::asn1::tag::tag_num_from_uint;"));
        if self.mixed_rules {
            output.line(format_args!(
                "use vps_lib::asn1::modifiers::{{\
            ...
            if self.options.encoding_rules == EncodingRules::Ber {
                ...
                output.line(format_args!("use vps_lib::asn1::der::{{SetFmt, SET}};"));
            }
        }
        output.line(format_args!(
            "use vps_lib::combinators::mapped::spec::{{BiMap, SpecMap}};"
        ));
        output.line(format_args!("use vps_lib::combinators::*;"));
        output.line(format_args!("use vps_lib::combinators::Eof;"));
        ...
        output.line(format_args!("use vps_lib::core::exec::serializer::{{ByteLen, PreSerializeError, Prepare, Serializer}};"));
        output.line(format_args!("use vps_lib::core::proof::*;"));
        output.line(format_args!("use vps_lib::core::spec::*;"));
        output.line(format_args!(
            "use vstd::prelude::*;
"
        ));
...
"
    ...
    fn render_format_impl_invocation(
        ...
        output.blank_line();
        output.line(format_args!(
            "    vps_lib::{implementation}!({kind}, {ownership}, {}, {}, {}, {}{mapper});",
