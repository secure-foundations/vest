//! ASN.1-to-VPS code generation.
//!
//! The frontend is Synta's ASN.1 parser and AST. The backend emits concrete
//! nominal `vps_lib::asn1` BER or DER formats, so generated parsers and
//! serializers use VPS's verified combinators directly while enclosing formats
...
/// Parse an ASN.1 module and generate nominal VPS DER formats.
///
